...
<iframe name="iframe_51148" id="iframe_51148" src="../en/Lookup.do?lookupableImplServiceName=WorkGroupLookupableImplService" frameborder="0" scrolling="auto" width="100%" height="100%">
</iframe>
