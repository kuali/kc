...
<table width="95%" align="center">
	...
	<tr>
	  <td>
        ...
        <font color="red"><html-el:errors property="hasErrors"/></font><br>
     </td>
	</tr>
</table>

<c:import url="RuleCreationPanel.jsp"/>

<br>
<a name="rule-1"></a>
<table border=0 cellpadding=0 cellspacing=0 width="100%">
  <tbody>
    <c:forEach var="rule" items="${Rule2Form.myRules.rules}" varStatus="status">
      <tr>
        ...
        <td>
          ...
          <jsp:include page="RulePanelEdit.jsp"/>
        </td>
        <td width=20><img src="images/pixel_clear.gif" alt="" height=20 width=20></td>
      </tr>
    </c:forEach>
  ...
  <table width="100%" border=0 cellpadding=0 cellspacing=0 class="bord-r-t" >
    <tr>
      <td class="thnormal" align="center" colspan="6">
        <c:set var="inputLocation" value="RuleEdit.jsp" scope="request"/>
