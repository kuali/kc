	     ...
	     <tr>
	      ...
	      <tr>
	  	  ...
	  	  <tr>
			  ...
			  <html-el:image property="methodToCall.performLookup" src="images/searchicon.gif" alt="search" align="absmiddle" onclick="javascript:configureLookup('RoleLookupableImplService', 'ActionRequest', 'roleName', '${ctr}');"/>	  	    
	  	    </td>
	  	  </tr>
	  	  <tr>
