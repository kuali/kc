...
jQuery(function(){
  ...
  window.setInterval(publishHeight, 500);
    ...
    <div id="view_div">
        ...
        <html:form styleId="kualiForm" action="/iacucMeetingManagement.do"
            ...
            <div class="headerarea" id="headerarea">
                <h1>Iacuc Meeting 
                    <a href="${pageContext.request.contextPath}/kr/help.do?methodToCall=getDocumentHelpText&amp;documentTypeName=IacucCommitteeDocument" tabindex="1000000" target="helpWindow"  title="[Help]document help"><img src="kr/static/images/my_cp_inf.gif" alt="[Help]document help" hspace=5 border=0  align="middle">
                    </a>
                </h1>
            </div>
        ...
        <!--TABBED TOP NAVIGATION-->
            ...
            <!-- Tabbed Panel Head: Protocols Submitted -->
                                <kra-meeting:protocolSubmitted 
                                	protocolSubmissionBOClassName="org.kuali.kra.iacuc.actions.submit.IacucProtocolSubmission" 
                                	meetingManagementActionName="iacucMeetingManagement" />
            ...
            <!-- Tabbed Panel Head: Attachments -->
                                <kra-meeting:meetingAttachments 
                                	attachmentViewAction="iacucMeetingManagement" />  
