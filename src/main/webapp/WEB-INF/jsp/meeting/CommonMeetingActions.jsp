...
<html:form styleId="kualiForm" action="/commonMeetingActions.do"
	method="post" 
    ...
    $(document).ready(function()     {
       ...
       if (viewId) {
         //  $("#"+viewId).click();
           ...
           openNewWindow('commonMeetingActions',viewId.substr(0,viewId.length - 1),viewId.substr(viewId.length - 1) - 1,0,'false');            
