...
<kul:documentPage showDocumentInfo="true"
	htmlFormAction="proposalDevelopmentProposalSummary"
	documentTypeName="ProposalDevelopmentDocument" renderMultipart="true"
	showTabButtons="true" auditCount="0"
	headerDispatch="${KualiForm.headerDispatch}"
	headerTabActive="proposalSummary">
	...
	<div id="workarea">
		...
		<kra-summary:proposalDevelopmentDataValidation
			auditActivated="${KualiForm.auditActivated}" topTab="true" />
	...
	${KualiForm.proposalDevelopmentParameters['propSummaryDisclaimerText'].value }
		...
		<html:image
			src="${ConfigProperties.kr.externalizable.images.url}buttonsmall_reload.gif"
			styleClass="globalbuttons" property="methodToCall.reload"
			title="reload" alt="reload"
			onclick="excludeSubmitRestriction=true;resetScrollPosition();"
			tabindex="${tabindex}" />

		<c:if
			test="${!empty KualiForm.documentActions[Constants.KUALI_ACTION_CAN_CLOSE]}">
			<html:image
				...
				title="close" alt="close" tabindex="${tabindex}" />
		</c:if>
