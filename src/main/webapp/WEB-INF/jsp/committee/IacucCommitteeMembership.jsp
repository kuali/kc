...
<kul:documentPage 
    ...
    <kra-committee:committeeMemberships readOnly="${readOnly}" membershipRoleValuesFinderClassName="org.kuali.kra.iacuc.committee.keyvalue.IacucMembershipRoleValuesFinder"/>
