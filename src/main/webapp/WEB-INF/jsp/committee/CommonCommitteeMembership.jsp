...
<kul:documentPage 
	...
	htmlFormAction="commonCommitteeMembership" 
    ...
    <kra-committee:committeeMemberships readOnly="${readOnly}" membershipRoleValuesFinderClassName="org.kuali.kra.common.committee.keyvalue.MembershipRoleValuesFinder"/>
