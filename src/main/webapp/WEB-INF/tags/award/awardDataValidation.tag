...
<kul:tabTop tabTitle="Data Validation" defaultOpen="${KualiForm.awardAuditActivated}"  
            tabErrorKey="">
	<div class="tab-container"  align="center">
				...
				<td>
                    ...
                    <ul>
                      ...
                      <li>errors that prevent submission to grants.gov</li>
						...
						<p align="center">
							<c:choose>
								<c:when test="${KualiForm.awardAuditActivated}"><html:image property="methodToCall.deactivate" src="${ConfigProperties.kra.externalizable.images.url}tinybutton-validateoff.gif" styleClass="tinybutton" alt="turn off validation"/></c:when>
		...
		<c:if test="${KualiForm.awardAuditActivated}">
			<table cellpadding="0" cellspacing="0" summary="">
