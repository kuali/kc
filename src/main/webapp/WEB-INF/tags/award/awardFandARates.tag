...
<kul:tab tabTitle="Rates" defaultOpen="false" tabErrorKey="newAwardFandaRate.*,document.awardList[0].awardFandaRate*,document.awardList[0].benefitsRates*,awardCommentTypeCodeError(20)*,awardCommentTypeCodeError(8)*" auditCluster="requiredFieldsAuditErrors" tabAuditKey="" useRiceAuditMode="true">
