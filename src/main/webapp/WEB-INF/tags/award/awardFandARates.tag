...
<kul:tab tabTitle="Rates" defaultOpen="false" auditCluster="requiredFieldsAuditErrors" tabAuditKey="" useRiceAuditMode="true">
    <kul:innerTab tabTitle="F&A Rates" parentTab="Rates" defaultOpen="false" tabErrorKey="newAwardFandaRate.*,document.awardList[0].awardFandaRate*,document.awardList[0].benefitsRates*">
    ...
    <kul:innerTab tabTitle="Benefits Rates" parentTab="Rates" defaultOpen="false" tabErrorKey="document.awardList[0].specialEbRateOnCampus,document.awardList[0].specialEbRateOffCampus">
		<div class="tab-container" align="right">
			<h3>
