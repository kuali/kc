...
<kul:tab tabTitle="Reports" defaultOpen="false" tabErrorKey="" auditCluster="reportsAuditErrors" tabAuditKey="document.reportTermsAuditRules*" useRiceAuditMode="true">
