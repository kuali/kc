...
<kul:tab tabTitle="Transactions (${KualiForm.document.awardNumber})" defaultOpen="false" tabErrorKey="document.newAwardAmountTransaction*,transactionBean.newPendingTransaction.obligatedAmount,transactionBean.newPendingTransaction.anticipatedAmount,transactionBean.newPendingTransaction.timeAndMoneyTransaction,transactionBean.newPendingTransaction.sourceAwardNumber,transactionBean.newPendingTransaction.destinationAwardNumber" auditCluster="requiredFieldsAuditErrors" tabAuditKey="" useRiceAuditMode="true">
