...
<kul:innerTab parentTab="Opportunity Search" defaultOpen="false" tabTitle="Opportunity" tabErrorKey="document.s2sOpportunity.opportunityId,document.s2sOpportunity.opportunityTitle,document.s2sOpportunity.s2sSubmissionTypeCode,document.s2sOpportunity.revisionCode,document.s2sOpportunity.cfdaNumber,document.s2sOpportunity.competetionId,document.s2sOpportunity.openingDate,document.s2sOpportunity.closingDate,document.s2sOpportunity.instructionUrl,document.s2sOpportunity.schemaUrl,document.s2sOpportunity.revisionOtherDescription" auditCluster="grantsGovAuditWarnings" tabAuditKey="document.s2sOpportunity.s2sSubmissionTypeCode">
 ...
 <tbody id="G1">	
	<tr>
		<th><div align="right"><kul:htmlAttributeLabel attributeEntry="${s2sOpportunity.opportunityId}" /></div></th>
	...
	<tr>
		<th><div align="right"><kul:htmlAttributeLabel attributeEntry="${s2sOpportunity.opportunityTitle}" /></div></th>
	...
	<tr>
		<th><div align="right"><kul:htmlAttributeLabel attributeEntry="${s2sOpportunity.s2sSubmissionTypeCode}" /></div></th>		
	...
	<tr>
		<th ><div align="right"><kul:htmlAttributeLabel attributeEntry="${s2sOpportunity.cfdaNumber}" /></div></th>
	...
	<tr>
		<th ><div align="right"><kul:htmlAttributeLabel attributeEntry="${s2sOpportunity.competetionId}" /></div></th>
	...
	<tr>
		<th ><div align="right"><kul:htmlAttributeLabel attributeEntry="${s2sOpportunity.openingDate}" /></div></th>
	...
	<tr>
		<th ><div align="right"><kul:htmlAttributeLabel attributeEntry="${s2sOpportunity.closingDate}" /></div></th>
	...
	<tr>
		<th ><div align="right"><kul:htmlAttributeLabel attributeEntry="${s2sOpportunity.instructionUrl}" /></div></th>
	...
	<tr>
		<th ><div align="right"><kul:htmlAttributeLabel attributeEntry="${s2sOpportunity.schemaUrl}" /></div></th>
