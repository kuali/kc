...
<kul:innerTab tabTitle="Close Enrollment" parentTab="" defaultOpen="false" tabErrorKey="actionHelper.protocolCloseEnrollmentBean*">
        ...
        <table class="tab" cellpadding="0" cellspacing="0" summary=""> 
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <nobr>
                            <kul:htmlControlAttribute property="actionHelper.protocolCloseEnrollmentBean.actionDate" attributeEntry="${attributes.actionDate}"  />
                        </nobr>
                    </td>
                </tr>
                
                <c:if test="${KualiForm.actionHelper.canAddCloseEnrollmentReviewerComments}">
	                <tr>
	                    <td colspan="2">
                ...
                <tr>
                    <td align="center" colspan="2">
                        <div align="center">
                            <html:image property="methodToCall.closeEnrollment.anchor${tabKey}"
