        ...
        <table class="tab" cellpadding="0" cellspacing="0" summary=""> 
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <nobr>
                            <kul:htmlControlAttribute property="actionHelper.protocolExpireBean.actionDate" attributeEntry="${attributes.actionDate}"  />
                        </nobr>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        <kra-irb-action:reviewComments bean="${KualiForm.actionHelper.protocolExpireBean.reviewCommentsBean}"
                                                       property="actionHelper.protocolExpireBean.reviewCommentsBean"
                                                       action="${action}"
                                                       actionName="Expire" />
                   </td>
                </tr>
