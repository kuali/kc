...
<kul:innerTab tabTitle="Request for Termination" parentTab="" defaultOpen="false" tabErrorKey="actionHelper.protocolTerminateRequest*">
            ...
            <tbody>
                <tr>
	                ...
	                <td align="left" valign="middle">
	                	<html:file property="actionHelper.protocolTerminateRequestBean.file" />
					</td>
                </tr>
                <tr>
                    <th width="15%"> 
                    ...
                    <td colspan="3">
                        <nobr>
                        <kul:htmlControlAttribute property="actionHelper.protocolTerminateRequestBean.reason" attributeEntry="${attributes.reason}" />
                        </nobr>
                    </td>
                </tr>
                <tr>
