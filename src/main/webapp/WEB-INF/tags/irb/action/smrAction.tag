...
<kul:innerTab tabTitle="Return for Specific Minor Revisions" parentTab="" defaultOpen="false" tabErrorKey="actionHelper.protocolSMRBean*">
   ...
   <kra-irb-action:padLeft>
        <table class="tab" cellpadding="0" cellspacing="0" summary=""> 
            <tbody>
                ...
                <tr>
                    <td colspan="2">
                        <kra-irb-action:reviewComments bean="${KualiForm.actionHelper.protocolSMRBean.reviewComments}"
                                                       property="actionHelper.protocolSMRBean.reviewComments"
                                                       action="${action}"
                                                       actionName="SMR"
