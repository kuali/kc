        ...
        <table class="tab" cellpadding="0" cellspacing="0" summary=""> 
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <nobr>
                            <kul:htmlControlAttribute property="actionHelper.protocolDeferBean.comments" attributeEntry="${attributes.comments}" />
                        </nobr>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <nobr>
                            <kul:htmlControlAttribute property="actionHelper.protocolDeferBean.actionDate" attributeEntry="${attributes.actionDate}"  />
                        </nobr>
                    </td>
                </tr>
                ...
                <tr>
                    <td align="center" colspan="2">
                        <div align="center">
                            <html:image property="methodToCall.defer.anchor${tabKey}"
