            ...
            <tbody>
                ...
                <c:if test="${KualiForm.protocolHelper.displayBillable}">
                	<tr>
                		...
                		<td>
                			<kul:htmlControlAttribute property="actionHelper.protocolExpediteApprovalBean.billable" attributeEntry="${attributes.billable}" disabled="${KualiForm.protocolHelper.billableReadOnly}" />
                		</td>
                	</tr>
                </c:if>
