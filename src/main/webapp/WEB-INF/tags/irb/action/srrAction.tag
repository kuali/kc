        ...
        <table class="tab" cellpadding="0" cellspacing="0" summary=""> 
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <nobr>
                            <kul:htmlControlAttribute property="actionHelper.protocolSRRBean.comments" attributeEntry="${attributes.comments}" />
                        </nobr>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <nobr>
                            <kul:htmlControlAttribute property="actionHelper.protocolSRRBean.actionDate" attributeEntry="${attributes.actionDate}"  />
                        </nobr>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        <kra-irb-action:reviewComments bean="${KualiForm.actionHelper.protocolSRRBean.reviewCommentsBean}"
                                                       property="actionHelper.protocolSRRBean.reviewCommentsBean"
                                                       action="${action}"
                                                       actionName="SRR" />
                   </td>
                </tr>
                ...
                <tr>
                    <td align="center" colspan="2">
                        <div align="center">
                            <html:image property="methodToCall.returnForSRR.anchor${tabKey}"
