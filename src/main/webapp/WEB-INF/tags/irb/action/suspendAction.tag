...
<kul:innerTab tabTitle="Suspend" parentTab="" defaultOpen="false" tabErrorKey="actionHelper.protocolSuspendBean*">
        ...
        <table class="tab" cellpadding="0" cellspacing="0" summary=""> 
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <nobr>
                            <kul:htmlControlAttribute property="actionHelper.protocolSuspendBean.actionDate" attributeEntry="${attributes.actionDate}"  />
                        </nobr>
                    </td>
                </tr>
                
                <c:if test="${KualiForm.actionHelper.canAddSuspendReviewerComments}">
	                <tr>
	                    <td colspan="2">
	                        <kra-irb-action:reviewComments bean="${KualiForm.actionHelper.protocolSuspendBean.reviewCommentsBean}"
	                                                       property="actionHelper.protocolSuspendBean.reviewCommentsBean"
	                                                       action="${action}"
	                                                       actionName="Suspend" />
	                   </td>
	                </tr>
