			...
			<tbody>
                            <tr>
                                ...
                                <td align="left" valign="middle" width="85%">
									...
									onclick="questionnairePop('${KualiForm.document.protocolList[0].protocolNumber}','${KualiForm.actionHelper.selectedSubmission.submissionNumber}','${KualiForm.formKey}',' ${KualiForm.document.sessionDocument}'); return false;"
