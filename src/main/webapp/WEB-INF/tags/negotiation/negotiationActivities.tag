...
<kul:innerTab parentTab="Activities & Attachments" tabTitle="Activity/Location History" defaultOpen="false" useCurrentTabIndexAsKey="true" overrideDivClass="innerTab-h3head">
	<table>
		...
		<c:forEach items="${KualiForm.negotiationActivityHistoryLineBeans}" var="current">
			...
			<tr>
				<td><c:out value="${lineNumber}"/></td>
				<td><c:out value="${current.activityType}"/></td>
				<td><c:out value="${current.location}"/></td>
				<td><c:out value="${current.startDate}"/></td>
				<td><c:out value="${current.endDate}"/></td>
				<td><c:out value="${current.activityDays}"/></td>
				<td><c:out value="${current.efectiveLocationStartDate}"/></td>
				<td><c:out value="${current.efectiveLocationEndDate}"/></td>
				<td><c:out value="${current.locationDays}"/></td>
