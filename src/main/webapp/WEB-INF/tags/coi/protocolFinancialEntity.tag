...
<table cellpadding=0 cellspacing=0 summary="">
    <tr>
        <td>
            <kul:innerTab tabTitle="Protocol - ${disclProject.eventProjectBo.protocolNumber} : ${disclProject.eventProjectBo.title}" parentTab="Protocol" defaultOpen="false" tabErrorKey="disclosureHelper.newDisclosurePersonUnit.*,document.coiDisclosureList[0].disclosurePersons[0]*" useCurrentTabIndexAsKey="false">
                    ...
                    <table class=tab cellpadding="0" cellspacing="0" summary="">
                        ...
                        <%-- Header --%>
                                 <tr>
                                    ...
                                    <th><div align="center"></div>Protocol Name</th> 
                                    <th><div align="center"></div>Protocol Type</th> 
                                    <th><div align="center">Application Date</div></th> 
