...
<kul:tab defaultOpen="false" tabTitle="Award and Financial Entities" auditCluster="" tabAuditKey="" useRiceAuditMode="true"
    tabErrorKey="disclosureHelper.newCoiDisclProject.*" >
	<div class="tab-container" align="center">
 
       <div class="div_AwardList">
                <h3>
    		        <span class="subhead-left">Awards</span>
