            ...
            <table style="border:none; width:100%;" cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td style="border:none; width:20px; vertical-align:bottom;">
                        <kul:expandedTextArea textAreaFieldName="document.institutionalProposal.proposalIpReviewJoin.intellectualPropertyReview.generalComments" action="institutionalProposalHome" textAreaLabel="General Comments" viewOnly="true" />
                    </td>
                </tr>
            </table>
        </td>
        ...
        <td>
            <table style="border:none; width:100%;" cellpadding=0 cellspacing=0>
                <tr>
                    ...
                    <td style="border:none; width:20px; vertical-align:bottom;">
                        <kul:expandedTextArea textAreaFieldName="document.institutionalProposal.proposalIpReviewJoin.intellectualPropertyReview.reviewerComments" action="institutionalProposalHome" textAreaLabel="Reviewer Comments" viewOnly="true" />
                    </td>
                </tr>
            </table>
        </td>
