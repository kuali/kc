	             		 	...
	             		 	<table cellpadding=0 cellspacing=0 summary="">
	             		 		...
	             		 		<c:forEach items="${budgetSubAwards.budgetSubAwardPeriodDetails}" var="periodDetails" varStatus="periodStatus">
	             		 			<tr>
	             		 				...
	             		 				<td class="infoline" style="text-align: center;"><kul:htmlControlAttribute property="document.budget.budgetSubAwards[${status.index}].budgetSubAwardPeriodDetails[${periodStatus.index}].directCost" attributeEntry="${periodDetailAttributes.directCost}" styleClass="amount" readOnly="${readOnly}"/></td>
	             		 				<td class="infoline" style="text-align: center;"><kul:htmlControlAttribute property="document.budget.budgetSubAwards[${status.index}].budgetSubAwardPeriodDetails[${periodStatus.index}].indirectCost" attributeEntry="${periodDetailAttributes.indirectCost}" styleClass="amount" readOnly="${readOnly}"/></td>
	             		 				...
	             		 				<td class="infoline" style="text-align: center;"><kul:htmlControlAttribute property="document.budget.budgetSubAwards[${status.index}].budgetSubAwardPeriodDetails[${periodStatus.index}].totalCost" attributeEntry="${periodDetailAttributes.totalCost}" styleClass="amount" readOnly="true"/></td>
	             		 			</tr>
	             		 		</c:forEach>
	             		 	</table>	
	             		 </kul:innerTab>
