  ...
  <table border="0" cellpadding="2" cellspacing="0">
   ...
   <tr>
    ...
    <td>
      ...
      <portal:portalLink displayTitle="false" title="Proposal Development" url="${ConfigProperties.workflow.url}/DocumentSearch.do?methodToCall=doDocSearch&docTypeFullName=ProposalDevelopmentDocument"><img src="static/images/searchicon.gif" alt="lookup" width="16" border="0" align="absmiddle"></portal:portalLink>
    </td>
  </tr>
  <tr>
