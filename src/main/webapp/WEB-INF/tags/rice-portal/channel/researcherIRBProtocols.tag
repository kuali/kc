...
<div class="body">
    <strong>Actions </strong>
      ...
      <ul class="chan">
        <li><portal:portalLink displayTitle="false" title="Create IRB Protocol" url="${ConfigProperties.application.url}/protocolProtocol.do?methodToCall=docHandler&command=initiate&docTypeName=ProtocolDocument">Create IRB Protocol</portal:portalLink></li>
        <li><portal:portalLink displayTitle="true" title="Amend or Renew IRB Protocol" url="${ConfigProperties.application.url}/kr/lookup.do?methodToCall=search&businessObjectClassName=org.kuali.kra.irb.Protocol&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true&lookupActionAmendRenewProtocol=true" /></li>
        ...
        <li><portal:portalLink displayTitle="true" title="Request a Status Change on a IRB Protocol" url="${ConfigProperties.application.url}/kr/lookup.do?methodToCall=search&businessObjectClassName=org.kuali.kra.irb.Protocol&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true&lookupActionRequestProtocol=true" /></li>
      </ul>
