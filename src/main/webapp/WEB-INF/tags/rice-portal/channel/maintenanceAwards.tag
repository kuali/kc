...
<div class="body">
  <ul class="chan">
    ...
    <li><portal:portalLink displayTitle="true" title="Financial Indirect Cost Type Code" url="kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.kra.external.award.FinancialIndirectCostTypeCode&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" /></li>
