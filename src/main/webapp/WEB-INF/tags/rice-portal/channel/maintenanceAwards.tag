...
<div class="body">
  <ul class="chan">
    ...
    <li><portal:portalLink displayTitle="true" title="FinancialObjectCodeMapping" url="kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.kra.external.budget.FinancialObjectCodeMapping&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" /></li>
