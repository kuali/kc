...
<div class="body">
  <ul class="chan">
    ...
    <li><portal:portalLink displayTitle="true" title="Attachment Type" url="kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.kra.award.notesandattachments.attachments.AwardAttachmentType&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true&docFormKey=88888888" /></li>
    ...
    <li><portal:portalLink displayTitle="true" title="Basis of Payment" url="kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.kra.award.home.AwardBasisOfPayment&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true&docFormKey=88888888" /></li>
    <li><portal:portalLink displayTitle="true" title="Valid Award Basis of Payment" url="kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.kra.award.home.ValidAwardBasisPayment&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true&docFormKey=88888888" /></li>
    ...
    <li><portal:portalLink displayTitle="true" title="OSP File Copy" url="kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.kra.award.home.Distribution&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" /></li>
    ...
    <li><portal:portalLink displayTitle="true" title="Report Status" url="kr/lookup.do?methodToCall=start&businessObjectClassName=org.kuali.kra.award.paymentreports.ReportStatus&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true" /></li>
