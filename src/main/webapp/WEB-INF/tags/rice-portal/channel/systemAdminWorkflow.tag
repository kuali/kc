...
<div class="body">
  ...
  <!--  TODO : not sure what it is in rice 1.1 
    ...
    <li><portal:portalLink displayTitle="false" title='Workflow Services' url='kr/lookup.do?businessObjectClassName=org.kuali.rice.kew.rule.bo.RuleAttribute&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true'>Rule Attribute</portal:portalLink></li>
    <li><portal:portalLink displayTitle="false" title='Workflow Services' url='kr/lookup.do?businessObjectClassName=org.kuali.rice.kew.rule.bo.RuleTemplate&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true'>Rule Template</portal:portalLink></li>
  ...
  <!--  TODO : not sure what it is in rice 1.1 
    <li><portal:portalLink displayTitle="false" title='Workflow Services' url='kr/lookup.do?businessObjectClassName=org.kuali.rice.kim.bo.group.impl.KimGroupImpl&docFormKey=88888888&returnLocation=${ConfigProperties.application.url}/portal.do&hideReturnLink=true'>Workgroup Type</portal:portalLink></li> -->
