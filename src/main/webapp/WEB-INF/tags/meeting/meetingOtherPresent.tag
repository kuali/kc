...
<c:set var="committeeScheduleAttendanceAttributes" value="${DataDictionary.CommitteeScheduleAttendance.attributes}" />
        ...
        <%--	<tr>
        		...
        		<kul:htmlAttributeHeaderCell literalLabel="Role" scope="col" />
	             ...
	             <tr>
	                ...
	                <td align="left" valign="middle" width="40%">
	               	<div align="left">
                        ...
                        <kra:expandedTextArea textAreaFieldName="meetingHelper.otherPresentBeans[${status.index}].attendance.comments" action="meetingManagement" textAreaLabel="${committeeScheduleAttendanceAttributes.comments.label}" />
	               	</div>
					</td>
                   <c:if test="${!readOnly}">
						<td  width="15%">
