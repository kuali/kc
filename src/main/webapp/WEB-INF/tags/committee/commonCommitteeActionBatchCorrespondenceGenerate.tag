...
<c:set var="committeeAttributes" value="${DataDictionary.CommonCommittee.attributes}" />
    ...
    <table cellpadding=0 cellspacing=0 border=0>
        <tr>
            <td class="infoline" colspan="2">
                ...
                <kra-committee:commonCommitteeActionBatchCorrespondenceRun committeeBatchCorrespondence="${KualiForm.committeeHelper.generateBatchCorrespondence[0]}" committeeBatchCorrespondenceProperty="committeeHelper.generateBatchCorrespondence[0]" />
            	</div>
            </td>
        </tr>
        <tr>
