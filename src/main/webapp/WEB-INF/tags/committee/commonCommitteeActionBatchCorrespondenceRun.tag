...
<%@ attribute name="committeeBatchCorrespondence" type="org.kuali.kra.common.committee.bo.CommitteeBatchCorrespondence" description="The committee batch correspondence." required="true" %>
