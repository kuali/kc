	...
	<%--
	 ...
	 --%>
        <h3>
	        ...
	        <c:if test = "${not empty KualiForm.questionnaireHelper.answerHeaders[answerHeaderIndex].answerHeaderId}" > 
 	        <html:image property="methodToCall.printSubmissionQuestionnaireAnswer.line${KualiForm.questionnaireHelper.answerHeaders[answerHeaderIndex].answerHeaderId}.anchor"
