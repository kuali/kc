...
<kul:innerTab tabTitle="${tabTitle}"
	...
	<div class="tab-container" align="center">
        ...
        <h3>
            <span class="subhead-left"><a href="#" id ="questionpanelcontrol:${property}:${answerHeaderIndex}" class="questionpanel"><img src='kr/images/tinybutton-show.gif' alt='show/hide panel' title='show/hide panel' width='45' height='15' border='0' align='absmiddle'></a>
                Questions </span>
                            ...
                            <td class="content_questionnaire">
                                <div class="Qdiv" id="${qname}div">
                                    <div class="Qquestiondiv">
                                        ...
                                        <span class="Qquestion"><b>QUESTION</b><Br/>${answer.question.question}</span>
