...
BEGIN
    ...
    role_loop:LOOP
        ...
        SET @insert_role_perm := CONCAT('INSERT INTO KRIM_ROLE_PERM_T (ROLE_PERM_ID, ROLE_ID, PERM_ID, ACTV_IND, OBJ_ID, VER_NBR)  VALUES ((SELECT MAX(ID) FROM KRIM_ROLE_PERM_ID_BS_S),(SELECT MAX(ID) FROM KRIM_ROLE_ID_BS_S),',rec,',''Y'',UUID(), 1)');
