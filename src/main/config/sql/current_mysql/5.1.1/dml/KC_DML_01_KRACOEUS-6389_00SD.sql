...
(25, (SELECT MODULE_CODE FROM COEUS_MODULE WHERE DESCRIPTION = 'COI Disclosure'), 16, 'Screening', NOW(), 'admin', 1, UUID())
/
...
values ((SELECT (MAX(ID)) FROM SEQ_QUESTIONNAIRE_REF_ID), (SELECT (MAX(ID)) FROM SEQ_QUESTIONNAIRE_ID), 1, 'COI Screening Questionnaire',
'Screening Questionnaire for Conflict of Interest to Determine if a financial entity will be required or not.', NOW(), 'admin', 'Y', 1, UUID(), null)
/
INSERT INTO SEQ_QUESTIONNAIRE_REF_ID VALUES(NULL)
/
...
VALUES ((SELECT (MAX(ID)) FROM SEQ_QUESTIONNAIRE_REF_ID), (SELECT QUESTIONNAIRE_REF_ID FROM QUESTIONNAIRE WHERE NAME = 'COI Screening Questionnaire' AND SEQUENCE_NUMBER = 1),
(SELECT MODULE_CODE FROM COEUS_MODULE WHERE DESCRIPTION = 'COI Disclosure'),
(SELECT SUB_MODULE_CODE FROM COEUS_SUB_MODULE WHERE DESCRIPTION = 'Screening'), NULL, 'COI Screening Questionnaire', 1, 'admin', NOW(), UUID(), 1, 'Y')
/
INSERT INTO SEQ_QUESTIONNAIRE_REF_ID VALUES(NULL)
/
INSERT INTO SEQ_QUESTION_ID VALUES(NULL)
/
...
VALUES ((SELECT (MAX(ID)) FROM SEQ_QUESTIONNAIRE_REF_ID),(SELECT (MAX(ID)) FROM SEQ_QUESTION_ID),1,'C',
...
'A', '7', '1', null, null, null, 1, null, NOW(), 'admin', 1, UUID(), null)
/
INSERT INTO SEQ_QUESTIONNAIRE_REF_ID VALUES(NULL)
/
...
1, 0, 1, 'N', null, null, 'admin', NOW(), UUID(), 1)
/
INSERT INTO SEQ_QUESTIONNAIRE_REF_ID VALUES(NULL)
/
INSERT INTO SEQ_QUESTION_ID VALUES(NULL)
...
2, 0, 1, 'N', null, null, 'admin', NOW(), UUID(), 1)
/
INSERT INTO SEQ_QUESTIONNAIRE_REF_ID VALUES(NULL)
/
INSERT INTO SEQ_QUESTION_ID VALUES(NULL)
...
3, 0, 1, 'N', null, null, 'admin', NOW(), UUID(), 1)
/
INSERT INTO SEQ_QUESTIONNAIRE_REF_ID VALUES(NULL)
/
INSERT INTO SEQ_QUESTION_ID VALUES(NULL)
...
4, 0, 1, 'N', null, null, 'admin', NOW(), UUID(), 1)
/
INSERT INTO SEQ_QUESTIONNAIRE_REF_ID VALUES(NULL)
/
INSERT INTO SEQ_QUESTION_ID VALUES(NULL)
...
5, 0, 1, 'N', null, null, 'admin', NOW(), UUID(), 1)
/
INSERT INTO SEQ_QUESTIONNAIRE_REF_ID VALUES(NULL)
/
INSERT INTO SEQ_QUESTION_ID VALUES(NULL)
...
6, 0, 1, 'N', null, null, 'admin', NOW(), UUID(), 1)
/
INSERT INTO SEQ_QUESTIONNAIRE_REF_ID VALUES(NULL)
/
INSERT INTO SEQ_QUESTION_ID VALUES(NULL)
...
7, 0, 1, 'N', null, null, 'admin', NOW(), UUID(), 1)
/
INSERT INTO SEQ_QUESTIONNAIRE_REF_ID VALUES(NULL)
/
INSERT INTO SEQ_QUESTION_ID VALUES(NULL)
...
8, 0, 1, 'N', null, null, 'admin', NOW(), UUID(), 1)
/
INSERT INTO SEQ_QUESTIONNAIRE_REF_ID VALUES(NULL)
/
INSERT INTO SEQ_QUESTION_ID VALUES(NULL)
...
9, 0, 1, 'N', null, null, 'admin', NOW(), UUID(), 1)
/
