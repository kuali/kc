...
INSERT INTO KRIM_ROLE_PERM_T (ROLE_PERM_ID,OBJ_ID,VER_NBR,ROLE_ID,PERM_ID,ACTV_IND)
       VALUES ((SELECT (MAX(ID)) FROM KRIM_PERM_ROLE_ID_BS_S),SYS_GUID(),1,(SELECT ROLE_ID FROM KRIM_ROLE_T WHERE ROLE_NM='Coi Disclosure Reviewer'),(SELECT PERM_ID FROM KRIM_PERM_T WHERE NM='Maintain Coi FE Status During Review'),'Y')
/
