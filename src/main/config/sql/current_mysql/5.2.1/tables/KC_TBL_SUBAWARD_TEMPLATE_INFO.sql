...
(
  ...
  SUBAWARD_CODE                        VARCHAR(20 BYTE) NOT NULL, 
  SEQUENCE_NUMBER                      DECIMAL(4,0) NOT NULL, 
  SOW_OR_SUB_PROPOSAL_BUDGET           VARCHAR(1 BYTE),
  ...
  PERF_SITE_DIFF_FROM_ORG_ADDR         VARCHAR(1 BYTE),
  PERF_SITE_SAME_AS_SUB_PI_ADDR	       VARCHAR(1 BYTE),
  SUB_REGISTERED_IN_CCR                VARCHAR(1 BYTE),
  SUB_EXEMPT_FROM_REPORTING_COMP	   VARCHAR(1 BYTE),
  PARENT_DUNS_NUMBER                   VARCHAR(20 BYTE),
  PARENT_CONGRESSIONAL_DISTRICT	       VARCHAR(20 BYTE),
  EXEMPT_FROM_RPRTG_EXEC_COMP	       VARCHAR(1 BYTE),
  COPYRIGHT_TYPE 	                   DECIMAL(3,0),
  AUTOMATIC_CARRY_FORWARD 	           VARCHAR(1 BYTE),
  CARRY_FORWARD_REQUESTS_SENT_TO 	   DECIMAL(3,0),
  TREATMENT_PRGM_INCOME_ADDITIVE 	   VARCHAR(1 BYTE),
  APPLICABLE_PROGRAM_REGULATIONS 	   VARCHAR(50 BYTE),
