...
VALUES ((SELECT (MAX(ID)) FROM KRIM_GRP_MBR_ID_BS_S),(SELECT GRP_ID FROM KRIM_GRP_T WHERE NMSPC_CD = 'KC-WKFLW' AND GRP_NM = 'IACUCAdmin'),(SELECT PRNCPL_ID FROM KRIM_PRNCPL_T WHERE PRNCPL_NM = 'kr'),'P',NOW(),UUID(),1)
/
DELIMITER ;
