...
VALUES ((SELECT (MAX(ID)) FROM SEQ_SPONSOR_FORM_TEMPLATES),(SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE PACKAGE_NAME = 'NIH 398 package (Coeus 4.0)'),8,'Face Page Continued','Face Page Continued.xslt','text/xml',EMPTY_CLOB(),'admin',NOW(),UUID(),1)
/
