...
Insert into SPONSOR_FORM_TEMPLATES (OBJ_ID,VER_NBR,SPONSOR_CODE,PACKAGE_NUMBER,PAGE_NUMBER,PAGE_DESCRIPTION,UPDATE_TIMESTAMP,UPDATE_USER,FILE_NAME,CONTENT_TYPE,FORM_TEMPLATE) values (sys_guid(),1,'000340', 5,'15','BioSketch',sysdate,'admin','BioSketch.xslt','text/xml',EMPTY_CLOB());
...
Insert into SPONSOR_FORM_TEMPLATES (OBJ_ID,VER_NBR,SPONSOR_CODE,PACKAGE_NUMBER,PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,FORM_TEMPLATE,UPDATE_TIMESTAMP,UPDATE_USER) values (sys_guid(),1,'000500',1,1,'Cover Page','Cover Page.xslt','text/xml',EMPTY_CLOB(),sysdate,'admin');
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES
WHERE
