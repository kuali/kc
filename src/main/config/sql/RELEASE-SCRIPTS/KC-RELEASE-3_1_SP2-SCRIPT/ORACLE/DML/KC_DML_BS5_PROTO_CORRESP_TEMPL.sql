...
insert into PROTO_CORRESP_TEMPL (PROTO_CORRESP_TEMPL_ID,PROTO_CORRESP_TYPE_CODE,COMMITTEE_ID,FILE_NAME,CORRESPONDENCE_TEMPLATE,UPDATE_TIMESTAMP,UPDATE_USER,OBJ_ID) values (SEQ_PROTO_CORRESP_TEMPL.nextVal, 10,'DEFAULT','10-ScheduleMinutes.xslt',EMPTY_CLOB(),sysdate,'admin',sys_guid());
...
WHERE
PROTO_CORRESP_TYPE_CODE =  10 and COMMITTEE_ID='DEFAULT'   FOR UPDATE;
buffer := '<xsl:if test="n1:GuestFlag =&apos;false&apos; and  n1:AlternateFlag =&apos;false&apos; and  n1:PresentFlag =&apos;false&apos;">
                                    <fo:list-block provisional-distance-between-starts="7mm" provisional-label-separation="2mm" start-indent="2mm" space-before.optimum="4pt" space-after.optimum="4pt">
                                        <xsl:for-each select="n1:AttendentName">
                                            <fo:list-item>
                                                <fo:list-item-label end-indent="label-end()">
                                ...
                                <!-- case 893 - remove Withdrawn protocols  -->
                                 <xsl:if test="n1:SubmissionStatusCode != 210">
                                    ...
                                    <fo:table width="100%" space-before.optimum="1pt" space-after.optimum="2pt">
                                        ...
                                        <fo:table-body>
                                            <fo:table-row>
                                                <fo:table-cell display-align="before" width="106pt" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" text-align="start" border-style="solid" ';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
END;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
...
WHERE
PROTO_CORRESP_TYPE_CODE =  10 and COMMITTEE_ID='DEFAULT'   FOR UPDATE;
buffer := 'border-width="1pt" border-color="white">
                                                    <fo:block>
                                    ...
                                    <fo:table width="100%" space-before.optimum="1pt" space-after.optimum="2pt">
                                        ...
                                        <fo:table-body>
                                            ...
                                            <fo:table-row>
                                                ...
                                                <fo:table-cell display-align="before" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" text-align="start" border-style="solid" border-width="1pt" border-color="white">
                                                    <fo:block>
                                                        <xsl:if test="../n1:ProtocolSummary/n1:ProtocolMasterData/n1:';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
END;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
                                    ...
                                    <fo:table width="100%" space-before.optimum="1pt" space-after.optimum="2pt">
                                        ...
                                        <fo:table-body>
                                            <fo:table-row>
                                                ...
                                                <fo:table-cell display-align="before" width="47pt" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" text-align="start" border-style="solid" borde';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
END;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
...
WHERE
PROTO_CORRESP_TYPE_CODE =  10 and COMMITTEE_ID='DEFAULT'   FOR UPDATE;
buffer := 'r-width="1pt" border-color="white">
                                                    <fo:block>
...
/
set define off;
insert into PROTO_CORRESP_TEMPL (PROTO_CORRESP_TEMPL_ID,PROTO_CORRESP_TYPE_CODE,COMMITTEE_ID,FILE_NAME,CORRESPONDENCE_TEMPLATE,UPDATE_TIMESTAMP,UPDATE_USER,OBJ_ID) values (SEQ_PROTO_CORRESP_TEMPL.nextVal, 9,'DEFAULT','9-AgendaReport.xslt',EMPTY_CLOB(),sysdate,'admin',sys_guid());
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT CORRESPONDENCE_TEMPLATE INTO data FROM PROTO_CORRESP_TEMPL
WHERE
                                                ...
                                                <xsl:for-each select="n1:NextSchedule">
                                                    <xsl:for-each select="n1:ScheduleMasterData">
                                                        <xsl:for-each select="n1:ScheduledDate">
                                                            <xsl:if test="string-length( . ) &gt;0">
                                                                <fo:inline>
                                                                    <xsl:value-of select="format-number(number(substring(string(string(.))';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
END;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
                                                                    ...
                                                                    <fo:table table-layout="fixed" width="100%" border-spacing="2pt">
                                                                        ...
                                                                        <fo:table-body start-indent="0pt">
                                                                            ...
                                                                            <fo:table-row>
                                                                                ...
                                                                                <fo:table-cell number-columns-spanned="4" padding="2pt" text-';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
END;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
...
WHERE
PROTO_CORRESP_TYPE_CODE =  9 and COMMITTEE_ID='DEFAULT'   FOR UPDATE;
buffer := 'align="left" display-align="before">
                                                                                    <fo:block>
