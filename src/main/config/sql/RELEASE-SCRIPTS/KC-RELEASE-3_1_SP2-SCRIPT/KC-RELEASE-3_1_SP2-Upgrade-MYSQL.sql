...
\. MYSQL/TABLES/KC_TBL_COMMITTEE_DOCUMENT.sql
...
\. MYSQL/TABLES/KC_TBL_EPS_PROPOSAL_DOCUMENT.sql
...
\. MYSQL/TABLES/KC_TBL_PROTOCOL_DOCUMENT.sql
...
\. MYSQL/TABLES/KC_TBL_PROTOCOL_ONLN_RVW_DOCUMENT.sql
...
\. MYSQL/DML/KC_DML_BS2_ARG_VALUE_LOOKUP.sql
\. MYSQL/DML/KC_DML_BS7_PERSON_EDITABLE_FIELDS.sql
\. MYSQL/DML/KC_DML_BS7_PROTOCOL_MODULES.sql
\. MYSQL/DML/KC_DML_BS7_PROTO_CORRESP_TEMPL.sql
\. MYSQL/CONSTRAINTS/KC_FK_QUEST_QUESTIONS_COND_TYPE.sql
\. MYSQL/CONSTRAINTS/KC_PERSON_EXT_FK1.sql
commit;
exit;
