...
/
INSERT INTO KREW_RULE_ATTR_T (CLS_NM,DESC_TXT,LBL,NM,OBJ_ID,RULE_ATTR_ID,RULE_ATTR_TYP_CD,SVC_NMSPC,VER_NBR,XML)
  VALUES ('org.kuali.rice.kew.rule.xmlrouting.StandardGenericXMLRuleAttribute','CustomDataAttribute','CustomDataAttribute','CustomDataAttribute','5D69FB7B-AAE6-082B-2615-C04BA0F0FD15',1659,'RuleXmlAttribute','KC',3,EMPTY_CLOB())
/
-- Length: 4697
-- Chunks: 2
 ...
 RULE_ATTR_ID = 1659    FOR UPDATE;        
    buffer := '<routingConfig>
                ...
                <fieldDef name="inventions" title="Inventions" workflowType="RULE">
                    ...
                    <fieldEvaluation>
                        <!-- expectation: this is run and evaluates to true -->
                        <xpathexpression>string(//xmlRouting/field[@name=''inventions'']/value) = ';
...
BEGIN
    ...
    WHERE 
 RULE_ATTR_ID = 1659    FOR UPDATE;        
    buffer := 'wf:ruledata(''inventions'')</xpathexpression>
                    </fieldEvaluation>
                </fieldDef>
