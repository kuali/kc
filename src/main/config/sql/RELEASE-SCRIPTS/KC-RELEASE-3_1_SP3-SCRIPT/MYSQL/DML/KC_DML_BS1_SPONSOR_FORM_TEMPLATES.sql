...
Insert into SPONSOR_FORM_TEMPLATES (OBJ_ID,VER_NBR,SPONSOR_CODE,PACKAGE_NUMBER,PAGE_NUMBER,PAGE_DESCRIPTION,UPDATE_TIMESTAMP,UPDATE_USER,FILE_NAME,CONTENT_TYPE,FORM_TEMPLATE) values (uuid(),1,'000340', 5,'15','BioSketch',now(),'admin','BioSketch.xslt','text/xml',
                ...
                <fo:flow flow-name="xsl-region-body">
                    <fo:block>
                        <xsl:for-each select="$XML">
                            ...
                            <fo:block/>
                            <fo:inline font-family="Verdana" font-size="10pt" line-height="12pt">
                                <xsl:text>After completion, the forms should be uploaded to Kuali Coeus as part of the Proposal Personnel screen.</xsl:text>
                            </fo:inline>
                            <fo:block/>
                            <fo:inline font-family="Verdana" font-size="10pt" line-height="12pt">
...
Insert into SPONSOR_FORM_TEMPLATES (OBJ_ID,VER_NBR,SPONSOR_CODE,PACKAGE_NUMBER,PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,UPDATE_TIMESTAMP,UPDATE_USER,FORM_TEMPLATE) values (uuid(),1,'000500',1,1,'Cover Page','Cover Page.xslt','text/xml',now(),'admin',
'<?xml version="1.0" encoding="UTF-8"?>
