...
ALTER TABLE EPS_PROP_EXEMPT_NUMBER 
ADD (PROPOSAL_EXEMPT_NUMBER_ID DECIMAL(12, 0),
	PROPOSAL_SPECIAL_REVIEW_ID DECIMAL(12, 0));
...
SET PROPOSAL_SPECIAL_REVIEW_ID = @spnum := if(@spnum is null,1,@spnum + 1);
...
SET PROPOSAL_EXEMPT_NUMBER_ID = @exnum := if(@exnum is null,1,@exnum + 1);
