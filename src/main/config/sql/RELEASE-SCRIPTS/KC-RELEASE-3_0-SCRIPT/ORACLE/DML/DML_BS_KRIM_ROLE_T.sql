...
VALUES( KRIM_ROLE_ID_S.NEXTVAL, SYS_GUID(), 1, 'IRB Online Reviewer', 'KC-UNT', 'Online Reviewers', (SELECT KIM_TYP_ID FROM KRIM_TYP_T WHERE NMSPC_CD = 'KC-WKFLW' AND NM = 'Derived Role: IRB Online Reviewer'), 'Y', sysdate );
