...
ALTER TABLE BUDGET_SUB_AWARD_FILES
    ADD CONSTRAINT FK1_BUDGET_SUB_AWARD_FILES FOREIGN KEY (BUDGET_ID, SUB_AWARD_NUMBER)
...
ALTER TABLE EPS_PROPOSAL
    ADD CONSTRAINT FK_POST_SUB_STATUS_KRA FOREIGN KEY (POST_SUB_STATUS_CODE)
...
ALTER TABLE ROLODEX
    ADD CONSTRAINT FK_ROLODEX_COUNTRY_KRA FOREIGN KEY (COUNTRY_CODE)
...
ALTER TABLE STATE_CODE
    ADD CONSTRAINT FK_STATE_CODE_COUNTRY FOREIGN KEY (COUNTRY_CODE)
    REFERENCES COUNTRY_CODE (COUNTRY_CODE)
/
