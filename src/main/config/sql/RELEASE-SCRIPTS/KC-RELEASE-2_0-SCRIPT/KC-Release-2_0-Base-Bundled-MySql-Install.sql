select "Running datasql/schema.sql...";
\. ALLKC/MYSQL/sql/schema.sql
select "Running datasql/ABSTRACT_TYPE.sql...";
 
\. ALLKC/MYSQL/datasql/ABSTRACT_TYPE.sql
select "Running datasql/ACCOUNT_TYPE.sql...";
 
\. ALLKC/MYSQL/datasql/ACCOUNT_TYPE.sql
select "Running datasql/ACTIVITY_TYPE.sql...";
 
\. ALLKC/MYSQL/datasql/ACTIVITY_TYPE.sql
select "Running datasql/AFFILIATION_TYPE.sql..."; 
\. ALLKC/MYSQL/datasql/AFFILIATION_TYPE.sql
select "Running datasql/APPOINTMENT_TYPE.sql..."; 
\. ALLKC/MYSQL/datasql/APPOINTMENT_TYPE.sql
select "Running datasql/ARG_VALUE_LOOKUP.sql..."; 
\. ALLKC/MYSQL/datasql/ARG_VALUE_LOOKUP.sql
select "Running datasql/AWARD_ATTACHMENT_TYPE.sql..."; 
\. ALLKC/MYSQL/datasql/AWARD_ATTACHMENT_TYPE.sql
select "Running datasql/AWARD_BASIS_OF_PAYMENT.sql..."; 
\. ALLKC/MYSQL/datasql/AWARD_BASIS_OF_PAYMENT.sql
select "Running datasql/AWARD_BUDGET_STATUS.sql..."; 
\. ALLKC/MYSQL/datasql/AWARD_BUDGET_STATUS.sql
select "Running datasql/AWARD_BUDGET_TYPE.sql..."; 
\. ALLKC/MYSQL/datasql/AWARD_BUDGET_TYPE.sql
select "Running datasql/AWARD_METHOD_OF_PAYMENT.sql..."; 
\. ALLKC/MYSQL/datasql/AWARD_METHOD_OF_PAYMENT.sql
select "Running datasql/AWARD_STATUS.sql..."; 
\. ALLKC/MYSQL/datasql/AWARD_STATUS.sql
...
\. ALLKC/MYSQL/datasql/LOCATION_TYPE.sql
select "Running datasql/MAIL_BY.sql..."; 
\. ALLKC/MYSQL/datasql/MAIL_BY.sql
select "Running datasql/MAIL_TYPE.sql..."; 
\. ALLKC/MYSQL/datasql/MAIL_TYPE.sql
select "Running datasql/MEMBERSHIP_ROLE.sql..."; 
\. ALLKC/MYSQL/datasql/MEMBERSHIP_ROLE.sql
select "Running datasql/MINUTE_ENTRY_TYPE.sql..."; 
\. ALLKC/MYSQL/datasql/MINUTE_ENTRY_TYPE.sql
select "Running datasql/NARRATIVE_STATUS.sql..."; 
\. ALLKC/MYSQL/datasql/NARRATIVE_STATUS.sql
select "Running datasql/NARRATIVE_TYPE.sql..."; 
\. ALLKC/MYSQL/datasql/NARRATIVE_TYPE.sql
select "Running datasql/NOTICE_OF_OPPORTUNITY.sql..."; 
\. ALLKC/MYSQL/datasql/NOTICE_OF_OPPORTUNITY.sql
select "Running datasql/NSF_CODES.sql..."; 
\. ALLKC/MYSQL/datasql/NSF_CODES.sql
...
\. ALLKC/MYSQL/datasql/ORGANIZATION_TYPE_LIST.sql
...
\. ALLKC/MYSQL/datasql/SPECIAL_REVIEW.sql
...
\. ALLKC/MYSQL/datasql/SPONSOR_TERM.sql
select "Running datasql/SPONSOR_TERM_TYPE.sql..."; 
\. ALLKC/MYSQL/datasql/SPONSOR_TERM_TYPE.sql
select "Running datasql/SPONSOR_TYPE.sql..."; 
\. ALLKC/MYSQL/datasql/SPONSOR_TYPE.sql
select "Running datasql/SP_REV_APPROVAL_TYPE.sql..."; 
\. ALLKC/MYSQL/datasql/SP_REV_APPROVAL_TYPE.sql
select "Running datasql/STATE_CODE.sql..."; 
\. ALLKC/MYSQL/datasql/STATE_CODE.sql
select "Running datasql/SUBMISSION_STATUS.sql..."; 
\. ALLKC/MYSQL/datasql/SUBMISSION_STATUS.sql
select "Running datasql/SUBMISSION_TYPE_QUALIFIER.sql..."; 
\. ALLKC/MYSQL/datasql/SUBMISSION_TYPE_QUALIFIER.sql
select "Running datasql/SUBMISSION_TYPE.sql..."; 
\. ALLKC/MYSQL/datasql/SUBMISSION_TYPE.sql
select "Running datasql/TBN.sql..."; 
\. ALLKC/MYSQL/datasql/TBN.sql
select "Running datasql/TRAINING.sql..."; 
\. ALLKC/MYSQL/datasql/TRAINING.sql
...
\. ALLKC/MYSQL/datasql/VALID_CLASS_REPORT_FREQ.sql
select "Running datasql/VALID_FREQUENCY_BASE.sql..."; 
\. ALLKC/MYSQL/datasql/VALID_FREQUENCY_BASE.sql
...
\. ALLKC/MYSQL/datasql/VULNERABLE_SUBJECT_TYPE.sql
select "Running datasql/YNQ_EXPLANATION.sql..."; 
\. ALLKC/MYSQL/datasql/YNQ_EXPLANATION.sql
select "Running datasql/YNQ_EXPLANATION_TYPE.sql..."; 
\. ALLKC/MYSQL/datasql/YNQ_EXPLANATION_TYPE.sql
select "Running datasql/YNQ.sql..."; 
\. ALLKC/MYSQL/datasql/YNQ.sql
select "Running BASE_UNIT_ROLODEX_ORGANIZATION.sql...";
\. ALLKC/MYSQL/datasql/BASE_UNIT_ROLODEX_ORGANIZATION.sql

select 'Applying constraints...';
\. ALLKC/MYSQL/sql/schema-constraints.sql
delimiter /
