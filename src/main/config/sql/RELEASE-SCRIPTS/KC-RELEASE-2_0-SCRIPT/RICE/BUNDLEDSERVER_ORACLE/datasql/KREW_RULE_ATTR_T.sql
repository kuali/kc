...
INSERT INTO KREW_RULE_ATTR_T (CLS_NM,DESC_TXT,LBL,NM,OBJ_ID,RULE_ATTR_ID,RULE_ATTR_TYP_CD,SVC_NMSPC,VER_NBR,XML)
  VALUES ('org.kuali.rice.kew.rule.xmlrouting.StandardGenericXMLRuleAttribute','AwardCustomDataAttribute','AwardCustomDataAttribute','AwardCustomDataAttribute','B591A340-BC9F-BD18-BBB7-4ED06E6560F0',1640,'RuleXmlAttribute','KC',7,EMPTY_CLOB())
/
-- Length: 3609
-- Chunks: 2
DECLARE    data CLOB; buffer VARCHAR2(32000);
BEGIN
    SELECT XML INTO data FROM KREW_RULE_ATTR_T 
    WHERE 
 RULE_ATTR_ID = 1640    FOR UPDATE;        
    buffer := '<routingConfig>
...
BEGIN
    ...
    WHERE 
 RULE_ATTR_ID = 1640    FOR UPDATE;        
    buffer := '<xpathexpression>string(//xmlRouting/field[@name=''tenured'']/value) = wf:ruledata(''tenured'')</xpathexpression>
                    </fieldEvaluation>
                </fieldDef>
...
/
INSERT INTO KREW_RULE_ATTR_T (CLS_NM,DESC_TXT,LBL,NM,OBJ_ID,RULE_ATTR_ID,RULE_ATTR_TYP_CD,SVC_NMSPC,VER_NBR,XML)
  VALUES ('org.kuali.rice.kew.rule.xmlrouting.StandardGenericXMLRuleAttribute','CustomDataAttribute','CustomDataAttribute','CustomDataAttribute','8C348B9A-0EB0-41A0-FD7B-EA833D0BB433',1651,'RuleXmlAttribute','KC',11,EMPTY_CLOB())
/
-- Length: 4780
-- Chunks: 2
DECLARE    data CLOB; buffer VARCHAR2(32000);
