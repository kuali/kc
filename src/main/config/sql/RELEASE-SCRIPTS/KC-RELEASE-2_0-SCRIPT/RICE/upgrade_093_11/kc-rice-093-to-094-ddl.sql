...
(
      CHNL_ID NUMBER(8), NM VARCHAR2(200) NOT NULL, DESC_TXT VARCHAR2(4000) NOT NULL, SUBSCRB_IND CHAR(1) NOT NULL, OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, CONSTRAINT KREN_NOTIFICATION_CHNL_UK1 UNIQUE (NM))
/
...
(
      CNTNT_TYP_ID NUMBER(8), NM VARCHAR2(200) NOT NULL, CUR_IND CHAR(1) default 'T' NOT NULL, CNTNT_TYP_VER_NBR NUMBER(8) default 0 NOT NULL, DESC_TXT VARCHAR2(1000) NOT NULL, NMSPC_CD VARCHAR2(1000) NOT NULL, XSD CLOB NOT NULL, XSL CLOB NOT NULL, OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, CONSTRAINT KREN_CONTENT_TYPE_UK1 UNIQUE (NM, CNTNT_TYP_VER_NBR))
/
...
(
      PRIO_ID NUMBER(8), NM VARCHAR2(40) NOT NULL, DESC_TXT VARCHAR2(500) NOT NULL, PRIO_ORD NUMBER(4) NOT NULL, OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, CONSTRAINT KREN_NOTIFICATION_PRIO_UK1 UNIQUE (NM))
/
...
(
      PRODCR_ID NUMBER(8), NM VARCHAR2(200) NOT NULL, DESC_TXT VARCHAR2(1000) NOT NULL, CNTCT_INFO VARCHAR2(1000) NOT NULL, OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, CONSTRAINT KREN_NOTIFN_PRODUCERS_UK1 UNIQUE (NM))
/
...
(
      RVWER_ID NUMBER(8), CHNL_ID NUMBER(8) NOT NULL, TYP VARCHAR2(10) NOT NULL, PRNCPL_ID VARCHAR2(40) NOT NULL, OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, CONSTRAINT KREN_NOTIFICATION_REVWR_UK1 UNIQUE (CHNL_ID, TYP, PRNCPL_ID))
/
...
(
      ADDR_TYP_CD VARCHAR2(40), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, NM VARCHAR2(40), ACTV_IND VARCHAR2(1) default 'Y', DISPLAY_SORT_CD VARCHAR2(2), LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_ADDR_TYPE_TC0 UNIQUE (OBJ_ID), CONSTRAINT KR_KIM_ADDR_TYPE_TC1 UNIQUE (NM))
/
...
(
      AFLTN_TYP_CD VARCHAR2(40), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, NM VARCHAR2(40), EMP_AFLTN_TYP_IND VARCHAR2(1) default 'N', ACTV_IND VARCHAR2(1) default 'Y', DISPLAY_SORT_CD VARCHAR2(2), LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_AFLTN_TYPE_TC0 UNIQUE (OBJ_ID), CONSTRAINT KR_KIM_AFLTN_TYPE_TC1 UNIQUE (NM))
/
...
(
      CTZNSHP_STAT_CD VARCHAR2(40), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, NM VARCHAR2(40), ACTV_IND VARCHAR2(1) default 'Y', DISPLAY_SORT_CD VARCHAR2(2), LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_CTZNSHP_STAT_TC0 UNIQUE (OBJ_ID), CONSTRAINT KR_KIM_CTZNSHP_STAT_TC1 UNIQUE (NM))
/
...
(
      DLGN_MBR_ID VARCHAR2(40), VER_NBR NUMBER(8) NOT NULL, OBJ_ID VARCHAR2(36) NOT NULL, DLGN_ID VARCHAR2(40), ROLE_MBR_ID VARCHAR(40), MBR_ID VARCHAR2(40), MBR_TYP_CD CHAR(1) default 'P', ACTV_FRM_DT DATE, ACTV_TO_DT DATE, LAST_UPDT_DT DATE, CONSTRAINT KRIM_DLGN_MBR_TC0 UNIQUE (OBJ_ID))
/
...
(
      EMAIL_TYP_CD VARCHAR2(40), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, NM VARCHAR2(40), ACTV_IND VARCHAR2(1) default 'Y', DISPLAY_SORT_CD VARCHAR2(2), LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_EMAIL_TYPE_TC0 UNIQUE (OBJ_ID), CONSTRAINT KR_KIM_EMAIL_TYPE_TC1 UNIQUE (NM))
/
...
(
      EMP_STAT_CD VARCHAR2(40), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, NM VARCHAR2(40), ACTV_IND VARCHAR2(1) default 'Y', DISPLAY_SORT_CD VARCHAR2(2), LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_EMP_STAT_TC0 UNIQUE (OBJ_ID), CONSTRAINT KR_KIM_EMP_STAT_TC1 UNIQUE (NM))
/
...
(
      EMP_TYP_CD VARCHAR2(40), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, NM VARCHAR2(40), ACTV_IND VARCHAR2(1) default 'Y', DISPLAY_SORT_CD VARCHAR2(2), LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_EMP_TYPE_TC0 UNIQUE (OBJ_ID), CONSTRAINT KR_KIM_EMP_TYPE_TC1 UNIQUE (NM))
/
...
(
      ENTITY_ADDR_ID VARCHAR2(40), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, ENTITY_ID VARCHAR2(40), ENT_TYP_CD VARCHAR2(40), ADDR_TYP_CD VARCHAR2(40), ADDR_LINE_1 VARCHAR2(50), ADDR_LINE_2 VARCHAR2(50), ADDR_LINE_3 VARCHAR2(50), CITY_NM VARCHAR2(30), POSTAL_STATE_CD VARCHAR2(2), POSTAL_CD VARCHAR2(20), POSTAL_CNTRY_CD VARCHAR2(2), DFLT_IND VARCHAR2(1) default 'N', ACTV_IND VARCHAR2(1) default 'Y', LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_ENTITY_ADDR_TC0 UNIQUE (OBJ_ID))
/
...
(
      ENTITY_AFLTN_ID VARCHAR2(40), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, ENTITY_ID VARCHAR2(40), AFLTN_TYP_CD VARCHAR2(40), CAMPUS_CD VARCHAR2(2), DFLT_IND VARCHAR2(1) default 'N', ACTV_IND VARCHAR2(1) default 'Y', LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_ENTITY_AFLTN_TC0 UNIQUE (OBJ_ID))
/
...
(
      ENTITY_ID VARCHAR2(40), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, ETHNCTY_CD VARCHAR2(40), BIRTH_DT DATE, GNDR_CD VARCHAR2(1) NOT NULL, LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_ENTITY_BIO_TC0 UNIQUE (OBJ_ID))
/
...
(
      ENTITY_CTZNSHP_ID VARCHAR2(40), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, ENTITY_ID VARCHAR2(40), POSTAL_CNTRY_CD VARCHAR2(2), CTZNSHP_STAT_CD VARCHAR2(40), STRT_DT DATE, END_DT DATE, ACTV_IND VARCHAR2(1) default 'Y', LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_ENTITY_CTZNSHP_TC0 UNIQUE (OBJ_ID))
/
...
(
      ENTITY_EMAIL_ID VARCHAR2(40), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, ENTITY_ID VARCHAR2(40), ENT_TYP_CD VARCHAR2(40), EMAIL_TYP_CD VARCHAR2(40), EMAIL_ADDR VARCHAR2(200), DFLT_IND VARCHAR2(1) default 'N', ACTV_IND VARCHAR2(1) default 'Y', LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_ENTITY_EMAIL_TC0 UNIQUE (OBJ_ID))
/
...
(
      OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, ENT_TYP_CD VARCHAR2(40), ENTITY_ID VARCHAR2(40), ACTV_IND VARCHAR2(1) default 'Y', LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_ENTITY_ENT_TYPE_TC0 UNIQUE (OBJ_ID))
/
...
(
      ENTITY_EXT_ID_ID VARCHAR2(40), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, ENTITY_ID VARCHAR2(40), EXT_ID_TYP_CD VARCHAR2(40), EXT_ID VARCHAR2(100), LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_ENTITY_EXT_ID_TC0 UNIQUE (OBJ_ID))
/
...
(
      ENTITY_NM_ID VARCHAR2(40), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, ENTITY_ID VARCHAR2(40), NM_TYP_CD VARCHAR2(40), FIRST_NM VARCHAR2(40), MIDDLE_NM VARCHAR2(40), LAST_NM VARCHAR2(80), SUFFIX_NM VARCHAR2(20), TITLE_NM VARCHAR2(20), DFLT_IND VARCHAR2(1) default 'N', ACTV_IND VARCHAR2(1) default 'Y', LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_ENTITY_NAME_TC0 UNIQUE (OBJ_ID))
/
...
(
      ENTITY_PHONE_ID VARCHAR2(40), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, ENTITY_ID VARCHAR2(40), ENT_TYP_CD VARCHAR2(40), PHONE_TYP_CD VARCHAR2(40), PHONE_NBR VARCHAR2(20), PHONE_EXTN_NBR VARCHAR2(8), POSTAL_CNTRY_CD VARCHAR2(2), DFLT_IND VARCHAR2(1) default 'N', ACTV_IND VARCHAR2(1) default 'Y', LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_ENTITY_PHONE_TC0 UNIQUE (OBJ_ID))
/
...
(
      ENTITY_ID VARCHAR2(40), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, SUPPRESS_NM_IND VARCHAR2(1) default 'N', SUPPRESS_EMAIL_IND VARCHAR2(1) default 'Y', SUPPRESS_ADDR_IND VARCHAR2(1) default 'Y', SUPPRESS_PHONE_IND VARCHAR2(1) default 'Y', SUPPRESS_PRSNL_IND VARCHAR2(1) default 'Y', LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_ENTITY_PRIV_PREF_TC0 UNIQUE (OBJ_ID))
/
...
(
      ENTITY_ID VARCHAR2(40), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, ACTV_IND VARCHAR2(1) default 'Y', LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_ENTITY_TC0 UNIQUE (OBJ_ID))
/
...
(
      ENT_NM_TYP_CD VARCHAR2(40), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, NM VARCHAR2(40), ACTV_IND VARCHAR2(1) default 'Y', DISPLAY_SORT_CD VARCHAR2(2), LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_ENT_NAME_TYPE_TC0 UNIQUE (OBJ_ID), CONSTRAINT KR_KIM_ENT_NAME_TYPE_TC1 UNIQUE (NM))
/
...
(
      GRP_MBR_ID VARCHAR2(40), VER_NBR NUMBER(8) NOT NULL, OBJ_ID VARCHAR2(36) NOT NULL, GRP_ID VARCHAR2(40), MBR_ID VARCHAR2(40), MBR_TYP_CD CHAR(1) default 'P', ACTV_FRM_DT DATE, ACTV_TO_DT DATE, LAST_UPDT_DT DATE, CONSTRAINT KRIM_GRP_MBR_TC0 UNIQUE (OBJ_ID))
/
...
(
      GRP_ID VARCHAR2(40), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, GRP_NM VARCHAR2(80) NOT NULL, NMSPC_CD VARCHAR2(40) NOT NULL, GRP_DESC VARCHAR2(4000), KIM_TYP_ID VARCHAR2(40), ACTV_IND VARCHAR2(1) default 'Y', LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_GROUP_TC0 UNIQUE (OBJ_ID), CONSTRAINT KR_KIM_GROUP_TC1 UNIQUE (GRP_NM, NMSPC_CD))
/
...
(
      FDOC_NBR VARCHAR2(14), ENTITY_ID VARCHAR2(40) NOT NULL, OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, PRNCPL_ID VARCHAR2(40) NOT NULL, PRNCPL_NM VARCHAR2(100) NOT NULL, PRNCPL_PSWD VARCHAR2(400), TAX_ID VARCHAR2(40), UNIV_ID VARCHAR2(40), ACTV_IND VARCHAR2(1) default 'Y')
/
...
(
      PHONE_TYP_CD VARCHAR2(40), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, PHONE_TYP_NM VARCHAR2(40), ACTV_IND VARCHAR2(1) default 'Y', DISPLAY_SORT_CD VARCHAR2(2), LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_PHONE_TYPE_TC0 UNIQUE (OBJ_ID), CONSTRAINT KR_KIM_PHONE_TYPE_TC1 UNIQUE (PHONE_TYP_NM))
/
...
(
      FDOC_NBR VARCHAR2(14), ENTITY_AFLTN_ID VARCHAR2(40), AFLTN_TYP_CD VARCHAR2(40), CAMPUS_CD VARCHAR2(2), EDIT_FLAG VARCHAR2(1) default 'N', DFLT_IND VARCHAR2(1) default 'N', ACTV_IND VARCHAR2(1) default 'Y', OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL)
/
...
(
      FDOC_NBR VARCHAR2(14), ROLE_ID VARCHAR2(40) NOT NULL, OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, ROLE_TYP_ID VARCHAR2(40) NOT NULL, ROLE_TYP_NAME VARCHAR2(40) NOT NULL, ROLE_NMSPC VARCHAR2(100) NOT NULL, ROLE_NM VARCHAR2(400), ACTV_IND VARCHAR2(1) default 'Y')
/
...
(
      ROLE_MBR_ID VARCHAR2(40), VER_NBR NUMBER(8) NOT NULL, OBJ_ID VARCHAR2(36) NOT NULL, ROLE_ID VARCHAR2(40), MBR_ID VARCHAR2(40), MBR_TYP_CD CHAR(1) default 'P', ACTV_FRM_DT DATE, ACTV_TO_DT DATE, LAST_UPDT_DT DATE, CONSTRAINT KRIM_ROLE_MBR_TC0 UNIQUE (OBJ_ID))
/
...
(
      ROLE_ID VARCHAR2(40), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, ROLE_NM VARCHAR2(80) NOT NULL, NMSPC_CD VARCHAR2(40) NOT NULL, DESC_TXT VARCHAR2(4000), KIM_TYP_ID VARCHAR2(40), ACTV_IND VARCHAR2(1) default 'Y', LAST_UPDT_DT DATE, CONSTRAINT KR_KIM_ROLE_TC0 UNIQUE (OBJ_ID), CONSTRAINT KR_KIM_ROLE_TC1 UNIQUE (ROLE_NM, NMSPC_CD))
/
...
(
      RECIP_TYP_CD NUMBER(1), ACTN_RQST_CD VARCHAR2(30), ACTN_RQST_RECIP_ID VARCHAR2(70), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, DOC_HDR_ID VARCHAR2(14), CONSTRAINT KRNS_ADHOC_RTE_ACTN_RECP_TC0 UNIQUE (OBJ_ID))
/
...
(
      NTE_ID NUMBER(14), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, MIME_TYP VARCHAR2(40), FILE_NM VARCHAR2(250), ATT_ID VARCHAR2(36), FILE_SZ NUMBER(14), ATT_TYP_CD VARCHAR2(2), CONSTRAINT KRNS_ATT_TC0 UNIQUE (OBJ_ID))
/
...
(
      CAMPUS_CD VARCHAR2(2), CAMPUS_NM VARCHAR2(250), CAMPUS_SHRT_NM VARCHAR2(250), CAMPUS_TYP_CD VARCHAR2(1), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, ACTV_IND VARCHAR2(1) default 'Y' NOT NULL, CONSTRAINT KRNS_CAMPUS_TC0 UNIQUE (OBJ_ID))
/
...
(
      CAMPUS_TYP_CD VARCHAR2(1), CMP_TYP_NM VARCHAR2(250), DOBJ_MAINT_CD_ACTV_IND VARCHAR2(1) NOT NULL, OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, ACTV_IND VARCHAR2(1) default 'Y' NOT NULL, CONSTRAINT KRNS_CMP_TYP_TC0 UNIQUE (OBJ_ID))
/
...
(
      DOC_HDR_ID VARCHAR2(14), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, FDOC_DESC VARCHAR2(40), ORG_DOC_HDR_ID VARCHAR2(10), TMPL_DOC_HDR_ID VARCHAR2(14), EXPLANATION VARCHAR2(400), CONSTRAINT KRNS_DOC_HEADER_TC0 UNIQUE (OBJ_ID))
/
...
(
      DOC_TYP_ATTR_ID NUMBER(8), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, ACTV_IND CHAR(1) default 'Y' NOT NULL, CD VARCHAR2(100) NOT NULL, VAL VARCHAR2(400), LBL VARCHAR2(400), DOC_TYP_CD VARCHAR2(4) NOT NULL, CONSTRAINT KRNS_DOC_TYPE_ATTR_TC0 UNIQUE (OBJ_ID))
/
...
(
      DOC_TYP_CD VARCHAR2(4), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, NM VARCHAR2(40), ACTV_IND VARCHAR2(1), CONSTRAINT KRNS_DOC_TYPE_TC0 UNIQUE (OBJ_ID))
/
...
(
      LOOKUP_RSLT_ID VARCHAR2(14), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, PRNCPL_ID VARCHAR2(10) NOT NULL, LOOKUP_DT DATE NOT NULL, SERIALZD_RSLTS CLOB, CONSTRAINT KRNS_LOOKUP_RESULTS_MTC0 UNIQUE (OBJ_ID))
/
...
(
      LOOKUP_RSLT_ID VARCHAR2(14), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, PRNCPL_ID VARCHAR2(10) NOT NULL, LOOKUP_DT DATE NOT NULL, SEL_OBJ_IDS CLOB, CONSTRAINT KRNS_LOOKUP_SELECTIONS_MTC0 UNIQUE (OBJ_ID))
/
...
(
      DOC_HDR_ID VARCHAR2(14), ATT_CNTNT BLOB NOT NULL, FILE_NM VARCHAR2(150), CNTNT_TYP VARCHAR2(50), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, CONSTRAINT KRNS_MAINT_DOC_ATTACHMENT_TC0 UNIQUE (OBJ_ID))
/
...
(
      DOC_HDR_ID VARCHAR2(14), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, DOC_CNTNT CLOB, CONSTRAINT KRNS_MAINTENANCE_DOCUMENT_TC0 UNIQUE (OBJ_ID))
/
...
(
      MAINT_LOCK_REP_TXT VARCHAR2(255), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, DOC_HDR_ID VARCHAR2(14) NOT NULL, CONSTRAINT KRNS_MAINT_LOCK_TC0 UNIQUE (OBJ_ID))
/
...
(
      NMSPC_CD VARCHAR2(20), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, NM VARCHAR2(40), ACTV_IND CHAR(1) default 'Y' NOT NULL,APPL_NMSPC_CD	VARCHAR2(20), CONSTRAINT KRNS_NMSPC_TC0 UNIQUE (OBJ_ID))
/
...
(
      NTE_ID NUMBER(14), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, RMT_OBJ_ID VARCHAR2(36) NOT NULL, AUTH_PRNCPL_ID VARCHAR2(30) NOT NULL, POST_TS DATE NOT NULL, NTE_TYP_CD VARCHAR2(4) NOT NULL, TXT VARCHAR2(800), PRG_CD VARCHAR2(1), TPC_TXT VARCHAR2(40), CONSTRAINT KRNS_NTE_TC0 UNIQUE (OBJ_ID))
/
...
(
      NTE_TYP_CD VARCHAR2(4), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, TYP_DESC_TXT VARCHAR2(100), ACTV_IND VARCHAR2(1), CONSTRAINT KRNS_NTE_TYP_TC0 UNIQUE (OBJ_ID))
/
...
(
      NMSPC_CD VARCHAR2(20), PARM_DTL_TYP_CD VARCHAR2(100), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, NM VARCHAR2(255), ACTV_IND CHAR(1) default 'Y' NOT NULL, CONSTRAINT KRNS_PARM_DTL_TYP_TC0 UNIQUE (OBJ_ID))
/
...
(
      NMSPC_CD VARCHAR2(20), PARM_DTL_TYP_CD VARCHAR2(100), PARM_NM VARCHAR2(100), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, PARM_TYP_CD VARCHAR2(5) NOT NULL, TXT VARCHAR2(4000), PARM_DESC_TXT VARCHAR2(4000), CONS_CD VARCHAR2(1), GRP_NM VARCHAR2(70) default 'WorkflowAdmin' NOT NULL, ACTV_IND CHAR(1) default 'Y' NOT NULL, CONSTRAINT KRNS_PARM_TC0 UNIQUE (OBJ_ID))
/
...
(
      PARM_TYP_CD VARCHAR2(5), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, NM VARCHAR2(40), ACTV_IND CHAR(1) default 'Y' NOT NULL, CONSTRAINT KRNS_PARM_TYP_TC0 UNIQUE (OBJ_ID))
/
...
(
      PESSIMISTIC_LOCK_ID NUMBER(14), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, LOCK_DESC_TXT VARCHAR2(4000), DOC_HDR_ID VARCHAR2(14) NOT NULL, GNRT_DT DATE NOT NULL, PRNCPL_ID VARCHAR2(10) NOT NULL, CONSTRAINT KRNS_PESSIMISTIC_LOCK_TC0 UNIQUE (OBJ_ID))
/
...
(
      FDOC_NBR VARCHAR2(14), OBJ_ID VARCHAR2(36) NOT NULL, VER_NBR NUMBER(8) default 1 NOT NULL, FDOC_EXPLAIN_TXT VARCHAR2(400), REQUEST_TRAV VARCHAR2(30) NOT NULL, TRAVELER VARCHAR2(200), ORG VARCHAR2(60), DEST VARCHAR2(60))
/
