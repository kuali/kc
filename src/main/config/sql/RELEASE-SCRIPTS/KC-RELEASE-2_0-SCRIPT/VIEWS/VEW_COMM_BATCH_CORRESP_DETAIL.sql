...
CREATE OR REPLACE VIEW OSP$COMM_CORRESP_BATCH_DETAIL AS 
SELECT COMM_BATCH_CORRESP_DETAIL.COMM_BATCH_CORRESP_ID AS CORRESP_BATCH_ID,
...
FROM   COMM_BATCH_CORRESP_DETAIL,
       PROTOCOL_ACTIONS
