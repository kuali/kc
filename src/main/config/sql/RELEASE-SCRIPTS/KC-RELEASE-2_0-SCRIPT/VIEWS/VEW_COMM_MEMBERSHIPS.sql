...
SELECT COMMITTEE.COMMITTEE_ID,
       DECODE (COMM_MEMBERSHIPS.PERSON_ID, NULL, TO_CHAR (COMM_MEMBERSHIPS.ROLODEX_ID) , COMM_MEMBERSHIPS.PERSON_ID) AS PERSON_ID,
       COMM_MEMBERSHIPS.MEMBERSHIP_ID,
       COMMITTEE.SEQUENCE_NUMBER,
       COMM_MEMBERSHIPS.PERSON_NAME,
       DECODE (COMM_MEMBERSHIPS.PERSON_ID, NULL, 'N', 'Y') AS NON_EMPLOYEE_FLAG,
