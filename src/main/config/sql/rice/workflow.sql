...
CREATE TABLE EN_DOC_TYP_T (
	...
	DB_LOCK_VER_NBR	              NUMBER(8) DEFAULT 0,
	CONSTRAINT EN_DOC_TYP_T_PK PRIMARY KEY (DOC_TYP_ID) USING INDEX
)
 /
...
CREATE INDEX EN_DOC_HDR_TI1 ON EN_DOC_HDR_T (DOC_TYP_ID)
  /

CREATE INDEX EN_DOC_HDR_TI2 ON EN_DOC_HDR_T (DOC_INITR_PRSN_EN_ID, DOC_TYP_ID)
 /

CREATE INDEX EN_DOC_HDR_TI3 ON EN_DOC_HDR_T (DOC_RTE_STAT_CD)
  /

CREATE INDEX EN_DOC_HDR_TI4 ON EN_DOC_HDR_T (DOC_TTL)
 /

CREATE INDEX EN_DOC_HDR_TI5 ON EN_DOC_HDR_T (DOC_CRTE_DT)
/

CREATE INDEX EN_DOC_HDR_TI6 ON EN_DOC_HDR_T (DOC_RTE_STAT_MDFN_DT)
/

CREATE INDEX EN_DOC_HDR_TI7 ON EN_DOC_HDR_T (DOC_APRV_DT)
/

CREATE INDEX EN_DOC_HDR_TI8 ON EN_DOC_HDR_T (DOC_FNL_DT)
/

CREATE INDEX EN_DOC_HDR_TI9 ON EN_DOC_HDR_T (DOC_APPL_DOC_ID)
/

CREATE INDEX EN_ACTN_TKN_TI1 ON EN_ACTN_TKN_T (DOC_HDR_ID, ACTN_TKN_PRSN_EN_ID)
/

CREATE INDEX EN_ACTN_TKN_TI2 ON EN_ACTN_TKN_T (DOC_HDR_ID, ACTN_TKN_PRSN_EN_ID, ACTN_TKN_CD)
 /

CREATE INDEX EN_ACTN_TKN_TI3 ON EN_ACTN_TKN_T (ACTN_TKN_PRSN_EN_ID)
/

CREATE INDEX EN_ACTN_TKN_TI4 ON EN_ACTN_TKN_T (ACTN_TKN_DLGTR_PRSN_EN_ID)
/

CREATE INDEX EN_ACTN_TKN_TI5 ON EN_ACTN_TKN_T (DOC_HDR_ID)
/

CREATE INDEX EN_ACTN_RQST_TI1 ON EN_ACTN_RQST_T (DOC_HDR_ID)
/

CREATE INDEX EN_ACTN_RQST_TI2 ON EN_ACTN_RQST_T (ACTN_RQST_PRSN_EN_ID)
/

CREATE INDEX EN_ACTN_RQST_T13 ON EN_ACTN_RQST_T (ACTN_TKN_ID)
/

CREATE INDEX EN_ACTN_RQST_T14 ON EN_ACTN_RQST_T (ACTN_RQST_PARNT_ID)
/

CREATE INDEX EN_ACTN_RQST_TI5 ON EN_ACTN_RQST_T (ACTN_RQST_RESP_ID)
/

CREATE INDEX EN_ACTN_RQST_TI6 ON EN_ACTN_RQST_T (ACTN_RQST_STAT_CD, ACTN_RQST_RESP_ID)
/

CREATE INDEX EN_ACTN_RQST_TI7 ON EN_ACTN_RQST_T (ACTN_RQST_RTE_NODE_INSTN_ID)
/

CREATE INDEX EN_ACTN_RQST_TI8 ON EN_ACTN_RQST_T (WRKGRP_ID)
/

CREATE INDEX EN_ACTN_RQST_TI9  ON EN_ACTN_RQST_T (ACTN_RQST_STAT_CD, DOC_HDR_ID)
/
CREATE UNIQUE INDEX EN_DOC_TYP_TI1 ON EN_DOC_TYP_T (DOC_TYP_NM, DOC_TYP_VER_NBR)
/

CREATE INDEX EN_DOC_TYP_TI2      ON EN_DOC_TYP_T (DOC_TYP_PARNT_ID)
/

CREATE INDEX EN_DOC_TYP_TI3      ON EN_DOC_TYP_T (DOC_TYP_ID, DOC_TYP_PARNT_ID)
/

CREATE INDEX EN_DOC_TYP_TI4      ON EN_DOC_TYP_T (DOC_TYP_PREV_VER)
/

CREATE INDEX EN_DOC_TYP_TI5      ON EN_DOC_TYP_T (DOC_TYP_CUR_IND)
/

CREATE INDEX EN_DOC_TYP_RTE_LVL_TI1      ON EN_DOC_TYP_RTE_LVL_T (DOC_TYP_ID)
 /

CREATE INDEX EN_ACTN_ITM_T1 ON EN_ACTN_ITM_T (ACTN_ITM_PRSN_EN_ID)
/

CREATE INDEX EN_ACTN_ITM_TI2 ON EN_ACTN_ITM_T (DOC_HDR_ID)
/

CREATE INDEX EN_ACTN_ITM_TI3 ON EN_ACTN_ITM_T (ACTN_RQST_ID)
/

CREATE INDEX EN_ACTN_ITM_TI4	ON EN_ACTN_ITM_T (ACTN_ITM_DLGN_PRSN_EN_ID, ACTN_ITM_DLGN_WRKGRP_ID, ACTN_ITM_PRSN_EN_ID, DLGN_TYP)
/

CREATE INDEX EN_USR_OPTN_TI1 ON EN_USR_OPTN_T(PRSN_EN_ID)
/

CREATE INDEX EN_WRKGRP_MBR_TI1 ON EN_WRKGRP_MBR_T(WRKGRP_MBR_PRSN_EN_ID)
/

CREATE UNIQUE INDEX EN_USR_TI1 ON EN_USR_T (PRSN_UNIV_ID)
/

CREATE UNIQUE INDEX EN_USR_TI2 ON EN_USR_T (PRSN_NTWRK_ID)
/

CREATE UNIQUE INDEX EN_USR_TI3 ON EN_USR_T (PRSN_UNVL_USR_ID)
/

CREATE INDEX EN_WRKGRP_TI1 ON EN_WRKGRP_T (WRKGRP_NM)
/

CREATE INDEX EN_RULE_EXT_T1 ON EN_RULE_EXT_T (RULE_BASE_VAL_ID)
/

CREATE INDEX EN_RULE_EXT_VAL_T1 ON EN_RULE_EXT_VAL_T (RULE_EXT_ID)
/
...
CREATE INDEX EN_DOC_NTE_TI1 ON EN_DOC_NTE_T (DOC_HDR_ID)
/

CREATE INDEX EN_HLP_TI1 ON EN_HLP_T (EN_HLP_KY)
/
...
/
insert into EN_APPL_CNST_T values ('Config.Application.AdminUserList', 'rkirkend jhopf temay ewestfal natjohns xqi bmcgough bghutchi', 0)
/
