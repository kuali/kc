  ...
  CREATE OR REPLACE FORCE VIEW "KRADEV"."OSP$BUDGET_RATE_BASE_FOR_EDI" ("PROPOSAL_NUMBER", "BUDGET_PERIOD", "LINE_ITEM_NUMBER", "RATE_NUMBER", "START_DATE", "END_DATE", "RATE_CLASS_CODE", "RATE_TYPE_CODE", "ON_OFF_CAMPUS_FLAG", "APPLIED_RATE", "BASE_COST", "BASE_COST_SHARING", "CALCULATED_COST", "CALCULATED_COST_SHARING", "UPDATE_TIMESTAMP", "UPDATE_USER") AS 
  SELECT 
