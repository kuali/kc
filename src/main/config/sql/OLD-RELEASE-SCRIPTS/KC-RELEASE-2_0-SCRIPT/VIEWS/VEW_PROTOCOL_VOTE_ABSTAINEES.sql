CREATE OR REPLACE VIEW OSP$PROTOCOL_VOTE_ABSTAINEES AS 
SELECT PROTOCOL.PROTOCOL_NUMBER,
...
FROM   PROTOCOL_VOTE_ABSTAINEES,
       COMM_SCHEDULE,
       PROTOCOL
WHERE  COMM_SCHEDULE.ID = PROTOCOL_VOTE_ABSTAINEES.SCHEDULE_ID_FK 
       AND PROTOCOL.PROTOCOL_ID = PROTOCOL_VOTE_ABSTAINEES.PROTOCOL_ID_FK;