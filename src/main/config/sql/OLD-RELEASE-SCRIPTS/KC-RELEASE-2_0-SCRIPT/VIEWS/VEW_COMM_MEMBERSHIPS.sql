...
SELECT COMMITTEE.COMMITTEE_ID,
       CASE WHEN COMM_MEMBERSHIPS.PERSON_ID IS NULL THEN TO_CHAR (COMM_MEMBERSHIPS.ROLODEX_ID) ELSE COMM_MEMBERSHIPS.PERSON_ID END AS PERSON_ID,
       COMM_MEMBERSHIPS.MEMBERSHIP_ID,
       COMMITTEE.SEQUENCE_NUMBER,
       COMM_MEMBERSHIPS.PERSON_NAME,
       CASE WHEN COMM_MEMBERSHIPS.PERSON_ID IS NULL THEN 'N' ELSE 'Y' END AS NON_EMPLOYEE_FLAG,
