...
INSERT INTO KREW_EDL_DEF_T (ACTV_IND,EDOCLT_DEF_ID,NM,OBJ_ID,VER_NBR,XML)
  VALUES (0,2000,'eDoc.Example1.Form','6166CBA1BC09644DE0404F8189D86C09',2,EMPTY_CLOB())
/
-- Length: 2805
-- Chunks: 2
DECLARE    data CLOB; buffer VARCHAR2(32000);
BEGIN
    SELECT XML INTO data FROM KREW_EDL_DEF_T 
    WHERE 
 EDOCLT_DEF_ID = 2000    FOR UPDATE;        
    buffer := '<edl name="eDoc.Example1.Form" title="Example 1">
      <security/>
...
BEGIN
    ...
    WHERE 
 EDOCLT_DEF_ID = 2000    FOR UPDATE;        
    buffer := 'sored program work is funded by NIH or NSF.">nihnsf</values>
        </display>
      </fieldDef>
...
/
INSERT INTO KREW_EDL_DEF_T (ACTV_IND,EDOCLT_DEF_ID,NM,OBJ_ID,VER_NBR,XML)
  VALUES (0,2005,'eDoc.Example1.Form','6166CBA1BC0A644DE0404F8189D86C09',2,EMPTY_CLOB())
/
-- Length: 2805
-- Chunks: 2
DECLARE    data CLOB; buffer VARCHAR2(32000);
...
/
INSERT INTO KREW_EDL_DEF_T (ACTV_IND,EDOCLT_DEF_ID,NM,OBJ_ID,VER_NBR,XML)
  VALUES (1,2008,'eDoc.Example1.Form','6166CBA1BC0B644DE0404F8189D86C09',1,EMPTY_CLOB())
/
-- Length: 2805
-- Chunks: 2
DECLARE    data CLOB; buffer VARCHAR2(32000);
