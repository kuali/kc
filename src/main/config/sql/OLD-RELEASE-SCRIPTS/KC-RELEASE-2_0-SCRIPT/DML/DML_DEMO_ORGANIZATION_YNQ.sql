...
INSERT INTO ORGANIZATION_YNQ (ORGANIZATION_ID, QUESTION_ID, ANSWER, EXPLANATION, REVIEW_DATE, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR) 
SELECT ORGANIZATION_IDS.ORGANIZATION_ID AS ORGANIZATION_ID,
       QUESTION_ID AS QUESTION_ID,
       'N' AS ANSWER,
       CASE WHEN YNQ.EXPLANATION_REQUIRED_FOR = 'N' 
                 OR YNQ.EXPLANATION_REQUIRED_FOR = 'YN' THEN 'STAGED DATA DEFAULT EXPLANATION' ELSE NULL END AS EXPLANATION,
       CASE WHEN YNQ.DATE_REQUIRED_FOR = 'N' 
                 OR YNQ.DATE_REQUIRED_FOR = 'YN' THEN TO_DATE ('2010-02-16 00:00:00', 'YYYY-MM-DD HH24:MI:SS') ELSE NULL END AS REVIEW_DATE,
...
FROM   YNQ CROSS JOIN
       (SELECT ORGANIZATION.ORGANIZATION_ID
        ...
        WHERE  (SELECT COUNT (*)
                ...
                WHERE  ORGANIZATION_YNQ.ORGANIZATION_ID = ORGANIZATION.ORGANIZATION_ID) = 0) ORGANIZATION_IDS
