...
(SELECT PERM_ID FROM KRIM_PERM_T PT where PT.NM = 'View Committee' AND PT.NMSPC_CD = 'KC-PROTOCOL'), 'Y');
...
(SELECT PERM_ID FROM KRIM_PERM_T PT where PT.NM = 'View Schedule' AND PT.NMSPC_CD = 'KC-PROTOCOL'), 'Y');
