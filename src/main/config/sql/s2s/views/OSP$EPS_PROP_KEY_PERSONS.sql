...
CREATE OR REPLACE VIEW OSP$EPS_PROP_KEY_PERSONS ( 
	   ...
	   AS select 
	   PROPOSAL_NUMBER, decode(PERSON_ID,null,ROLODEX_ID,PERSON_ID) PERSON_ID, FULL_NAME, PRIMARY_TITLE, IS_FACULTY, 
	   decode(PERSON_ID,null,'N','Y') NON_MIT_PERSON_FLAG, PERCENTAGE_EFFORT, UPDATE_TIMESTAMP, UPDATE_USER
