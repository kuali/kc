...
DECLARE
  ...
  CURSOR role_mbr_data IS SELECT RMT.MBR_ID, RMT.ROLE_ID, RMT.MBR_TYP_CD, RMAD.ATTR_VAL, RMAD.KIM_TYP_ID, RMAD.KIM_ATTR_DEFN_ID FROM KRIM_ROLE_MBR_T RMT 
...
EXECUTE IMMEDIATE 'INSERT INTO KRIM_ROLE_MBR_T (ROLE_MBR_ID,ROLE_ID,MBR_ID,MBR_TYP_CD,LAST_UPDT_DT,OBJ_ID,VER_NBR) 
   VALUES (CONCAT(''KC'',KRIM_ROLE_MBR_ID_S.NEXTVAL),(SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = ''KC-PROTOCOL-DOC'' AND ROLE_NM = ''Protocol Aggregator''),(:1),(:2),SYSDATE,SYS_GUID(),1 )' USING record.MBR_ID, record.MBR_TYP_CD;
...
DECLARE
 ...
 BEGIN
    ...
    LOOP        
EXECUTE IMMEDIATE 'INSERT INTO KRIM_ROLE_MBR_T (ROLE_MBR_ID,ROLE_ID,MBR_ID,MBR_TYP_CD,LAST_UPDT_DT,OBJ_ID,VER_NBR) 
   VALUES (CONCAT(''KC'',KRIM_ROLE_MBR_ID_S.NEXTVAL),(SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = ''KC-PROTOCOL-DOC'' AND ROLE_NM = ''Protocol Viewer''),(:1),(:2),SYSDATE,SYS_GUID(),1 )' USING record.MBR_ID, record.MBR_TYP_CD;
