...
INSERT INTO NOTIFICATION_TYPE (NOTIFICATION_TYPE_ID, MODULE_CODE, ACTION_CODE, DESCRIPTION, SUBJECT, MESSAGE, PROMPT_USER, SEND_NOTIFICATION, UPDATE_USER, UPDATE_TIMESTAMP, VER_NBR, OBJ_ID)
	VALUES (SEQ_NOTIFICATION_TYPE_ID.NEXTVAL, 3, '102','Notification sent when a narrative is changed in a proposal that is not in pending status.',
	'{LEAD_UNIT} - Notification : Narrative change in proposal : {PROPOSAL_NUMBER}',
	'Narrative module details for Proposal : {PROPOSAL_NUMBER}, Module No. {NARRATIVE_MODULE_NUM} have been changed.<br/>Narrative Type: {NARRATIVE_TYPE}<br/>Module Description: {NARRATIVE_MODULE_DESCRIPTION}',  'Y', 'Y', 'admin', SYSDATE, 1, SYS_GUID())
/

INSERT INTO NOTIFICATION_TYPE (NOTIFICATION_TYPE_ID, MODULE_CODE, ACTION_CODE, DESCRIPTION, SUBJECT, MESSAGE, PROMPT_USER, SEND_NOTIFICATION, UPDATE_USER, UPDATE_TIMESTAMP, VER_NBR, OBJ_ID)
	VALUES (SEQ_NOTIFICATION_TYPE_ID.NEXTVAL, 3, '104','Notification sent when a narrative is is added to a proposal that is not in pending status.',
...
INSERT INTO NOTIFICATION_TYPE_RECIPIENT (NOTIFICATION_TYPE_RECIPIENT_ID, NOTIFICATION_TYPE_ID, ROLE_NAME, UPDATE_USER, UPDATE_TIMESTAMP, VER_NBR, OBJ_ID)
	VALUES (SEQ_NOTIFICATION_TYPE_ID.NEXTVAL, (select NOTIFICATION_TYPE_ID from notification_type where MODULE_CODE = 3 and ACTION_CODE = '104'), 'KC-WKFLW:All Past Approvers', 'admin', SYSDATE, 1, SYS_GUID())
/
