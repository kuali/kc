INSERT INTO NOTIFICATION_TYPE (NOTIFICATION_TYPE_ID, MODULE_CODE, ACTION_CODE, DESCRIPTION, SUBJECT, MESSAGE, PROMPT_USER, SEND_NOTIFICATION, UPDATE_USER, UPDATE_TIMESTAMP, VER_NBR, OBJ_ID)
	VALUES (SEQ_NOTIFICATION_TYPE_ID.NEXTVAL, 5, '100','Negotiation Closed Status','Negotiation activities are complete.','The negotiation is complete.<br/><br/>{NEGOTIATION_INFO}',  'Y', 'Y', 'admin', SYSDATE, 1, SYS_GUID())
/
