/* first insert the data in the various entity tables and the principal table to create the coi admin user */
...
/* now insert the role-member data to create the association between the pre-existing coi admin role and coi admin user created above */
