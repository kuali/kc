...
INSERT INTO KRIM_ROLE_MBR_T (ROLE_MBR_ID,ROLE_ID,MBR_ID,MBR_TYP_CD,LAST_UPDT_DT,OBJ_ID,VER_NBR) 
       VALUES (KRIM_ENTITY_ID_S.CURRVAL,(SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = 'KC-UNT' AND ROLE_NM = 'IACUCApprover'),(SELECT PRNCPL_ID FROM KRIM_PRNCPL_T WHERE PRNCPL_NM = 'iacucadmin'),'P',SYSDATE,SYS_GUID(),1)
/
INSERT INTO KRIM_ENTITY_EMP_INFO_T (ACTV_IND,BASE_SLRY_AMT,EMP_ID,EMP_REC_ID,EMP_STAT_CD,EMP_TYP_CD,ENTITY_EMP_ID,ENTITY_ID,LAST_UPDT_DT,OBJ_ID,PRMRY_DEPT_CD,PRMRY_IND,VER_NBR)
       VALUES ('Y',100000,'iacucadmin','1','A','P',KRIM_ENTITY_ID_S.CURRVAL,KRIM_ENTITY_ID_S.CURRVAL,SYSDATE,SYS_GUID(),'000001','Y',1)
/
...
/
INSERT INTO KRIM_ROLE_MBR_T (ROLE_MBR_ID,ROLE_ID,MBR_ID,MBR_TYP_CD,LAST_UPDT_DT,OBJ_ID,VER_NBR) 
       VALUES (KRIM_ENTITY_ID_S.CURRVAL,(SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = 'KC-UNT' AND ROLE_NM = 'IACUCApprover'),(SELECT PRNCPL_ID FROM KRIM_PRNCPL_T WHERE PRNCPL_NM = 'iacucresearcher'),'P',SYSDATE,SYS_GUID(),1)
/
INSERT INTO KRIM_ENTITY_EMP_INFO_T (ACTV_IND,BASE_SLRY_AMT,EMP_ID,EMP_REC_ID,EMP_STAT_CD,EMP_TYP_CD,ENTITY_EMP_ID,ENTITY_ID,LAST_UPDT_DT,OBJ_ID,PRMRY_DEPT_CD,PRMRY_IND,VER_NBR)
       VALUES ('Y',100000,'iacucresearcher','1','A','P',KRIM_ENTITY_ID_S.CURRVAL,KRIM_ENTITY_ID_S.CURRVAL,SYSDATE,SYS_GUID(),'IN-CARD','Y',1)
/
...
/
INSERT INTO KRIM_ENTITY_EMP_INFO_T (ACTV_IND,BASE_SLRY_AMT,EMP_ID,EMP_REC_ID,EMP_STAT_CD,EMP_TYP_CD,ENTITY_EMP_ID,ENTITY_ID,LAST_UPDT_DT,OBJ_ID,PRMRY_DEPT_CD,PRMRY_IND,VER_NBR)
       VALUES ('Y',100000,'iacucaggregator','1','A','P',KRIM_ENTITY_ID_S.CURRVAL,KRIM_ENTITY_ID_S.CURRVAL,SYSDATE,SYS_GUID(),'IN-CARD','Y',1)
/
...
/
INSERT INTO KRIM_ROLE_MBR_T (ROLE_MBR_ID,ROLE_ID,MBR_ID,MBR_TYP_CD,LAST_UPDT_DT,OBJ_ID,VER_NBR) 
       VALUES (KRIM_ENTITY_ID_S.CURRVAL,(SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = 'KC-UNT' AND ROLE_NM = 'IACUCApprover'),(SELECT PRNCPL_ID FROM KRIM_PRNCPL_T WHERE PRNCPL_NM = 'iacucreviewer'),'P',SYSDATE,SYS_GUID(),1)
/
INSERT INTO KRIM_ENTITY_EMP_INFO_T (ACTV_IND,BASE_SLRY_AMT,EMP_ID,EMP_REC_ID,EMP_STAT_CD,EMP_TYP_CD,ENTITY_EMP_ID,ENTITY_ID,LAST_UPDT_DT,OBJ_ID,PRMRY_DEPT_CD,PRMRY_IND,VER_NBR)
       VALUES ('Y',100000,'iacucreviewer','1','A','P',KRIM_ENTITY_ID_S.CURRVAL,KRIM_ENTITY_ID_S.CURRVAL,SYSDATE,SYS_GUID(),'IN-CARD','Y',1)
/
...
/
INSERT INTO KRIM_ENTITY_EMP_INFO_T (ACTV_IND,BASE_SLRY_AMT,EMP_ID,EMP_REC_ID,EMP_STAT_CD,EMP_TYP_CD,ENTITY_EMP_ID,ENTITY_ID,LAST_UPDT_DT,OBJ_ID,PRMRY_DEPT_CD,PRMRY_IND,VER_NBR)
       VALUES ('Y',100000,'iacucviewer','1','A','P',KRIM_ENTITY_ID_S.CURRVAL,KRIM_ENTITY_ID_S.CURRVAL,SYSDATE,SYS_GUID(),'IN-CARD','Y',1)
/
...
/
INSERT INTO KRIM_ENTITY_EMP_INFO_T (ACTV_IND,BASE_SLRY_AMT,EMP_ID,EMP_REC_ID,EMP_STAT_CD,EMP_TYP_CD,ENTITY_EMP_ID,ENTITY_ID,LAST_UPDT_DT,OBJ_ID,PRMRY_DEPT_CD,PRMRY_IND,VER_NBR)
       VALUES ('Y',100000,'iacuccreate','1','A','P',KRIM_ENTITY_ID_S.CURRVAL,KRIM_ENTITY_ID_S.CURRVAL,SYSDATE,SYS_GUID(),'IN-CARD','Y',1)
/
...
/
INSERT INTO KRIM_ROLE_MBR_T (ROLE_MBR_ID,ROLE_ID,MBR_ID,MBR_TYP_CD,LAST_UPDT_DT,OBJ_ID,VER_NBR) 
       VALUES (KRIM_ENTITY_ID_S.CURRVAL,(SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = 'KC-UNT' AND ROLE_NM = 'IACUCApprover'),(SELECT PRNCPL_ID FROM KRIM_PRNCPL_T WHERE PRNCPL_NM = 'iacucadmin-card'),'P',SYSDATE,SYS_GUID(),1)
/
INSERT INTO KRIM_ENTITY_EMP_INFO_T (ACTV_IND,BASE_SLRY_AMT,EMP_ID,EMP_REC_ID,EMP_STAT_CD,EMP_TYP_CD,ENTITY_EMP_ID,ENTITY_ID,LAST_UPDT_DT,OBJ_ID,PRMRY_DEPT_CD,PRMRY_IND,VER_NBR)
       VALUES ('Y',100000,'iacucadmin-card','1','A','P',KRIM_ENTITY_ID_S.CURRVAL,KRIM_ENTITY_ID_S.CURRVAL,SYSDATE,SYS_GUID(),'IN-CARD','Y',1)
/
