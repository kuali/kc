...
/
insert into SPONSOR_FORM_TEMPLATES (PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,SPONSOR_FORM_TEMPLATE_ID,SPONSOR_FORM_ID,FORM_TEMPLATE,OBJ_ID,UPDATE_TIMESTAMP,UPDATE_USER) values (11,'Key Personnel report','Key Personnel report.xslt','text/xml',13,'2',EMPTY_CLOB(),sys_guid(),sysdate,user);
...
/
set define off;
insert into SPONSOR_FORM_TEMPLATES (PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,SPONSOR_FORM_TEMPLATE_ID,SPONSOR_FORM_ID,FORM_TEMPLATE,OBJ_ID,UPDATE_TIMESTAMP,UPDATE_USER) values (12,'Detailed Budget Period 1','Detailed Budget Period 1.xslt','text/xml',11,'2',EMPTY_CLOB(),sys_guid(),sysdate,user);
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES
WHERE
...
/
set define off;
insert into SPONSOR_FORM_TEMPLATES (PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,SPONSOR_FORM_TEMPLATE_ID,SPONSOR_FORM_ID,FORM_TEMPLATE,OBJ_ID,UPDATE_TIMESTAMP,UPDATE_USER) values (13,'Budget Entire Proposed Period','Budget Entire Proposed Period.xslt','text/xml',14,'2',EMPTY_CLOB(),sys_guid(),sysdate,user);
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES
WHERE
...
/
set define off;
insert into SPONSOR_FORM_TEMPLATES (PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,SPONSOR_FORM_TEMPLATE_ID,SPONSOR_FORM_ID,FORM_TEMPLATE,OBJ_ID,UPDATE_TIMESTAMP,UPDATE_USER) values (14,'checklist','checklist.xslt','text/xml',15,'2',EMPTY_CLOB(),sys_guid(),sysdate,user);
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES
WHERE
...
/
set define off;
insert into SPONSOR_FORM_TEMPLATES (PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,SPONSOR_FORM_TEMPLATE_ID,SPONSOR_FORM_ID,FORM_TEMPLATE,OBJ_ID,UPDATE_TIMESTAMP,UPDATE_USER) values (17,'Resources','Resources.xslt','text/xml',17,'2',EMPTY_CLOB(),sys_guid(),sysdate,user);
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES
WHERE
...
/
set define off;
insert into SPONSOR_FORM_TEMPLATES (PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,SPONSOR_FORM_TEMPLATE_ID,SPONSOR_FORM_ID,FORM_TEMPLATE,OBJ_ID,UPDATE_TIMESTAMP,UPDATE_USER) values (18,'Table Of Contents','Table Of Contents.xslt','text/xml',18,'2',EMPTY_CLOB(),sys_guid(),sysdate,user);
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES
WHERE
...
/
set define off;
insert into SPONSOR_FORM_TEMPLATES (PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,SPONSOR_FORM_TEMPLATE_ID,SPONSOR_FORM_ID,FORM_TEMPLATE,OBJ_ID,UPDATE_TIMESTAMP,UPDATE_USER) values (7,'facepage','facepage.xslt','text/xml',19,'2',EMPTY_CLOB(),sys_guid(),sysdate,user);
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES
WHERE
...
/
set define off;
insert into SPONSOR_FORM_TEMPLATES (PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,SPONSOR_FORM_TEMPLATE_ID,SPONSOR_FORM_ID,FORM_TEMPLATE,OBJ_ID,UPDATE_TIMESTAMP,UPDATE_USER) values (8,'face page continued','face page continued.xslt','text/xml',20,'2',EMPTY_CLOB(),sys_guid(),sysdate,user);
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES
WHERE
