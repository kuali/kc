DELETE FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = 1 AND PAGE_NUMBER = 8
/
commit
/
INSERT INTO SPONSOR_FORM_TEMPLATES (SPONSOR_FORM_TEMPLATE_ID,SPONSOR_FORM_ID,PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,FORM_TEMPLATE,UPDATE_USER,UPDATE_TIMESTAMP,OBJ_ID,VER_NBR) values (SEQ_SPONSOR_FORM_TEMPLATES.NEXTVAL,1,8,'Proposal Development Summary Print','ProposalDevelopmentSummary.xslt','text/xml',EMPTY_CLOB(),'admin',SYSDATE,SYS_GUID(),1)
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES
WHERE
SPONSOR_FORM_ID =1 AND PAGE_NUMBER = 8 FOR UPDATE;
...
buffer := 'ct="$value-of-template"/>
														...
														<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
															<fo:block>
																...
																<xsl:if test="propdev:MULTI_PI_FLAG =&apos;N&apos;">
																	<fo:inline>
																		<xsl:text>No</xsl:text>
																	</fo:inline>
																</xsl:if>
...
buffer := ' select="$value-of-template"/>
										...
										<xsl:if test="count(  //propdev:PROPOSAL/propdev:PROP_PER_CREDIT_SPLIT/propdev:PROP_UNIT_CREDIT_SPLIT  )  &gt;0">
											<fo';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
END;
/
											...
											<fo:table font-family="Arial" font-size="9pt" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="-1pt">
												...
												<fo:table-body start-indent="0pt">
													<fo:table-row font-weight="bold">
														...
														<fo:table-cell border="solid 1pt gray" padding="0" height="13" text-align="ri';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
END;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
...
WHERE
SPONSOR_FORM_ID =1 AND PAGE_NUMBER = 8 FOR UPDATE;
buffer := 'ght" display-align="center">
															<fo:block>
									...
									<fo:table-body start-indent="0pt">
										<fo:table-row font-weight="bold">
											<fo:table-cell font-weight="bold" border="solid 1pt gray" padding="0" display-align="center">
												<fo:block>
													<fo:inline>
														<xsl:text>Investigator Total</xsl:text>
													</fo:inline>
												</fo:block>
											</fo:table-cell>
											<fo:table-cell border="solid 1pt gray" padding="0" height="13" text-align="right" display-align="center">
...
WHERE
SPONSOR_FORM_ID =1 AND PAGE_NUMBER = 8 FOR UPDATE;
buffer := 'border="solid 1pt gray" padding="0" display-align="center">
														<fo:block>
...
WHERE
SPONSOR_FORM_ID =1 AND PAGE_NUMBER = 8 FOR UPDATE;
buffer := '							<xsl:if test="propdev:ANSWER = &apos;N&apos;">
																	<fo:inline>
																		<xsl:text>No</xsl:text>
																	</fo:inline>
																</xsl:if>
...
WHERE
SPONSOR_FORM_ID =1 AND PAGE_NUMBER = 8 FOR UPDATE;
buffer := ':for-each select="propdev:SPONSOR_PROPOSAL_NUMBER">
															<xsl:variable name="value-of-template">
																<xsl:apply-templates/>
															</xsl:variable>
															<xsl:choose>
											...
											<fo:table-row>
												<fo:table-cell font-weight="bold" padding="2pt" height="18" display-align="center">
													<fo:block>
														<fo:inline>
															<xsl:text>Funding Opportunity:</xsl:text>
								';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
END;
/
...
buffer := ':when test="contains(string($value-of-template),''&#x2029;'')">
											...
											<fo:table-row>
												...
												<fo:table-cell padding="2pt" display-align="center">
													<fo:block>
														<xsl:for-each select="lookuptypes:NSF_SCIENCE_CODE">
															<xsl:for-each select="lookuptypes:NSF_CODE">
																<xsl:variable name="value-of-template">
																	<xsl:apply-templates/>
																</xsl:variable>
																<xsl:choose>
...
WHERE
SPONSOR_FORM_ID =1 AND PAGE_NUMBER = 8 FOR UPDATE;
buffer := 'ial" font-size="9pt" table-layout="fixed" width="100%" border-spacing="2pt">
														...
														<fo:table-body start-indent="0pt">
															<fo:table-row>
																...
																<fo:table-cell number-columns-spanned="3" padding="2pt" display-align="center">
																	<fo:block>
																		<xsl:if test="propdev:PROPOSAL/propdev:PROPOSAL_MASTER/propdev:BUDGET_STATUS = &apos;I&apos;">
																			<fo:inline>
																				<xsl:text>InComplete</xsl:text>
																			</fo:inline>
																		</xsl:if>
																		<xsl:if test="propdev:PROPOSAL/propdev:PROPOSAL_MASTER/propdev:BUDGET_STATUS = &apos;C&apos;">
																			<fo:inline>
...
WHERE
SPONSOR_FORM_ID =1 AND PAGE_NUMBER = 8 FOR UPDATE;
buffer := 'ght="bold" number-columns-spanned="4" padding="2pt" display-align="center">
																	<fo:block>
																		<fo:inline>
															...
															<fo:table-row>
																<fo:table-cell font-weight="bold" padding="2pt" display-align="c';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
END;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
														...
														<fo:table-cell font-weight="bold" padding="2pt" display-align="center">
															<fo:block>
																<xsl:for-each select="propdev:COLUMN_NAME">
																	...
																	<xsl:choose>
																		<xsl:when test="contains(string($value-o';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
END;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
...
WHERE
SPONSOR_FORM_ID =1 AND PAGE_NUMBER = 8 FOR UPDATE;
buffer := 'st="contains(string($value-of-template),''&#x2029;'')">
																													<fo:block>
																														<xsl:copy-of select="$value-of-template"/>
																													</fo:block>
																												</xsl:when>
																						...
																						<fo:table-cell border="solid 1pt gray" padding="0" display-align="center">
																							<fo:block>
																								<xsl:for-each select="approvalRouting:UpdateTimestamp">
																									<fo:inline>
																										<xsl:value-of select="format-number(number(substring(string(string(.)), 6, 2)), ''00'')"/>
																										<xsl:text>/</xsl:text>
																										<xsl:value-of select="format-number(number(substring(string(string(.)), 9, 2)), ''00'')"/>
							...
							<fo:table-row>
								<fo:table-cell padding="0" padding-bottom="0" number-columns-spanned="4" height="18" display-align="center">
									<fo:block>
										<xsl:for-each select="propdev:PROPOSAL">
											<xsl:for-each select="propdev:SCHOOL_INFO_TYPE">
												<xsl:for-each select="propdev:Acronym">
													<xsl:variable name="value-of-template">
														<xsl:apply-templates/>
													</xsl:variable>
													<xsl:choose>
...
WHERE
SPONSOR_FORM_ID =1 AND PAGE_NUMBER = 8 FOR UPDATE;
buffer := 'ntains(string($value-of-template),''&#x2029;'')">
														<fo:block>
															<xsl:copy-of select="$value-of-template"/>
														</fo:block>
													</xsl:when>
