...
VALUES(KRIM_ROLE_ID_BS_S.NEXTVAL, SYS_GUID(), 1, 'Maintain COI Questionnaire', 'KC-COIDISCLOSURE', 'Grants the ability to maintain IACUC questionnaires.', (SELECT KIM_TYP_ID FROM KRIM_TYP_T WHERE NM = 'Default'), 'Y', SYSDATE)
/
...
/
INSERT INTO KRIM_ROLE_PERM_T (ROLE_PERM_ID, OBJ_ID, VER_NBR, ROLE_ID, PERM_ID, ACTV_IND) 
VALUES(KRIM_ROLE_PERM_ID_BS_S.NEXTVAL, SYS_GUID(), 1, (SELECT ROLE_ID FROM KRIM_ROLE_T WHERE ROLE_NM='Maintain IACUC Questionnaire' AND nmspc_cd='KC-COIDISCLOSURE'),
       (SELECT PERM_ID FROM KRIM_PERM_T WHERE NMSPC_CD = 'KC-COIDISCLOSURE' AND NM = 'Maintain Questionnaire Usage'), 'Y')
/
INSERT INTO KRIM_ROLE_PERM_T (ROLE_PERM_ID, OBJ_ID, VER_NBR, ROLE_ID, PERM_ID, ACTV_IND) 
