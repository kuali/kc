...
BEGIN
    ...
    LOOP
        ...
        IF rolePermCount = 0 THEN
            EXECUTE IMMEDIATE 'INSERT INTO KRIM_ROLE_PERM_T (ROLE_PERM_ID, ROLE_ID, PERM_ID, ACTV_IND, OBJ_ID, VER_NBR) VALUES (CONCAT('KC',KRIM_ROLE_PERM_ID_S.NEXTVAL),(SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD = ''KC-SYS'' AND ROLE_NM = ''KC Superuser''),' || rec.PERM_ID || ',''Y'',SYS_GUID(),1)';
        END IF;
    END LOOP;
END;
/
