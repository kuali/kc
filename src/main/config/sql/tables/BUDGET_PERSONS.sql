 CREATE TABLE BUDGET_PERSONS 
   (	"PROPOSAL_NUMBER" VARCHAR2(12) constraint BUDGET_PERSONSN1 NOT NULL ENABLE, 
	...
	"PERSON_SEQUENCE_NUMBER" NUMBER(3,0) constraint BUDGET_PERSONN3 NOT NULL ENABLE,
	...
	CONSTRAINT "PK_BUDGET_PERSONS_KRA" PRIMARY KEY ("PROPOSAL_NUMBER", "VERSION_NUMBER", "PERSON_SEQUENCE_NUMBER") ENABLE
); 
