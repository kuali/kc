...
(
   ...
   UPDATE_USER VARCHAR2(60) CONSTRAINT CARRIER_TYPE_N4 not null,
...
(
   ...
   UPDATE_USER VARCHAR2(60) CONSTRAINT NOTICE_OF_OPPORTUNITY_N4 not null,
...
(
   ...
   UPDATE_USER VARCHAR2(60) CONSTRAINT STATE_CODE_N5 NOT NULL,
