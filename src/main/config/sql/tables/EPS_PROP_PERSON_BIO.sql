 CREATE TABLE EPS_PROP_PERSON_BIO 
   (	"PROPOSAL_NUMBER" NUMBER(12,0) constraint EPS_PROP_PERSON_BION1 NOT NULL ENABLE, 
	"PERSON_ID" VARCHAR2(9) constraint EPS_PROP_PERSON_BION2 NOT NULL ENABLE, 
	...
	CONSTRAINT "PK_EPS_PROP_PERSON_BIO_KRA" PRIMARY KEY ("PROPOSAL_NUMBER", "PERSON_ID", "BIO_NUMBER") ENABLE
) ;
