 CREATE TABLE BUDGET_DETAILS_CAL_AMTS 
   (	"PROPOSAL_NUMBER" VARCHAR2(12) constraint BUDGET_DETAILS_CAL_AMTSN1 NOT NULL ENABLE, 
	...
	"RATE_CLASS_CODE" NUMBER(3,0) constraint BUDGET_DETAILS_CAL_AMTSN5 NOT NULL ENABLE, 
	"RATE_TYPE_CODE" NUMBER(3,0) constraint BUDGET_DETAILS_CAL_AMTSN6 NOT NULL ENABLE, 
