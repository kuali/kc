 CREATE TABLE INSTITUTE_RATES 
   (	"RATE_CLASS_CODE" NUMBER(3,0) constraint INSTITUTE_RATESN1 NOT NULL ENABLE, 
	"RATE_TYPE_CODE" NUMBER(3,0) constraint INSTITUTE_RATESN2 NOT NULL ENABLE, 
	"ACTIVITY_TYPE_CODE" NUMBER(3,0) constraint INSTITUTE_RATESN3 NOT NULL ENABLE, 
	...
	"UPDATE_USER" VARCHAR2(60) constraint INSTITUTE_RATESN9 NOT NULL ENABLE, 
	...
	active_flag char(1) default 'Y' constraint institute_ratesN15 NOT NULL enable,
...
ALTER table INSTITUTE_RATES modify RATE_TYPE_CODE VARCHAR2(3);
 ...
 ALTER TABLE INSTITUTE_RATES ADD (CONSTRAINT "FK_INSTITUTE_RATES_ACTIVITY_KRA" FOREIGN KEY ("ACTIVITY_TYPE_CODE")
