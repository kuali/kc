 CREATE TABLE BUDGET_PERSONNEL_CAL_AMTS 
   (	"PROPOSAL_NUMBER" VARCHAR2(12) constraint BUDGET_PERSONNEL_CAL_AMTSN1 NOT NULL ENABLE, 
	...
	"UPDATE_USER" VARCHAR2(60) constraint BUDGET_PERSONNEL_CAL_AMTSN10 NOT NULL ENABLE, 
	...
	CONSTRAINT "PK_BUDGET_PERSONNEL_CAL_AMTS_KRA" PRIMARY KEY ("PROPOSAL_NUMBER", "VERSION_NUMBER", "BUDGET_PERIOD", "LINE_ITEM_NUMBER", "PERSON_NUMBER", "RATE_CLASS_CODE", "RATE_TYPE_CODE") ENABLE
);
