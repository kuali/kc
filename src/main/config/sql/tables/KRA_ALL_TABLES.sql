...
(	"PROPOSAL_NUMBER" NUMBER(12,0) CONSTRAINT "PROPOSAL_NEXTVALUE_N1" NOT NULL    
ENABLE,                                                                         
"PROPERTY_NAME" VARCHAR2(200) CONSTRAINT "PROPOSAL_NEXTVALUE_N2" NOT NULL       
ENABLE,                                                                         
"NEXT_VALUE" NUMBER(12,0) CONSTRAINT "PROPOSAL_NEXTVALUE_N3" NOT NULL ENABLE,   
"UPDATE_TIMESTAMP" DATE CONSTRAINT "PROPOSAL_NEXTVALUE_N4" NOT NULL ENABLE,     
"UPDATE_USER" VARCHAR2(8) CONSTRAINT "PROPOSAL_NEXTVALUE_N5" NOT NULL ENABLE,   
"VER_NBR" NUMBER(8,0) DEFAULT 1 CONSTRAINT "PROPOSAL_NEXTVALUE_N6" NOT NULL     
ENABLE,                                                                         
"OBJ_ID" VARCHAR2(36) DEFAULT SYS_GUID() CONSTRAINT "PROPOSAL_NEXTVALUE_N7" NOT 
NULL ENABLE,                                                                    
CONSTRAINT "PK_PROPOSAL_NEXTVALUE" PRIMARY KEY ("PROPOSAL_NUMBER",              
...
CONSTRAINT "KIM_NMSPCE_DFLT_ATTR_UK1" UNIQUE ("NAMESPACE_ID", "ATTRIBUTE_NAME") 
ENABLE                                                                          
) ;
...
"PERSON_ID" NUMBER(8,0) NOT NULL ENABLE,                                        
"GROUP_ID" NUMBER(8,0) NOT NULL ENABLE,                                         
"GROUP_ATTRIBUTE_ID" NUMBER(8,0) NOT NULL ENABLE,                               
"OBJ_ID" VARCHAR2(36) DEFAULT SYS_GUID() NOT NULL ENABLE,                       
"VER_NBR" NUMBER(8,0) DEFAULT 1 NOT NULL ENABLE,                                
CONSTRAINT "KIM_PERSON_QUALIFIED_GROUP_PK" PRIMARY KEY ("PERSON_ID", "GROUP_ID",
"GROUP_ATTRIBUTE_ID") ENABLE                                                    
) ;                                                                             
...
"ROLE_ATTRIBUTE_ID" NUMBER(8,0) NOT NULL ENABLE,                                
"OBJ_ID" VARCHAR2(36) DEFAULT SYS_GUID() NOT NULL ENABLE,                       
"VER_NBR" NUMBER(8,0) DEFAULT 1 NOT NULL ENABLE,                                
CONSTRAINT "KIM_PERSON_QUALIFIED_ROLE_PK" PRIMARY KEY ("PERSON_ID", "ROLE_ID",  
"ROLE_ATTRIBUTE_ID") ENABLE                                                     
) ;                                                                             
...
"OBJ_ID" VARCHAR2(36) DEFAULT SYS_GUID() NOT NULL ENABLE,                       
"VER_NBR" NUMBER(8,0) DEFAULT 1 NOT NULL ENABLE,                                
CONSTRAINT "KIM_ROLES_GROUPS_PK" PRIMARY KEY ("ROLE_ID", "GROUP_ID") ENABLE     
) ;                                                                             
...
"OBJ_ID" VARCHAR2(36) DEFAULT SYS_GUID() NOT NULL ENABLE,                       
"VER_NBR" NUMBER(8,0) DEFAULT 1 NOT NULL ENABLE,                                
CONSTRAINT "KIM_ROLES_PERSONS_PK" PRIMARY KEY ("ROLE_ID", "PERSON_ID") ENABLE   
) ;                                                                             
...
CONSTRAINT "NOTIFICATION_CONTENT_TYPE_UK1" UNIQUE ("NAME") ENABLE
   ) ;
...
CREATE TABLE COST_ELEMENT_GROUPS 
   (	"MAPPING_NAME" VARCHAR2(200) constraint COST_ELEMENT_GROUPSN1 NOT NULL ENABLE, 
	"COST_ELEMENT" VARCHAR2(8) constraint COST_ELEMENT_GROUPSN2 NOT NULL ENABLE, 
	"COST_ELEMENT_GROUP" VARCHAR2(8) constraint COST_ELEMENT_GROUPSN3 NOT NULL ENABLE, 
	"UPDATE_USER" VARCHAR2(8) constraint COST_ELEMENT_GROUPSN4 NOT NULL ENABLE, 
	"UPDATE_TIMESTAMP" DATE constraint COST_ELEMENT_GROUPSN5 NOT NULL ENABLE, 
	 "VER_NBR" NUMBER(8,0) DEFAULT 1  constraint  COST_ELEMENT_GROUPSN6  NOT NULL ENABLE,
	"OBJ_ID" VARCHAR2(36) DEFAULT SYS_GUID()  constraint  COST_ELEMENT_GROUPSN7  NOT NULL ENABLE,
	CONSTRAINT "PK_COST_ELEMENT_GROUP_KRA" PRIMARY KEY ("MAPPING_NAME", "COST_ELEMENT", "COST_ELEMENT_GROUP") ENABLE
);
