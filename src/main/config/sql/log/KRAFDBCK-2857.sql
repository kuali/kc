...
select krim_entity_nm_id_s.nextval, krim_entity_id_s.currval, 'Ima', 'Viewer', 'PRFR', 'Y', 'Y', sysdate, sys_guid(), 1 from dual;
...
select krim_role_mbr_attr_data_id_s.nextval, krim_role_mbr_id_s.currval, t.kim_typ_id, d.kim_attr_defn_id, '000001', sys_guid(), 1 from krim_typ_t t, KRIM_ATTR_DEFN_T d
where t.nm = 'UnitHierarchy' and d.nm = 'unitNumber';

insert into krim_role_mbr_attr_data_t (attr_data_id, role_mbr_id, kim_typ_id, kim_attr_defn_id, attr_val, obj_id, ver_nbr)
select krim_role_mbr_attr_data_id_s.nextval, krim_role_mbr_id_s.currval, t.kim_typ_id, d.kim_attr_defn_id, 'Y', sys_guid(), 1 from krim_typ_t t, KRIM_ATTR_DEFN_T d
where t.nm = 'UnitHierarchy' and d.nm = 'subunits';
/*
insert into krim_grp_mbr_t (GRP_MBR_ID, grp_id, mbr_id, MBR_TYP_CD, LAST_UPDT_DT, OBJ_ID, VER_NBR)
select krim_grp_mbr_id_s.nextval, grp_id, krim_prncpl_id_s.currval, 'P', sysdate, sys_guid(), VER_NBR
from KRIM_GRP_T
where grp_nm = 'ProposalAdmin';

insert into krim_grp_mbr_t (GRP_MBR_ID, grp_id, mbr_id, MBR_TYP_CD, LAST_UPDT_DT, OBJ_ID, VER_NBR)
select krim_grp_mbr_id_s.nextval, grp_id, krim_prncpl_id_s.currval, 'P', sysdate, sys_guid(), VER_NBR
from KRIM_GRP_T
where grp_nm = 'KcAdmin';
*/
