...
set define off;
delete from SPONSOR_FORM_TEMPLATES where SPONSOR_CODE =  '000340' and PACKAGE_NUMBER=6 and PAGE_NUMBER=1;
delete from SPONSOR_FORM_TEMPLATES where SPONSOR_CODE =  '000340' and PACKAGE_NUMBER=5 and PAGE_NUMBER=15;
Insert into SPONSOR_FORM_TEMPLATES (SPONSOR_CODE,PACKAGE_NUMBER,PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,FORM_TEMPLATE,UPDATE_TIMESTAMP,UPDATE_USER) values ('000340',5,15,'BioSketch','BioSketch.xslt','text/xml',EMPTY_CLOB(),sysdate,user);
										...
										<xsl:attribute name="external-destination">
											...
											<xsl:call-template name="double-backslash">
												...
												<xsl:with-param name="text-length">
													<xsl:value-of select="string-length(string(&apos;h';
...
WHERE
SPONSOR_CODE =  '000340' and PACKAGE_NUMBER=5 and PAGE_NUMBER=15  FOR UPDATE;
buffer := 'ttp://grants.nih.gov/grants/funding/phs398/phs398.html&apos;))"/>
												</xsl:with-param>
											</xsl:call-template>
											<xsl:text>)</xsl:text>
										</xsl:attribute>
...
/
set define off;
Insert into SPONSOR_FORM_TEMPLATES (SPONSOR_CODE,PACKAGE_NUMBER,PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,FORM_TEMPLATE,UPDATE_TIMESTAMP,UPDATE_USER) values ('000340',6,1,'Face Page','Face Page.xslt','text/xml',EMPTY_CLOB(),sysdate,user);
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES
WHERE
SPONSOR_CODE =  '000340' and PACKAGE_NUMBER=6 and PAGE_NUMBER=1  FOR UPDATE;
buffer := '<?xml version="1.0" encoding="UTF-8"?>
