set define off
  DECLARE 
    ...
    l_adhoc_review_doc_perm_tmpl_id VARCHAR2(40);                      
  ...
  BEGIN
    ...
    SELECT PERM_TMPL_ID INTO l_adhoc_review_doc_perm_tmpl_id FROM KRIM_PERM_TMPL_T T WHERE T.NMSPC_CD = 'KR-WKFLW' AND T.NM = 'Ad Hoc Review Document';
    ...
    SELECT KIM_TYP_ID INTO l_doc_type_note_id FROM KRIM_TYP_T WHERE NMSPC_CD = 'KR-NS' AND NM = 'Document Type & Relationship to Note Author, KR-NS';
    ...
    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, krim_perm_id_s.currval, l_doc_type_id, l_doc_type_attr_id, 'KC');
    ...
    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, krim_perm_id_s.currval, l_doc_type_rte_node_id, l_doc_type_attr_id, 'KC'); 
    ...
    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, krim_perm_id_s.currval, l_doc_type_note_id, l_doc_type_attr_id, 'KC');
 
    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, krim_perm_id_s.currval, l_doc_type_note_id, l_created_by_self_attr_id, 'false');

    insert into krim_role_perm_t (role_perm_id, role_id, perm_id, actv_ind, obj_id) 
    values (krim_role_perm_id_s.nextval, krim_role_id_s.currval, krim_perm_id_s.currval, 'Y', SYS_GUID());

    insert into krim_perm_t (perm_id, perm_tmpl_id, nmspc_cd, nm, desc_txt, actv_ind, obj_id) 
    values (krim_perm_id_s.nextval, l_adhoc_review_doc_perm_tmpl_id, 'KC-SYS', 'Ad Hoc Review Document', 'Authorizes users to take the Approve action on KC documents Ad Hoc routed to them.', 'Y', SYS_GUID());
    
    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, krim_perm_id_s.currval, l_adhoc_review_type_id, l_doc_type_attr_id, 'KC');

    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, krim_perm_id_s.currval, l_adhoc_review_type_id, l_action_request_attr_id, 'A');
    
    insert into krim_perm_t (perm_id, perm_tmpl_id, nmspc_cd, nm, desc_txt, actv_ind, obj_id) 
    values (krim_perm_id_s.nextval, l_adhoc_review_doc_perm_tmpl_id, 'KC-SYS', 'Ad Hoc Review Document', 'Authorizes users to take the FYI action on KC documents Ad Hoc routed to them.', 'Y', SYS_GUID());

    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, krim_perm_id_s.currval, l_adhoc_review_type_id, l_doc_type_attr_id, 'KC');

    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, krim_perm_id_s.currval, l_adhoc_review_type_id, l_action_request_attr_id, 'F');
    
    insert into krim_perm_t (perm_id, perm_tmpl_id, nmspc_cd, nm, desc_txt, actv_ind, obj_id) 
    values (krim_perm_id_s.nextval, l_adhoc_review_doc_perm_tmpl_id, 'KC-SYS', 'Ad Hoc Review Document', 'Authorizes users to take the Acknowledge action on KC documents Ad Hoc routed to them.', 'Y', SYS_GUID());
 
    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, krim_perm_id_s.currval, l_adhoc_review_type_id, l_doc_type_attr_id, 'KC');

    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, krim_perm_id_s.currval, l_adhoc_review_type_id, l_action_request_attr_id, 'K');
    ...
    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, krim_perm_id_s.currval, l_doc_type_id, l_doc_type_attr_id, 'KcMaintenanceDocument');
    ...
    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, krim_perm_id_s.currval, l_role_type_id, l_namespace_attr_id, 'KRA*');

    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, krim_perm_id_s.currval, l_role_type_id, l_namespace_attr_id, 'KC*');
    ...
    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, krim_perm_id_s.currval, l_perm_type_id, l_namespace_attr_id, 'KRA*');

    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, krim_perm_id_s.currval, l_perm_type_id, l_namespace_attr_id, 'KC*');

    insert into krim_role_perm_t (role_perm_id, role_id, perm_id, actv_ind, obj_id) 
    values (krim_role_perm_id_s.nextval, krim_role_id_s.currval, krim_perm_id_s.currval, 'Y', SYS_GUID());

    insert into krim_perm_t (perm_id, perm_tmpl_id, nmspc_cd, nm, desc_txt, actv_ind, obj_id) 
    values (krim_perm_id_s.nextval, l_grant_perm_resp_tmpl_id, 'KC-SYS', 'Grant Responsibility', 'Authorizes users to modify the information on the Responsibility tab of the Role Document for roles with a Module Code that begins with KFS.', 'Y', SYS_GUID());
    --Need to decide how to include KRA* or KC*

    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, krim_perm_id_s.currval, l_resp_type_id, l_namespace_attr_id, 'KRA*');

    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, krim_perm_id_s.currval, l_resp_type_id, l_namespace_attr_id, 'KC*');
    ...
    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, krim_perm_id_s.currval, l_parm_type_id, l_namespace_attr_id, 'KRA*');

    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, krim_perm_id_s.currval, l_parm_type_id, l_namespace_attr_id, 'KC*');
    ...
    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, l_maintain_parm_perm_id, l_parm_type_id, l_namespace_attr_id, 'KR-SYS');

    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, l_maintain_parm_perm_id, l_parm_type_id, l_namespace_attr_id, 'KR*');
    ...
    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, l_full_unmask_fld_perm_id, l_comp_fld_type_id, l_comp_attr_id, 'KimPrincipalImpl');

    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, l_full_unmask_fld_perm_id, l_comp_fld_type_id, l_property_attr_id, 'password');
    ...
    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, l_full_unmask_fld_perm_id, l_comp_fld_type_id, l_comp_attr_id, 'IdentityManagementPersonDocument');

    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, l_full_unmask_fld_perm_id, l_comp_fld_type_id, l_property_attr_id, 'taxId');
    ...
    insert into krim_perm_attr_data_t (attr_data_id, perm_id, kim_typ_id, kim_attr_defn_id, attr_val) 
    values (krim_attr_data_id_s.nextval, l_full_unmask_fld_perm_id, l_doc_type_id, l_doc_type_attr_id, 'RiceDocument');
    ...
    UPDATE KRIM_PERM_T T SET NMSPC_CD = 'KUALI' AND DESC_TXT = 'Authorizes users to take Approve, Acknowledge or FYI action on KUALI documents Ad Hoc routed to them.' WHERE PERM_ID = l_adhoc_review_doc_perm_id;
    ...
    UPDATE KRIM_PERM_T T SET NMSPC_CD = 'KUALI' AND DESC_TXT = 'Allows access to the Copy button on KC Documents.' WHERE PERM_ID = l_copy_doc_perm_id;
