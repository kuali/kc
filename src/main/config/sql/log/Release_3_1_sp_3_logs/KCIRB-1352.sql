...
--Oracle
update protocol_attachment_protocol a set a.description = concat( concat( (select description from protocol_attachment_type b where b.type_cd = a.type_cd), ' - '), a.update_timestamp) where a.description IS NULL;
...
commit;
alter table protocol_attachment_protocol modify (description not null);
alter table protocol_attachment_personnel modify (description not null);
...
update protocol_attachment_personnel a set a.description = concat( concat( (select description from protocol_attachment_type b where b.type_cd = a.type_cd), ' - '), a.update_timestamp) where a.description IS NULL;
commit;
alter table protocol_attachment_protocol modify column description varchar(200) not null;
