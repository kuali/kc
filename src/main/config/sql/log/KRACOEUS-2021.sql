 -- New Flags for budget cost sharing and unrecovered f and a allocation enforcement for KRACOEUS-1982

INSERT
INTO sh_parm_t (sh_parm_nmspc_cd, sh_parm_dtl_typ_cd, sh_parm_nm, obj_id, ver_nbr, sh_parm_typ_cd, sh_parm_txt, sh_parm_desc, sh_p, arm_cons_cd, wrkgrp_nm, active_ind)
