...
set define off;
Insert into SPONSOR_FORM_TEMPLATES (OBJ_ID,VER_NBR,SPONSOR_CODE,PACKAGE_NUMBER,PAGE_NUMBER,PAGE_DESCRIPTION,UPDATE_TIMESTAMP,UPDATE_USER,FILE_NAME,CONTENT_TYPE,FORM_TEMPLATE) values ('999B28323AB8902BE040DC0A1F8A6BD8',1,'000340', 5,'15','BioSketch',sysdate,user,'BioSketch.xslt','text/xml',EMPTY_CLOB());
