...
select KRIM_ROLE_ID_S.NEXTVAL from dual;
    INSERT INTO KRIM_ROLE_RSP_T (ROLE_RSP_ID, ROLE_ID, RSP_ID, ACTV_IND, OBJ_ID) 
       VALUES (KRIM_ROLE_RSP_ID_S.NEXTVAL, KRIM_ROLE_ID_S.CURRVAL, KRIM_RSP_ID_S.CURRVAL, 'Y', SYS_GUID());
select KRIM_ROLE_RSP_ID_S.NEXTVAL from dual;
    INSERT INTO KRIM_ROLE_RSP_ACTN_T (ROLE_RSP_ACTN_ID, ROLE_MBR_ID, ACTN_TYP_CD, PRIORITY_NBR, ACTN_PLCY_CD, ROLE_RSP_ID, FRC_ACTN, OBJ_ID) 
       VALUES (KRIM_ROLE_RSP_ACTN_ID_S.NEXTVAL, '*', 'A', 1, 'F', KRIM_ROLE_RSP_ID_S.CURRVAL, 'Y', SYS_GUID());
