														...
														<children>
															<paragraph>
																<children>
																	...
																	<text fixtext=" reviewed the above mentioned protocol and determined that substantive revisions are required. These revisions are noted  below.  If you agree with all of the committee’s revisions, incorporate them in a revised protocol and submit it to the ">
																		<styles font-size="10pt"/>
																	</text>
																	<template match="n1:Protocol" matchtype="schemagraphitem">
																		<children>
