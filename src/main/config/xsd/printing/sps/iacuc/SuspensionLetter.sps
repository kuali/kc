					...
					<template subtype="source" match="XML">
						<children>
												...
												<children>
													...
													<tgridrow>
														<children>
															...
															<tgridcell>
																<children>
																	<text fixtext="Suspension Letter"/>
																</children>
															</tgridcell>
														</children>
													</tgridrow>
							...
							<paragraph paragraphtag="p">
								<properties class="linesp"/>
								<children>
									<text fixtext="The above mentioned protocol"/>
									<template subtype="element" match="n1:Correspondence">
										<children>
											<template subtype="element" match="n1:Protocol">
												<children>
													<text fixtext=" has suspended as of "/>
													<template subtype="element" match="n1:Submissions">
														<children>
													...
													<text fixtext=". Studies being conducted on expired protocols shall be immediately suspended and animals involved in these studies removed from "/>
													<template subtype="element" match="n1:SchoolInfo">
														<children>
															<template subtype="element" match="n1:SchoolName">
																<children>
																	<content/>
																</children>
																<variables/>
									...
									<text fixtext=" Housing. This decision is based on federal law which requires that all vertebrate animals housed for research and teaching be identified with an approved protocol. During unannounced inspection federal agents identifying animals housed under expired protocols may levy substantial fines against the University."/>
								</children>
							</paragraph>
							<paragraph paragraphtag="p">
								<children>
