								...
								<children>
															...
															<tablerow>
																<children>
																	...
																	<tablecell>
																		...
																		<styles font-family="Arial"/>
																		<children>
																			<text fixtext="Approval Withheld Pending Clarification">
																				<styles font-size="10pt" font-weight="bold"/>
																			</text>
																		</children>
																	</tablecell>
															...
															<tablerow>
																<children>
																	<tablecell>
																		...
																		<styles font-family="Arial"/>
																		<children>
																			<text fixtext="IACUC Action Date: ">
																				<styles font-size="10pt" font-weight="bold"/>
																			</text>
																			<text fixtext="     ">
																				<styles font-size="10pt"/>
									...
									<paragraph>
										...
										<children>
											...
											<text fixtext=", the Committee reviewed the above mentioned protocol and decided to withheld the approval. ">
												<styles font-size="10pt"/>
											</text>
										</children>
									</paragraph>
