...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:PHS398_CareerDevelopmentAwardSup="http://apply.grants.gov/forms/PHSCareer-V1.0" xmlns:att="http://apply.grants.gov/system/Attachments-V1.0" xmlns:codes="http://apply.grants.gov/system/UniversalCodes-V2.0" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:glob="http://apply.grants.gov/system/Global-V1.0" xmlns:globLib="http://apply.grants.gov/system/GlobalLibrary-V2.0" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format">
									...
									<fo:table-row>
										<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
											<fo:block>
												...
												<fo:block/>
												<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
													<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:ApplicationType">
														<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:TypeOfApplication">
															<xsl:choose>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:IntroductionToApplication">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CandidateBackground">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerGoalsAndObjectives">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAndTrainingActivities">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:ResponsibleConductOfResearch">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:MentoringPlan">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:StatementsOfSupport">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
													...
													<fo:table-body start-indent="0pt">
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:InsitutionalEnvironment">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
														...
														<fo:table-row>
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		<xsl:text>9. Insitutional Commitment to Candidate&apos;s</xsl:text>
																	</fo:inline>
																	<fo:block/>
																	<fo:inline>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:InstitutionalCommitment">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
													...
													<fo:table-body start-indent="0pt">
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:SpecificAims">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
														...
														<fo:table-row>
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		<xsl:text>11. Background and Significance</xsl:text>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell padding="2pt" display-align="center">
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:BackgroundAndSignificance">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
														...
														<fo:table-row>
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		<xsl:text>12. Preliminary Studies/Progress Report</xsl:text>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell padding="2pt" display-align="center">
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PreliminaryStudiesProgressReport">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
														...
														<fo:table-row>
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		<xsl:text>13. Research Design and Methods</xsl:text>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell padding="2pt" display-align="center">
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:ResearchDesignAndMethods">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
														...
														<fo:table-row>
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		<xsl:text>14. Inclusion Enrollment Report</xsl:text>
																	</fo:inline>
																	<fo:block/>
																	<fo:inline>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:InclusionEnrollmentReport">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
														...
														<fo:table-row>
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		<xsl:text>15. Progress Report Publication List</xsl:text>
																	</fo:inline>
																	<fo:block/>
																	<fo:inline>
																		<xsl:text>(for RENEWAL applications only)</xsl:text>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:ProgressReportPublicationList">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
													...
													<fo:table-body start-indent="0pt">
														...
														<fo:table-row>
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		<xsl:text>16. Protection of Human Subjects</xsl:text>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell padding="2pt" display-align="center">
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" height="20" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:ProtectionOfHumanSubjects">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:InclusionOfWomenAndMinorities">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
														...
														<fo:table-row>
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		<xsl:text>18. Targeted/Planned Enrollment</xsl:text>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell padding="2pt" display-align="center">
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:TargetedPlannedEnrollment">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
														...
														<fo:table-row>
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		<xsl:text>19. Inclusion of Children</xsl:text>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell padding="2pt" display-align="center">
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:InclusionOfChildren">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
													...
													<fo:table-body start-indent="0pt">
														...
														<fo:table-row>
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		<xsl:text>20. Vertebrate Animals</xsl:text>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell padding="2pt" display-align="center">
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:VertebrateAnimals">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
														...
														<fo:table-row>
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		<xsl:text>21. Select Agent Research</xsl:text>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell padding="2pt" display-align="center">
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:SelectAgentResearch">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
														...
														<fo:table-row>
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		<xsl:text>22. Consortium/Contractual Arrangements</xsl:text>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell padding="2pt" display-align="center">
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:ConsortiumContractualArrangements">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
														...
														<fo:table-row>
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline>
																		<xsl:text>23. Resource Sharing Plan(s)</xsl:text>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell padding="2pt" display-align="center">
																			...
																			<fo:table-row>
																				<fo:table-cell border="solid 1pt gray" padding="2pt" display-align="center">
																					<fo:block>
																						...
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																							<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																								<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:ResourceSharingPlans">
																									<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:attFile">
																										<xsl:for-each select="att:FileName">
																											<xsl:variable name="value-of-template">
																												<xsl:apply-templates/>
														...
														<fo:table-row>
															...
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block>
																	...
																	<xsl:if test="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup/PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments/PHS398_CareerDevelopmentAwardSup:Appendix/att:AttachedFile">
																		<fo:table font-family="v" font-size="9pt" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																			<fo:table-column column-width="proportional-column-width(1)"/>
																			<fo:table-body start-indent="0pt">
																				<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																					<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:CareerDevelopmentAwardAttachments">
																						<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:Appendix">
														...
														<fo:table-row font-size="8pt">
															<fo:table-cell number-columns-spanned="4" padding="2pt" display-align="before">
																<fo:block>
																	...
																	<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:PHS398_CareerDevelopmentAwardSup">
																		<xsl:for-each select="PHS398_CareerDevelopmentAwardSup:Citizenship">
																			<xsl:choose>
