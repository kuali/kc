...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:PHS398_CoverPageSupplement="http://apply.grants.gov/forms/PHS398_CoverPageSupplement-V1.1" xmlns:footer="http://apply.grants.gov/system/Footer-V1.0" xmlns:att="http://apply.grants.gov/system/Attachments-V1.0" xmlns:glob="http://apply.grants.gov/system/Global-V1.0" xmlns:globLib="http://apply.grants.gov/system/GlobalLibrary-V2.0" xmlns:header="http://apply.grants.gov/system/Header-V1.0" xmlns:xs="http://www.w3.org/2001/XMLSchema">
         ...
         <fo:page-sequence master-reference="default-page" format="1" initial-page-number="1">
            ...
            <fo:flow flow-name="xsl-region-body">
               ...
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="70.30303030303031px" top="680.6060606060606px" height="13.333333333333334px" width="246.06060606060606px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(//PHS398_CoverPageSupplement:PHS398_CoverPageSupplement/PHS398_CoverPageSupplement:ContactPersonInfo/PHS398_CoverPageSupplement:ContactAddress/globLib:Province) or //PHS398_CoverPageSupplement:PHS398_CoverPageSupplement/PHS398_CoverPageSupplement:ContactPersonInfo/PHS398_CoverPageSupplement:ContactAddress/globLib:Province = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="//PHS398_CoverPageSupplement:PHS398_CoverPageSupplement/PHS398_CoverPageSupplement:ContactPersonInfo/PHS398_CoverPageSupplement:ContactAddress/globLib:Province"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>
              <fo:block-container background-color="transparent" border-style="none" position="absolute" left="252.27272727272728px" top="700.6060606060606px" height="13.333333333333334px" width="246.06060606060606px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
                        <xsl:when test="not(//PHS398_CoverPageSupplement:PHS398_CoverPageSupplement/PHS398_CoverPageSupplement:ContactPersonInfo/PHS398_CoverPageSupplement:ContactAddress/globLib:ZipPostalCode) or //PHS398_CoverPageSupplement:PHS398_CoverPageSupplement/PHS398_CoverPageSupplement:ContactPersonInfo/PHS398_CoverPageSupplement:ContactAddress/globLib:ZipPostalCode = ''">
                           <fo:inline color="#FFFFFF">&#160;</fo:inline>
                        </xsl:when>
                        <xsl:otherwise>
                           <xsl:value-of select="//PHS398_CoverPageSupplement:PHS398_CoverPageSupplement/PHS398_CoverPageSupplement:ContactPersonInfo/PHS398_CoverPageSupplement:ContactAddress/globLib:ZipPostalCode"/>
                        </xsl:otherwise>
                     </xsl:choose>
                  </fo:block>
               </fo:block-container>               
              ...
              <fo:block-container background-color="transparent" border-style="none" position="absolute" left="172.27272727272728px" top="700.6060606060606px" height="12.121212121212121px" width="81.81818181818182px">
               ...
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="30.90909090909091px" top="680.6060606060606px" height="13.333333333333334px" width="45.45454545454546px">
               ...
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="25.454545454545457px" top="700.0000000000000px" height="12.121212121212121px" width="52.121212121212125px">
               ...
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="216.36363636363637px" top="316.3636363636364px" height="12.121212121212121px" width="25.333333333333334px">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">No</fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="260.6060606060606px" top="316.3636363636364px" height="12.121212121212121px" width="25.181818181818183px">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">Yes</fo:block>
               </fo:block-container>
               ...
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="216.36363636363637px" top="343.6363636363637px" height="12.121212121212121px" width="25.333333333333334px">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">No</fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="260.6060606060606px" top="343.6363636363637px" height="12.121212121212121px" width="25.181818181818183px">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">Yes</fo:block>
               </fo:block-container>
               ...
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="70.30303030303031px" top="700.0000000000000px" height="13.333333333333334px" width="41.21212121212121px">
                  <fo:block padding-left="2px" background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
                     <xsl:choose>
  ...
  <fo:block background-color="transparent" color="#000000" text-align="center" font-size="14pt" font-style="normal" font-family="Helvetica" font-weight="bold">PHS 398 Cover Page Supplement</fo:block> 
               ...
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="341.21212121212125px" top="105.45454545454545px" height="12.121212121212121px" width="25.333333333333334px">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">No</fo:block>
               </fo:block-container>
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="382.42424242424244px" top="105.45454545454545px" height="12.121212121212121px" width="25.181818181818183px">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">Yes</fo:block>
               </fo:block-container>
