...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:footer="http://apply.grants.gov/system/Footer-V1.0" xmlns:glob="http://apply.grants.gov/system/Global-V1.0" xmlns:globLib="http://apply.grants.gov/system/GlobalLibrary-V2.0"  xmlns:SF424B="http://apply.grants.gov/forms/SF424B-V1.1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	...
	<xsl:template match="SF424B:Assurances">
		<fo:root>
					...
					<fo:block>
						<fo:block text-align="center" space-before.optimum="1pt" space-after.optimum="2pt">
							<fo:block>
								...
								<fo:block text-align="right" font-size="8.5pt">Expiration Date 04/30/2008</fo:block>
									<fo:block>
									<xsl:text>&#xA;</xsl:text>
								</fo:block>
											...
											<fo:block space-before.optimum="1pt" space-after.optimum="2pt">
												<fo:block font-size="10pt">
													<fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                        ...
                                                        <xsl:for-each select="SF424B:AuthorizedRepresentative">
														<xsl:for-each select="SF424B:RepresentativeName">
															<xsl:apply-templates/>
														</xsl:for-each>
													</xsl:for-each>
												</fo:block>
											...
											<fo:block space-before.optimum="1pt" space-after.optimum="2pt">
												<fo:block font-size="10pt">
													<fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                        ...
                                                        <xsl:for-each select="SF424B:AuthorizedRepresentative">
														<xsl:for-each select="SF424B:RepresentativeTitle">
															<xsl:apply-templates/>
														</xsl:for-each>
													</xsl:for-each>
												</fo:block>
											...
											<fo:block space-before.optimum="1pt" space-after.optimum="2pt">
												<fo:block font-size="9.5pt">
													<fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                        ...
                                                        <xsl:for-each select="SF424B:ApplicantOrganizationName">
														<xsl:apply-templates/>
													</xsl:for-each>
												</fo:block>
											</fo:block>
											...
											<fo:block space-before.optimum="1pt" space-after.optimum="2pt">
												<fo:block font-size="9.5pt">
													<fo:block space-before.optimum="1pt" space-after.optimum="2pt">
                                                        ...
                                                        <xsl:for-each select="SF424B:SubmittedDate">
