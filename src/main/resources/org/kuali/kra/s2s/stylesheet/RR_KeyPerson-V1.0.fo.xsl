                                       ...
                                       <fo:table width="100%">
                                          ...
                                          <fo:table-body>
                                             <fo:table-row>
                                                ...
                                                <fo:table-cell hyphenate="true">
                                                   <fo:block>* Zip Code:&#160;<xsl:value-of select="globLib:ZipCode"/>
                                                   </fo:block>
                                                </fo:table-cell>
                                                <fo:table-cell hyphenate="true">
