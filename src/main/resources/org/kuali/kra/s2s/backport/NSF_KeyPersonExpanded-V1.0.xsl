...
xmlns:NSF_KeyPersonExpanded_1_0="http://apply.grants.gov/forms/NSF_KeyPersonExpanded-V1.0"
...
xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:header="http://devapply.row.com/system/Header-V1.0">
	...
	<xsl:template match="NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded">
		<fo:root>
			...
			<fo:page-sequence master-reference="default-page" initial-page-number="1" format="1">
				...
				<fo:flow flow-name="xsl-region-body" font-family="Helvetica,Times,Courier">
					<!--title-->
					<fo:block text-align="center" font-size="15pt" font-weight="200">NSF Senior/Key Person Profile (Expanded)
               </fo:block>
					<fo:block>&#160;</fo:block>
					<!--==========PDPI============================================================================-->
					<fo:block font-size="8pt">
						<!--table for PDPI information-->
						<fo:table width="100%" border-style="solid" border-width="1pt" border-top-width="1.5pt" border-color="black" border-bottom-width="1.0pt" table-layout="fixed">
							<fo:table-column column-width="proportional-column-width(1)"/>
							<fo:table-body>
								<!--row1, header-->
								<fo:table-row>
								...
								<!--row3, name values-->
								<xsl:for-each select="NSF_KeyPersonExpanded_1_0:PDPI/NSF_KeyPersonExpanded_1_0:Profile">
									<xsl:for-each select="NSF_KeyPersonExpanded_1_0:Name">
										<fo:table-row>
													...
													<fo:table-body>
														<fo:table-row>
															<fo:table-cell hyphenate="true" language="en" padding-start="4pt">
																<fo:block>Position/Title:&#160;<xsl:value-of select="NSF_KeyPersonExpanded_1_0:Title"/>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell hyphenate="true" language="en">
																<fo:block>Department:&#160;<xsl:value-of select="NSF_KeyPersonExpanded_1_0:DepartmentName"/>
																</fo:block>
															</fo:table-cell>
														</fo:table-row>
													</fo:table-body>
											...
											<fo:block>
												...
												<fo:table width="100%" table-layout="fixed">
													...
													<fo:table-body>
														<fo:table-row>
															<fo:table-cell hyphenate="true" language="en" padding-start="4pt">
																<fo:block>Organization Name:&#160;<xsl:value-of select="NSF_KeyPersonExpanded_1_0:OrganizationName"/>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell hyphenate="true" language="en">
																<fo:block>Division:&#160;<xsl:value-of select="NSF_KeyPersonExpanded_1_0:DivisionName"/>
																</fo:block>
															</fo:table-cell>
														</fo:table-row>
													</fo:table-body>
									...
									<xsl:for-each select="NSF_KeyPersonExpanded_1_0:Address">
										<!--row6-->
										<fo:table-row>
											<fo:table-cell line-height="10pt">
												<fo:block>
												...
												<fo:table width="100%" table-layout="fixed">
													...
													<fo:table-body>
														<fo:table-row>
															<fo:table-cell hyphenate="true" language="en">
																<fo:block>
																	<xsl:value-of select="NSF_KeyPersonExpanded_1_0:Phone"/>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell hyphenate="true" language="en">
																<fo:block>
																	<xsl:value-of select="NSF_KeyPersonExpanded_1_0:Fax"/>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell hyphenate="true" language="en">
																<fo:block>
																	<xsl:value-of select="NSF_KeyPersonExpanded_1_0:Email"/>
																</fo:block>
															</fo:table-cell>
														</fo:table-row>
													</fo:table-body>
									...
									<!--row, credentials-->
									<fo:table-row>
										<fo:table-cell padding-start="4pt" padding-before="3pt" padding-after="3pt" line-height="8pt" border-top-style="solid" border-top-color="black" border-top-width="1.0pt">
											<fo:block>Credential, e.g., agency login:&#160;<xsl:value-of select="NSF_KeyPersonExpanded_1_0:Credential"/>
											</fo:block>
										</fo:table-cell>
									</fo:table-row>
														...
														<fo:table-row>
															<fo:table-cell hyphenate="true" language="en" padding-start="4pt">
																<fo:block>* Project Role:&#160;<fo:inline font-weight="100">
																		<xsl:value-of select="NSF_KeyPersonExpanded_1_0:ProjectRole"/>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell hyphenate="true" language="en">
																<fo:block>Other Project Role Category:&#160;<fo:inline font-weight="100">
																		<xsl:value-of select="NSF_KeyPersonExpanded_1_0:OtherProjectRoleCategory"/>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
														</fo:table-row>
											...
											<fo:block font-weight="bold">
												<fo:table width="100%" table-layout="fixed">
													...
													<fo:table-body>
														<fo:table-row>
															<fo:table-cell hyphenate="true" language="en" padding-start="4pt">
																<fo:block>Degree Type:&#160;<fo:inline font-weight="100">
																		<xsl:value-of select="NSF_KeyPersonExpanded_1_0:DegreeType"/>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell hyphenate="true" language="en">
																<fo:block>Degree Year:&#160;<fo:inline font-weight="100">
																		<xsl:value-of select="NSF_KeyPersonExpanded_1_0:DegreeYear"/>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
														</fo:table-row>
													...
													<fo:table-body>
														...
														<fo:table-row>
															...
															<fo:table-cell text-align="center" hyphenate="true" language="en">
																<fo:block>
																	<xsl:value-of select="NSF_KeyPersonExpanded_1_0:BioSketchsAttached/NSF_KeyPersonExpanded_1_0:BioSketchAttached/att:FileName"/>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell text-align="center">
																<fo:block>
																	<xsl:value-of select="NSF_KeyPersonExpanded_1_0:BioSketchsAttached/NSF_KeyPersonExpanded_1_0:BioSketchAttached/att:MimeType"/>
																</fo:block>
															</fo:table-cell>
														</fo:table-row>
														<fo:table-row>
															...
															<fo:table-cell text-align="center" hyphenate="true" language="en">
																<fo:block>
																	<xsl:value-of select="NSF_KeyPersonExpanded_1_0:SupportsAttached/NSF_KeyPersonExpanded_1_0:SupportAttached/att:FileName"/>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell text-align="center">
																<fo:block>
																	<xsl:value-of select="NSF_KeyPersonExpanded_1_0:SupportsAttached/NSF_KeyPersonExpanded_1_0:SupportAttached/att:MimeType"/>
																</fo:block>
															</fo:table-cell>
														</fo:table-row>
														<fo:table-row>
															<fo:table-cell font-weight="bold" padding-after="6pt">
																<fo:block>Attach Collaborator</fo:block>
															</fo:table-cell>
															<fo:table-cell text-align="center" hyphenate="true" language="en">
																<fo:block>
																	<xsl:value-of select="NSF_KeyPersonExpanded_1_0:CollaboratorsAttached/NSF_KeyPersonExpanded_1_0:CollaboratorAttached/att:FileName"/>
																</fo:block>
															</fo:table-cell>
															<fo:table-cell text-align="center">
																<fo:block>
																	<xsl:value-of select="NSF_KeyPersonExpanded_1_0:CollaboratorsAttached/NSF_KeyPersonExpanded_1_0:CollaboratorAttached/att:MimeType"/>
																</fo:block>
															</fo:table-cell>
														</fo:table-row>
													</fo:table-body>
					...
					<!--========== End of PDPI========================================================================-->
					<xsl:for-each select="NSF_KeyPersonExpanded_1_0:KeyPerson/NSF_KeyPersonExpanded_1_0:Profile">
				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.78787878787878px" hyphenate="true" language="en" keep-together="always" top="350.90909090909093px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
							<xsl:choose>
								<xsl:when test="not(//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:KeyPersonAttachmentFileName1) or //NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:KeyPersonAttachmentFileName1 = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:KeyPersonAttachmentFileName1"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.78787878787878px" hyphenate="true" language="en" keep-together="always" top="366.06060606060606px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
							<xsl:choose>
								<xsl:when test="not(//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:KeyPersonAttachmentFileName2) or //NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:KeyPersonAttachmentFileName2 = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:KeyPersonAttachmentFileName2"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.78787878787878px" hyphenate="true" language="en" keep-together="always" top="381.21212121212125px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
							<xsl:choose>
								<xsl:when test="not(//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:KeyPersonAttachmentFileName3) or //NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:KeyPersonAttachmentFileName3 = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:KeyPersonAttachmentFileName3"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.78787878787878px" hyphenate="true" language="en" keep-together="always" top="396.3636363636364px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
							<xsl:choose>
								<xsl:when test="not(//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:KeyPersonAttachmentFileName4) or //NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:KeyPersonAttachmentFileName4 = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:KeyPersonAttachmentFileName4"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.66666666666669px" hyphenate="true" language="en" keep-together="always" top="441.6666666666667px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
							<xsl:choose>
								<xsl:when test="not(//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:AdditionalProfileAttached/att:FileName) or //NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:AdditionalProfileAttached/att:FileName = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:AdditionalProfileAttached/att:FileName"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.66666666666669px" hyphenate="true" language="en" keep-together="always" top="471.6666666666667px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
							<xsl:choose>
								<xsl:when test="not(//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:AdditionalProfileAttached/att:MimeType) or //NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:AdditionalProfileAttached/att:MimeType = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:AdditionalProfileAttached/att:MimeType"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.66666666666669px" hyphenate="true" language="en" keep-together="always" top="521.03030303030306px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
							<xsl:choose>
								<xsl:when test="not(//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:BioSketchsAttached/NSF_KeyPersonExpanded_1_0:BioSketchAttached/att:FileName) or //NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:BioSketchsAttached/NSF_KeyPersonExpanded_1_0:BioSketchAttached/att:FileName = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:BioSketchsAttached/NSF_KeyPersonExpanded_1_0:BioSketchAttached/att:FileName"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.66666666666669px" hyphenate="true" language="en" keep-together="always" top="550.03030303030306px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
							<xsl:choose>
								<xsl:when test="not(//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:BioSketchsAttached/NSF_KeyPersonExpanded_1_0:BioSketchAttached/att:MimeType) or //NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:BioSketchsAttached/NSF_KeyPersonExpanded_1_0:BioSketchAttached//att:MimeType = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:BioSketchsAttached/NSF_KeyPersonExpanded_1_0:BioSketchAttached/att:MimeType"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.66666666666669px" hyphenate="true" language="en" keep-together="always" top="601.39393939393943px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
							<xsl:choose>
								<xsl:when test="not(//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:SupportsAttached/NSF_KeyPersonExpanded_1_0:SupportAttached/att:FileName) or //NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:SupportsAttached/NSF_KeyPersonExpanded_1_0:SupportAttached/att:FileName = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:SupportsAttached/NSF_KeyPersonExpanded_1_0:SupportAttached/att:FileName"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.66666666666669px" hyphenate="true" language="en" keep-together="always" top="631.39393939393943px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
							<xsl:choose>
								<xsl:when test="not(//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:SupportsAttached/NSF_KeyPersonExpanded_1_0:SupportAttached/att:MimeType) or //NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:SupportsAttached/NSF_KeyPersonExpanded_1_0:SupportAttached/att:MimeType = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:SupportsAttached/NSF_KeyPersonExpanded_1_0:SupportAttached/att:MimeType"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					<!--Block below is for the field named single_attachment2 with FieldID -->
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.66666666666669px" hyphenate="true" language="en" keep-together="always" top="681.39393939393943px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
							<xsl:choose>
								<xsl:when test="not(//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:CollaboratorsAttached/NSF_KeyPersonExpanded_1_0:CollaboratorAttached/att:FileName) or //NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:CollaboratorsAttached/NSF_KeyPersonExpanded_1_0:CollaboratorAttached/att:FileName = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:CollaboratorsAttached/NSF_KeyPersonExpanded_1_0:CollaboratorAttached/att:FileName"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.66666666666669px" hyphenate="true" language="en" keep-together="always" top="711.39393939393943px" height="13.333333333333334px" width="300px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">
							<xsl:choose>
								<xsl:when test="not(//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:CollaboratorsAttached/NSF_KeyPersonExpanded_1_0:CollaboratorAttached/att:MimeType) or //NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:CollaboratorsAttached/NSF_KeyPersonExpanded_1_0:CollaboratorAttached/att:MimeType = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//NSF_KeyPersonExpanded_1_0:NSF_KeyPersonExpanded/NSF_KeyPersonExpanded_1_0:AdditionalProfilesAttached/NSF_KeyPersonExpanded_1_0:CollaboratorsAttached/NSF_KeyPersonExpanded_1_0:CollaboratorAttached/att:MimeType"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.66666666666669px" hyphenate="true" language="en" keep-together="always" top="666.6666666666667px" height="13.333333333333334px" width="185.63636363636365px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="bold">Filename</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="138.66666666666669px" hyphenate="true" language="en" keep-together="always" top="696.6666666666667px" height="13.333333333333334px" width="185.63636363636365px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="bold">MimeType</fo:block>
					</fo:block-container>
					<!--Block below is for the label named LABEL32-->
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="4.242424242424242px" hyphenate="true" language="en" keep-together="always" top="681.39393939393943px" height="13.333333333333334px" width="212.72727272727275px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="bold">Additional Collaborators</fo:block>
					</fo:block-container>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="35.75757575757576px" hyphenate="true" language="en" keep-together="always" top="124.24242424242425px" height="13.333333333333334px" width="494.54545454545456px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">Select the "Select to Extract the NSF Additional Senior/Key Person Form" button, which appears below.  </fo:block>
					</fo:block-container>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="80.84848484848486px" hyphenate="true" language="en" keep-together="always" top="18.78787878787879px" height="23.636363636363637px" width="400.51515151515156px">
						<fo:block background-color="transparent" color="#000000" font-size="14pt" font-style="normal" font-family="Helvetica" font-weight="normal">NSF Senior/Key Person Profile (Expanded)</fo:block>
					</fo:block-container>
		...
		<fo:block font-size="8pt">
			...
			<fo:table width="100%" border-style="solid" border-width="1pt" border-top-width="1.5pt" border-color="black" border-bottom-width="1.0pt" table-layout="fixed">
				...
				<fo:table-body>
					...
					<!--row2, name titles-->
					<fo:table-row>
						<fo:table-cell line-height="10pt" border-top-style="solid" border-width="1.0pt" border-top-color="black">
							<fo:block text-align="center">
								<fo:leader leader-pattern="space"/>
								<fo:table width="100%" table-layout="fixed">
									<fo:table-column column-width="proportional-column-width(10)"/>
