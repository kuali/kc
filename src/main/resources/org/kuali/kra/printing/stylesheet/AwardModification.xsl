							...
							<xsl:if test="count(  AwardNotice/AwardDisclosure/DisclosureItem  ) &gt; 0">
								...
								<fo:table font-family="Arial" font-size="9pt" line-height="9pt" table-layout="fixed" width="100%" border-spacing="2pt">
									...
									<fo:table-body start-indent="0pt">
										...
										<fo:table-row>
											<fo:table-cell font-family="Arial" font-size="12pt" number-columns-spanned="2" padding="2pt" display-align="center">
												<fo:block>
													<fo:block/>
													<fo:inline font-family="Times New Roman" font-size="9pt" font-weight="bold">
											...
											<fo:table-cell font-family="Arial" font-size="12pt" padding="0" padding-left="0" number-columns-spanned="2" display-align="center">
												<fo:block>
													...
													<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
														...
														<fo:table-body start-indent="0pt">
															<fo:table-row>
																<fo:table-cell font-family="Arial" font-size="9pt" padding="2pt" text-align="right" display-align="center">
																	<fo:block>
																		<fo:inline font-weight="bold">
																...
																<fo:table-cell font-family="Arial" font-size="9pt" padding-right="30pt" padding="2pt" text-align="center" display-align="center">
																	<fo:block>
																		<fo:block/>
																		<fo:block/>
																		<fo:block/>
																...
																<fo:table-cell font-family="Arial" font-size="9pt" padding-right="45pt" padding="2pt" text-align="center" display-align="center">
																	<fo:block>
																		<fo:block/>
																		<fo:block/>
																		<fo:block/>
															...
															<fo:table-row>
																...
																<fo:table-cell font-family="Arial" font-size="9pt" padding-right="30pt" padding="2pt" text-align="center" display-align="after">
																	<fo:block>
																		<fo:block/>
																		<fo:block/>
																		<fo:block text-align="center">
												...
												<fo:table font-family="Arial" table-layout="fixed" width="100%" border-spacing="2pt">
													...
													<fo:table-body font-family="Arial" start-indent="0pt">
														<fo:table-row font-family="Arial">
															...
															<fo:table-cell font-family="Arial" font-size="9pt" padding-left="0" padding="2pt" display-align="after">
																<fo:block>
																	<xsl:for-each select="AwardNotice">
																		<xsl:for-each select="Award">
																			<xsl:for-each select="AwardDetails">
										...
										<fo:table-cell padding="0" display-align="center">
											<fo:block>
												...
												<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
													...
													<fo:table-body start-indent="0pt">
														<fo:table-row>
															<fo:table-cell font-family="Arial" font-size="12pt" font-weight="bold" number-columns-spanned="4" padding="2pt" display-align="center">
																<fo:block>
																	<fo:inline-container>
																		<fo:block>
																			<xsl:text>&#x2029;</xsl:text>
																	...
																	<fo:table border-collapse="0" font-family="Arial" table-layout="fixed" width="100%" border-spacing="2pt">
																		...
																		<fo:table-body font-family="Arial" start-indent="0pt">
																			<fo:table-row font-family="Arial">
																				<fo:table-cell font-family="Arial" font-size="12pt" font-weight="bold" padding="0" height="25" display-align="center">
																					<fo:block>
																						<fo:inline font-weight="bold">
														...
														<fo:table-row>
															<fo:table-cell font-family="Arial" font-size="12pt" font-weight="bold" padding="0" number-columns-spanned="4" display-align="center">
																<fo:block>
								...
								<xsl:for-each select="Award">
									...
									<xsl:if test="../PrintRequirement/CommentsRequired = &quot;1&quot;">
										<xsl:if test="count(  AwardComments/Comment [CommentDetails/CommentCode  &gt; 1 and CommentDetails/CommentCode  &lt; 7  and  string-length(CommentDetails/Comments ) &gt;= 1] )  &gt; 0">
											...
											<xsl:if test="AwardComments/Comment">
												<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
													<fo:table-column column-width="30%"/>
																		...
																		<xsl:for-each select="ReportTermDetails">
																			<xsl:if test="ReportClassCode != 4">
																				...
																				<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
																					...
																					<fo:table-body start-indent="0pt">
																						<fo:table-row>
																							<fo:table-cell font-family="Arial" font-size="9pt" font-weight="bold" padding="0" padding-bottom="0" padding-top="0" height="19" display-align="center">
																								<fo:block>
																									<fo:inline>
																										<xsl:text>Type of Report: </xsl:text>
																									</fo:inline>
																							...
																							<fo:table-cell font-family="Arial" font-size="9pt" font-weight="normal" padding="0" padding-bottom="0" padding-top="0" display-align="center">
																								<fo:block>
																									<xsl:for-each select="ReportCodeDesc">
																										<xsl:variable name="value-of-template">
																											<xsl:apply-templates/>
																						...
																						<fo:table-row>
																							<fo:table-cell font-family="Arial" font-size="9pt" font-weight="bold" padding="0" padding-bottom="0" padding-top="0" display-align="center">
																								<fo:block>
																									<fo:inline>
																										<xsl:text>Frequency:</xsl:text>
																									</fo:inline>
				...
				<xsl:for-each select="$XML">
					...
					<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
						...
						<fo:table-body start-indent="0pt">
							...
							<fo:table-row>
								<fo:table-cell font-family="Arial" padding-top="0" padding="2pt" text-align="left" display-align="before">
									<fo:block/>
								</fo:table-cell>
								<fo:table-cell padding-left="0" padding-top="0" padding="2pt" text-align="left" display-align="after">
									<fo:block/>
								</fo:table-cell>
