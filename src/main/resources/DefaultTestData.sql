...
;
INSERT into fs_parm_t(FS_SCR_NM, FS_PARM_NM, OBJ_ID, VER_NBR, FS_PARM_TXT, FS_PARM_DESC, FS_MULT_VAL_IND, FS_MOD_CD)
 VALUES('SYSTEM', 'multipleValueLookupResultsPerPage', '39F2E4C3560331CEE043814FD88131CE', 0, '200', 'Limit results returned for lookup - multiple results', 'N', 'MC')
;
INSERT into fs_parm_t(FS_SCR_NM, FS_PARM_NM, OBJ_ID, VER_NBR, FS_PARM_TXT, FS_PARM_DESC, FS_MULT_VAL_IND, FS_MOD_CD)
 VALUES('SYSTEM', 'proposaldevelopment.displayKeywordPanel', '3A6F3F7A1FD770CAE043814FD88170CA', 1, 'True', 'Display Proposal Keyword panel', 'N', 'MC')
;
