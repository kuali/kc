...
public class KraDocSearchCriteriaDTOLookupableHelperServiceImpl extends DocSearchCriteriaDTOLookupableHelperServiceImpl {
     ...
     */
    private void filterOutProtocolNotificationDocument(Collection resultTable, List<DocumentSearchResult> docSearchResults) {
     ...
     */
    private boolean isProtocolActionNotification (String title) {
