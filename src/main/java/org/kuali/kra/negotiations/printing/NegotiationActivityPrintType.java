...
public enum NegotiationActivityPrintType {
	...
	NegotiationActivityPrintType(String negotiationActivityPrintType) {
		this.negotiationActivityPrintType = negotiationActivityPrintType;
	}

	public String getNegotiationActivityPrintType() {
		return negotiationActivityPrintType;
	}
}
