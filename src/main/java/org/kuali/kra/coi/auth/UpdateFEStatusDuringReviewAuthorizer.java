 ...
 */
public class UpdateFEStatusDuringReviewAuthorizer extends CoiDisclosureAuthorizer {

    @Override
    public boolean isAuthorized(String userId, CoiDisclosureTask task) {
        CoiDisclosure coiDisclosure = task.getCoiDisclosure();
        return hasPermission(userId, coiDisclosure, PermissionConstants.UPDATE_FE_STATUS_DURING_REVIEW)
