...
/**
 * 
 * This class is a comparator for AwardReportTerm's frequencyBaseCode object.
 * It is used for sorting.
 */
public class AwardReportTermsComparator3 implements Comparator<AwardReportTerm> {
