 ...
 */
public interface AddAwardReportTermRule extends BusinessRule {
     ...
     * @return boolean
     */
    public boolean processAddAwardReportTermEvent(AddAwardReportTermEvent addAwardReportTermEvent);
