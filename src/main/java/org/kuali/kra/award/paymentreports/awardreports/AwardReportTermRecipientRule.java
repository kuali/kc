 ...
 */
public interface AwardReportTermRecipientRule extends BusinessRule {
     ...
     * @return
     */
    boolean processAwardReportTermRecipientBusinessRules(AwardReportTermRecipientRuleEvent event);
     ...
     * @return
     */
    boolean processAddAwardReportTermRecipientBusinessRules(AddAwardReportTermRecipientRuleEvent event);
}
