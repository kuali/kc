...
public interface ReportTrackingPrintingService {
 ...
 public AttachmentDataSource printReportTracking( KraPersistableBusinessObjectBase institutionalProposal, 
             String reportName,
Map<String, Object> reportParameters) throws PrintingException;	
public AwardReportTracking getReportPrintable(ReportTrackingType reportTrackingType,ReportTracking detailResult);
    
 public Printable getReportPrintArtifacts(ReportTracking reportTracking);
