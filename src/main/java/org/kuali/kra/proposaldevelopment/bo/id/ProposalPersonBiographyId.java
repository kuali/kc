...
/**
 * Primary Key for the ProposalPersonBiography BO.
 */
@SuppressWarnings("serial")
public class ProposalPersonBiographyId implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ProposalPersonBiographyId)) return false;
        if (obj == null) return false;
        ProposalPersonBiographyId other = (ProposalPersonBiographyId) obj;
