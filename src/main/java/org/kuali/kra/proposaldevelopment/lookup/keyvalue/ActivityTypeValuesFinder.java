...
public class ActivityTypeValuesFinder extends KeyValuesBase {
    ...
    public List getKeyValues() {
        ...
        for (Iterator iter = activityTypes.iterator(); iter.hasNext();) {
            ...
            keyValues.add(new KeyLabelPair(activityType.getActivityTypeCode(), activityType.getDescription()));
        }
        return keyValues;
    }
}
