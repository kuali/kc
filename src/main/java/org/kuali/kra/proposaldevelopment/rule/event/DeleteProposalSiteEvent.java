...
/**
 * Event class for deleting a Proposal Site.
 */
public class DeleteProposalSiteEvent extends ProposalSiteEventBase {
    ...
    public Class getRuleInterfaceClass() {
        return DeleteProposalSiteRule.class;
    }

    public boolean invokeRuleMethod(BusinessRule rule) {
        return ((DeleteProposalSiteRule)rule).processDeleteDeleteProposalSiteRules(this);
    }
