...
public class ScheduleServiceImpl {
    ...
    public List<Date> getScheduledDates(Date startDate, Date endDate, String time24h, 
    ...
    public List<Date> getScheduledDates(Date startDate, Date endDate, String time24h, Integer day, 
            ScheduleSequence scheduleSequence) throws ParseException {
    ...
    public List<Date> getScheduledDates(Date startDate, Date endDate, String time24h, 
            CronSpecialChars [] weekdays, ScheduleSequence scheduleSequence) throws ParseException {
    ...
    public List<Date> getScheduledDates(Date startDate, Date endDate, String time24h, CronSpecialChars dayOfWeek, Integer weekOfMonth, 
                                        Integer frequencyInMonth, ScheduleSequence scheduleSequence) throws ParseException {
