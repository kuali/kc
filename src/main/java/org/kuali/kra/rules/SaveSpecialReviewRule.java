...
/**
 * Runs the rule processing for saving SpecialReviews.
 * @param <T> The subclass of AbstractSpecialReview
 */
public class SaveSpecialReviewRule<T extends AbstractSpecialReview<? extends AbstractSpecialReviewExemption>> extends SpecialReviewRuleBase<T> 
    implements BusinessRuleInterface<SaveSpecialReviewEvent<T>> {

    /**
     * Constructs a SaveSpecialReviewRule.java.
     * @param rootErrorPath
     */
    public SaveSpecialReviewRule(String rootErrorPath) {
        super(rootErrorPath);
    }
