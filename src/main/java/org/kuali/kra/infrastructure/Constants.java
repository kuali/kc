...
public interface Constants {
    ...
    public static final String S2SBUDGET_KEY_MAPPING_NAME = "s2sBudgetKeyMappingName";
    public static final String S2SBUDGET_KEY_TARGET_CATEGORY_CODE = "s2sBudgetKeyTargetCategoryCode";
    public static final String S2SBUDGET_MAX_KEY_PERSON_COUNT = "s2sBudgetMaxKeyPersonCount";
    ...
    public static final String S2SBUDGET_RATE_CLASS_TYPE_OTHER = "s2sBudgetRateClassTypeOther";
    ...
    public static final String S2SBUDGET_CATEGORY_TYPE_OTHER_DIRECT_COST = "s2sBudgetCategoryTypeOtherDirectCost";
    ...
    public static final String S2SBUDGET_LASALARIES = "s2sBudgetLasalaries";
    public static final String S2SBUDGET_PERSONNEL_TYPE_GRAD = "s2sBudgetPersonnelTypeGrad";
    public static final String S2SBUDGET_PERSONNEL_TYPE_POSTDOC = "s2sBudgetPersonnelTypePostdoc";
    public static final String S2SBUDGET_PERSONNEL_TYPE_UNDERGRAD = "s2sBudgetPersonnelTypeUndergrad";
    public static final String S2SBUDGET_PERSONNEL_TYPE_SEC = "s2sBudgetPersonnelTypeSec";
    public static final String S2SBUDGET_PERSONNEL_TYPE_OTHER = "s2sBudgetPersonnelTypeOther";
    public static final String S2SBUDGET_PERSONNEL_TYPE_OTHER_PROFESSIONALS = "s2sBudgetPersonnelTypeOtherProfessionals";
    public static final String S2SBUDGET_PERSONNEL_TYPE_ALLOCATED_ADMIN_SUPPORT = "s2sBudgetPersonnelTypeAllocatedAdminSupport";
    public static final String S2SBUDGET_ROLE_GRADUATE_STUDENTS = "s2sBudgetRoleGraduateStudents";
    public static final String S2SBUDGET_ROLE_POST_DOCTORAL_ASSOCIATES = "s2sBudgetRolePostDoctoralAssociates";
    public static final String S2SBUDGET_ROLE_GRADUATE_UNDERGRADUATE_STUDENTS = "s2sBudgetRoleGraduateUndergraduateStudents";
    public static final String S2SBUDGET_ROLE_GRADUATE_SECRETARIAL_OR_CLERICAL = "s2sBudgetRoleGraduateSecretarialOrClerical";
    public static final String S2SBUDGET_ROLE_GRADUATE_OTHER = "s2sBudgetRoleGraduateOther";
    public static final String S2SBUDGET_ROLE_GRADUATE_OTHER_PROFESSIONALS = "s2sBudgetRoleGraduateOtherProfessionals";
    public static final String S2SBUDGET_ROLE_GRADUATE_ALLOCATED_ADMIN_SUPPORT = "s2sBudgetRoleGraduateAllocatedAdminSupport";
    ...
    public static final String S2SBUDGET_TARGET_CATEGORY_CODE_01 = "s2sBudgetTargetCategoryCode01";
    public static final String S2SBUDGET_OTHER_DIRECT_COSTS = "s2sBudgetOtherDirectCosts";
    public static final String S2SBUDGET_ALL_OTHER_COSTS = "s2sBudgetAllOtherCosts";
    public static final String S2SBUDGET_DESCRIPTION = "s2sBudgetDescription";
    public static final String S2SBUDGET_DESCRIPTION_LA = "s2sBudgetDescriptionLa";
    ...
    public static final String S2SBUDGET_KEYPERSON_CO_PD_PI = "s2sBudgetKeypersonCoPdPi";
    public static final String S2SBUDGET_NID_PD_PI = "s2sBudgetNidPdPi";
    public static final String S2SBUDGET_NID_CO_PD_PI = "s2sBudgetNidCoPdPi";
    public static final String S2SBUDGET_KEYPERSON_OTHER = "s2sBudgetKeypersonOther";
    ...
    public static final String S2SBUDGET_PRINCIPAL_INVESTIGATOR_ROLE = "s2sBudgetPrincipalInvestigatorRole";
    public static final String S2SBUDGET_KEY_ROLODEX_ID = "s2sBudgetKeyRolodexId";
