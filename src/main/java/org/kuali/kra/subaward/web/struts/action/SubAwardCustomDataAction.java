...
public class SubAwardCustomDataAction extends SubAwardAction {
    ...
    public ActionForward reload(ActionMapping mapping, ActionForm form,
        ...
        subAwardCustomData(mapping, subAwardForm, request, response);
    }

    /**
     * There is the additional logic in save for custom data.
     * there is not add functionality in the
     * custom data tab, so the form custom data
     * is being added to the subAward on save.
     * @see org.kuali.kra.web.struts.action.
     * KraTransactionalDocumentActionBase#save
    ...
    public void copyCustomDataToSubAward(SubAwardForm subAwardForm) {
        ...
        if (subAwardForm.getSubAwardDocument().getSubAward().
    ...
    /**
     * This method is called when custom data is created on a newly
     *  created SubAward. It initializes the list on SubAward and sets
    ...
    private void copyCustomDataToNewSubAward(SubAwardForm subAwardForm) {
        ...
        getCustomAttributeValues().entrySet()) {
            int customAttributeId = Integer.parseInt(
            ...
            subAwardCustomData.setSubAward(subAwardForm.
            ...
            getSubAwardCustomDataList().add(subAwardCustomData);
        }
    }

    /**
     * This method copies the values from the form
     * to the subAwardCustomDataList on SubAward.
     * @param subAwardForm
     */
            ...
            for (SubAwardCustomData subAwardCustomData
             : subAwardForm.getSubAwardDocument().getSubAward().
               getSubAwardCustomDataList()) {
                if (customAttributeId == subAwardCustomData.
