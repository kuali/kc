...
public class CommitteeScheduleLookupableHelperServiceImpl extends CommitteeScheduleLookupableHelperServiceImplBase<CommitteeSchedule, Committee, CommitteeTaskBase<Committee>, CommitteeScheduleTask> {
    ...
    // TODO this method was added during backfit solely to have a reflection-based unit test pass
    @Override
...
//        
//        // we set the lookup to only list schedule for committees of type IRB TODO will need a hook here for backfitting
//        fieldValues.put(COMMITTEE_COMMITTEE_TYPE_CODE, CommitteeType.IRB_TYPE_CODE);
//        
