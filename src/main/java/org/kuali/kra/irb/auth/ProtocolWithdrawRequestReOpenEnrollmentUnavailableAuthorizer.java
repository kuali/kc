 ...
 */
public class ProtocolWithdrawRequestReOpenEnrollmentUnavailableAuthorizer extends ProtocolAuthorizer {
    ...
    public boolean isAuthorized(String userId, ProtocolTask task) {
        return hasPermission(userId, task.getProtocol(), PermissionConstants.SUBMIT_PROTOCOL) &&
                ...
                !canExecuteAction(task.getProtocol(), ProtocolActionType.WITHDRAW_REQUEST_TO_REOPEN_ENROLLMENT));
    }
}
