 ...
 */
public class ProtocolRequestTerminateUnavailableAuthorizer extends ProtocolAuthorizer {
    ...
    public boolean isAuthorized(String userId, ProtocolTask task) {
        return hasPermission(userId, task.getProtocol(), PermissionConstants.SUBMIT_PROTOCOL) &&
               (isAmendmentOrRenewal(task.getProtocol()) ||
                !canExecuteAction(task.getProtocol(), ProtocolActionType.REQUEST_FOR_TERMINATION));
    }
}
