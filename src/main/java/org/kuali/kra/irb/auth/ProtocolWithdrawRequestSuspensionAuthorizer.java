 ...
 */
public class ProtocolWithdrawRequestSuspensionAuthorizer extends ProtocolAuthorizer {
    ...
    public boolean isAuthorized(String userId, ProtocolTask task) {
        return !isAmendmentOrRenewal(task.getProtocol()) &&
                canExecuteAction(task.getProtocol(), ProtocolActionType.WITHDRAW_REQUEST_FOR_SUSPENSION) &&
