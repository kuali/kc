 ...
 */
public class ProtocolSpecialReviewExemptionValuesFinder extends KeyValuesBase {
     ...
     */
    public ProtocolSpecialReviewExemptionValuesFinder() {
     ...
     */
    ProtocolSpecialReviewExemptionValuesFinder(final KeyValuesFinder finder) {
        if (finder == null) {
