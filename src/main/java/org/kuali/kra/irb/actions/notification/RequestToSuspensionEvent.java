...
public class RequestToSuspensionEvent extends NotificationEventBase {
    ...
    private static final Logger LOG = Logger.getLogger(RequestToSuspensionEvent.class);
    ...
    public void getRecipients(Element recipients) {
        try {
            ...
            LOG.info("Request To Suspension Notification - get recipeint - exception " + e.getStackTrace());
    ...
    public String getTemplatePath() {
        ...
        return "/org/kuali/kra/irb/notification/stylesheet/RequestToSuspensionNotification.xsl";
    }
