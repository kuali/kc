 ...
 */
public interface ExecuteUndoLastActionRule extends BusinessRule {
     ...
     */
    boolean processUndoLastActionRule(ProtocolDocument document, UndoLastActionBean actionBean);
}
