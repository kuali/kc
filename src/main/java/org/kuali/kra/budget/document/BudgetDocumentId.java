...
/**
 * Primary Key for the BudgetDocument.
 */
@SuppressWarnings("serial")
public class BudgetDocumentId implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof BudgetDocumentId)) return false;
        if (obj == null) return false;
        BudgetDocumentId other = (BudgetDocumentId) obj;
