...
/**
 * Abstract Primary Key for the AbstractBudgetCalculatedAmount BOs.
 */
public abstract class AbstractBudgetCalculatedAmountId implements Serializable {
    @Id
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AbstractBudgetCalculatedAmountId)) return false;
        if (obj == null) return false;
        AbstractBudgetCalculatedAmountId other = (AbstractBudgetCalculatedAmountId) obj;
