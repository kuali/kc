...
/**
 * Primary Key for the BudgetSubAwards BO.
 */
@SuppressWarnings("serial")
public class BudgetSubAwardsId implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof BudgetSubAwardsId)) return false;
        if (obj == null) return false;
        BudgetSubAwardsId other = (BudgetSubAwardsId) obj;
