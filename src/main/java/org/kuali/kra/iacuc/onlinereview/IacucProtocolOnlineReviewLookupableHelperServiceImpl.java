...
public class IacucProtocolOnlineReviewLookupableHelperServiceImpl extends KraLookupableHelperServiceImpl {

    private static final long serialVersionUID = 6830796311898825327L;

    private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(IacucProtocolOnlineReviewLookupableHelperServiceImpl.class);
   ...
   public List<? extends BusinessObject> getSearchResults(Map<String, String> fieldValues) {
       ...
       List<IacucProtocolOnlineReview> results;
       ...
       results = (List<IacucProtocolOnlineReview>)super.getSearchResults(fieldValues);
       return filterResults(results);
   }

   protected List<IacucProtocolOnlineReview> filterResults(List<IacucProtocolOnlineReview> results) {
       List<IacucProtocolOnlineReview> onlineReviews = new ArrayList<IacucProtocolOnlineReview>();
       for (IacucProtocolOnlineReview review : results) {
