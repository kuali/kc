...
import org.kuali.kra.iacuc.noteattachment.IacucProtocolAttachmentBase;
 ...
 */
class IacucProtocolDaoOjb extends PlatformAwareDaoBaseOjb implements OjbCollectionAware, IacucProtocolDao {

    private static final Log LOG = LogFactory.getLog(IacucProtocolDaoOjb.class);
    ...
    /**
     * 
     * @see org.kuali.kra.iacuc.IacucProtocolDao#getProtocols(java.util.Map)
     */
    @SuppressWarnings("unchecked")
    public List<IacucProtocol> getProtocols(Map<String, String> fieldValues) {
        ...
        if (!baseLookupFieldValues.isEmpty()) {
            crit = getCollectionCriteriaFromMap(new IacucProtocol(), baseLookupFieldValues);
        }
        ...
        Query q = QueryFactory.newQuery(IacucProtocol.class, crit, true);
        logQuery(q);
    ...
    /** {@inheritDoc} */
    @SuppressWarnings("unchecked")
    public <T extends IacucProtocolAttachmentBase & TypedAttachment> List<T> retrieveAttachmentVersions(T attachment, Class<T> type) {
     ...
     */
    @SuppressWarnings("unchecked")
    public List<IacucProtocol> getExpiringProtocols(String committeeId, Date startDate, Date endDate) {
        Criteria crit = new Criteria();
     ...
     */
    @SuppressWarnings("unchecked")
    public List<IacucProtocol> getIrbNotifiedProtocols(String committeeId, Date startDate, Date endDate) {
       ...
       // subCritProtocolAction.addEqualToField(SUBMISSION_NUMBER, Criteria.PARENT_QUERY_PREFIX + SUBMISSION_NUMBER);
        ...
        ReportQueryByCriteria subQueryProtocolAction = QueryFactory.newReportQuery(IacucProtocolAction.class, subCritProtocolAction);
    ...
    private ReportQueryByCriteria getSubQueryMaxSequenceNumber() {
        ...
        ReportQueryByCriteria subQueryMaxSequenceNumber = QueryFactory.newReportQuery(IacucProtocol.class, subCritMaxSequenceNumber);
    ...
    private ReportQueryByCriteria getsubQueryMaxProtocolSubmission() {
        ...
        ReportQueryByCriteria subQueryMaxProtocolSubmission = QueryFactory.newReportQuery(IacucProtocolSubmission.class, subCritMaxSubmissionNumber);
     ...
     */
    private <T extends IacucProtocolAttachmentBase & TypedAttachment> boolean validAttachmentForVersionLookup(T attachment) {
    ...
    private ReportQueryByCriteria getUnitReportQuery(Entry<String, String> entry) {
        ...
        crit.addExists(QueryFactory.newReportQuery(IacucProtocolUnit.class, subCrit));

        return QueryFactory.newReportQuery(IacucProtocolPerson.class, crit);
    }
    ...
    public enum CritField {
        ...
        KEYPERSON(ProtocolLookupConstants.Property.PERSON_NAME, IacucProtocolPerson.class), 
        INVESTIGATOR(ProtocolLookupConstants.Property.PERSON_NAME, IacucProtocolPerson.class), 
        ...
        RESEARCHAREA(ProtocolLookupConstants.Property.RESEARCH_AREA_CODE,IacucProtocolResearchArea.class);
     ...
     * @see org.kuali.kra.iacuc.IacucProtocolDao#getProtocolSubmissionCount(java.lang.String)
     */
    public boolean getProtocolSubmissionCountFromProtocol(String protocolNumber) {
        ...
        ReportQueryByCriteria query = QueryFactory.newReportQuery(IacucProtocol.class, crit);
    ...
    private ReportQueryByCriteria getMaxSequenceNumberQuery() {
        ...
        subQuery = QueryFactory.newReportQuery(IacucProtocol.class, subCrit);
