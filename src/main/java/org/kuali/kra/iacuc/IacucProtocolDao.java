 ...
 */
public interface IacucProtocolDao {
     ...
     * @return
     */
    List<IacucProtocol> getProtocols(Map<String,String> fieldValues);
    
    /**
     * 
     * This method Check if there are any pending amendments/renewals for this protocols.
     ...
     */
    <T extends IacucProtocolAttachmentBase & TypedAttachment> List<T> retrieveAttachmentVersions(T attachment, Class<T> type);
     ...
     */
    List<IacucProtocol> getExpiringProtocols(String committeeId, Date startDate, Date endDate);
     ...
     * @return List of the requested Protocols
     */
    List<IacucProtocol> getIrbNotifiedProtocols(String committeeId, Date startDate, Date endDate);
