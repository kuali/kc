 ...
 */
public abstract class IacucProtocolAttachmentBase extends ProtocolAttachmentBase {
     ...
     */
    public IacucProtocolAttachmentBase() {
        super();
    }
     ...
     */
    public IacucProtocolAttachmentBase(final IacucProtocol protocol) {
        super(protocol);
    }
     ...
     */
    public static <T extends IacucProtocolAttachmentBase> void addAttachmentToCollection(T attachment, Collection<T> toCollection) {
        if (attachment == null) {
     ...
     * @throws IllegalArgumentException if the attachment or the list is null.
     */
    public static <T extends IacucProtocolAttachmentBase> void removeAttachmentFromCollection(T attachment, Collection<T> fromCollection) {
        if (attachment == null) {
            throw new IllegalArgumentException("the attachment is null");
        }
    ...
    public boolean equals(Object obj) {
        ...
        IacucProtocolAttachmentBase other = (IacucProtocolAttachmentBase) obj;
        if (this.file == null) {
            if (other.file != null) {
                return false;
            }
