...
public class CustomDataAction {
    ...
    public static ActionForward awardCustomData(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        if (form instanceof CustomDataForm) {
            SortedMap<String, List> customAttributeGroups = new TreeMap<String, List>();
     ...
     */
    @SuppressWarnings("unchecked")
    public static void buildCustomDataCollectionsOnFormExistingAward(SortedMap<String, List> customAttributeGroups, 
                                                       AwardForm awardForm, 
     ...
     */
    @SuppressWarnings("unchecked")
    public static void buildCustomDataCollectionsOnFormNewAward(SortedMap<String, List> customAttributeGroups, 
