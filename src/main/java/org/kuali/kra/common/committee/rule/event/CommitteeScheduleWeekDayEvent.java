...
public class CommitteeScheduleWeekDayEvent extends CommitteeScheduleEventBase<CommitteeScheduleWeekDayRule> {
    ...
    public CommitteeScheduleWeekDayEvent(String errorPathPrefix, CommitteeDocument document, ScheduleData scheduleData, List<CommitteeSchedule> committeeSchedules, ErrorType type) {
