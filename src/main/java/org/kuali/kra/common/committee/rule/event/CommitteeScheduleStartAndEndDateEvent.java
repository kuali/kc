...
public class CommitteeScheduleStartAndEndDateEvent extends CommitteeScheduleEventBase<CommitteeScheduleStartAndEndDateRule> {
    ...
    public CommitteeScheduleStartAndEndDateEvent(String errorPathPrefix, CommitteeDocumentBase document, ScheduleData scheduleData, List<CommitteeSchedule> committeeSchedules, ErrorType type) {
