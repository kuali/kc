...
//                .findAll(CommonCommitteeDocument.class);
    ...
    private Committee populateCommitteeFromXmlDocumentContents(String xmlDocumentContents) {
        ...
        if (!StringUtils.isEmpty(xmlDocumentContents)) {
            ...
            committee = (Committee) getBusinessObjectFromXML(xmlDocumentContents, getCommitteeBOClassHook().getName());
...
//                committee = (CommonCommittee) getBusinessObjectFromXML(xmlDocumentContents, CommonCommittee.class.getName());
    ...
    /**
     * @see org.kuali.kra.common.committee.rule.AddCommitteeMembershipRule#processAddCommitteeMembershipRules(org.kuali.kra.common.committee.rule.event.AddCommitteeMembershipEvent)
     */
    ...
    /**
     * @see org.kuali.kra.common.committee.rule.AddCommitteeMembershipRoleRule#processAddCommitteeMembershipRoleBusinessRules(org.kuali.kra.common.committee.rule.event.AddCommitteeMembershipRoleEvent)
     */
