...
public class CommitteeScheduleFilterEvent extends CommitteeScheduleEventBase<CommitteeScheduleFilterDatesRule> {
    ...
    public CommitteeScheduleFilterEvent(String errorPathPrefix, CommitteeDocumentBase document, ScheduleData scheduleData, List<CommitteeSchedule> committeeSchedules, ErrorType type) {
