...
public class CommitteeScheduleDayEvent extends CommitteeScheduleEventBase<CommitteeScheduleDayRule> {
    ...
    public CommitteeScheduleDayEvent(String errorPathPrefix, CommonCommitteeDocument document, ScheduleData scheduleData, List<CommonCommitteeSchedule> committeeSchedules, ErrorType type) {
        super(MSG + getDocumentId(document), errorPathPrefix, document, scheduleData, committeeSchedules, type);
    }
    
    public CommitteeScheduleDayEvent(String errorPathPrefix, Document document, ScheduleData scheduleData, List<CommonCommitteeSchedule> committeeSchedules, ErrorType type) {
