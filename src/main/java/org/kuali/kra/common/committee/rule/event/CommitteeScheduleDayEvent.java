...
public class CommitteeScheduleDayEvent extends CommitteeScheduleEventBase<CommitteeScheduleDayRule> {
    ...
    public CommitteeScheduleDayEvent(String errorPathPrefix, CommitteeDocumentBase document, ScheduleData scheduleData, List<CommitteeSchedule> committeeSchedules, ErrorType type) {
