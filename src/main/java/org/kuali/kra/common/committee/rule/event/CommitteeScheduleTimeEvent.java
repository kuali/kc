...
public class CommitteeScheduleTimeEvent extends CommitteeScheduleEventBase<CommitteeScheduleTimeRule> {
    ...
    public CommitteeScheduleTimeEvent(String errorPathPrefix, CommonCommitteeDocument document, ScheduleData scheduleData, List<CommitteeSchedule> committeeSchedules, ErrorType type) {
