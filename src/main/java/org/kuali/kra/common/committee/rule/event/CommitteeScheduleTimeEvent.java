...
public class CommitteeScheduleTimeEvent extends CommitteeScheduleEventBase<CommitteeScheduleTimeRule> {
    ...
    public CommitteeScheduleTimeEvent(String errorPathPrefix, CommitteeDocumentBase document, ScheduleData scheduleData, List<CommitteeSchedule> committeeSchedules, ErrorType type) {
