...
public class LookupHelper<T extends KraTransactionalDocumentFormBase> implements Serializable {
    private KraTransactionalDocumentFormBase form;    
    private boolean viewOnly;
    
    public LookupHelper(T form) {
        this.form = form;
    }
