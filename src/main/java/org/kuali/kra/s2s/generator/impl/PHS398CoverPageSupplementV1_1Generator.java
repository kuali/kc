...
/**
 * Class for generating the XML object for grants.gov PHS398CoverPageSupplementV1_1. Form is generated using XMLBean classes and is
 * based on PHS398CoverPageSupplement schema.
 * 
 * @author Kuali Research Administration Team (kualidev@oncourse.iu.edu)
 */
public class PHS398CoverPageSupplementV1_1Generator extends PHS398CoverPageSupplementBaseGenerator {
    ...
    private ContactPersonInfo getContactPersonInfo() {
        ...
        if (rolodex != null) {
            ...
            contactPersonInfo.setContactAddress(globLibV20Generator.getAddressDataType(rolodex));
        }
