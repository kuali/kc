...
public class PHS398ChecklistV1_0Generator extends PHS398ChecklistBaseGenerator {
	private static final Logger LOG = Logger
			.getLogger(PHS398ChecklistV1_0Generator.class);
	...
	private PHS398ChecklistDocument getPHS398Checklist() {
		...
		if (budget != null && budget.getBudgetProjectIncomes() != null
			...
			IncomeBudgetPeriod[] budgetPeriodsArray = new IncomeBudgetPeriod[budget
		...
		for (Narrative narrative : pdDoc.getDevelopmentProposal()
			...
			if (narrative.getNarrativeTypeCode() != null
				...
				CertificationExplanation certificationExplanation = CertificationExplanation.Factory
						.newInstance();
				AttachedFileDataType attachedFileDataType = AttachedFileDataType.Factory
						.newInstance();
				attachedFileDataType = getAttachedFileType(narrative);
				certificationExplanation
						.setCertifications(attachedFileDataType);
				phsChecklist
						.setCertificationExplanation(certificationExplanation);
			}
		}
