...
/**
 * Class for generating the XML object for grants.gov PHS398ModularBudgetV1_0. Form is generated using XMLBean classes and is based
 * on PHS398ModularBudget schema.
 * 
 * @author Kuali Research Administration Team (kualidev@oncourse.iu.edu)
 */
public class PHS398ModularBudgetV1_0Generator extends PHS398ModularBudgetBaseGenerator {

    private static final Logger LOG = Logger.getLogger(PHS398ModularBudgetV1_0Generator.class);
    ...
    private CummulativeBudgetInfo getCummBudget() {
        CummulativeBudgetInfo cummBudget = CummulativeBudgetInfo.Factory.newInstance();
        ...
        for (Narrative narrative : pdDoc.getDevelopmentProposal().getNarratives()) {
            if (narrative.getNarrativeTypeCode() != null) {
                ...
                if (Integer.parseInt(narrative.getNarrativeTypeCode()) == NARRATIVE_JUSTIFICATION_CODE) {
                    AdditionalNarrativeJustification additionalNarrative = AdditionalNarrativeJustification.Factory.newInstance();
                    additionalNarrative.setAttFile(getAttachedFileType(narrative));
