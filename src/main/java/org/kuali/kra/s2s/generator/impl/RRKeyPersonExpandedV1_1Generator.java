...
/**
 * This class generates RRKeyPersonExpanded xml object. It uses xmlbeans for generation of the form. Form is generated based on
 * RRKeyPersonExpanded schema.
 * 
 * @author Kuali Research Administration Team (kualidev@oncourse.iu.edu)
 */
public class RRKeyPersonExpandedV1_1Generator extends RRKeyPersonExpandedBaseGenerator {

    private static final Logger LOG = Logger.getLogger(RRKeyPersonExpandedV1_1Generator.class);
            ...
            if (pdDoc.getOwnedByUnit() != null) {
                ...
                if (departmentName != null) {
                    if (departmentName.length() > DEPARTMENT_NAME_MAX_LENGTH) {
                        profile.setDepartmentName(departmentName.substring(0, DEPARTMENT_NAME_MAX_LENGTH));
                    }
                    else {
