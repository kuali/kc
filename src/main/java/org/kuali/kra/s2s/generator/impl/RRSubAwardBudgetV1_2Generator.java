 ...
 */
public class RRSubAwardBudgetV1_2Generator extends RRSubAwardBudgetBaseGenerator {

    private static final Logger LOG = Logger.getLogger(RRSubAwardBudgetV1_2Generator.class);
