...
/**
 * 
 * This class is used to generate XML Document object for grants.gov RRBudgetV1.1. This form is generated using XMLBean API's
 * generated by compiling RRBudgetV1.1 schema.
 * 
...
public class RRBudgetV1_1Generator extends RRBudgetBaseGenerator {
     ...
     * the RRBudget.
     * 
     * @param periodInfo (BudgetPeriodInfo) budget summary entry.
     * @return BudgetYear1DataType corresponding to the BudgetSummaryInfo object.
     */
    ...
    private Equipment getEquipment(BudgetPeriodInfo periodInfo) {
        ...
        if (periodInfo != null && periodInfo.getEquipment() != null && periodInfo.getEquipment().size() > 0) {
            ...
            totalFund.setTotalFundForAttachedEquipmentExist(YesNoDataType.Y_YES);
     ...
     * 
     * @param compensation (CompensationInfo) compensation info entry.
    ...
    private KeyPersons getKeyPersons(BudgetPeriodInfo periodInfo) {
        ...
        if (periodInfo != null) {
            if (periodInfo.getKeyPersons() != null) {
                KeyPersonDataType[] keyPersonArray = new KeyPersonDataType[periodInfo.getKeyPersons().size()];
        ...
        TotalFundForAttachedKeyPersons totalFund = TotalFundForAttachedKeyPersons.Factory.newInstance();
