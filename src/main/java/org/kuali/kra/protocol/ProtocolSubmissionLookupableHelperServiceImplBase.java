...
//        if (kraAuthorizationService.hasPermission(getUserIdentifier(), ((ProtocolSubmissionBase) businessObject).getProtocol(),
//                PermissionConstants.MODIFY_PROTOCOL)) {
//            AnchorHtmlData editHtmlData = getViewLink((ProtocolSubmissionBase) businessObject);
...
//            htmlDataList.add(getViewLink((ProtocolSubmissionBase) businessObject));
//        }
//        return htmlDataList;
//    }
//    
...
//        List<ProtocolSubmissionBase> submissionLookupData=(List<ProtocolSubmissionBase>)super.getSearchResults(fieldValues);
//        try{
