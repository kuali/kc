 ...
 */
package org.kuali.kra.protocol.actions.assigncmtsched;
...
public class ProtocolAssignCmtSchedBean extends ProtocolActionBean implements Serializable {
    ...
    public void init() {
//TODO:IACUC        String committeeId = getProtocolAssignCmtSchedService().getAssignedCommitteeId(getProtocol());
//        if (committeeId != null) {
...
//TODO:IACUC    private ProtocolAssignCmtSchedService getProtocolAssignCmtSchedService() {
