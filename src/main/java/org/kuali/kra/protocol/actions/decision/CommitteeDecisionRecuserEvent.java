 ...
 * This class...
 */
public abstract class CommitteeDecisionRecuserEvent<CD extends CommitteeDecision<?>> extends KraDocumentEventBase {
...
//    private static final org.apache.commons.logging.Log LOG = org.apache.commons.logging.LogFactory.getLog(CommitteeDecisionRecuserEvent.class);
     ...
     * @param decision
     */
    public CommitteeDecisionRecuserEvent(ProtocolDocument document, CD decision) {
    ...
    public boolean invokeRuleMethod(BusinessRule rule) {
        return ((ExecuteCommitteeDecisionRecuserRule<CD>) rule).proccessCommitteeDecisionRecuserRule((ProtocolDocument) this.getDocument(), this.actionBean);
    }
