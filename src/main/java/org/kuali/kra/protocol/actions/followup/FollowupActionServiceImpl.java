...
public abstract class FollowupActionServiceImpl<T extends ValidProtocolActionAction> implements FollowupActionService<T> {
...
//    private static final Log LOG = LogFactory.getLog(FollowupActionServiceImpl.class);
     ...
     */
    public List<T> getFollowupsForProtocol(Protocol protocol) {
        List<T> resultList; 
