...
public abstract class CreateContinuationEvent extends KraDocumentEventBaseExtension {

    private String continuationSummary;
    private String propertyName;

    public CreateContinuationEvent(ProtocolDocument document, String propertyName, String continuationSummary) {
