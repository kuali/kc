 ...
 * This class...
 */
public abstract class CommitteeDecisionEvent<CD extends CommitteeDecision<?>> extends KraDocumentEventBase {
...
//    .getLog(CommitteeDecisionEvent.class);
     ...
     * @param decision
     */
    public CommitteeDecisionEvent(ProtocolDocument document, CD decision) {
    ...
    public boolean invokeRuleMethod(BusinessRule rule) {
        return ((ExecuteCommitteeDecisionRule<CD>) rule).proccessCommitteeDecisionRule((ProtocolDocument) this.getDocument(), this.actionBean);
    }
