 ...
 */
public abstract class ProtocolCopyServiceImpl<GenericProtocolDocument extends ProtocolDocument> implements ProtocolCopyService<GenericProtocolDocument> {
    ...
    /**
     * @see org.kuali.kra.protocol.actions.copy.ProtocolCopyService#copyProtocol(org.kuali.kra.protocol.ProtocolDocument)
     */
    ...
    /**
     * @see org.kuali.kra.protocol.actions.copy.ProtocolCopyService#copyProtocol(org.kuali.kra.protocol.ProtocolDocument, java.lang.String)
     */
    ...
    protected GenericProtocolDocument createNewProtocol(GenericProtocolDocument srcDoc, String protocolNumber, boolean isAmendmentRenewal) throws Exception {
        ...
        org.kuali.kra.protocol.actions.ProtocolAction protocolAction = getProtocolActionNewInstanceHook(newDoc.getProtocol(), null, getProtocolActionProtocolCreatedCodeHook());
