 ...
 */
public abstract class CommitteeDecisionServiceImpl<CD extends CommitteeDecision<? extends CommitteePerson> > implements CommitteeDecisionService<CD> {
     ...
     */
    public void processCommitteeDecision(Protocol protocol, CD committeeDecision) throws Exception {
        ...
        if (submission != null) {
            ...
            ProtocolAction protocolAction = getNewProtocolActionInstanceHook(protocol, submission, getProtocolActionTypeCodeForRecordCommitteeDecisionHook());
