...
//TODO:IACUC import org.kuali.kra.protocol.actions.followup.FollowupActionService;
...
//TODO:IACUC    protected FollowupActionService followupActionService;
   
  //TODO:IACUC    protected ProtocolDao protocolDao;
...
//TODO:IACUC    public void setProtocolDao(ProtocolDao protocolDao) {
//TODO:IACUC        this.protocolDao = protocolDao;
//TODO:IACUC    }

//TODO:IACUC    public void setFollowupActionService(FollowupActionService followupActionService) {
...
//    }
   ...
   public boolean isProtocolPersonnel(Protocol protocol) {
    ...
    protected abstract boolean canPerformAction(String actionTypeCode, Protocol protocol);

// Following demoted to IACUC    
//    /**
