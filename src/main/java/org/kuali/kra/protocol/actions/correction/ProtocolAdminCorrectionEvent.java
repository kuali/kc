...
/**
 * The event that occurs when the Protocol Administrator assigns reviewers to a protocol.
 */
public abstract class ProtocolAdminCorrectionEvent extends KraDocumentEventBaseExtension {
    ...
    public ProtocolAdminCorrectionEvent(ProtocolDocument document, String propertyName, AdminCorrectionBean actionBean) {
