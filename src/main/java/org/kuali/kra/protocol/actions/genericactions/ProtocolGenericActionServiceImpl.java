 ...
 * state change.
 */
public abstract class ProtocolGenericActionServiceImpl implements ProtocolGenericActionService {
...
//    }
     ...
     * @throws Exception
     */
    protected void performGenericAction(Protocol protocol, ProtocolGenericActionBean actionBean, String protocolActionType, String newProtocolStatus) throws Exception {
...
//    }
    ...
    private ProtocolAction createProtocolActionAndAttach(Protocol protocol, ProtocolGenericActionBean actionBean, String protocolActionType) {
        ProtocolAction protocolAction = getNewProtocolActionInstanceHook(protocol, null, protocolActionType);
...
//    }
    ...
    protected ProtocolDocument getReturnedVersionedDocument(Protocol protocol) throws Exception {
