 ...
 */
public abstract class ProtocolPrintingServiceImpl extends PrintingServiceImpl implements ProtocolPrintingService {
    ...
    private static final String REPORT_PREFIX = "Protocol-";
    ...
    /**
     * 
     * @see org.kuali.kra.protocol.actions.print.ProtocolPrintingService#getProtocolPrintArtifacts(org.kuali.kra.protocol.Protocol)
     */
     ...
     */
    protected List<Printable> getPrintReportArtifacts(ProtocolForm protocolForm, StringBuffer fileName) {
    ...
    protected Printable getPrintableArtifacts(Protocol protocol, String reportType, StringBuffer fileName,Map reportParameters) {
    ...
    protected List<Printable> getPrintArtifacts(ProtocolForm protocolForm) {
        List<Printable> printableArtifactList = new ArrayList<Printable>();
    ...
    public AttachmentDataSource printProtocolDocument(ProtocolForm protocolForm) throws PrintingException {
        Protocol protocol = protocolForm.getProtocolDocument().getProtocol();
    ...
    public AttachmentDataSource printProtocolSelectedItems(ProtocolForm protocolForm) throws PrintingException {
        Protocol protocol = protocolForm.getProtocolDocument().getProtocol();
