 ...
 */
public abstract class ProtocolAdminCorrectionRule extends ResearchDocumentRuleBase implements BusinessRuleInterface<ProtocolAdminCorrectionEvent>  {
   
    public boolean processRules(ProtocolAdminCorrectionEvent event) {
        boolean valid = true;
