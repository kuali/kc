...
public abstract class UndoLastActionServiceImpl implements UndoLastActionService {
    ...
    protected abstract void removeAttachedCorrespondences(ProtocolAction protocolAction);
    ...
    public ProtocolDocument undoLastAction(ProtocolDocument protocolDocument, UndoLastActionBean undoLastActionBean) throws Exception {
        ...
        ProtocolAction lastActionPerformed = undoLastActionBean.getLastAction();
...
//            protocolOnlineReviewService.moveOnlineReviews(oldSubmission, protocolDocument.getProtocol().getProtocolSubmission());
     ...
     */
    protected void updateProtocolReviews(Protocol protocol) throws Exception {
     ...
     * @return
     */
    protected abstract Protocol getOldProtocol(Protocol protocol);

    /*
     * create & route onlnreview doc for the new versioned protocol
     */
    protected void createOnlnReviews(Protocol protocol, Protocol oldProtocol) throws Exception {
     ...
     */
    //replay the
    protected void resetOnlineReviewStatus(ProtocolOnlineReviewDocument oldDocument, ProtocolOnlineReviewDocument document) throws Exception {
     ...
     */
    protected ProtocolReviewer getReviewer(ProtocolOnlineReview onlineReview, Protocol protocol) {
        ProtocolSubmission protocolSubmission = protocol.getProtocolSubmission();
     ...
     */
    protected void setNewOnlnReview(ProtocolOnlineReview copiedReview, ProtocolReviewer reviewer, Protocol protocol) {
        ProtocolSubmission protocolSubmission = protocol.getProtocolSubmission();
