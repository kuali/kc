 ...
 */
public abstract class ProtocolApproveEvent extends KraDocumentEventBaseExtension {
    ...
    public ProtocolApproveRule getRule() {
        return getNewProtocolApproveRuleInstanceHook();
    }

    protected abstract ProtocolApproveRule getNewProtocolApproveRuleInstanceHook();
