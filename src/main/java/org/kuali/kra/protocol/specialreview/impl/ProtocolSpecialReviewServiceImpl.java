...
public abstract class ProtocolSpecialReviewServiceImpl implements ProtocolSpecialReviewService {
    ...
    @SuppressWarnings("rawtypes")
    protected abstract void setProtocolExemptStudiesCheckListItemHook(Protocol protocol, SpecialReview  specialReview);
