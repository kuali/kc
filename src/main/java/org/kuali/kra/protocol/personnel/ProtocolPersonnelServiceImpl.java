...
public abstract class ProtocolPersonnelServiceImpl implements ProtocolPersonnelService {
    ...
    /**
     * 
     * @see org.kuali.kra.protocol.personnel.ProtocolPersonnelService#addProtocolPersonAttachment(org.kuali.kra.protocol.Protocol, org.kuali.kra.protocol.noteattachment.ProtocolAttachmentPersonnel, int)
     */
    ...
    /**
     * @see org.kuali.kra.protocol.personnel.ProtocolPersonnelService#addProtocolPersonUnit(org.kuali.kra.protocol.Protocol, org.kuali.kra.protocol.personnel.ProtocolPerson)
     */
    ...
    /**
     * @see org.kuali.kra.protocol.personnel.ProtocolPersonnelService#deleteProtocolPersonUnit(java.util.List, org.kuali.kra.protocol.personnel.ProtocolPerson, int)
     */
...
//        selectedPerson.getProtocolUnits().remove(protocolUnit);
    ...
    /**
     * @see org.kuali.kra.protocol.personnel.ProtocolPersonnelService#isDuplicateUnit(java.util.List, org.kuali.kra.protocol.personnel.ProtocolUnit)
     */
    ...
    /**
     * @see org.kuali.kra.protocol.personnel.ProtocolPersonnelService#isDuplicatePerson(java.util.List, org.kuali.kra.protocol.personnel.ProtocolPerson)
     */
    ...
    /**
     * {@inheritDoc}
     * @see org.kuali.kra.protocol.personnel.ProtocolPersonnelService#setPrincipalInvestigator(org.kuali.kra.protocol.personnel.ProtocolPerson, 
    ...
    /**
     * {@inheritDoc}
     * @see org.kuali.kra.protocol.personnel.ProtocolPersonnelService#getLeadUnit(org.kuali.kra.protocol.personnel.ProtocolPerson)
     */
    ...
    /**
     * {@inheritDoc}
     * @see org.kuali.kra.protocol.personnel.ProtocolPersonnelService#setLeadUnit(org.kuali.kra.protocol.personnel.ProtocolUnit, 
     *                                                                       org.kuali.kra.protocol.personnel.ProtocolPerson, org.kuali.kra.protocol.Protocol)
     */
    ...
    /**
     * @see org.kuali.kra.protocol.personnel.ProtocolPersonnelService#syncPersonRoleAndUnit(org.kuali.kra.protocol.personnel.ProtocolPerson)
     */
    ...
    /**
     * @see org.kuali.kra.protocol.personnel.ProtocolPersonnelService#syncPersonRoleAndAffiliation(org.kuali.kra.protocol.personnel.ProtocolPerson)
     */
