...
public abstract class ProtocolPerson extends ProtocolAssociate implements PersonEditableInterface, AbstractProjectPerson {
    ...
    public void postInitHook(Protocol protocol) {
        ...
        // TODO The below for loop should be uncommented once ProtocolAttachmentPersonnel has been refactored
        /*
