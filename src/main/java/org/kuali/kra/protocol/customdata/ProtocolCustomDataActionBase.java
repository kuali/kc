 ...
 */
public abstract class ProtocolCustomDataActionBase extends ProtocolActionBase {
...
//
//        ((ProtocolFormBase)form).getCustomDataHelper().initializePermissions();
//        
...
//        CustomDataAction.copyCustomDataToDocument(form);
//        ((ProtocolFormBase)form).getCustomDataHelper().prepareView(((ProtocolFormBase)form).getProtocolDocument());
//        
...
//    }
    ...
    public ActionForward clearLookupValue(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ProtocolFormBase protocolForm = (ProtocolFormBase) form;
        ProtocolCustomDataHelperBase protocolCustomDataHelper = protocolForm.getCustomDataHelper();
