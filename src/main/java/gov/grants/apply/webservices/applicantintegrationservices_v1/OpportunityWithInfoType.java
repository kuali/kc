...
/**
 * <p>Java class for OpportunityWithInfoType complex type.
 * 
...
@XmlType(name = "OpportunityWithInfoType", propOrder = {
    "opportunityID",
    "opportunityTitle",
    "openingDate",
    "closingDate",
...
public class OpportunityWithInfoType {
    ...
    @XmlElement(name = "CFDADescription")
    protected String cfdaDescription;
    @XmlElement(name = "OfferingAgency")
     ...
     *     
     */
    public void setAgencyContact(String value) {
