...
public class GetOpportunityListResponse {
    ...
    @XmlElement(name = "OpportunityInformation")
     ...
     * This is why there is not a <CODE>set</CODE> method for the opportunityInformation property.
     * 
     * <p>
     ...
     * {@link OpportunityInformationType }
     * 
     * 
     */
    public List<OpportunityInformationType> getOpportunityInformation() {
        if (opportunityInformation == null) {
            opportunityInformation = new ArrayList<OpportunityInformationType>();
        }
        return this.opportunityInformation;
    }
