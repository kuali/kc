...
public class AwardCommentServiceImplTest {
    ...
    public void setUp() throws Exception {
        ...
        commentType1.setDescription("some comments");
        commentType1.setCommentTypeCode("1");
        commentType2.setAwardCommentScreenFlag(true);
        commentType2.setDescription("some other comments");
        commentType2.setCommentTypeCode("2");
    ...
    public void testRetrieveCommentTypesToAwardFormForPanelHeaderDisplay() {
        ...
        Assert.assertTrue(awardCommentServiceImpl.retrieveCommentTypesToAwardFormForPanelHeaderDisplay().size() == 2);
    }
}
