...
public class SubAwardDocumentRuleTest extends KcUnitTestBase {
    ...
    public void testProcessAddSubAwardAmountReleasedBusinessRules() {
        ...
        Assert.assertTrue(subAwardDocumentRule.processAddSubAwardAmountReleasedBusinessRules(subAwardAmountReleased));
    }    
    ...
    public void testProcessAddSubAwardFundingSourceBusinessRules(){
        ...
        Assert.assertTrue(subAwardDocumentRule.processAddSubAwardFundingSourceBusinessRules(subAwardFundingSource));
    }    
