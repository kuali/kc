...
public class BudgetCategoryMapMaintenanceDocumentTest extends MaintenanceDocumentTestBase {
    ...
    public void testCreateNewBudgetCategoryMap() throws Exception {
        HtmlPage budgetCategoryMapMaintenancePage = getMaintenanceDocumentPage("Budget Category Maps","org.kuali.kra.budget.core.BudgetCategoryMap","Kuali :: Budget Category Maps Maintenance Document");
