...
@PerTestUnitTestData(
        @UnitTestData(
                sqlStatements = {
                        @UnitTestSql("delete from budget_category where budget_category_CODE = '99'"),
                        @UnitTestSql("update budget_category set description = 'Duplicating' where budget_category_CODE = '10'")
...
public class BudgetCategoryMaintenanceDocumentTest extends MaintenanceDocumentTestBase {
    ...
    public void testCopyBudgetCategoryMaintenanceDocument() throws Exception {
        ...
        setFieldValue(budgetCategoryMaintenanceDocumentMaintenanceCopyPage, "document.documentHeader.financialDocumentDescription", "Budget Category - copy test");
    ...
    public void testEditBudgetCategoryMaintenanceDocument() throws Exception {
        ...
        setFieldValue(budgetCategoryMaintenanceDocumentMaintenanceEditPage, "document.documentHeader.financialDocumentDescription", "Budget Category - edit test");
    ...
    public void testCreateNewBudgetCategory() throws Exception {
        ...
        setFieldValue(budgetCategoryMaintenancePage, "document.documentHeader.financialDocumentDescription", "Budget Category - test");
