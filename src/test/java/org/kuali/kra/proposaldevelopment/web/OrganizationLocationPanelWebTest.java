...
//     http://localhost:8080/kc-dev/kew/DocHandler.do?docId=2241&command=displayActionListView
     String url = PROTOCOL_AND_HOST + ":" + getPort() + "/kc-dev/kew/DocHandler.do?docId=" + documentNumber + "&command=displayActionListView";
