...
public class CommitteeWebTest extends CommitteeWebTestBase {
    ...
    public void testSaveOfCommitteeFields() throws Exception {
        ...
        String committeeId = setDefaultRequiredFields(committeePage);
        ...
        assertEquals(DEFAULT_NAME + committeeId, getFieldValue(committeePage, COMMITTEE_NAME_ID));
        ...
        assertContains(committeePage, "Committee ID: " + committeeId + " * Committee Name");
