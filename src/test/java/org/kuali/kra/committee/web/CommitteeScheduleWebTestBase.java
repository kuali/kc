...
public class CommitteeScheduleWebTestBase extends CommitteeWebTestBase {
    ...
    private static final String SCHEDULEDATA_SCHEDULESTARTDATE = "committeeHelper.scheduleData.scheduleStartDate";
    
    private static final String SCHEDULEDATA_TIME_TIME = "committeeHelper.scheduleData.time.time";
