...
public class BudgetPersonnelWebTest extends BudgetWebTestBase {
    ...
    /**    
     *
     * @see org.kuali.kra.budget.personnel.BudgetPerson
     * @see org.kuali.kra.proposaldevelopment.budget.bo.ProposalBudgetLineItem;
     */
    /*
    ...
    private void assignBudgetPersonnel() throws Exception {
        navigateToBudgetPersonnel();
        currentBudgetPage = multiLookup(currentBudgetPage, "org.kuali.kra.bo.KcPerson", "personId", "000000003");
