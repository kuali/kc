...
/**
 * This class tests generation and validation of XML for Cumulative Budget
 * Report
 * 
 */

public class BudgetCumulativeXmlStreamTest extends
		XmlStreamTestBase<BudgetCumilativeXmlStream> {

	@Override
	protected Map<String, Object> getReportParameters() {
		return PrintingTestUtils.getBudgetCumulativeReportParameters();
	}

	@Override
	protected Class<BudgetCumilativeXmlStream> getXmlStream() {
		return BudgetCumilativeXmlStream.class;
	}
