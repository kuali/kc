...
public class BudgetSalaryXmlStreamTest extends
		XmlStreamTestBase<BudgetSalaryXmlStream> {

	@Override
	protected Map<String, Object> getReportParameters() {
		return PrintingTestUtils.getBudgetSalaryReportParameters();
	}

	@Override
	protected Class<BudgetSalaryXmlStream> getXmlStream() {
		return BudgetSalaryXmlStream.class;
	}
