...
/**
 * This class tests generation and validation of XML for Industrial Cumulative
 * Budget Report
 * 
 */

public class IndustrialCumulativeBudgetXmlStreamTest extends
		XmlStreamTestBase<IndustrialCumBudgetXmlStream> {

	@Override
	protected Map<String, Object> getReportParameters() {
		return PrintingTestUtils
				.getIndustrialCumulativeBudgetReportParameters();
	}

	@Override
	protected Class<IndustrialCumBudgetXmlStream> getXmlStream() {
		return IndustrialCumBudgetXmlStream.class;
	}
