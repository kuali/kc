...
/**
 * This class tests the FaithBasedSurveyOnEEOV1_0Generator
 */
public class FaithBasedSurveyOnEEOV1_0GeneratorTest extends S2STestBase<FaithBasedSurveyOnEEOV1_0Generator> {

    @Override
    protected Class<FaithBasedSurveyOnEEOV1_0Generator> getFormGeneratorClass() {
        return FaithBasedSurveyOnEEOV1_0Generator.class;
    }
    ...
    protected void prepareData(ProposalDevelopmentDocument document) throws Exception {
        ...
        organization.setDunsNumber("5644464565");
