...
public class RRBudgetV1_1GeneratorTest extends S2STestBase<RRBudgetV1_1Generator> {


    @Override
    protected Class<RRBudgetV1_1Generator> getFormGeneratorClass() {
        return RRBudgetV1_1Generator.class;
    }
