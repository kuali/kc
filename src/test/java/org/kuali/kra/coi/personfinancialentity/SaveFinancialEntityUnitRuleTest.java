...
public class SaveFinancialEntityUnitRuleTest {

    @Test
    public void testSaveFinancialEntityUnitOK() {
        new TemplateRuleTest<SaveFinancialEntityUnitEvent, SaveFinancialEntityUnitRule>() {
            @Override
            protected void prerequisite() {
                ...
                financialEntityUnits.add(financialEntityUnit);
                ...
                event = new SaveFinancialEntityUnitEvent(Constants.EMPTY_STRING, financialEntityUnits);
                rule = new SaveFinancialEntityUnitRule();
    ...
    @Test
    public void testNoFinancialEntityUnit() {
        new TemplateRuleTest<SaveFinancialEntityUnitEvent, SaveFinancialEntityUnitRule>() {
            @Override
            protected void prerequisite() {
                List<FinancialEntityUnit> financialEntityUnits = new ArrayList<FinancialEntityUnit>();
