...
public class AddFinancialEntityReporterUnitRuleTest {

    @Test
    public void testAddFinancialEntityReporterUnitOK() {
        new TemplateRuleTest<AddFinancialEntityReporterUnitEvent, AddFinancialEntityReporterUnitRule>() {
            @Override
            protected void prerequisite() {
                ...
                event = new AddFinancialEntityReporterUnitEvent(Constants.EMPTY_STRING, financialEntityReporterUnit, financialEntityReporterUnits);
                rule = new AddFinancialEntityReporterUnitRule();
