...
public class PrintingTestUtils {
	...
	private static Award getAwardTwo() {
		...
		award.setNonCompetingContPrpslDue(frequency);
		award.setCompetingRenewalPrpslDue(frequency);
		award.setCompetingRenewalPrpslDueCode("renewal Proposal due");
		award.setBasisOfPaymentCode("basis of  payment code 123");
		award.setMethodOfPaymentCode("method Of Payment Code 123");
		award.setPaymentInvoiceFreqCode("payment Invoice Freq Code 123");
		award.setInvoiceNumberOfCopies(1);
		award.setFinalInvoiceDue(230);
		...
		award.setPaymentInvoiceFrequency(frequency);
