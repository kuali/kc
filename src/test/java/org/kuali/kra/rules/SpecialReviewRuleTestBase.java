...
public abstract class SpecialReviewRuleTestBase<T extends AbstractSpecialReview> extends KcUnitTestBase {
    ...
    private SpecialReviewRule<T> rule = null;
    ...
    public void setUp() throws Exception {
        super.setUp();
        rule = new SpecialReviewRulesImpl<T>();
    ...
    public void testOK() throws Exception {
        ...
        AddSpecialReviewEvent<T> addSpecialReviewEvent = new AddSpecialReviewEvent<T>(Constants.EMPTY_STRING, document, newSpecialReview);
    ...
    public void testBlankApprovalTypeCode() throws Exception {
        ...
        assertError(NEW_SPECIAL_REVIEW + DOT + APPROVAL_TYPE_CODE_FIELD, KeyConstants.ERROR_REQUIRED_SELECT_APPROVAL_STATUS);
    }
    ...
    public void testBlankSpecialReviewCode() throws Exception {
        ...
        assertFalse(rule.processAddSpecialReviewEvent(addSpecialReviewEvent));
        assertError(NEW_SPECIAL_REVIEW + DOT + SPECIAL_REVIEW_CODE_FIELD, KeyConstants.ERROR_REQUIRED_SELECT_SPECIAL_REVIEW_CODE);
    }
    ...
    public void testNonApprovalWithApprovalDate() throws Exception {
        ...
        assertFalse(rule.processAddSpecialReviewEvent(addSpecialReviewEvent));
        assertError(NEW_SPECIAL_REVIEW + DOT + APPROVAL_DATE_FIELD, KeyConstants.ERROR_NOT_APPROVED_SPECIALREVIEW);
    }
    ...
    public void testApprovalDateBeforeApplicationDate() throws Exception {
        ...
        newSpecialReview.setApprovalDate(new Date(dateFormat.parse("Aug 21, 2007").getTime()));
        AddSpecialReviewEvent<T> addProposalSpecialReviewEvent = new AddSpecialReviewEvent<T>(Constants.EMPTY_STRING, document, newSpecialReview);
        
        assertFalse(rule.processAddSpecialReviewEvent(addProposalSpecialReviewEvent));
        assertError(NEW_SPECIAL_REVIEW + DOT + APPROVAL_DATE_FIELD, KeyConstants.ERROR_APPROVAL_DATE_BEFORE_APPLICATION_DATE_SPECIALREVIEW);
    }
    ...
    public void testExpirationDateBeforeApprovalDate() throws Exception {
        ...
        assertFalse(rule.processAddSpecialReviewEvent(addProposalSpecialReviewEvent));
        assertError(NEW_SPECIAL_REVIEW + DOT + EXPIRATION_DATE_FIELD, KeyConstants.ERROR_SPECIAL_REVIEW_DATE_ORDERING);
    }
    ...
    public void testProtocolWithBlankProtocolNumber() throws Exception {
        ...
        assertFalse(rule.processAddSpecialReviewEvent(addSpecialReviewEvent));
        assertError(NEW_SPECIAL_REVIEW + DOT + PROTOCOL_NUMBER_FIELD, KeyConstants.ERROR_REQUIRED_FOR_VALID_SPECIALREVIEW);
    }
    ...
    public void testApplicationWithBlankApplicationDate() throws Exception {
        ...
        assertFalse(rule.processAddSpecialReviewEvent(addSpecialReviewEvent));
        assertError(NEW_SPECIAL_REVIEW + DOT + APPLICATION_DATE_FIELD, KeyConstants.ERROR_REQUIRED_FOR_VALID_SPECIALREVIEW);
    }
    ...
    public void testApprovalWithBlankApprovalDate() throws Exception {
        ...
        assertFalse(rule.processAddSpecialReviewEvent(addSpecialReviewEvent));
        assertError(NEW_SPECIAL_REVIEW + DOT + APPROVAL_DATE_FIELD, KeyConstants.ERROR_REQUIRED_FOR_VALID_SPECIALREVIEW);
    }
    ...
    public void testExemptWithBlankExemptionCodes() throws Exception {
        ...
        assertFalse(rule.processAddSpecialReviewEvent(addSpecialReviewEvent));
        assertError(NEW_SPECIAL_REVIEW + DOT + EXEMPTION_TYPE_CODE_FIELD, KeyConstants.ERROR_REQUIRED_FOR_VALID_SPECIALREVIEW);
    }
    ...
    public void testNotExemptWithExemptionCodes() throws Exception {
        ...
        assertFalse(rule.processAddSpecialReviewEvent(addSpecialReviewEvent));
        assertError(NEW_SPECIAL_REVIEW + DOT + EXEMPTION_TYPE_CODE_FIELD, KeyConstants.ERROR_EXEMPT_NUMBER_SELECTED);
    }
