...
public class AwardHierarchyTest {
    private static final String ROOT_AWARD_NUMBER = "10000001-0001";
    
    @Test
    public void testCreatingRootNode() {
        AwardHierarchy root = AwardHierarchy.createRootNode(ROOT_AWARD_NUMBER); 
        assertNotNull(root);
        assertEquals(ROOT_AWARD_NUMBER, root.getAwardNumber());
