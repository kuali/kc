...
/**
 * Test the Protocol Request Close Authorizer.
 */
public class ProtocolRequestCloseAuthorizerTest extends ProtocolAuthorizerTestBase {
    ...
    protected ProtocolAuthorizer createProtocolAuthorizer(ProtocolDocument protocolDocument, boolean hasPermission, boolean isActionAllowed, boolean isInWorkflow) {
        ProtocolAuthorizer authorizer = new ProtocolRequestCloseAuthorizer();
        ...
        authorizer.setProtocolActionService(buildProtocolActionService(ProtocolActionType.REQUEST_TO_CLOSE, protocolDocument, isActionAllowed));
        return authorizer;
    }
    
    @Override
    protected String getTaskName() {
        return TaskName.PROTOCOL_REQUEST_CLOSE;
    }
