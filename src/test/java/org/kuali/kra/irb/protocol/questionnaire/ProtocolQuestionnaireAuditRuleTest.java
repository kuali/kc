...
public class ProtocolQuestionnaireAuditRuleTest extends ProtocolRuleTestBase {
    ...
    public void testProcessRunAuditBusinessRules() throws Exception {     
        ...
        QuestionnaireUsage amenRenNonMandatoryUsage1 = getUsage(CoeusModule.IRB_MODULE_CODE, CoeusSubModule.AMENDMENT_RENEWAL, 1, false);
        QuestionnaireUsage amenRenMandatoryUsage1 = getUsage(CoeusModule.IRB_MODULE_CODE, CoeusSubModule.AMENDMENT_RENEWAL, 2, true);
        ...
        QuestionnaireUsage amenRenNonMandatoryUsage2 = getUsage(CoeusModule.IRB_MODULE_CODE, CoeusSubModule.AMENDMENT_RENEWAL, 1, true);
        QuestionnaireUsage amenRenMandatoryUsage2 = getUsage(CoeusModule.IRB_MODULE_CODE, CoeusSubModule.AMENDMENT_RENEWAL, 2, false);
        ...
        QuestionnaireUsage amenRenMandatoryUsage3 = getUsage(CoeusModule.IRB_MODULE_CODE, CoeusSubModule.AMENDMENT_RENEWAL, 1, true);
        QuestionnaireUsage amenRenNonMandatoryUsage3 = getUsage(CoeusModule.IRB_MODULE_CODE, CoeusSubModule.AMENDMENT_RENEWAL, 2, false);
        ...
        QuestionnaireUsage amenRenNonMandatoryUsage6 = getUsage(CoeusModule.IRB_MODULE_CODE, CoeusSubModule.AMENDMENT_RENEWAL, 1, false);
        QuestionnaireUsage amenRenMandatoryUsage6 = getUsage(CoeusModule.IRB_MODULE_CODE, CoeusSubModule.AMENDMENT_RENEWAL, 2, true);
        ...
        QuestionnaireUsage amenRenNonMandatoryUsage7 = getUsage(CoeusModule.IRB_MODULE_CODE, CoeusSubModule.AMENDMENT_RENEWAL, 1, true);
        QuestionnaireUsage amenRenMandatoryUsage7 = getUsage(CoeusModule.IRB_MODULE_CODE, CoeusSubModule.AMENDMENT_RENEWAL, 2, false);
        ...
        AnswerHeader hdr1 = getAnswerHeader(questionnaire1, true);
        AnswerHeader hdr2 = getAnswerHeader(questionnaire2, true);
        AnswerHeader hdr3 = getAnswerHeader(questionnaire3, true);
        AnswerHeader hdr4 = getAnswerHeader(questionnaire4, true);
        AnswerHeader hdr5 = getAnswerHeader(questionnaire5, true);
        AnswerHeader hdr6 = getAnswerHeader(questionnaire6, true);
        AnswerHeader hdr7 = getAnswerHeader(questionnaire7, true);
