 ...
 */
public class ProtocolSpecialReviewSeleniumTest extends KcSeleniumTestBase {
    ...
    private static final String LIST_PREFIX = "document.protocolList[0].specialReviews[%d].";
    ...
    public void testAddApprovedSpecialReview() throws Exception {
        ...
        helper.clickProtocolSpecialReviewPage();
