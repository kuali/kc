...
public class ProtocolPersonnelWebTest extends ProtocolWebTestBase{
    ...
    private static final String DELETE_UNIT_BUTTON = "methodToCall.deleteProtocolPersonUnit.document.protocol.protocolPersons[0].line1";
    ...
    private static final String PERSON_PI_DELETE_FLAG = "document.protocol.protocolPersons[0].delete";
    private static final String PERSON_COI_DELETE_FLAG = "document.protocol.protocolPersons[1].delete";
    private static final String PERSON_PI_ROLE_ID_FIELD = "document.protocol.protocolPersons[0].protocolPersonRoleId";
