...
public class ProtocolNoteAndAttachmentWebTest extends ProtocolWebTestBase {
    ...
    private static final String NEW_ATTACHMENT_PERSONNEL_TYPE_CODE_NAME = "notesAndAttachmentsHelper.newAttachmentPersonnel.type.code";
    private static final String NEW_ATTACHMENT_PERSONNEL_PERSON_PROTOCOL_PERSON_ID_NAME = "notesAndAttachmentsHelper.newAttachmentPersonnel.person.protocolPersonId";
    ...
    private static final String ATTACHMENT_PROTOCOL_0_NEW_FILE_NAME = "document.protocolList[0].attachmentProtocol[0].newFile";
    private static final String FILE_1 = "ProtocolNoteAndAttachmentWebTest.class";
    private static final String ATTACHMENT_PROTOCOL_0_DESCRIPTION_NAME = "document.protocolList[0].attachmentProtocol[0].description";
    private static final String ATTACHMENT_PROTOCOL_0_CONTACT_PHONE_NUMBER_NAME = "document.protocolList[0].attachmentProtocol[0].contactPhoneNumber";
    private static final String ATTACHMENT_PROTOCOL_0_CONTACT_EMAIL_ADDRESS_NAME = "document.protocolList[0].attachmentProtocol[0].contactEmailAddress";
    private static final String ATTACHMENT_PROTOCOL_0_CONTACT_NAME_NAME = "document.protocolList[0].attachmentProtocol[0].contactName";
    private static final String ATTACHMENT_PROTOCOL_0_COMMENTS_NAME = "document.protocolList[0].attachmentProtocol[0].comments";
    private static final String ATTACHMENT_PROTOCOL_0_STATUS_CODE_NAME = "document.protocolList[0].attachmentProtocol[0].status.code";
    ...
    private static final String NEW_ATTACHMENT_PROTOCOL_STATUS_CODE_NAME = "notesAndAttachmentsHelper.newAttachmentProtocol.status.code";
    private static final String NEW_ATTACHMENT_PROTOCOL_TYPE_CODE_NAME = "notesAndAttachmentsHelper.newAttachmentProtocol.type.code";
