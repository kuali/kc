...
INSERT INTO sh_parm_t (sh_parm_nmspc_cd, sh_parm_dtl_typ_cd, sh_parm_nm, ver_nbr, sh_parm_typ_cd, sh_parm_txt, sh_parm_desc, sh_p, arm_cons_cd, wrkgrp_nm, active_ind) VALUES('KRA-B', 'D', 'budgetCostSharingEnforcementFlag', 1, 'CONFG', 'Y', 'Flag indicating if Cost Sharing allocation should be enforced', 'A', 'WorkflowAdmin', 'Y');
INSERT INTO sh_parm_t (sh_parm_nmspc_cd, sh_parm_dtl_typ_cd, sh_parm_nm, ver_nbr, sh_parm_typ_cd, sh_parm_txt, sh_parm_desc, sh_p, arm_cons_cd, wrkgrp_nm, active_ind) VALUES('KRA-B', 'D', 'budgetUnrecoveredFandAEnforcementFlag',1, 'CONFG', 'Y', 'Flag indicating if Unrecovered F and A allocation should be enforced', 'A', 'WorkflowAdmin', 'Y');
