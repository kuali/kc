...
INSERT INTO KIM_PERSONS_T (ID, USERNAME, PASSWORD)
VALUES (1, 'quickstart', 'fK69ATFsAydwQuteang+xMva+Tc=') ;

INSERT INTO KIM_PERSONS_T (ID, USERNAME, PASSWORD)
VALUES (2, 'ljoconno', 'fK69ATFsAydwQuteang+xMva+Tc=') ;

INSERT INTO KIM_PERSONS_T (ID, USERNAME, PASSWORD)
VALUES (3, 'bhutchin', 'fK69ATFsAydwQuteang+xMva+Tc=') ;

INSERT INTO KIM_PERSONS_T (ID, USERNAME, PASSWORD)
VALUES (4, 'aslusar', 'fK69ATFsAydwQuteang+xMva+Tc=') ;

INSERT INTO KIM_PERSONS_T (ID, USERNAME, PASSWORD)
VALUES (5, 'tdurkin', 'fK69ATFsAydwQuteang+xMva+Tc=') ;

INSERT INTO KIM_PERSONS_T (ID, USERNAME, PASSWORD)
VALUES (6, 'pcberg', 'fK69ATFsAydwQuteang+xMva+Tc=') ;

INSERT INTO KIM_PERSONS_T (ID, USERNAME, PASSWORD)
VALUES (7, 'jtester', 'fK69ATFsAydwQuteang+xMva+Tc=') ;

INSERT INTO KIM_PERSONS_T (ID, USERNAME, PASSWORD)
VALUES (8, 'KULUSER', 'fK69ATFsAydwQuteang+xMva+Tc=') ;

INSERT INTO KIM_PERSONS_T (ID, USERNAME, PASSWORD)
VALUES (9, 'superuser', 'fK69ATFsAydwQuteang+xMva+Tc=') ;

INSERT INTO KIM_PERSONS_T (ID, USERNAME, PASSWORD)
VALUES (12, 'woods', 'fK69ATFsAydwQuteang+xMva+Tc=') ; 

INSERT INTO KIM_PERSONS_T (ID, USERNAME, PASSWORD)
VALUES (82, 'lvclinks', 'fK69ATFsAydwQuteang+xMva+Tc=') ;

INSERT INTO KIM_PERSONS_T (ID, USERNAME, PASSWORD)
VALUES (11, 'chew', 'fK69ATFsAydwQuteang+xMva+Tc=') ;

INSERT INTO KIM_PERSONS_T (ID, USERNAME, PASSWORD)
VALUES (53, 'donugent', 'fK69ATFsAydwQuteang+xMva+Tc=') ; 

INSERT INTO KIM_ROLES_PERSONS_T (ID, ROLE_ID, PERSON_ID)
VALUES(1, 18, 1) ;
...
-- for questionnaire authz
INSERT INTO KIM_ROLES_PERMISSIONS_T (ROLE_ID, PERMISSION_ID)
VALUES (13, 64) ;
INSERT INTO UNIT_ACL (ID, PERSON_ID, ROLE_ID, UNIT_NUMBER, SUBUNITS, ACTIVE_FLAG)
VALUES (42, '000000008', 13, '000001', 'N', 'Y') ;
INSERT INTO UNIT_ACL (ID, PERSON_ID, ROLE_ID, UNIT_NUMBER, SUBUNITS, ACTIVE_FLAG)
VALUES (43, '000000008', 10, 'IN-CARD', 'N', 'Y') ;
