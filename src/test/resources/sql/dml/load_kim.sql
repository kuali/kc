...
insert into KIM_ROLES_T (ID,NAME,DESCRIPTION, ROLE_TYPE_CODE, DESCENinsert into KIM_PERMISSIONS_T (ID,NAME,DESCRIPTION,NAMESPACE_ID) values(22,'EDIT_PROTOCOL_BILLABLE','Edit Billable field', 2);
D_FLAG) values(8,'Proposal Submission','Proposal Submission', 'O', 'Y');
