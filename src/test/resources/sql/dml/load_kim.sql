...
insert into KIM_PERMISSIONS_T (ID,NAME,DESCRIPTION,NAMESPACE_ID) values(61, 'SUBMIT_PROTOCOL', 'Submit a Protocol to IRB for review', 2);Insert into KIM_PERMISSIONS_T (ID,NAME,DESCRIPTION,NAMESPACE_ID) values(62,'ADD_PROPOSAL_VIEWER','Assign User to Proposal Viewer Role',2);
