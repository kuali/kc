...
SELECT ENTITY_EMP_ID, ENTITY_ID, ENTITY_AFLTN_ID, EMP_STAT_CD, EMP_TYP_CD, PRMRY_IND, ACTV_IND, PRMRY_DEPT_CD, EMP_ID, EMP_REC_ID, OBJ_ID, VER_NBR FROM KRIM_ENTITY_EMP_INFO_T WHERE ENTITY_ID > 1200 AND ENTITY_ID < 1265;
...
SELECT PRNCPL_ID, 'kc'||PRNCPL_NM AS PRNCPL_NM, ENTITY_ID, PRNCPL_PSWD, ACTV_IND, OBJ_ID, VER_NBR FROM KRIM_PRNCPL_T WHERE ENTITY_ID > 1200 AND ENTITY_ID < 1265;
