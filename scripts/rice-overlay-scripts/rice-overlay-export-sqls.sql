...
SELECT ENTITY_ID, ACTV_IND, OBJ_ID, VER_NBR FROM KRIM_ENTITY_T WHERE ENTITY_ID > 1200 AND ENTITY_ID < 1265;
SELECT ENTITY_ID, ENT_TYP_CD, ACTV_IND, OBJ_ID, VER_NBR FROM KRIM_ENTITY_ENT_TYP_T WHERE ENTITY_ID > 1200 AND ENTITY_ID < 1265;
SELECT ENTITY_NM_ID, ENTITY_ID, NM_TYP_CD, FIRST_NM, MIDDLE_NM, LAST_NM, SUFFIX_NM, TITLE_NM, DFLT_IND, ACTV_IND, OBJ_ID, VER_NBR FROM KRIM_ENTITY_NM_T WHERE ENTITY_ID > 1200 AND ENTITY_ID < 1265;
SELECT ENTITY_ADDR_ID, ENTITY_ID, ENT_TYP_CD, ADDR_TYP_CD, ADDR_LINE_1, ADDR_LINE_2, ADDR_LINE_3, CITY_NM, POSTAL_STATE_CD, POSTAL_CD, POSTAL_CNTRY_CD, DFLT_IND, ACTV_IND, OBJ_ID, VER_NBR FROM KRIM_ENTITY_ADDR_T WHERE ENTITY_ID > 1200 AND ENTITY_ID < 1265;
SELECT ENTITY_EMP_ID, ENTITY_ID, ENTITY_AFLTN_ID, EMP_STAT_CD, EMP_TYP_CD, BASE_SLRY_AMT, PRMRY_IND, ACTV_IND, PRMRY_DEPT_CD, EMP_ID, EMP_REC_ID, OBJ_ID, VER_NBR FROM KRIM_ENTITY_EMP_INFO_T WHERE ENTITY_ID > 1200 AND ENTITY_ID < 1265;
SELECT ENTITY_EMAIL_ID, ENTITY_ID, ENT_TYP_CD, EMAIL_TYP_CD, EMAIL_ADDR, DFLT_IND, ACTV_IND, OBJ_ID, VER_NBR FROM KRIM_ENTITY_EMAIL_T WHERE ENTITY_ID > 1200 AND ENTITY_ID < 1265;
SELECT ENTITY_PHONE_ID, ENTITY_ID, ENT_TYP_CD, PHONE_TYP_CD, PHONE_NBR, PHONE_EXTN_NBR, POSTAL_CNTRY_CD, DFLT_IND, ACTV_IND, OBJ_ID, VER_NBR FROM KRIM_ENTITY_PHONE_T WHERE ENTITY_ID > 1200 AND ENTITY_ID < 1265;
SELECT PRNCPL_ID, PRNCPL_NM, ENTITY_ID, PRNCPL_PSWD, ACTV_IND, OBJ_ID, VER_NBR FROM KRIM_PRNCPL_T WHERE ENTITY_ID > 1200 AND ENTITY_ID < 1265;
...
SELECT ROLE_MBR_ID, ROLE_ID, MBR_ID, MBR_TYP_CD, ACTV_FRM_DT, ACTV_TO_DT, OBJ_ID, VER_NBR FROM KRIM_ROLE_MBR_T  WHERE ROLE_ID IN (SELECT ROLE_ID FROM KRIM_ROLE_T WHERE NMSPC_CD LIKE 'KC%');
...
SELECT GRP_MBR_ID, GRP_ID, MBR_ID, MBR_TYP_CD, ACTV_FRM_DT, ACTV_TO_DT, OBJ_ID, VER_NBR FROM KRIM_GRP_MBR_T WHERE GRP_ID IN (SELECT GRP_ID FROM KRIM_GRP_T WHERE NMSPC_CD LIKE 'KC%');
...
DELETE FROM KRIM_ENTITY_EMAIL_T WHERE ENTITY_ID > 1200 AND ENTITY_ID < 1265;
DELETE FROM KRIM_ENTITY_EMP_INFO_T WHERE ENTITY_ID > 1200 AND ENTITY_ID < 1265;
DELETE FROM KRIM_ENTITY_PHONE_T WHERE ENTITY_ID > 1200 AND ENTITY_ID < 1265;
DELETE FROM KRIM_ENTITY_ADDR_T WHERE ENTITY_ID > 1200 AND ENTITY_ID < 1265;
DELETE FROM KRIM_ENTITY_NM_T WHERE ENTITY_ID > 1200 AND ENTITY_ID < 1265;
DELETE FROM KRIM_ENTITY_ENT_TYP_T WHERE ENTITY_ID > 1200 AND ENTITY_ID < 1265;
DELETE FROM KRIM_PRNCPL_T WHERE ENTITY_ID > 1200 AND ENTITY_ID < 1265;
DELETE FROM KRIM_ENTITY_T WHERE ENTITY_ID > 1200 AND ENTITY_ID < 1265;
