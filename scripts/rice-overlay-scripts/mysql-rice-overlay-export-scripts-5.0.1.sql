...
SELECT CONCAT('KC',ENTITY_ID) AS ENTITY_ID, OBJ_ID, VER_NBR, ACTV_IND FROM KRIM_ENTITY_T WHERE ENTITY_ID > 10000 AND ENTITY_ID < 10095
UNION 
...
SELECT CONCAT('KC',ENTITY_ID) AS ENTITY_ID, ENT_TYP_CD, ACTV_IND, OBJ_ID, VER_NBR FROM KRIM_ENTITY_ENT_TYP_T WHERE ENTITY_ID > 10000 AND ENTITY_ID < 10095 
UNION 
...
SELECT CONCAT('KC',ENTITY_NM_ID) AS ENTITY_NM_ID, CONCAT('KC',ENTITY_ID) AS ENTITY_ID, NM_TYP_CD, FIRST_NM, MIDDLE_NM, LAST_NM, SUFFIX_NM, TITLE_NM, DFLT_IND, ACTV_IND, OBJ_ID, VER_NBR, PREFIX_NM, NOTE_MSG, NM_CHNG_DT FROM KRIM_ENTITY_NM_T WHERE ENTITY_ID > 10000 AND ENTITY_ID < 10095
UNION 
...
SELECT CONCAT('KC',ENTITY_AFLTN_ID) AS ENTITY_AFLTN_ID, CONCAT('KC',ENTITY_ID) AS ENTITY_ID, AFLTN_TYP_CD, CAMPUS_CD, DFLT_IND, ACTV_IND, OBJ_ID, VER_NBR FROM KRIM_ENTITY_AFLTN_T WHERE ENTITY_ID > 10000 AND ENTITY_ID < 10095
UNION
...
WHEN NULL THEN 'NULL' WHEN '' THEN 'NULL' END AS EMP_TYP_CD, PRMRY_IND, ACTV_IND, PRMRY_DEPT_CD, EMP_ID, EMP_REC_ID, OBJ_ID, VER_NBR, BASE_SLRY_AMT FROM KRIM_ENTITY_EMP_INFO_T WHERE ENTITY_ID > 10000 AND ENTITY_ID <10095
UNION 
...
SELECT CONCAT('KC',ENTITY_EMAIL_ID) AS ENTITY_EMAIL_ID, CONCAT('KC',ENTITY_ID) AS ENTITY_ID, ENT_TYP_CD, EMAIL_TYP_CD, EMAIL_ADDR, DFLT_IND, ACTV_IND, OBJ_ID, VER_NBR FROM KRIM_ENTITY_EMAIL_T WHERE ENTITY_ID > 10000 AND ENTITY_ID < 10095
UNION 
...
SELECT CONCAT('KC',ENTITY_PHONE_ID) AS ENTITY_PHONE_ID, CONCAT('KC',ENTITY_ID) AS ENTITY_ID, ENT_TYP_CD, PHONE_TYP_CD, PHONE_NBR, PHONE_EXTN_NBR, POSTAL_CNTRY_CD, DFLT_IND, ACTV_IND, OBJ_ID, VER_NBR FROM KRIM_ENTITY_PHONE_T WHERE ENTITY_ID > 10000 AND ENTITY_ID < 10095 
UNION 
...
SELECT PRNCPL_ID AS PRNCPL_ID, CONCAT('kc',PRNCPL_NM) AS PRNCPL_NM, CONCAT('KC',ENTITY_ID) AS ENTITY_ID, PRNCPL_PSWD, ACTV_IND, OBJ_ID, VER_NBR FROM KRIM_PRNCPL_T WHERE ENTITY_ID > 10000 AND ENTITY_ID < 10095
UNION 
...
MBR_TYP_CD, OBJ_ID, VER_NBR, ACTV_FRM_DT, ACTV_TO_DT
...
SELECT CONCAT('KC',GRP_MBR_ID) AS GRP_MBR_ID, CONCAT('100',GRP_ID) AS GRP_ID, 
   ...
   THEN CONCAT('KC',MBR_ID) 
   ELSE MBR_ID END AS MBR_ID, 
MBR_TYP_CD, OBJ_ID, VER_NBR, ACTV_FRM_DT, 
CASE WHEN ACTV_TO_DT IS NOT NULL 
THEN NULL
ELSE ACTV_TO_DT END AS ACTV_TO_DT FROM KRIM_GRP_MBR_T WHERE GRP_ID IN (SELECT GRP_ID FROM KRIM_GRP_T WHERE NMSPC_CD LIKE 'KC%') INTO OUTFILE '/tmp/riceOverlay/KRIM_GRP_MBR_T.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' ESCAPED BY '\\' LINES TERMINATED BY '\n';
