...
/**
 * Test the Modify Protocol Personnel Authorizer.
 */
public class ModifyProtocolPersonnelAuthorizerTest extends ModifyProtocolModuleAuthorizerTestBase {
    @Test
    ...
    protected ModifyAmendmentAuthorizer createModifyAmendmentAuthorizer() {
        return new ModifyProtocolPersonnelAuthorizer();
    }
    ...
    protected String getTaskName() {
        return TaskName.MODIFY_PROTOCOL_PERSONNEL;
    }
