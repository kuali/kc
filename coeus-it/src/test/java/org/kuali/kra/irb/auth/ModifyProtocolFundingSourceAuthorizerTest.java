...
/**
 * Test the Modify Protocol Funding Source Authorizer.
 */
public class ModifyProtocolFundingSourceAuthorizerTest extends ModifyProtocolModuleAuthorizerTestBase {
    ...
    protected ModifyAmendmentAuthorizer createModifyAmendmentAuthorizer() {
        return new ModifyProtocolFundingSourceAuthorizer();
    }
    
    @Override
    protected String getModuleTypeCode() {
        return ProtocolModule.FUNDING_SOURCE;
    }

    @Override
    protected String getTaskName() {
        return TaskName.MODIFY_PROTOCOL_FUNDING_SOURCE;
    }
