 ...
 */
public class ProtocolRequestCloseEnrollmentAuthorizerTest extends ProtocolAuthorizerTestBase {
    ...
    protected ProtocolAuthorizer createProtocolAuthorizer(ProtocolDocument protocolDocument, boolean hasPermission, boolean isActionAllowed, boolean isInWorkflow) {
        ProtocolAuthorizer authorizer = new ProtocolRequestCloseEnrollmentAuthorizer();
        ...
        authorizer.setProtocolActionService(buildProtocolActionService(ProtocolActionType.REQUEST_TO_CLOSE_ENROLLMENT, protocolDocument, isActionAllowed));
        return authorizer;
    }
    
    @Override
    protected String getTaskName() {
        return TaskName.PROTOCOL_REQUEST_CLOSE_ENROLLMENT;
    }
