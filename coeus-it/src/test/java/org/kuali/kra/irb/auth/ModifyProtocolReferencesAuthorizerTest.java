...
/**
 * Test the Modify Protocol References Authorizer.
 */
public class ModifyProtocolReferencesAuthorizerTest extends ModifyProtocolModuleAuthorizerTestBase {
    ...
    protected ModifyAmendmentAuthorizer createModifyAmendmentAuthorizer() {
        return new ModifyProtocolReferencesAuthorizer();
    }
    
    @Override
    protected String getModuleTypeCode() {
        return ProtocolModule.PROTOCOL_REFERENCES;
    }

    @Override
    protected String getTaskName() {
        return TaskName.MODIFY_PROTOCOL_REFERENCES;
    }
