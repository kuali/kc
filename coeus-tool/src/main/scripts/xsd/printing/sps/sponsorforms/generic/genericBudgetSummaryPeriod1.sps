...
<structure version="2" schemafile="c:\proposal printing\schemas\phs398schema.xsd" workingxmlfile="C:\coeus40_vss\Reports\Budget genericSummary Period 1.xml" templatexmlfile="">
								...
								<children>
									...
									<tablecol>
										...
										<children>
											...
											<paragraph paragraphtag="p">
												<children>
													<text fixtext="Granted by Sponsor">
														<styles font-family="Verdana" font-size="7pt"/>
													</text>
												</children>
											</paragraph>
...
n1:ResearchAndRelatedProject/BudgetSummary/BudgetPeriod[BudgetPeriodID=1]/NSFOtherPersonnel/UnderGradFunds +
n1:ResearchAndRelatedProject/BudgetSummary/BudgetPeriod[BudgetPeriodID=1]/NSFOtherPersonnel/ClericalFunds +
 n1:ResearchAndRelatedProject/BudgetSummary/BudgetPeriod/SalarySubtotals/FringeBenefits"/>
												</autocalc>
												<format string="##,###,###,##0.00" xslt="1" datatype="decimal"/>
											</autovalue>
										</children>
...
sum(n1:ResearchAndRelatedProject/BudgetSummary/BudgetPeriod[BudgetPeriodID=1]/n3:OtherDirectCosts[Type=&apos;Materials and Supplies&apos;]/Cost ) + sum(n1:ResearchAndRelatedProject/BudgetSummary/BudgetPeriod[BudgetPeriodID=1]/n3:OtherDirectCosts[Type=&apos;Publication Costs&apos;]/Cost ) + sum(n1:ResearchAndRelatedProject/BudgetSummary/BudgetPeriod[BudgetPeriodID=1]/n3:OtherDirectCosts[Type=&apos;Consultant Costs&apos;]/Cost ) + sum(n1:ResearchAndRelatedProject/BudgetSummary/BudgetPeriod[BudgetPeriodID=1]/n3:OtherDirectCosts[Type=&apos;Computer Services&apos;]/Cost ) + sum(n1:ResearchAndRelatedProject/BudgetSummary/BudgetPeriod[BudgetPeriodID=1]/n3:OtherDirectCosts[Type=&apos;Subcontract&apos;]/Cost ) + sum(n1:ResearchAndRelatedProject/BudgetSummary/BudgetPeriod[BudgetPeriodID=1]/n3:OtherDirectCosts[Type=&apos;Other Direct Costs&apos;]/Cost)"/>
												</autocalc>
												<format string="##,###,###,##0.00" xslt="1" datatype="decimal"/>
											</autovalue>
										</children>
