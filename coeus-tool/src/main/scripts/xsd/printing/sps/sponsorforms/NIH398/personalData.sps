...
<structure version="7" xsltversion="1" cssmode="strict" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="UTF-8" encodingpdf="UTF-8" embed-images="1">
	...
	<schemasources>
		...
		<schemasources>
			<xsdschemasource name="$XML" main="1" schemafile="c:\proposal printing\schemas\phs398schema.xsd" workingxmlfile="nihproposal.xml">
				<xmltablesupport/>
				<textstateicons/>
			</xsdschemasource>
		</schemasources>
			...
			<globaltemplate match="/" matchtype="named" parttype="main">
				<children>
					<template match="$XML" matchtype="schemasource">
						<children>
							<newline/>
							<text fixtext="PERSONAL DATA ON PRINCIPAL INVESTIGATOR/PROGRAM DIRECTOR">
								<styles font-family="Verdana" font-size="12pt" font-weight="bold" line-height="12pt"/>
							</text>
							<newline/>
							<newline/>
							<text fixtext="Coeus does not collect personal data such as social security numbers or information pertaining to race and ethnicity.">
								<styles font-family="Verdana" font-size="10pt" line-height="12pt"/>
							</text>
							<newline/>
							<newline/>
							<text fixtext="NIH provides a fillable PDF form for this information.">
								<styles font-family="Verdana" font-size="10pt" line-height="12pt"/>
							</text>
							<newline/>
							<newline/>
							...
							<newline/>
							<newline/>
							<text fixtext="Please note that some of the fields on this form are optional. ">
								<styles font-family="Verdana" font-size="10pt" line-height="12pt"/>
							</text>
							<newline/>
							<newline/>
