														...
														<children>
															<list ordered="1">
																<children>
																	...
																	<listrow>
																		<children>
																			<text fixtext="DoD 3210.6-R, Department of Defense Grants and Agreement Regulations, including addenda in effect as of the beginning date of the period of performance."/>
																		</children>
																	</listrow>
																	<listrow>
																		<children>
																			...
																			<link>
																				<children>
																					<text fixtext="http://www.nsf.gov/pubs/policydocs/rtc/afosr_708.pdf"/>
																				</children>
																				<action>
																					<none/>
																				</action>
																				<bookmark/>
																				<hyperlink>
																					<fixtext value="nsf.gov/pubs/policydocs/rtc/afosr_708.pdf"/>
																				</hyperlink>
																			</link>
																			...
																			<list ordered="1">
																				...
																				<children>
																					...
																					<listrow>
																						<children>
																							<text fixtext="The payment mechanism described in Article 22 and the financial reporting requirements in Article 52 of the Research Terms and Conditions and Article 11 of the Agency-Specific Requirements are replaced with Terms and Conditions (1) through (4) of this Subaward Agreement; and"/>
																						</children>
																					</listrow>
																					<listrow>
																						<children>
