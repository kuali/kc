															...
															<list ordered="1">
																<children>
																	...
																	<listrow>
																		<styles font-family="time" font-size="10pt" font-weight="normal"/>
																		<children>
																			<text fixtext="DoDGARS Part 32 "/>
																			<link>
																				<children>
																					<text fixtext="http://www.dtic.mil/whs/directives/corres/pdf/321006r32p.pdf "/>
																				</children>
																				<action>
																					<none/>
																				</action>
																				<bookmark/>
																				<hyperlink>
																					<fixtext value="dtic.mil/whs/directives/corres/pdf/321006r32p.pdf "/>
																				</hyperlink>
																			</link>
																		</children>
																	</listrow>
																	<listrow>
																		...
																		<children>
																			...
																			<link>
																				<children>
																					<text fixtext="http://www.nsf.gov/pubs/policydocs/rtc/onr_708.pdf"/>
																				</children>
																				<action>
																					<none/>
																				</action>
																				<bookmark/>
																				<hyperlink>
																					<fixtext value="nsf.gov/pubs/policydocs/rtc/onr_708.pdf"/>
																				</hyperlink>
																			</link>
																			...
																			<list ordered="1">
																				...
																				<children>
																					...
																					<listrow>
																						<children>
																							<text fixtext="The payment mechanism described in Article 22 and the financial reporting requirements in Article 52 of the Research Terms and Conditions and Articles 9 and 11 of the Agency-Specific Requirements are replaced with Terms and Conditions (1) through (4) of this agreement; and"/>
																						</children>
																					</listrow>
																					<listrow>
																						<children>
