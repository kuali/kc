															...
															<list ordered="1">
																<children>
																	<listrow>
																		...
																		<children>
																			<text fixtext="Under the authority of 42 U.S.C. 2473(c)(5), and is subject to all applicable laws and regulations of the United States in effect on the date of this agreement, including but not limited to 14 CFR Part 1260 (Grants and Cooperative Agreements)."/>
																		</children>
																	</listrow>
																	<listrow>
																		<styles font-family="time" font-size="10pt" font-weight="normal"/>
																	...
																	<listrow>
																		...
																		<children>
																			...
																			<link>
																				<children>
																					<text fixtext="http://www.nsf.gov/pubs/policydocs/rtc/nasa_708.pdf"/>
																				</children>
																				<action>
																					<none/>
																				</action>
																				<bookmark/>
																				<hyperlink>
																					<fixtext value="nsf.gov/pubs/policydocs/rtc/nasa_708.pdf"/>
																				</hyperlink>
																			</link>
