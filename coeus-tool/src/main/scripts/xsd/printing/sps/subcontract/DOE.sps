															...
															<list ordered="1">
																<children>
																	...
																	<listrow>
																		<styles font-family="time" font-size="10pt" font-weight="normal"/>
																		<children>
																			<text fixtext="Applicable program regulations "/>
																			<template match="subcontract:SubContractData" matchtype="schemagraphitem">
																				...
																				<children>
																					<template match="subcontract:SubcontractTemplateInfo" matchtype="schemagraphitem">
																						<editorproperties elementstodisplay="5"/>
																						<children>
																							<template match="subcontract:ApplicableProgramRegulations" matchtype="schemagraphitem">
																								<editorproperties elementstodisplay="5"/>
																								<children>
																									<content>
																			...
																			<template match="subcontract:SubContractData" matchtype="schemagraphitem">
																				...
																				<children>
																					<template match="subcontract:SubcontractTemplateInfo" matchtype="schemagraphitem">
																						<editorproperties elementstodisplay="5"/>
																						<children>
																							<template match="subcontract:ApplicableProgramRegsDate" matchtype="schemagraphitem">
																								<editorproperties elementstodisplay="5"/>
																								<children>
																									<content>
																										<format string="MM/DD/YYYY" datatype="date"/>
																	...
																	<listrow>
																		<styles font-family="time" font-size="10pt" font-weight="normal"/>
																		<children>
																			<text fixtext="DOE Financial Assistance Rules, 10 CFR Part 600, as amended."/>
																		</children>
																	</listrow>
																	<listrow>
																		<styles font-family="time" font-size="10pt" font-weight="normal"/>
																		<children>
																			...
																			<link>
																				<children>
																					<text fixtext="http://www.nsf.gov/pubs/policydocs/rtc/doe_708.pdf"/>
																				</children>
																				<action>
																					<none/>
																				</action>
																				<bookmark/>
																				<hyperlink>
																					<fixtext value="nsf.gov/pubs/policydocs/rtc/doe_708.pdf"/>
																				</hyperlink>
																			</link>
																			...
																			<list ordered="1">
																				...
																				<children>
																					...
																					<listrow>
																						<children>
																							<text fixtext="The payment mechanism described in Article 22 and the financial reporting requirements in Article 52 of the Research Terms and Conditions and Article 10 of the Agency-Specific Requirements are replaced with Terms and Conditions (1) through (4) of this agreement; and"/>
																						</children>
																					</listrow>
																					<listrow>
																						<children>
