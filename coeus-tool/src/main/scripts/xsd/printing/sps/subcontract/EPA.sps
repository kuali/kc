															...
															<list ordered="1">
																<children>
																	...
																	<listrow>
																		<styles font-family="time" font-size="10pt" font-weight="normal"/>
																		<children>
																			<text fixtext="40 CFR Parts 30 and 40 as applicable."/>
																		</children>
																	</listrow>
																	<listrow>
																		<styles font-family="time" font-size="10pt" font-weight="normal"/>
																		<children>
																			...
																			<link>
																				<children>
																					<text fixtext="http://www.nsf.gov/pubs/policydocs/rtc/epa_708.pdf"/>
																				</children>
																				<action>
																					<none/>
																				</action>
																				<bookmark/>
																				<hyperlink>
																					<fixtext value="nsf.gov/pubs/policydocs/rtc/epa_708.pdf"/>
																				</hyperlink>
																			</link>
