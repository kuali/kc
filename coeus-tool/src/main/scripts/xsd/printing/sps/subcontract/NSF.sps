											...
											<tablerow>
												...
												<children>
													...
													<tablecell>
														<styles font-size="10pt" font-weight="normal"/>
														<children>
															<text fixtext="as of the effective date of this Research Subaward Agreement:"/>
														</children>
													</tablecell>
												</children>
											</tablerow>
															...
															<list ordered="1">
																<children>
																	...
																	<listrow>
																		<styles font-family="time" font-size="10pt" font-weight="normal"/>
																		<children>
																			<text fixtext="OMB Circular A-110 or 45 CFR Part 602 as applicable."/>
																		</children>
																	</listrow>
																	<listrow>
																		<styles font-family="time" font-size="10pt" font-weight="normal"/>
																		<children>
																			<text fixtext="The Proposal and Award Policies and Procedures Guide, including addenda in effect as of the beginning date of the period of performance."/>
																		</children>
																	</listrow>
																	<listrow>
																		<styles font-family="time" font-size="10pt" font-weight="normal"/>
																		<children>
																			...
																			<link>
																				<children>
																					<text fixtext="http://www.nsf.gov/pubs/policydocs/rtc/nsf_110.pdf"/>
																				</children>
																				<action>
																					<none/>
																				</action>
																				<bookmark/>
																				<hyperlink>
																					<fixtext value="nsf.gov/pubs/policydocs/rtc/nsf_110.pdf"/>
																				</hyperlink>
																			</link>
																			...
																			<list ordered="1">
																				...
																				<children>
																					...
																					<listrow>
																						<children>
																							<text fixtext="The payment mechanism described in Article 22 and the financial reporting requirements in Article 52 of the Research Terms and Conditions and Article 9 of the Agency-Specific Requirements are replaced with Terms and Conditions (1) through (4) of this agreement; and"/>
																						</children>
																					</listrow>
																					<listrow>
																						<children>
