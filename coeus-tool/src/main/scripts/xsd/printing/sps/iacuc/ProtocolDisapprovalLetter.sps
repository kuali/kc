					...
					<template subtype="source" match="XML">
						<children>
												...
												<children>
													...
													<tgridrow>
														<children>
															...
															<tgridcell>
																<children>
																	<text fixtext="Protocol Disapproval Letter"/>
																</children>
															</tgridcell>
														</children>
													</tgridrow>
							...
							<paragraph paragraphtag="p">
								<styles text-align="left"/>
								<children>
									<text fixtext="Your protocol has been reviewed and recommendations have been made for revisions. Please revise your protocol and resubmit to the IACUC office. Your protocol will not be approved until all recommendations have been addressed."/>
								</children>
							</paragraph>
							<newline/>
