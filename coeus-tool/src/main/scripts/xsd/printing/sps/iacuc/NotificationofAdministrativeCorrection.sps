				...
				<children>
					...
					<template subtype="source" match="XML">
						<children>
												...
												<children>
													...
													<tgridrow>
														<children>
															...
															<tgridcell>
																<children>
																	<text fixtext="Notification Of Administrative Correction"/>
																</children>
															</tgridcell>
														</children>
													</tgridrow>
							...
							<newline/>
							<newline/>
							<text fixtext="                                   This is to inform that the above mentioned protocol had go through minor administrative correction."/>
							<newline/>
							<newline/>
							<newline/>
