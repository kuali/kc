					...
					<template subtype="source" match="XML">
						<children>
												...
												<children>
													...
													<tgridrow>
														<children>
															...
															<tgridcell>
																<children>
																	<text fixtext="Reviewer Assignment Notification"/>
																</children>
															</tgridcell>
														</children>
													</tgridrow>
							...
							<paragraph paragraphtag="p">
								<children>
									<text fixtext="The above mentioned protocol has been added. Please review and make any recommendations for revisions and submit them to the IACUC office. "/>
								</children>
							</paragraph>
							<paragraph paragraphtag="p">
								<children>
