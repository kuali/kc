...
<structure version="7" xsltversion="1" cssmode="strict" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="UTF-8" encodingpdf="UTF-8" embed-images="1">
	...
	<schemasources>
		...
		<schemasources>
			<xsdschemasource name="$XML" main="1" schemafile="D:\Coeus\4.4\Printing\iacuc\xmlspy project\iacuc.xsd" workingxmlfile="Y:\ele\Correspondence09202004-032207.xml">
				<xmltablesupport/>
				<textstateicons/>
			</xsdschemasource>
		</schemasources>
							...
							<template match="n1:Correspondence" matchtype="schemagraphitem">
								<children>
									...
									<paragraph>
										<styles font-family="Arial" font-size="10pt"/>
										<children>
											<text fixtext="The above-referenced protocol has been LIFT HOLD by the IACUC Committee.   ">
												<styles font-size="10pt"/>
											</text>
											<newline/>
											<newline/>
