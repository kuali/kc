												...
												<children>
													...
													<tgridrow>
														<children>
															...
															<tgridcell>
																<children>
																	<text fixtext="Termination Letter"/>
																</children>
															</tgridcell>
														</children>
													</tgridrow>
								...
								<children>
									...
									<template subtype="element" match="n1:Correspondence">
										<children>
											<template subtype="element" match="n1:Protocol">
												<children>
													<text fixtext=" has terminated as of "/>
													<template subtype="element" match="n1:Submissions">
														<children>
													...
													<text fixtext=". Studies being conducted on expired protocols shall be immediately terminated and animals involved in these studies removed from "/>
