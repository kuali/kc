				...
				<children>
					...
					<template subtype="source" match="XML">
						<children>
												...
												<children>
													...
													<tgridrow>
														<children>
															...
															<tgridcell>
																<children>
																	<text fixtext="Revision Required Reminder Notification"/>
																</children>
															</tgridcell>
														</children>
													</tgridrow>
							...
							<newline/>
							<newline/>
							<text fixtext="             This is to remind you that you have not yet responded to IACUC notification released on "/>
							<template subtype="element" match="n1:Correspondence">
								<children>
									<template subtype="element" match="n1:Protocol">
										<children>
