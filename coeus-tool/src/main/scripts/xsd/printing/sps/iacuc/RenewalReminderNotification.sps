					...
					<template subtype="source" match="XML">
						<children>
												...
												<children>
													...
													<tgridrow>
														...
														<children>
															...
															<tgridcell>
																<children>
																	<text fixtext="Renewal Reminder Notification"/>
																</children>
															</tgridcell>
														</children>
													</tgridrow>
							...
							<paragraph paragraphtag="p">
								<children>
									<text fixtext="Above mentioned protocol will be due for an Annual Review on –ANNUAL REVIEW DATE-. Please submit an annual report in sufficient time for the IACUC to review and approve the continuation by –ANNUAL REVIEW DATE-. The IACUC must suspend your approval to use animals if the annual report is not submitted and approved before –ANNUAL REVIEW DATE-."/>
								</children>
							</paragraph>
							<newline/>
							<paragraph paragraphtag="p">
								<children>
									<text fixtext="Please Note: Annual reviews cannot be approved unless all personnel named on the protocol are up to date with Module 1 training requirements."/>
								</children>
							</paragraph>
							<newline/>
							<paragraph paragraphtag="p">
