						...
						<children>
							...
							<template subtype="element" match="n1:Correspondence">
								<children>
												...
												<children>
													...
													<tgridrow>
														<children>
															...
															<tgridcell>
																<children>
																	<text fixtext="Adverse Event Notification"/>
																</children>
															</tgridcell>
														</children>
													</tgridrow>
									...
									<newline/>
									<newline/>
									<text fixtext="                                   This is to inform that this committee has reviewed  an unexpected adverse event that has reported by "/>
									<template subtype="element" match="n1:Protocol">
										<children>
											<template subtype="element" match="n1:ProtocolMasterData">
												<children>
