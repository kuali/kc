				...
				<children>
					...
					<template subtype="source" match="XML">
						<children>
												...
												<children>
														...
														<children>
															...
															<tgridcell>
																<children>
																	<template subtype="element" match="n1:Protocol">
																		<children>
																			<template subtype="element" match="n1:Organization">
																				<children>
																					<template subtype="element" match="n1:OrgName">
																						<children>
																							<content/>
																						</children>
																						<variables/>
													...
													<tgridrow>
														<children>
															...
															<tgridcell>
																<children>
																	<text fixtext="Adverse Event Reporting"/>
																</children>
															</tgridcell>
														</children>
													</tgridrow>
							...
							<newline/>
							<newline/>
							<text fixtext="                                 This is to inform you about an unexpected adverse event that had occurred in above mentioned protocol."/>
							<newline/>
							<newline/>
