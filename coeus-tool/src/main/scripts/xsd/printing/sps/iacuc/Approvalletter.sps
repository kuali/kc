								...
								<children>
									<paragraph>
										...
										<children>
											...
											<table>
												<properties border="0" width="100%"/>
												<styles font-family="Arial" table-layout="fixed"/>
												<children>
													<tablebody>
														<styles font-family="Arial"/>
														<children>
									...
									<condition>
										<children>
											<conditionbranch xpath="n1:Protocol/n1:Submissions/n1:CurrentSubmissionFlag = &apos;No&apos; and  n1:Protocol/n1:Submissions/n1:SubmissionDetails/n1:SubmissionTypeCode = 102">
												<children>
													<text fixtext="The amendment to the above-referenced protocol has been APPROVED following full board review by the IACUC Committee">
														<styles font-family="Arial" font-size="10pt"/>
													</text>
													<newline/>
													<newline/>
											...
											<conditionbranch xpath="n1:Protocol/n1:Submissions/n1:CurrentSubmissionFlag = &apos;No&apos; and  n1:Protocol/n1:Submissions/n1:SubmissionDetails/n1:SubmissionTypeCode = 101">
												<children>
													<text fixtext="The above-referenced protocol was given renewed approval following full board review by the Committee on the Use of Humans as Experimental Subjects (COUHES).">
														<styles font-family="Arial" font-size="10pt"/>
													</text>
											...
											<conditionbranch>
												<children>
													...
													<newline/>
													<newline/>
													<text fixtext="It is the Principal Investigator’s responsibility to obtain review and continued approval before the expiration date.  Please allow sufficient time for continued approval.  You may not continue any research activity beyond the expiration date without COUHES approval.  Failure to receive approval for continuation before the expiration date will result in the automatic suspension of the approval of this protocol.  Information">
														<styles font-family="Arial" font-size="10pt"/>
													</text>
													<text fixtext=" ">
									...
									<newline/>
									<newline/>
									<text fixtext="Amendments:  Any changes to the protocol that impact human subjects, including changes in experimental design, equipment, personnel or funding, must be approved by IACUC before they can be initiated. ">
										<styles font-family="Arial" font-size="10pt"/>
									</text>
									<newline/>
									<paragraph>
