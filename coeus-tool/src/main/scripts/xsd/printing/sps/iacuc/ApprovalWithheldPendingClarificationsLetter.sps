							...
							<template subtype="element" match="n1:Correspondence">
								<children>
									...
									<paragraph paragraphtag="p">
										<children>
											<text fixtext="Above referenced protocol has been reviewed and recommendations have been made for revisions. Please revise your protocol and resubmit to the IACUC office. Your protocol will not be approved until all recommendations have been addressed."/>
										</children>
									</paragraph>
								</children>
								<variables/>
