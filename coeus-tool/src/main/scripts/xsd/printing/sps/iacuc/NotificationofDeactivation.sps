								...
								<children>
									...
									<template subtype="element" match="n1:Correspondence">
										<children>
											<template subtype="element" match="n1:Protocol">
												<children>
													<text fixtext=" has deactivated as of "/>
													<template subtype="element" match="n1:Submissions">
														<children>
													...
													<text fixtext=" . Studies being conducted on expired protocols shall be immediately deactivated and animals involved in these studies removed from "/>
