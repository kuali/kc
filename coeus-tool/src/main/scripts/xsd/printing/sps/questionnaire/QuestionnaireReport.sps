									...
									<tablebody>
										<children>
											<tablerow>
												<children>
													<tablecell>
														<properties align="justify" nowrap="set" valign="top" width="120"/>
													...
													<tablecell>
														<properties colspan="3" width="719"/>
														<children>
														...
														<children>
															<tablerow>
																<children>
																	<tablecell>
																		...
																		<styles font-weight="bold" width="120pt"/>
																		<children>
																	...
																	<tablecell>
																		<properties nowrap="set" width="25%"/>
																		<styles font-weight="normal" width="180pt"/>
																		<children>
																			<template match="Questionnaire" matchtype="schemagraphitem">
																				<editorproperties elementstodisplay="1"/>
																				<children>
																	...
																	<tablecell>
																		...
																		<styles padding-left="70pt" text-align="left" width="180pt"/>
																		<children>
															...
															<tablerow>
																<children>
																	...
																	<tablecell>
																		<properties nowrap="set" width="20%"/>
																		<styles padding-left="70pt" width="180pt"/>
																		<children>
																			<text fixtext="Prinicipal Investigator:"/>
																		</children>
																	</tablecell>
																	<tablecell>
																		<properties nowrap="set" width="20%"/>
														...
														<children>
															<tablerow>
																<children>
																	...
																	<tablecell>
																		<properties nowrap="set" width="199"/>
																		<styles font-size="9pt" font-weight="bold" width="150pt"/>
																		<children>
