							...
							<template match="n1:Correspondence" matchtype="schemagraphitem">
								<children>
									...
									<paragraph>
										<styles font-family="Arial" font-size="10pt"/>
										<children>
											<text fixtext="The above-referenced protocol has been DEFERRED by the Committee on the Use of Humans as Experimental Subjects.   Reasons for the above Committee action are listed below.">
												<styles font-size="10pt"/>
											</text>
											<newline/>
											<newline/>
