															...
															<tablerow>
																<children>
																	...
																	<tablecell>
																		...
																		<styles font-family="Arial"/>
																		<children>
																			<text fixtext="Substantive Revisions Required">
																				<styles font-size="10pt" font-weight="bold"/>
																			</text>
																		</children>
																	</tablecell>
										...
										<children>
											<paragraph>
												<children>
													...
													<text fixtext=", the Committee On the Use of Humans as Experimental Subjects reviewed the above mentioned protocol and determined that substantive revisions are required. These revisions are noted below.  If you agree with all of the committee’s revisions, incorporate them in a revised protocol and/or consent form and submit it to the ">
														<styles font-family="Arial" font-size="10pt"/>
													</text>
													<template match="n1:Protocol" matchtype="schemagraphitem">
														<children>
													...
													<tablebody>
														<children>
															...
															<tablerow>
																<children>
																	<tablecell>
																		<properties height="32" width="47"/>
																	</tablecell>
																	<tablecell>
																		<properties height="32" valign="top" width="452"/>
																		<children>
																			<paragraph paragraphtag="pre-wrap">
																				<children>
																					<template match="n1:Protocol" matchtype="schemagraphitem">
