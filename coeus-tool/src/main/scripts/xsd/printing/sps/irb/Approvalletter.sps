						...
						<children>
							...
							<template match="n1:Correspondence" matchtype="schemagraphitem">
								<children>
									...
									<condition>
										<children>
											<conditionbranch xpath="n1:Protocol/n1:Submissions/n1:CurrentSubmissionFlag = &apos;No&apos; and  n1:Protocol/n1:Submissions/n1:SubmissionDetails/n1:SubmissionTypeCode = 102">
												<children>
													<text fixtext="The amendment to the above-referenced protocol has been APPROVED following full board review by the Committee on the Use of Humans as Experimental Subjects (COUHES).">
														<styles font-family="Arial" font-size="10pt"/>
													</text>
													<newline/>
													<newline/>
									...
									<newline/>
									<newline/>
									<text fixtext="Prospective new study personnel must, where applicable, complete training in human subjects research and in the HIPAA Privacy Rule before participating in the study.">
										<styles font-family="Arial" font-size="10pt"/>
									</text>
									<newline/>
									<newline/>
									<text fixtext="You must maintain a research file for at least 3 years after completion of the study.  This file should include all correspondence with COUHES, original signed consent forms, and study data.">
										<styles font-family="Arial" font-size="10pt"/>
									</text>
									<paragraph>
										<children>
