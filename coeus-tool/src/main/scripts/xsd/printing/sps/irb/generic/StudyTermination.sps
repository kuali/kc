...
<structure version="7" xsltversion="1" cssmode="strict" relativeto="*SPS" encodinghtml="UTF-8" encodingrtf="UTF-8" encodingpdf="UTF-8" embed-images="1">
	...
	<schemasources>
		...
		<schemasources>
			<xsdschemasource name="$XML" main="1" schemafile="D:\StyleVisionFiles\Correspondent templates\xmlpyproject\irb.xsd" workingxmlfile="C:\jakarta-tomcat-4.0.4\webapps\CoeusApplet\Reports\Correspondence05182004-100833.xml">
				<xmltablesupport/>
				<textstateicons/>
			</xsdschemasource>
		</schemasources>
															...
															<tablerow>
																<children>
																	...
																	<tablecell>
																		<properties width="451"/>
																		<children>
																			<text fixtext="Protocol Termination">
																				<styles font-size="10pt" font-weight="bold"/>
																			</text>
																		</children>
																	</tablecell>
										...
										<children>
											<paragraph paragraphtag="p">
												<children>
													...
													<paragraph>
														<children>
															<text fixtext="This is to notify you that the above protocol has been TERMINATED effective ">
																<styles font-size="10pt"/>
															</text>
															<template match="n1:CurrentDate" matchtype="schemagraphitem">
																<children>
															...
															<text fixtext=".  Data collected after the expiration date is considered unapproved research and cannot be included with data collected during an approved period.  Furthermore, data collected after termination of approval cannot be reported or published as research data.">
																<styles font-size="10pt"/>
															</text>
															<newline/>
															<newline/>
															<text fixtext="In accordance with University policy and federal regulations, you may NOT continue any further research efforts covered by this protocol.  If the study is sponsored with extramural funds, you should notify the sponsoring agency that this protocol is terminated.

If you wish to gather further research information, you must submit a new proposal for review by the Institutional Review Board.">
																<styles font-size="10pt"/>
															</text>
														</children>
													</paragraph>
