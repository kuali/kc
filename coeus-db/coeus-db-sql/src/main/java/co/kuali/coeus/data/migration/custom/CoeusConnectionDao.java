...
public class CoeusConnectionDao implements ConnectionDaoService {

	private Connection coeusConnection;
	private Connection riceConnection;
	
	public CoeusConnectionDao(Connection coeusConnection, Connection riceConnection) {
