...
insert into QUESTION_EXPLANATION (QUESTION_EXPLANATION_ID, QUESTION_REF_ID_FK, EXPLANATION_TYPE, EXPLANATION, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID) 
    VALUES (6173, (select question_ref_id from question where QUESTION = 'Have lobbying activities been conducted on behalf of this proposal?' and sequence_status = 'C'), 'N', 'I have not and will not lobby any federal agency on behalf of this proposal nor do I have any knowledge of anyone else doing so.', now(), 'admin', 1, uuid());
...
insert into QUESTION_EXPLANATION (QUESTION_EXPLANATION_ID, QUESTION_REF_ID_FK, EXPLANATION_TYPE, EXPLANATION, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID) 
    VALUES (6176, (select question_ref_id from question where QUESTION = 'Are you familiar with the requirements of the Procurement Liabilities Act?' and sequence_status = 'C'), 'A', 'I am familiar with the requirements of the Procurement Liabilities Act.', now(), 'admin', 1, uuid());

insert into QUESTION_EXPLANATION (QUESTION_EXPLANATION_ID, QUESTION_REF_ID_FK, EXPLANATION_TYPE, EXPLANATION, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID) 
    VALUES (6177, (select question_ref_id from question where QUESTION = 'Are you familiar with the requirements of the Procurement Liabilities Act?' and sequence_status = 'C'), 'N', 'I am not familiar with the requirements of the Procurement Liabilities Act.', now(), 'admin', 1, uuid());
