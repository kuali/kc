...
CREATE TABLE REVIEWER_ATTACHMENTS
   (REVIEWER_ATTACHMENT_ID DECIMAL(12) NOT NULL,
    PROTOCOL_ONLN_RVW_FK DECIMAL(12) NULL, 
    PROTOCOL_ID_FK DECIMAL(12) NOT NULL, 
    SUBMISSION_ID_FK DECIMAL(12) NOT NULL, 
    PERSON_ID        	VARCHAR(40) NOT NULL,
    ATTACHMENT_ID    	DECIMAL(3) NOT NULL,
    FILE_ID DECIMAL(12) NOT NULL,
    ...
    CREATE_USER VARCHAR(10) NOT NULL) ENGINE InnoDB CHARACTER SET utf8 COLLATE utf8_bin;
/
