...
VALUES (SEQ_NOTIFICATION_TYPE_ID.NEXTVAL, (SELECT NOTIFICATION_TYPE_ID FROM NOTIFICATION_TYPE WHERE DESCRIPTION = 'IACUC Submission Modified' and MODULE_CODE = (SELECT MODULE_CODE from COEUS_MODULE WHERE DESCRIPTION = 'IACUC Protocol')), 'KC-IACUC:PI', 'admin', SYSDATE, 1, SYS_GUID())
/
INSERT INTO NOTIFICATION_TYPE_RECIPIENT (NOTIFICATION_TYPE_RECIPIENT_ID, NOTIFICATION_TYPE_ID, ROLE_NAME, UPDATE_USER, UPDATE_TIMESTAMP, VER_NBR, OBJ_ID)
VALUES (SEQ_NOTIFICATION_TYPE_ID.NEXTVAL, (SELECT NOTIFICATION_TYPE_ID FROM NOTIFICATION_TYPE WHERE DESCRIPTION = 'IACUC Submission Modified' and MODULE_CODE = (SELECT MODULE_CODE from COEUS_MODULE WHERE DESCRIPTION = 'IACUC Protocol')), 'KC-UNT:IACUC Administrator', 'admin', SYSDATE, 1, SYS_GUID())
/
