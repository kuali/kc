...
UPDATE_USER,VER_NBR,OBJ_ID,DOCUMENT_NUMBER) values (SEQ_QUESTIONNAIRE_REF_ID.NEXTVAL, '123', 
((select MAX(SEQUENCE_NUMBER) from QUESTION where QUESTION_ID = '123') + 1), 
'C','Does this project have an actual or potential impact - positive or negative - on the environment?', 'A', '2', '1', null, null, null, '1','1',SYSDATE, 
...
291,0,'N','4',null,SYSDATE, 'admin',13,1,SYS_GUID(), 'KC149')
/
