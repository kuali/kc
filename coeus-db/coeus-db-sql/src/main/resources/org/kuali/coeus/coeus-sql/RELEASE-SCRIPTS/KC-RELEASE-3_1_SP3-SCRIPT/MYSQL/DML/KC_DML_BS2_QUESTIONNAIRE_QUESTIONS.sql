...
INSERT INTO QUESTIONNAIRE_QUESTIONS (QUESTIONNAIRE_QUESTIONS_ID, QUESTIONNAIRE_REF_ID_FK, QUESTION_REF_ID_FK, QUESTION_NUMBER, PARENT_QUESTION_NUMBER, CONDITION_FLAG, CONDITION_TYPE, CONDITION_VALUE, UPDATE_TIMESTAMP, UPDATE_USER, QUESTION_SEQ_NUMBER, VER_NBR, OBJ_ID) 
    VALUES (6118, (SELECT QUESTIONNAIRE_REF_ID FROM QUESTIONNAIRE WHERE NAME = 'Proposal Person Certification'), (SELECT QUESTION_REF_ID FROM QUESTION WHERE QUESTION = 'Are you familiar with the requirements of the Procurement Liabilities Act?'), 6, 0, 'N', NULL, NULL, NOW(), 'admin', 6, 1, UUID());
