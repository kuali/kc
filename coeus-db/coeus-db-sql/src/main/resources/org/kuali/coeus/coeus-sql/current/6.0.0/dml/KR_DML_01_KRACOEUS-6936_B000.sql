...
VALUES (CONCAT('KC', KRMS_FUNC_S.NEXTVAL),'checkProposalPersonIsPi','Check ProposalPerson is PI','java.lang.Boolean',1,'Y', 
...
VALUES (CONCAT('KC', KRMS_TERM_SPEC_S.NEXTVAL),'KC-PD',(select FUNC_ID from KRMS_FUNC_T where  NM='checkProposalPersonIsPi'and NMSPC_CD='KC-PD'), 
...
VALUES (CONCAT('KC', KRMS_TERM_RSLVR_S.NEXTVAL),'KC-PD','Check ProposalPerson is PI Resolver', 
...
VALUES (CONCAT('KC', KRMS_FUNC_PARM_S.NEXTVAL),'DevelopmentProposal','DevelopmentProposal','org.kuali.kra.proposaldevelopment.bo.DevelopmentProposal', 
...
INSERT INTO KRMS_FUNC_T (FUNC_ID,NM,DESC_TXT,RTRN_TYP,VER_NBR,ACTV,TYP_ID,NMSPC_CD) 
VALUES (CONCAT('KC', KRMS_FUNC_S.NEXTVAL),'checkProposalPersonIsCoi','Check ProposalPerson is CoInvestigator','java.lang.Boolean',1,'Y', 
(select TYP_ID from KRMS_TYP_T where NM='ProposalDevelopment Java Function Term Service' and NMSPC_CD='KC-PD'),'KC-PD')
/

INSERT INTO KRMS_TERM_SPEC_T (TERM_SPEC_ID, NMSPC_CD, NM, DESC_TXT, TYP, ACTV, VER_NBR) 
VALUES (CONCAT('KC', KRMS_TERM_SPEC_S.NEXTVAL),'KC-PD',(select FUNC_ID from KRMS_FUNC_T where  NM='checkProposalPersonIsCoi'and NMSPC_CD='KC-PD'), 
'Check ProposalPerson is CoInvestigator','java.lang.Boolean','Y',1)
/

INSERT INTO KRMS_TERM_T(TERM_ID,TERM_SPEC_ID,VER_NBR,DESC_TXT) 
VALUES (CONCAT('KC', KRMS_TERM_S.NEXTVAL),(select TERM_SPEC_ID from KRMS_TERM_SPEC_T where NMSPC_CD='KC-PD' and NM=(select FUNC_ID 
from KRMS_FUNC_T where  NM='checkProposalPersonIsCoi' and NMSPC_CD='KC-PD')), 1,'Check ProposalPerson is CoInvestigator')
/

INSERT INTO KRMS_CNTXT_VLD_TERM_SPEC_T (CNTXT_TERM_SPEC_PREREQ_ID, CNTXT_ID, TERM_SPEC_ID, PREREQ) 
VALUES (CONCAT('KC', KRMS_CNTXT_VLD_TERM_SPEC_S.NEXTVAL),'KC-PD-CONTEXT',(select TERM_SPEC_ID from KRMS_TERM_SPEC_T where 
...
INSERT INTO KRMS_TERM_RSLVR_T (TERM_RSLVR_ID, NMSPC_CD, NM, TYP_ID, OUTPUT_TERM_SPEC_ID, ACTV, VER_NBR) 
VALUES (CONCAT('KC', KRMS_TERM_RSLVR_S.NEXTVAL),'KC-PD','Check ProposalPerson is CoInvestigator Resolver', (select TYP_ID from KRMS_TYP_T where NM='Function Term Resolver Type Service' 
...
INSERT INTO KRMS_FUNC_T (FUNC_ID,NM,DESC_TXT,RTRN_TYP,VER_NBR,ACTV,TYP_ID,NMSPC_CD) 
VALUES (CONCAT('KC', KRMS_FUNC_S.NEXTVAL),'checkProposalPersonIsKeyPerson','Check ProposalPerson is KeyPerson','java.lang.Boolean',1,'Y', 
(select TYP_ID from KRMS_TYP_T where NM='ProposalDevelopment Java Function Term Service' and NMSPC_CD='KC-PD'),'KC-PD') 
/

INSERT INTO KRMS_TERM_SPEC_T (TERM_SPEC_ID, NMSPC_CD, NM, DESC_TXT, TYP, ACTV, VER_NBR) 
VALUES (CONCAT('KC', KRMS_TERM_SPEC_S.NEXTVAL),'KC-PD',(select FUNC_ID from KRMS_FUNC_T where  NM='checkProposalPersonIsKeyPerson'and NMSPC_CD='KC-PD'),
...
INSERT INTO KRMS_TERM_RSLVR_T (TERM_RSLVR_ID, NMSPC_CD, NM, TYP_ID, OUTPUT_TERM_SPEC_ID, ACTV, VER_NBR) 
VALUES (CONCAT('KC', KRMS_TERM_RSLVR_S.NEXTVAL),'KC-PD','Check ProposalPerson is KeyPerson Resolver', (select TYP_ID from KRMS_TYP_T where NM='Function Term Resolver Type Service' 
and NMSPC_CD='KC-KRMS'), (select TERM_SPEC_ID from KRMS_TERM_SPEC_T where NMSPC_CD='KC-PD' and NM=(select FUNC_ID from KRMS_FUNC_T where  NM='checkProposalPersonIsKeyPerson' and NMSPC_CD='KC-PD')), 'Y',1) 
/
