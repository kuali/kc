...
alter table PERSON_FIN_INT_DISCLOSURE add STUDENT_INVOLVEMENT VARCHAR2(4000)
/

alter table PERSON_FIN_INT_DISCLOSURE add STAFF_INVOLVEMENT VARCHAR2(4000)
/

alter table PERSON_FIN_INT_DISCLOSURE add FACILITY_USE VARCHAR2(4000)
/
