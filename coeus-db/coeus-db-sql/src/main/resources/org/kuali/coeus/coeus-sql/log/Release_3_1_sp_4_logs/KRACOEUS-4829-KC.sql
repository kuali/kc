CREATE TABLE EPS_PROP_PERSON_EXT  ( 
    ...
    PROP_PERSON_NUMBER		NUMBER(3,0) NOT NULL,
    ...
    CONSTRAINT EPS_PROP_PERSON_EXT_TP1 PRIMARY KEY(PROPOSAL_NUMBER, PROP_PERSON_NUMBER, PROP_PERSON_ROLE_ID)
	NOT DEFERRABLE
	 VALIDATE
)
/
...
/
ALTER TABLE EPS_PROP_PERSON_EXT MODIFY ( "PERSON_ID" VARCHAR2(40) NULL )
/
ALTER TABLE EPS_PROP_PERSON_EXT MODIFY ( "PROP_PERSON_NUMBER" NUMBER(12,0) )