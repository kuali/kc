...
INSERT INTO IACUC_PROTO_OLR_DT_REC_TYPE (REVIEW_DETERM_RECOM_CD,DESCRIPTION,UPDATE_TIMESTAMP,UPDATE_USER,VER_NBR,OBJ_ID,ASSOC_REVIEW_TYPE,IACUC_PROT_ACTION_TYPE)
       VALUES (22,'Table',SYSDATE(),'admin',1,UUID(),(SELECT PROTOCOL_REVIEW_TYPE_CODE FROM IACUC_PROTO_REVIEW_TYPE WHERE DESCRIPTION='Designated Member Review'),(SELECT PROTOCOL_ACTION_TYPE_CODE FROM IACUC_PROTOCOL_ACTION_TYPE WHERE DESCRIPTION='Tabled'))
/
INSERT INTO IACUC_PROTO_OLR_DT_REC_TYPE (REVIEW_DETERM_RECOM_CD,DESCRIPTION,UPDATE_TIMESTAMP,UPDATE_USER,VER_NBR,OBJ_ID,ASSOC_REVIEW_TYPE,IACUC_PROT_ACTION_TYPE)
...
/
INSERT INTO IACUC_PROTO_OLR_DT_REC_TYPE (REVIEW_DETERM_RECOM_CD,DESCRIPTION,UPDATE_TIMESTAMP,UPDATE_USER,VER_NBR,OBJ_ID,ASSOC_REVIEW_TYPE,IACUC_PROT_ACTION_TYPE)
       VALUES (25,'Return to PI',SYSDATE(),'admin',1,UUID(),(SELECT PROTOCOL_REVIEW_TYPE_CODE FROM IACUC_PROTO_REVIEW_TYPE WHERE DESCRIPTION='Designated Member Review'),(SELECT PROTOCOL_ACTION_TYPE_CODE FROM IACUC_PROTOCOL_ACTION_TYPE WHERE DESCRIPTION='Returned to PI'))
/
INSERT INTO IACUC_PROTO_OLR_DT_REC_TYPE (REVIEW_DETERM_RECOM_CD,DESCRIPTION,UPDATE_TIMESTAMP,UPDATE_USER,VER_NBR,OBJ_ID,ASSOC_REVIEW_TYPE,IACUC_PROT_ACTION_TYPE)
