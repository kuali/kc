...
Insert into SPONSOR_FORM_TEMPLATES (SPONSOR_CODE,PACKAGE_NUMBER,PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,FORM_TEMPLATE,UPDATE_TIMESTAMP,UPDATE_USER) values ('000500',1,1,'Cover Page','Cover Page.xslt','text/xml',EMPTY_CLOB(),sysdate,user);
