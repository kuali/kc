...
INSERT INTO KRCR_PARM_T (APPL_ID, nmspc_cd, CMPNT_CD,parm_nm,ver_nbr,parm_typ_cd,VAL,parm_desc_txt,EVAL_OPRTR_CD,obj_id)
   VALUES ('KC','KC-AWARD','Document','option.warning.error.award.FnA.validation',1,'CONFG','E','This parameter is used when paramater enable.award.FnA.validation = 2.If this parameter value = "W" then warning is given after validation and if value= "E" then error is given after validation.','A',SYS_GUID())
/
