...
INSERT INTO SPONSOR_FORM_TEMPLATES (SPONSOR_FORM_TEMPLATE_ID,SPONSOR_FORM_ID,PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,FORM_TEMPLATE,UPDATE_USER,UPDATE_TIMESTAMP,OBJ_ID,VER_NBR) 
    VALUES (SEQ_SPONSOR_FORM_TEMPLATES.NEXTVAL,(SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE PACKAGE_NAME = 'NIH 398 package (Coeus 4.0)'),14,'Checklist','Checklist.xslt','text/xml',EMPTY_CLOB(),'admin',SYSDATE,SYS_GUID(),1)
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE PACKAGE_NAME = 'NIH 398 package (Coeus 4.0)') AND PAGE_NUMBER = 14 FOR UPDATE;
...
../nih:ResearchCoverPage/ApplicationCategory/CategoryIdentifier  = &apos;Resubmission&apos;">
                                    ...
                                    <fo:table-row>
                                        <fo:table-cell number-columns-spanned="3" padding="';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
END;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
...
buffer := '-each select="nihInventions">
                            ...
                            <xsl:if test="count(nih:ResearchAndRelatedProject/Bu';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
END;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
                            ...
                            <fo:table font-size="8pt" table-layout="fixed" width="100%" border-spacing="2pt">
                                ...
                                <fo:table-body start-indent="0pt">
                                    ...
                                    <fo:table-row>
                                        ...
                                        <fo:table-cell font-family="Verdana" padding="2pt" text-align="right"';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
END;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
...
buffer := '             </fo:block>
                                    ...
                                    <fo:table-row>
                                        ...
                                        <fo:table-cell padding="2pt" text-align="left" display-align="center">
                                            <fo:block>
                                                <xsl:for-each select="nih:ResearchAn';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
END;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
                                                        ...
                                                        <xsl:for-each select="BudgetPeriod">
                                                            <xsl:for-each select="BudgetPeriodID">
                                                                <xsl:if test=". =1">
                                                                    <xsl:choose>
                                                                        <xsl:when test="string(.)=''true''">
                                                                            <fo:inline border="solid 1pt black" font-family="ZapfDingbats" font-s';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
END;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
                                                ...
                                                <xsl:if test="BudgetPeriod">
                                                    <fo:table font-size="8pt" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
                                                        ...
                                                        <fo:table-body start-indent="0pt">
                                                            <xsl:for-each select="BudgetPeriod">
                                                                <fo:table-row>
                                                                    <fo:table-cell font-family="Verdana" font-size="9pt" line-height="6pt" border="solid 1pt gray" padding="2pt" height="21" display';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
END;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
                                                                        ...
                                                                        <fo:block>
                                                                            ...
                                                                            <xsl:if test="ProgramIncomeDetails">
                                                                                <fo:table table-layout="fixed" width="100%" border-spacing="2pt">
                                                                                    <fo:table-column column-width="proportional-column-width(1)"/>
                                                                                    <fo:table-body start-indent="0pt">
                                                                                        <xsl:for-each select="ProgramIncome';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
END;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
                                                            ...
                                                            <fo:table-body start-indent="0pt">
                                                                <xsl:for-each select="IndirectCostDetails">
                                                                    <fo:table-row>
                                                                        ...
                                                                        <fo:table-cell font-family="Verdana" font-size="8pt" border="s';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
END;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
