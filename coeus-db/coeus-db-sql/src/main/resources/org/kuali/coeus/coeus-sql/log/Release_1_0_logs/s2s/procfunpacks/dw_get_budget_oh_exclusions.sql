create or replace procedure dw_get_budget_oh_exclusions
...
IF li_Count > 0 THEN
	...
	union
	select '2' sort_id, 'Employee Benefits on Allocated Administrative Support' description, sum(pcal.calculated_cost) cost
	from osp$budget_per_details_for_edi pd, 
