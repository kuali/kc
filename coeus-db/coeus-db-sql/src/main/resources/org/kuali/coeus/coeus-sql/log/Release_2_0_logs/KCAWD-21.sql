/* Drop old AWARD table */
DROP TABLE AWARD;

/* Drop AWARD1 and AWARD_DOCUMENT tables and SEQ_AWARD_AWARD_ID sequence so that AWARD1 can be replaced by AWARD table */
DROP TABLE AWARD1;
DROP TABLE AWARD_DOCUMENT;

DROP SEQUENCE SEQ_AWARD_AWARD_ID;
