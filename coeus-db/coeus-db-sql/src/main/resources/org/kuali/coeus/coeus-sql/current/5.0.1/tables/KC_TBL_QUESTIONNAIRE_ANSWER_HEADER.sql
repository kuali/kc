...
UPDATE QUESTIONNAIRE_ANSWER_HEADER HEAD SET 
  MODULE_ITEM_KEY = (SELECT COI_DISCLOSURE_ID FROM COI_DISCLOSURE DISC WHERE DISC.COI_DISCLOSURE_NUMBER = HEAD.MODULE_ITEM_KEY AND DISC.SEQUENCE_NUMBER = TO_NUMBER(HEAD.MODULE_SUB_ITEM_KEY)),
