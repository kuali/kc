...
VALUES ('KC-COIDISCLOSURE','Document','disclNotesAndAttachmentsHelp',SYS_GUID(),1,'HELP','default.htm?turl=Documents/notesattachmentsannualdisclosure.htm','Disclosure Notes and Attachments Help','A','KC')
/
...
INSERT INTO KRCR_PARM_T (nmspc_cd, cmpnt_cd, parm_nm, OBJ_ID, VER_NBR, parm_typ_cd, val, parm_desc_txt, eval_oprtr_cd, appl_id)
VALUES ('KC-COIDISCLOSURE','Document','disclDataValidationHelp',SYS_GUID(),1,'HELP','default.htm?turl=Documents/disclosuredatavalidationannualdisclosure.htm','Disclosure Data Validation Help','A','KC')
/
