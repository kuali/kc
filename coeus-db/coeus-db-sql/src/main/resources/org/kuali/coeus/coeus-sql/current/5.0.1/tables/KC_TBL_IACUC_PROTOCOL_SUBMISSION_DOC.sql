...
ALTER TABLE IACUC_PROTOCOL_SUBMISSION_DOC ADD SUBMISSION_DOC_ID NUMBER(12)
/
...
ALTER TABLE IACUC_PROTOCOL_SUBMISSION_DOC ADD PROTOCOL_ID NUMBER(12,0) NOT NULL
/

ALTER TABLE IACUC_PROTOCOL_SUBMISSION_DOC ADD SUBMISSION_ID_FK NUMBER(12,0) NOT NULL
/
