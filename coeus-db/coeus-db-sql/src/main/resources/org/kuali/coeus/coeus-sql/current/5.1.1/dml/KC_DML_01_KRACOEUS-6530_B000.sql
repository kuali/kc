...
insert into COI_DISPOSITION_STATUS (COI_DISPOSITION_CODE, COI_DISCLOSURE_STATUS_CODE, DESCRIPTION, DISPLAY_TO_REPORTER, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID)
	values (209, '3', 'Project Level Approval', 'N', SYSDATE, 'admin', 1, SYS_GUID())
/

insert into COI_DISPOSITION_STATUS (COI_DISPOSITION_CODE, COI_DISCLOSURE_STATUS_CODE, DESCRIPTION, DISPLAY_TO_REPORTER, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID)
	values (305, '2', 'Awaiting Additional Information', 'N', SYSDATE, 'admin', 1, SYS_GUID())
/

insert into COI_DISPOSITION_STATUS (COI_DISPOSITION_CODE, COI_DISCLOSURE_STATUS_CODE, DESCRIPTION, DISPLAY_TO_REPORTER, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID)
	values (310, '2', 'Potential Relationship', 'Y', SYSDATE, 'admin', 1, SYS_GUID())
/

insert into COI_DISPOSITION_STATUS (COI_DISPOSITION_CODE, COI_DISCLOSURE_STATUS_CODE, DESCRIPTION, DISPLAY_TO_REPORTER, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID)
	values (320, '2', 'Relationship Identified', 'Y', SYSDATE, 'admin', 1, SYS_GUID())
/

insert into COI_DISPOSITION_STATUS (COI_DISPOSITION_CODE, COI_DISCLOSURE_STATUS_CODE, DESCRIPTION, DISPLAY_TO_REPORTER, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID)
	values (325, '2', 'Reviewer Identified Conflict', 'N', SYSDATE, 'admin', 1, SYS_GUID())
/

insert into COI_DISPOSITION_STATUS (COI_DISPOSITION_CODE, COI_DISCLOSURE_STATUS_CODE, DESCRIPTION, DISPLAY_TO_REPORTER, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID)
	values (330, '4', 'Unresolved', 'N', SYSDATE, 'admin', 1, SYS_GUID())
/
