...
/
INSERT INTO S2S_ERROR (S2S_ERROR_ID, MESSAGE_KEY, MESSAGE, FIX_LINK, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID)
VALUES ((SELECT (MAX(ID)) FROM SEQ_S2S_ERROR_ID), '/GrantApplication/Forms/RR_PerformanceSite/OtherSite/Address/Country', 'Country code is missing for one of the performance sites', 'proposal.Organization/Location',NOW(),'admin',1,UUID())
/
...
/
INSERT INTO S2S_ERROR (S2S_ERROR_ID, MESSAGE_KEY, MESSAGE, FIX_LINK, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID)
VALUES ((SELECT (MAX(ID)) FROM SEQ_S2S_ERROR_ID), '/GrantApplication/Forms/RR_SF424/EstimatedProjectFunding/TotalEstimatedAmount', 'Total estimated amount is missing -Please provide a budget', 'budgetVersions',NOW(),'admin',1,UUID())
/
...
/
INSERT INTO S2S_ERROR (S2S_ERROR_ID, MESSAGE_KEY, MESSAGE, FIX_LINK, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID)
VALUES ((SELECT (MAX(ID)) FROM SEQ_S2S_ERROR_ID), '/GrantApplication/Forms/RR_SF424/EstimatedProjectFunding/TotalfedNonfedrequested', 'Total requested funding is missing - Please provide a budget', 'budgetVersions',NOW(),'admin',1,UUID())
/
...
/
INSERT INTO S2S_ERROR (S2S_ERROR_ID, MESSAGE_KEY, MESSAGE, FIX_LINK, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID)
VALUES ((SELECT (MAX(ID)) FROM SEQ_S2S_ERROR_ID), '/GrantApplication/Forms/RR_SF424/EstimatedProjectFunding/EstimatedProgramIncome', 'Program Income is missing - Please provide a budget', 'budgetVersions',NOW(),'admin',1,UUID())
/
...
/
INSERT INTO S2S_ERROR (S2S_ERROR_ID, MESSAGE_KEY, MESSAGE, FIX_LINK, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID)
VALUES ((SELECT (MAX(ID)) FROM SEQ_S2S_ERROR_ID), '/GrantApplication/Forms/RR_SF424/PDPIContactInfo', 'PDPI contact info missing', 'keyPersonnel',NOW(),'admin',1,UUID())
/
...
/
INSERT INTO S2S_ERROR (S2S_ERROR_ID, MESSAGE_KEY, MESSAGE, FIX_LINK, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID)
VALUES ((SELECT (MAX(ID)) FROM SEQ_S2S_ERROR_ID), '/GrantApplication/Forms/RR_KeyPerson/KeyPerson/Profile/BioSketchsAttached', 'Each investigator and key person must have a BioSketch.  Upload the PDF on the Proposal Personnel screen, with "BIOSKETCH" as the description.', 'abstractsAttachments',NOW(),'admin',1,UUID())
/
...
/
INSERT INTO S2S_ERROR (S2S_ERROR_ID, MESSAGE_KEY, MESSAGE, FIX_LINK, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID)
VALUES ((SELECT (MAX(ID)) FROM SEQ_S2S_ERROR_ID), '/GrantApplication/Forms/RR_OtherProjectInfo/OtherAttachments', 'You must have an at least one Narrative with the proposal.', 'abstractsAttachments',NOW(),'admin',1,UUID())
/
...
/
INSERT INTO S2S_ERROR (S2S_ERROR_ID, MESSAGE_KEY, MESSAGE, FIX_LINK, UPDATE_TIMESTAMP, UPDATE_USER, VER_NBR, OBJ_ID)
VALUES ((SELECT (MAX(ID)) FROM SEQ_S2S_ERROR_ID), '/GrantApplication/Forms/RR_OtherProjectInfo/EnvironmentalImpact/EnvironmentalExemption/EnvironmentalExemptionExplanation', 'Please explain the Environmental Exemption question for this form within the Questions tab.', 'questions',NOW(),'admin',1,UUID())
/
