...
INSERT INTO SUBAWARD_FORMS(FORM_ID,DESCRIPTION,UPDATE_TIMESTAMP,UPDATE_USER,FORM,FILE_NAME,CONTENT_TYPE,VER_NBR,OBJ_ID,TEMPLATE_TYPE_CODE) values ('FDP Modification','FDP Modification',now(),'admin',
'<?xml version="1.0" encoding="UTF-8"?>
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:award="http://subcontractFdpReports.bean.xml.utils.coeus.mit.edu/award" xmlns:subcontract="http://subcontractFdpReports.bean.xml.utils.coeus.mit.edu/subcontract" xmlns:fo="http://www.w3.org/1999/XSL/Format">
<xsl:output version="1.0" method="xml" encoding="UTF-8" indent="no"/>
<xsl:param name="SV_OutputFormat" select="''PDF''"/>
...
','FDP_Modification_Template.xsl','application/octet-stream',1,UUID(),4);
...
','AFOSR Attachment.xsl','application/octet-stream',1,UUID(),2);
...
','AMRMC Attachment.xsl','application/octet-stream',1,UUID(),2);
...
','ARO Attachment.xsl','application/octet-stream',1,UUID(),2);
...
','FDP Attachment 3B.xsl','application/octet-stream',1,UUID(),3);
...
','FDP Attachment 3BPage2.xsl','application/octet-stream',1,UUID(),3);
...
','DOE Attachment.xsl','application/octet-stream',1,UUID(),2);
...
','EPA Attachment.xsl','application/octet-stream',1,UUID(),2);
...
','NSF Attachment.xsl','application/octet-stream',1,UUID(),2);
...
','ONR Attachment.xsl','application/octet-stream',1,UUID(),2);
...
','USDA Attachment.xsl','application/octet-stream',1,UUID(),2);