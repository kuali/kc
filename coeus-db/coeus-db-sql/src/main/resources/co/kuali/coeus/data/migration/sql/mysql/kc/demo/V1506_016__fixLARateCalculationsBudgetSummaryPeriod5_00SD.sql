...
</xsl:stylesheet>' where PAGE_DESCRIPTION = 'Budget Summary Period 5' and SPONSOR_FORM_ID = (select sponsor_form_id from sponsor_forms where package_name= 'Generic Printing Forms (Coeus 4.x)');
