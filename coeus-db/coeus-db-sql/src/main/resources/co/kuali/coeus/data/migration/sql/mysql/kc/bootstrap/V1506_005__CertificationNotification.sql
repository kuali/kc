...
ALTER TABLE EPS_PROP_PERSON ADD CERTIFIED_BY VARCHAR(60);

ALTER TABLE EPS_PROP_PERSON ADD LAST_NOTIFICATION DATETIME;

ALTER TABLE EPS_PROP_PERSON ADD CERTIFIED_TIME DATETIME;