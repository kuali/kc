...
values ('KC-T','All','TM_POST_ENABLED',SYS_GUID(),1,'CONFG','false',
...
INSERT INTO KRIM_PERM_T (PERM_ID,PERM_TMPL_ID,NMSPC_CD,NM,DESC_TXT,ACTV_IND,OBJ_ID,VER_NBR)
    ...
    'KC-SYS','Post Time and Money','Post Time and Money information to the account table.','Y',SYS_GUID(),1);

insert into KRIM_ROLE_PERM_T values ('RES-BOOT1003', SYS_GUID(), 1,
(select ROLE_ID from KRIM_ROLE_T where ROLE_NM = 'KC Superuser'),
'RES-BOOT1002', 'Y');

insert into KRIM_ROLE_PERM_T values ('RES-BOOT1004', SYS_GUID(), 1,
