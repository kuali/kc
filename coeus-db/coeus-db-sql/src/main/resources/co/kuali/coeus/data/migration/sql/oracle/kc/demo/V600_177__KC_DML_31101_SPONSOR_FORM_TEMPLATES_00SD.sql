...
INSERT INTO SPONSOR_FORM_TEMPLATES (SPONSOR_FORM_TEMPLATE_ID,SPONSOR_FORM_ID,PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,FORM_TEMPLATE,UPDATE_USER,UPDATE_TIMESTAMP,OBJ_ID,VER_NBR) 
	VALUES (SEQ_SPONSOR_FORM_TEMPLATES.NEXTVAL,(SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5),11,'Key Personnel report','Key Personnel report.xslt','text/xml',EMPTY_CLOB(),'admin',SYSDATE,SYS_GUID(),1);
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 11 FOR UPDATE;
...
/
INSERT INTO SPONSOR_FORM_TEMPLATES (SPONSOR_FORM_TEMPLATE_ID,SPONSOR_FORM_ID,PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,FORM_TEMPLATE,UPDATE_USER,UPDATE_TIMESTAMP,OBJ_ID,VER_NBR) 
	VALUES (SEQ_SPONSOR_FORM_TEMPLATES.NEXTVAL,(SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5),12,'Detailed Budget Period 1','Detailed Budget Period 1.xslt','text/xml',EMPTY_CLOB(),'admin',SYSDATE,SYS_GUID(),1);
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 12 FOR UPDATE;
buffer := '<?xml version="1.0" encoding="UTF-8"?>
<!--Designed and generated by Altova StyleVision Enterprise Edition 2008 rel. 2 - see http://www.altova.com/stylevision for more information.-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:common="http://era.nih.gov/Projectmgmt/SBIR/CGAP/common.namespace" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:nih="http://era.nih.gov/Projectmgmt/SBIR/CGAP/nihspecific.namespace" xmlns:phs398="http://era.nih.gov/Projectmgmt/SBIR/CGAP/phs398.namespace" xmlns:rar="http://era.nih.gov/Projectmgmt/SBIR/CGAP/researchandrelated.namespace" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	<xsl:output version="1.0" method="xml" encoding="UTF-8" indent="no"/>
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 12 FOR UPDATE;
buffer := 'st="count(nih:ResearchAndRelatedProject/BudgetSummary/BudgetPeriod[BudgetPeriodID=1]/SalariesAndWages/Name ) &lt; 8">
										<xsl:for-each select="nih:ResearchAndRelatedProject">
											<xsl:for-each select="BudgetSummary">
																		...
																		<fo:table-row>
																			...
																			<fo:table-cell border-top-style="none" line-height="9pt" number-rows-spanned="2" border="solid 1pt gray" padding="5" text-align="left" display-align="before">
																				<fo:block>
																					...
																					<fo:table table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
																						<fo:table-column column-width="proportional-colum';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
...
buffer := '								<xsl:choose>
									...
									<xsl:if test="count(nih:ResearchA';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 12 FOR UPDATE;
buffer := 'ndRelatedProject/BudgetSummary/BudgetPeriod[BudgetPeriodID=1]/SalariesAndWages/Name ) &gt;=8">
										<fo:inline-container>
											<fo:block>
												<xsl:text>&#x2029;</xsl:text>
											</fo:block>
										...
										<fo:table line-height="20pt" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="-1pt">
											...
											<fo:table-body start-indent="0pt">
												...
												<fo:table-row>
													...
													<fo:table-cell border-top-style="none" ';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 12 FOR UPDATE;
buffer := 'font-family="Verdana" font-size="8pt" border="solid 1pt gray" padding="0" display-align="center">
														<fo:block>
															<fo:inline>
																<xsl:text>INST.</xsl:text>
															</fo:inline>
												...
												<fo:table-row>
													...
													<fo:table-cell font-family="Verdana" font-size="8pt" border="solid 1pt gray';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 12 FOR UPDATE;
buffer := '" padding="0" display-align="center">
														<fo:block/>
													</fo:table-cell>
													<fo:table-cell font-family="Verdana" font-size="8pt" border="solid 1pt gray" padding="0" display-align="center">
														<fo:block/>
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 12 FOR UPDATE;
buffer := 'y="Verdana" font-size="8pt">
															<xsl:text>)&#160; </xsl:text>
														</fo:inline>
														<xsl:for-each select="nih:ResearchAndRelatedProject">
															<xsl:for-each select="BudgetSummary">
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 12 FOR UPDATE;
buffer := 'py-of select="$value-of-template"/>
																							</fo:block>
																						</xsl:when>
																						<xsl:otherwise>
																							<fo:inline>
													...
													<fo:block>
														<xsl:for-each select="nih:ResearchAndRelatedProject">
															<xsl:for-each select="BudgetSummary">
																<xsl:for-each select="BudgetPeriod">
																	<xsl:if test="BudgetPeriodID=1">
																		<xsl:for-each select="rar:OtherDi';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
...
buffer := 'rectCosts">
											...
											<fo:table-row>
												<fo:table-cell font-family="Verdana" font-size="8pt" number-columns-spanned="2" border="solid 1pt gray" padding="5" text-align="le';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 12 FOR UPDATE;
buffer := 'ft" display-align="center">
													<fo:block>
														<fo:inline>
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 12 FOR UPDATE;
buffer := 'ach select="ConsortiumCosts">
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 12 FOR UPDATE;
buffer := '"Verdana" font-size="8pt" border="solid 1pt gray" padding="5" text-align="center" display-align="center">
																			<fo:block>
																				<xsl:for-each select="SummerFundingMonths">
																					<xsl:variable name="value-of-template">
																						<xsl:apply-templates/>
...
/
INSERT INTO SPONSOR_FORM_TEMPLATES (SPONSOR_FORM_TEMPLATE_ID,SPONSOR_FORM_ID,PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,FORM_TEMPLATE,UPDATE_USER,UPDATE_TIMESTAMP,OBJ_ID,VER_NBR) 
	VALUES (SEQ_SPONSOR_FORM_TEMPLATES.NEXTVAL,(SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5),13,'Budget Entire Proposed Period','Budget Entire Proposed Period.xslt','text/xml',EMPTY_CLOB(),'admin',SYSDATE,SYS_GUID(),1);
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 13 FOR UPDATE;
buffer := '<?xml version="1.0" encoding="UTF-8"?>
<!--Designed and generated by Altova StyleVision Enterprise Edition 2008 rel. 2 - see http://www.altova.com/stylevision for more information.-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:common="http://era.nih.gov/Projectmgmt/SBIR/CGAP/common.namespace" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:nih="http://era.nih.gov/Projectmgmt/SBIR/CGAP/nihspecific.namespace" xmlns:phs398="http://era.nih.gov/Projectmgmt/SBIR/CGAP/phs398.namespace" xmlns:rar="http://era.nih.gov/Projectmgmt/SBIR/CGAP/researchandrelated.namespace" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	<xsl:output version="1.0" method="xml" encoding="UTF-8" indent="no"/>
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 13 FOR UPDATE;
buffer := '<fo:table-cell number-rows-spanned="2" border="solid 1pt gray" padding="2pt" height="17" text-align="center" display-align="center">
											<fo:block>
												<fo:inline font-size="8pt">
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 13 FOR UPDATE;
buffer := '						<xsl:value-of select="format-number(number(string(.)), ''#,###,###,##0'')"/>
																	</fo:inline>
																</xsl:if>
															</xsl:for-each>
														</xsl:for-each>
...
buffer := '														</xsl:for-each>
									...
									<fo:table-row>
										...
										<fo:table-cell font-size="8pt" border="solid 1pt gray" padding="2pt" height="15" text-align="right" display-align="center">
											<fo:block>
												<xsl:for-each select="nih:ResearchAnd';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
...
/
INSERT INTO SPONSOR_FORM_TEMPLATES (SPONSOR_FORM_TEMPLATE_ID,SPONSOR_FORM_ID,PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,FORM_TEMPLATE,UPDATE_USER,UPDATE_TIMESTAMP,OBJ_ID,VER_NBR) 
	VALUES (SEQ_SPONSOR_FORM_TEMPLATES.NEXTVAL,(SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5),14,'checklist','checklist.xslt','text/xml',EMPTY_CLOB(),'admin',SYSDATE,SYS_GUID(),1);
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 14 FOR UPDATE;
buffer := '<?xml version="1.0" encoding="UTF-8"?>
<!--Designed and generated by Altova StyleVision Enterprise Edition 2008 rel. 2 - see http://www.altova.com/stylevision for more information.-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:common="http://era.nih.gov/Projectmgmt/SBIR/CGAP/common.namespace" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:nih="http://era.nih.gov/Projectmgmt/SBIR/CGAP/nihspecific.namespace" xmlns:phs398="http://era.nih.gov/Projectmgmt/SBIR/CGAP/phs398.namespace" xmlns:rar="http://era.nih.gov/Projectmgmt/SBIR/CGAP/researchandrelated.namespace" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	<xsl:output version="1.0" method="xml" encoding="UTF-8" indent="no"/>
										...
										<fo:table-cell number-columns-spanned="3" padding="2pt" display-align="center">
											<fo:block>
												<xsl:choose>
													...
													<xsl:when test="nih:ResearchAndRelatedProject/nih:ResearchCoverPage/Applicat';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 14 FOR UPDATE;
buffer := 'ionCategory/CategoryIdentifier =&apos;New&apos;">
										...
										<fo:table-cell font-family="Verdana" font-size="8pt" number-columns-spanned="2" padding="2pt" display-align="before">
											<fo:block>
												...
												<fo:block font-family="Verdana" font-size="8pt" margin="0pt">
													<fo:block>
														<fo:inline>
															<xsl:text>In signing the application Face Page, the authorized organizational representative agrees to comply with the policies, assurances and/or certifications listed in ';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 14 FOR UPDATE;
buffer := 'the application instructions when applicable. Descriptions of individual assurances/certifications are provided in Part III and listed in Part 1, 4.1 under Item 14.&#160; If unable to certify compliance, where applicable, provide an explanation and place it after this page.</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:block>
									...
									<fo:table-row>
										<fo:table-cell number-columns-spanned="3" padding="2pt" display-align="center">
											<fo:block>
												...
												<xsl:choose>
													<xsl:when test="nih:ResearchAndRelatedProject/BudgetSummary/IndirectCostRateDetails/DHHSAgreementNegotiation';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
								...
								<fo:table-body start-indent="0pt">
									...
									<fo:table-row>
										...
										<fo:table-cell font-family="Verdana" padding="2pt" text-align="left" display-align="center">
											<fo:block>
												<xsl:for-each select="nih:ResearchAndR';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 14 FOR UPDATE;
buffer := 'ostDetails/CostType =&apos;MTDC&apos;">
																	<xsl:choose>
																		<xsl:when test="string(.)=''true''">
																			<fo:inline border="solid 1pt black" font-family="ZapfDingbats" font-size="10pt ">
																				<xsl:text>&#x2714;</xsl:text>
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 14 FOR UPDATE;
buffer := '								<fo:table-cell font-family="Verdana" font-size="9pt" line-height="6pt" border="solid 1pt gray" padding="2pt" height="21" display-align="before">
																		<fo:block>
																			<xsl:for-each select="BudgetPeriodID">
																				<xsl:variable name="value-of-template">
																					<xsl:apply-templates/>
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 14 FOR UPDATE;
buffer := '-each select="nih:ResearchAndRelatedProject">
										<xsl:for-each select="BudgetSummary">
											<xsl:for-each select="BudgetPeriod">
												<xsl:if test="BudgetPeriodID =2">
													<fo:inline-container>
													...
													<xsl:if test="IndirectCostDetails">
														<fo:table table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
															...
															<fo:table-body start-indent="0pt">
																<xsl:for-each select="IndirectCostDetails">
																	<fo:table-row>
																		<fo:table-cell font-family="Verdana" font-size="8pt" bo';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 14 FOR UPDATE;
buffer := 'rder="solid 1pt gray" padding="2pt" display-align="center">
																			<fo:block>
																				<xsl:for-each select="BaseAmount">
																					<fo:inline>
																						<xsl:text>$</xsl:text>
													...
													<xsl:if test="IndirectCostDetails">
														<fo:table table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
															...
															<fo:table-header start-indent="0pt">
																...
																<fo:table-row>
																	<fo:table-cell font-family="Verdana" font-size="8pt" border="solid 1pt gray" padding="2pt" ';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
...
/
INSERT INTO SPONSOR_FORM_TEMPLATES (SPONSOR_FORM_TEMPLATE_ID,SPONSOR_FORM_ID,PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,FORM_TEMPLATE,UPDATE_USER,UPDATE_TIMESTAMP,OBJ_ID,VER_NBR) 
	VALUES (SEQ_SPONSOR_FORM_TEMPLATES.NEXTVAL,(SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5),17,'Resources','Resources.xslt','text/xml',EMPTY_CLOB(),'admin',SYSDATE,SYS_GUID(),1);
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS 
WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 17 FOR UPDATE;
buffer := '<?xml version="1.0" encoding="UTF-8"?>
<!--Designed and generated by Altova StyleVision Enterprise Edition 2008 rel. 2 - see http://www.altova.com/stylevision for more information.-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:common="http://era.nih.gov/Projectmgmt/SBIR/CGAP/common.namespace" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:nih="http://era.nih.gov/Projectmgmt/SBIR/CGAP/nihspecific.namespace" xmlns:phs398="http://era.nih.gov/Projectmgmt/SBIR/CGAP/phs398.namespace" xmlns:rar="http://era.nih.gov/Projectmgmt/SBIR/CGAP/researchandrelated.namespace" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	<xsl:output version="1.0" method="xml" encoding="UTF-8" indent="no"/>
										...
										<fo:table-cell number-columns-spanned="3" padding="0" text-align="center" display-align="before">
											<fo:block>
												...
												<fo:block margin="0pt">
													<fo:block>
														<fo:block text-align="center">
															<fo:leader leader-pattern="rule" rule-thicknes';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 17 FOR UPDATE;
buffer := 's="1" leader-length="100%" color="black"/>
														</fo:block>
													</fo:block>
												</fo:block>
											</fo:block>
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 17 FOR UPDATE;
buffer := 'ring-length(nih:ResearchAndRelatedProject/Abstract [AbstractTypeCode = 7]/AbstractText ) &lt;= 0"/>
												<xsl:for-each select="nih:ResearchAndRelatedProject">
													<xsl:for-each select="Abstract">
														<xsl:for-each select="AbstractText">
									...
									<fo:table-row>
										<fo:table-cell padding-bottom="0pt" padding-top="6pt" number-columns-spanned="3" padding';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 17 FOR UPDATE;
buffer := 'white-space="pre" white-space-collapse="false" margin="0pt">
																	<fo:block>
																		<xsl:variable name="value-of-template">
																			<xsl:apply-templates/>
																		</xsl:variable>
...
buffer := 'xsl:copy-of select="$value-of-template"/>
	...
	<xsl:template name="double-backslash">
		...
		<xsl:param name="text-length"/>
		<xsl:variable name="text-after-bs" select="substring-after($text, ''\'')"/>
		<xsl:variable name="text-after-bs-length" select="string-length($text-aft';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
...
/
INSERT INTO SPONSOR_FORM_TEMPLATES (SPONSOR_FORM_TEMPLATE_ID,SPONSOR_FORM_ID,PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,FORM_TEMPLATE,UPDATE_USER,UPDATE_TIMESTAMP,OBJ_ID,VER_NBR) 
	VALUES (SEQ_SPONSOR_FORM_TEMPLATES.NEXTVAL,(SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5),18,'Table Of Contents','Table Of Contents.xslt','text/xml',EMPTY_CLOB(),'admin',SYSDATE,SYS_GUID(),1);
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS 
WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 18 FOR UPDATE;
buffer := '<?xml version="1.0" encoding="UTF-8"?>
...
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 18 FOR UPDATE;
...
/
INSERT INTO SPONSOR_FORM_TEMPLATES (SPONSOR_FORM_TEMPLATE_ID,SPONSOR_FORM_ID,PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,FORM_TEMPLATE,UPDATE_USER,UPDATE_TIMESTAMP,OBJ_ID,VER_NBR) 
	VALUES (SEQ_SPONSOR_FORM_TEMPLATES.NEXTVAL,(SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5),7,'facepage','facepage.xslt','text/xml',EMPTY_CLOB(),'admin',SYSDATE,SYS_GUID(),1);
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS 
WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 7 FOR UPDATE;
buffer := '<?xml version="1.0" encoding="UTF-8"?>
<!--Designed and generated by Altova StyleVision Enterprise Edition 2008 rel. 2 - see http://www.altova.com/stylevision for more information.-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:common="http://era.nih.gov/Projectmgmt/SBIR/CGAP/common.namespace" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:nih="http://era.nih.gov/Projectmgmt/SBIR/CGAP/nihspecific.namespace" xmlns:phs398="http://era.nih.gov/Projectmgmt/SBIR/CGAP/phs398.namespace" xmlns:rar="http://era.nih.gov/Projectmgmt/SBIR/CGAP/researchandrelated.namespace" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	<xsl:output version="1.0" method="xml" encoding="UTF-8" indent="no"/>
									...
									<fo:table-row>
										<fo:table-cell line-height="9pt" padding-top="6" number-columns-spanned="4" border="solid 1pt gray" padding="0" height="25" text-align="center" display-align="before">
											<fo:block>
												...
												<fo:block margin-left="(100% - 100%) div 2" margin-right="(100% - 100%) div 2" margin';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 7 FOR UPDATE;
buffer := '="0pt">
													<fo:block>
														<fo:inline font-family="Verdana" font-size="9pt">
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 7 FOR UPDATE;
buffer := 'able-cell line-height="9pt" number-columns-spanned="7" border="solid 1pt gray" padding="0" height="35" text-align="left" display-align="center">
											<fo:block>
												<fo:inline font-family="Verdana" font-size="8pt">
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 7 FOR UPDATE;
buffer := ' number and title) </xsl:text>
														</fo:inline>
													</fo:block>
												</fo:block>
												<fo:block/>
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 7 FOR UPDATE;
buffer := 'le-cell font-family="Verdana" font-size="8pt" line-height="9pt" border="solid 1pt gray" padding="0" text-align="left" display-align="before">
											<fo:block>
												<fo:inline font-family="Verdana" font-size="8pt">
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 7 FOR UPDATE;
buffer := 'alue-of select="nih:ResearchAndRelatedProject/KeyPerson[1]/PositionTitle"/>
														</fo:inline>
													</fo:block>
												</fo:block>
											</fo:block>
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 7 FOR UPDATE;
buffer := ':inline font-weight="bold">
																	<xsl:text>&#160;</xsl:text>
																</fo:inline>
																<fo:inline font-family="Verdana" font-size="8pt" font-weight="normal">
																	<xsl:text>Yes</xsl:text>
										...
										<fo:table-cell font-size="8pt" line-height="9pt" number-columns-spanned="4" border="solid 1pt gray" padding="0" text-align="left" display-align="before">
											<fo:block>
												...
												<xsl:choose>
													...
													<xsl:when test="nih:ResearchAndRelatedProject/nih:ProjectDes';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 7 FOR UPDATE;
buffer := 'cription/rar:AnimalSubject/VertebrateAnimalsUsedQuestion   = &apos;false&apos;">
														<fo:inline>
															<xsl:text>&#160; </xsl:text>
														</fo:inline>
														<fo:inline font-family="Verdana" font-size="8pt">
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 7 FOR UPDATE;
buffer := '-family="Verdana" font-size="8pt">
														<xsl:text>&#160;</xsl:text>
													</fo:inline>
													<fo:inline font-family="ZapfDingbats" font-size="10pt " width="19px">				
														           <xsl:text>&#x2714;</xsl:text>
...
or nih:ResearchAndRelatedProject/nih:ResearchCoverPage/ApplicantOrganization/OrganizationClassification/CategoryCode =9">
														...
														<xsl:if test="nih:ResearchAndRelatedProject/nih:ResearchCoverPage/ApplicantOrganization/OrganizationClassification/CategoryCode = 11">
															<fo:inline font-family="Verdana" font-';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 7 FOR UPDATE;
buffer := '11. ENTITY IDENTIFICATION NUMBER: </xsl:text>
												</fo:inline>
												<xsl:for-each select="nih:ResearchAndRelatedProject">
													<xsl:for-each select="nih:ResearchCoverPage">
														<xsl:for-each select="ApplicantOrganization">
											...
											<fo:block>
												...
												<fo:block line-height="9pt" margin="0pt">
													<fo:block>
														...
														<xsl:for-each select="nih:ResearchAndRelatedPr';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 7 FOR UPDATE;
buffer := 't-family="Verdana" font-size="9pt">
																						<xsl:copy-of select="$value-of-template"/>
																					</fo:block>
																				</xsl:when>
																				<xsl:otherwise>
...
/
INSERT INTO SPONSOR_FORM_TEMPLATES (SPONSOR_FORM_TEMPLATE_ID,SPONSOR_FORM_ID,PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,FORM_TEMPLATE,UPDATE_USER,UPDATE_TIMESTAMP,OBJ_ID,VER_NBR) 
	VALUES (SEQ_SPONSOR_FORM_TEMPLATES.NEXTVAL,(SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5),8,'face page continued','face page continued.xslt','text/xml',EMPTY_CLOB(),'admin',SYSDATE,SYS_GUID(),1);
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS 
WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 8 FOR UPDATE;
buffer := '<?xml version="1.0" encoding="UTF-8"?>
<!--Designed and generated by Altova StyleVision Enterprise Edition 2008 rel. 2 - see http://www.altova.com/stylevision for more information.-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:common="http://era.nih.gov/Projectmgmt/SBIR/CGAP/common.namespace" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:nih="http://era.nih.gov/Projectmgmt/SBIR/CGAP/nihspecific.namespace" xmlns:phs398="http://era.nih.gov/Projectmgmt/SBIR/CGAP/phs398.namespace" xmlns:rar="http://era.nih.gov/Projectmgmt/SBIR/CGAP/researchandrelated.namespace" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	<xsl:output version="1.0" method="xml" encoding="UTF-8" indent="no"/>
...
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 8 FOR UPDATE;
buffer := '"8pt">
																		<xsl:text>, </xsl:text>
																	</fo:inline>
																	<xsl:for-each select="FirstName">
															...
															<xsl:if test="keyPersonFlag/keyPersonFlagDesc = &apos;PI&apos;">
																<xsl:for-each select="Name">
																	<xsl:for-each select="LastName">
																		...
																		<xsl:choose>
																			<xsl:when test="contains(string($valu';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
...
buffer := 'e-of-template),''&#x2029;'')">
													...
													<fo:table-cell font-family="Verdana" font-size="8pt" line-height="9pt" border=';
DBMS_LOB.writeappend(data,LENGTH(buffer),buffer);
end;
/
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 8 FOR UPDATE;
buffer := '"solid 1pt gray" padding="2pt" text-align="left" display-align="before">
														<fo:block>
															<fo:inline>
																<xsl:text>3h. eRA Commons User Name</xsl:text>
															</fo:inline>
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 8 FOR UPDATE;
buffer := 'mily="Traditional Arabic" font-size="8pt">
							<fo:table-cell padding="0" number-columns-spanned="2" height="30" display-align="center">
								<fo:block>
									<fo:inline>
...
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 8 FOR UPDATE;
buffer := 'oncat(substring($text,1,$text-length - 1), ''\\'')"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="$text"/>
					</xsl:otherwise>
...
/
INSERT INTO SPONSOR_FORM_TEMPLATES (SPONSOR_FORM_TEMPLATE_ID,SPONSOR_FORM_ID,PAGE_NUMBER,PAGE_DESCRIPTION,FILE_NAME,CONTENT_TYPE,FORM_TEMPLATE,UPDATE_USER,UPDATE_TIMESTAMP,OBJ_ID,VER_NBR) 
	VALUES (SEQ_SPONSOR_FORM_TEMPLATES.NEXTVAL,(SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5),9,'Page 2-Performance Sites Key Personnel','Page 2-Performance Sites Key Personnel.xslt','text/xml',EMPTY_CLOB(),'admin',SYSDATE,SYS_GUID(),1);
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS 
WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 9 FOR UPDATE;
buffer := '<?xml version="1.0" encoding="UTF-8"?>
<!--Designed and generated by Altova StyleVision Enterprise Edition 2008 rel. 2 - see http://www.altova.com/stylevision for more information.-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:common="http://era.nih.gov/Projectmgmt/SBIR/CGAP/common.namespace" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:nih="http://era.nih.gov/Projectmgmt/SBIR/CGAP/nihspecific.namespace" xmlns:phs398="http://era.nih.gov/Projectmgmt/SBIR/CGAP/phs398.namespace" xmlns:rar="http://era.nih.gov/Projectmgmt/SBIR/CGAP/researchandrelated.namespace" xmlns:xdt="http://www.w3.org/2005/xpath-datatypes" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format">
	<xsl:output version="1.0" method="xml" encoding="UTF-8" indent="no"/>
...
DECLARE    data CLOB; buffer VARCHAR2(30000);
BEGIN
SELECT FORM_TEMPLATE INTO data FROM SPONSOR_FORM_TEMPLATES WHERE SPONSOR_FORM_ID = (SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE SPONSOR_CODE='000340' and PACKAGE_NUMBER=5) AND PAGE_NUMBER = 9 FOR UPDATE;
buffer := '-size="8pt">
															<xsl:copy-of select="$value-of-template"/>
														</fo:block>
													</xsl:when>
