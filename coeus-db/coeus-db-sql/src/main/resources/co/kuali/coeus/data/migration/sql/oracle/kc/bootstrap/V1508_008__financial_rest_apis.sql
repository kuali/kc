...
INSERT INTO KRCR_PARM_T(NMSPC_CD,CMPNT_CD,PARM_NM,OBJ_ID,VER_NBR,PARM_TYP_CD,VAL,PARM_DESC_TXT,EVAL_OPRTR_CD,APPL_ID)
VALUES ('KC-AWARD','All','DISPLAY_ACCOUNT_BALANCES',SYS_GUID(),1,'CONFG','false','This parameter is used to determine if the account balances for an account should show up in the aaward.','A','KC');
