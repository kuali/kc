...
VALUES ((SELECT (MAX(ID)) FROM SEQ_SPONSOR_FORM_TEMPLATES),(SELECT SPONSOR_FORM_ID FROM SPONSOR_FORMS WHERE PACKAGE_NAME = 'NSF forms (Coeus 4.0)'),3,'Budget Summary Period 2','Budget Summary Period 2.xslt','text/xml',
...
<xsl:value-of select="format-number(sum( n1:ResearchAndRelatedProject/BudgetSummary/BudgetPeriod[BudgetPeriodID=2]/NSFSeniorPersonnel/FundsRequested )+
sum( n1:ResearchAndRelatedProject/BudgetSummary/BudgetPeriod[BudgetPeriodID=2]/NSFOtherPersonnel/PostDocFunds ) +
sum( n1:ResearchAndRelatedProject/BudgetSummary/BudgetPeriod[BudgetPeriodID=2]/NSFOtherPersonnel/OtherProfFunds ) +
sum( n1:ResearchAndRelatedProject/BudgetSummary/BudgetPeriod[BudgetPeriodID=2]/NSFOtherPersonnel/GradFunds ) +
sum( n1:ResearchAndRelatedProject/BudgetSummary/BudgetPeriod[BudgetPeriodID=2]/NSFOtherPersonnel/UnderGradFunds ) +
