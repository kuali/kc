...
public class AwardUpdateUserDaoImpl extends AbstractUpdateUserDao {
    ...
    private static final String AWARD_DOCUMENT_UPDATE_SQL = "update award_document u set u.update_user = ? where u.document_number = ? and u.update_user = 'kr'";
    ...
    private static final String AWARD_UPDATE_SQL = "update award u set u.update_user = ? where u.document_number = ? and u.update_user = 'kr'";
    ...
    private static final String AWARD_COMMENT_UPDATE_SQL = "update AWARD_COMMENT t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_FUNDING_PROPOSALS_UPDATE_SQL = "update AWARD_FUNDING_PROPOSALS t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_PERSONS_UPDATE_SQL = "update AWARD_PERSONS t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_PERSON_UNITS_UPDATE_SQL = "update AWARD_PERSON_UNITS t set t.update_user = ? where t.AWARD_PERSON_ID = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_PERSON_CREDIT_SPLITS_UPDATE_SQL = "update AWARD_PERSON_CREDIT_SPLITS t set t.update_user = ? where t.AWARD_PERSON_ID = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_PERS_UNIT_CRED_SPLITS_UPDATE_SQL = "update AWARD_PERS_UNIT_CRED_SPLITS t set t.update_user = ? where t.AWARD_PERSON_UNIT_ID = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_COST_SHARE_UPDATE_SQL = "update AWARD_COST_SHARE t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_IDC_RATE_UPDATE_SQL = "update AWARD_IDC_RATE t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_REPORT_TERMS_UPDATE_SQL = "update AWARD_REPORT_TERMS t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_REP_TERMS_RECNT_UPDATE_SQL = "update AWARD_REP_TERMS_RECNT t set t.update_user = ? where t.AWARD_REPORT_TERMS_ID = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_APPROVED_SUBAWARDS_UPDATE_SQL = "update AWARD_APPROVED_SUBAWARDS t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_APPROVED_EQUIPMENT_UPDATE_SQL = "update AWARD_APPROVED_EQUIPMENT t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_APPROVED_FOREIGN_TRAVEL_UPDATE_SQL = "update AWARD_APPROVED_FOREIGN_TRAVEL t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_SCIENCE_KEYWORD_UPDATE_SQL = "update AWARD_SCIENCE_KEYWORD t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_SPECIAL_REVIEW_UPDATE_SQL = "update AWARD_SPECIAL_REVIEW t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_EXEMPT_NUMBER_UPDATE_SQL = "update AWARD_EXEMPT_NUMBER t set t.update_user = ? where t.AWARD_SPECIAL_REVIEW_ID = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_SPONSOR_TERM_UPDATE_SQL = "update AWARD_SPONSOR_TERM t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_PAYMENT_SCHEDULE_UPDATE_SQL = "update AWARD_PAYMENT_SCHEDULE t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_TRANSFERRING_SPONSOR_UPDATE_SQL = "update AWARD_TRANSFERRING_SPONSOR t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_AMT_FNA_DISTRIBUTION_UPDATE_SQL = "update AWARD_AMT_FNA_DISTRIBUTION t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_AMOUNT_INFO_UPDATE_SQL = "update AWARD_AMOUNT_INFO t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_UNIT_CONTACTS_UPDATE_SQL = "update AWARD_UNIT_CONTACTS t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_SPONSOR_CONTACTS_UPDATE_SQL = "update AWARD_SPONSOR_CONTACTS t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_CUSTOM_DATA_UPDATE_SQL = "update AWARD_CUSTOM_DATA t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_CLOSEOUT_UPDATE_SQL = "update AWARD_CLOSEOUT t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_NOTEPAD_UPDATE_SQL = "update AWARD_NOTEPAD t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_ATTACHMENT_UPDATE_SQL = "update AWARD_ATTACHMENT t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String ATTACHMENT_FILE_UPDATE_SQL = "update attachment_file t set t.update_user = ? where t.file_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_SYNC_CHANGE_UPDATE_SQL = "update AWARD_SYNC_CHANGE t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_CGB_UPDATE_SQL = "update AWARD_CGB t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    ...
    private static final String BUDGET_DOCUMENT_UPDATE_SQL = "update BUDGET_DOCUMENT u set u.update_user = ? where u.document_number = ? and u.update_user = 'kr'";
    ...
    private static final String AWARD_BUDGET_EXT_UPDATE_SQL = "update AWARD_BUDGET_EXT u set u.update_user = ? where u.document_number = ? and u.update_user = 'kr'";
    ...
    private static final String BUDGET_UPDATE_SQL = "update BUDGET t set t.update_user = ? where t.budget_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_BUDGET_PERIOD_EXT_UPDATE_SQL = "update AWARD_BUDGET_PERIOD_EXT t set t.update_user = ? where t.BUDGET_PERIOD_NUMBER = ? and t.update_user = 'kr'";
    ...
    private static final String BUDGET_PERIODS_UPDATE_SQL = "update BUDGET_PERIODS t set t.update_user = ? where t.BUDGET_PERIOD_NUMBER = ? and t.update_user = 'kr'";
    ...
    private static final String EPS_PROP_RATES_UPDATE_SQL = "update EPS_PROP_RATES t set t.update_user = ? where t.budget_id = ? and t.update_user = 'kr'";
    ...
    private static final String EPS_PROP_LA_RATES_UPDATE_SQL = "update EPS_PROP_LA_RATES t set t.update_user = ? where t.budget_id = ? and t.update_user = 'kr'";
    ...
    private static final String BUDGET_PERSONS_UPDATE_SQL = "update BUDGET_PERSONS t set t.update_user = ? where t.budget_id = ? and t.update_user = 'kr'";
    ...
    private static final String BUDGET_PERSON_SALARY_DETAILS_UPDATE_SQL = "update BUDGET_PERSON_SALARY_DETAILS t set t.update_user = ? where t.BUDGET_PERSON_SALARY_DETAIL_ID = ? and t.update_user = 'kr'";
    ...
    private static final String EPS_PROP_COST_SHARING_UPDATE_SQL = "update EPS_PROP_COST_SHARING t set t.update_user = ? where t.budget_id = ? and t.update_user = 'kr'";
    ...
    private static final String BUDGET_PROJECT_INCOME_UPDATE_SQL = "update BUDGET_PROJECT_INCOME t set t.update_user = ? where t.budget_id = ? and t.update_user = 'kr'";
    ...
    private static final String EPS_PROP_IDC_RATE_UPDATE_SQL = "update EPS_PROP_IDC_RATE t set t.update_user = ? where t.budget_id = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_BUDGET_DETAILS_EXT_UPDATE_SQL = "update AWARD_BUDGET_DETAILS_EXT t set t.update_user = ? where t.BUDGET_DETAILS_ID = ? and t.update_user = 'kr'";
    ...
    private static final String BUDGET_DETAILS_UPDATE_SQL = "update BUDGET_DETAILS t set t.update_user = ? where t.BUDGET_DETAILS_ID = ? and t.update_user = 'kr'";
    ...
    private static final String BUDGET_RATE_AND_BASE_UPDATE_SQL = "update BUDGET_RATE_AND_BASE t set t.update_user = ? where t.budget_id = ? and t.update_user = 'kr'";
    ...
    private static final String BUD_FORMULATED_COST_DETAIL_UPDATE_SQL = "update BUD_FORMULATED_COST_DETAIL t set t.update_user = ? where t.BUDGET_DETAILS_ID = ? and t.update_user = 'kr'";
    ...
    private static final String AWD_BGT_DET_CAL_AMTS_EXT_UPDATE_SQL = "update AWD_BGT_DET_CAL_AMTS_EXT t set t.update_user = ? where t.BUDGET_DETAILS_CAL_AMTS_ID = ? and t.update_user = 'kr'";
    ...
    private static final String BUDGET_DETAILS_CAL_AMTS_UPDATE_SQL = "update BUDGET_DETAILS_CAL_AMTS t set t.update_user = ? where t.BUDGET_DETAILS_CAL_AMTS_ID = ? and t.update_user = 'kr'";
    ...
    private static final String AWD_BUDGET_PER_DET_EXT_UPDATE_SQL = "update AWD_BUDGET_PER_DET_EXT t set t.update_user = ? where t.BUDGET_PERSONNEL_DETAILS_ID = ? and t.update_user = 'kr'";
    ...
    private static final String BUDGET_PERSONNEL_DETAILS_UPDATE_SQL = "update BUDGET_PERSONNEL_DETAILS t set t.update_user = ? where t.BUDGET_PERSONNEL_DETAILS_ID = ? and t.update_user = 'kr'";
    ...
    private static final String AWD_BUDGET_PER_CAL_AMTS_EXT_UPDATE_SQL = "update AWD_BUDGET_PER_CAL_AMTS_EXT t set t.update_user = ? where t.BUDGET_PERSONNEL_CAL_AMTS_ID = ? and t.update_user = 'kr'";
    ...
    private static final String BUDGET_PERSONNEL_CAL_AMTS_UPDATE_SQL = "update BUDGET_PERSONNEL_CAL_AMTS t set t.update_user = ? where t.BUDGET_PERSONNEL_CAL_AMTS_ID = ? and t.update_user = 'kr'";
    ...
    private static final String AWD_BGT_PER_SUM_CALC_AMT_UPDATE_SQL = "update AWD_BGT_PER_SUM_CALC_AMT t set t.update_user = ? where t.BUDGET_PERIOD_ID = ? and t.update_user = 'kr'";
    ...
    private static final String AWARD_BUDGET_LIMIT_AWARD_UPDATE_SQL = "update AWARD_BUDGET_LIMIT t set t.update_user = ? where t.award_id = ? and t.update_user = 'kr'";
    private static final String AWARD_BUDGET_LIMIT_BUDGET_UPDATE_SQL = "update AWARD_BUDGET_LIMIT t set t.update_user = ? where t.budget_id = ? and t.update_user = 'kr'";
    ...
    private static final String DOCUMENT_NEXTVALUE_AD_UPDATE_SQL = "update DOCUMENT_NEXTVALUE t set t.update_user = ? where t.DOCUMENT_NUMBER = ? and t.update_user = 'kr'";
    ...
    private static final String DOCUMENT_NEXTVALUE_BD_UPDATE_SQL = "update DOCUMENT_NEXTVALUE t set t.update_user = ? where t.DOCUMENT_NUMBER = ? and t.update_user = 'kr'";
