...
public class InstitutionalProposalUpdateUserDaoImpl extends AbstractUpdateUserDao {
    ...
    private static final String INSTITUTE_PROPOSAL_DOCUMENT_UPDATE_SQL = "update INSTITUTE_PROPOSAL_DOCUMENT u set u.update_user = ? where u.document_number = ?";
    ...
    private static final String INSTITUTE_PROPOSAL_UPDATE_SQL = "update PROPOSAL u set u.update_user = ? where u.document_number = ?";
    ...
    private static final String PROPOSAL_IP_REVIEW_JOIN_UPDATE_SQL = "update PROPOSAL_IP_REVIEW_JOIN t set t.update_user = ? where t.PROPOSAL_ID = ?";
    ...
    private static final String IP_REVIEW_UPDATE_SQL = "update IP_REVIEW t set t.update_user = ? where t.IP_REVIEW_ID = ?";
    ...
    private static final String PROPOSAL_IP_REV_ACTIVITY_UPDATE_SQL = "update PROPOSAL_IP_REV_ACTIVITY t set t.update_user = ? where t.IP_REVIEW_ID = ?";
    ...
    private static final String PROPOSAL_UNIT_CONTACTS_UPDATE_SQL = "update PROPOSAL_UNIT_CONTACTS t set t.update_user = ? where t.PROPOSAL_ID = ?";
    ...
    private static final String PROPOSAL_COST_SHARING_UPDATE_SQL = "update PROPOSAL_COST_SHARING t set t.update_user = ? where t.PROPOSAL_ID = ?";
    ...
    private static final String PROPOSAL_IDC_RATE_UPDATE_SQL = "update PROPOSAL_IDC_RATE t set t.update_user = ? where t.PROPOSAL_ID = ?";
    ...
    private static final String PROPOSAL_CUSTOM_DATA_UPDATE_SQL = "update PROPOSAL_CUSTOM_DATA t set t.update_user = ? where t.PROPOSAL_ID = ?";
    ...
    private static final String PROPOSAL_NOTEPAD_UPDATE_SQL = "update PROPOSAL_NOTEPAD t set t.update_user = ? where t.PROPOSAL_ID = ?";
    ...
    private static final String PROPOSAL_SCIENCE_KEYWORD_UPDATE_SQL = "update PROPOSAL_SCIENCE_KEYWORD t set t.update_user = ? where t.PROPOSAL_ID = ?";
    ...
    private static final String PROPOSAL_SPECIAL_REVIEW_UPDATE_SQL = "update PROPOSAL_SPECIAL_REVIEW t set t.update_user = ? where t.PROPOSAL_ID = ?";
    ...
    private static final String PROPOSAL_EXEMPT_NUMBER_UPDATE_SQL = "update PROPOSAL_EXEMPT_NUMBER t set t.update_user = ? where t.PROPOSAL_SPECIAL_REVIEW_ID = ?";
    ...
    private static final String PROPOSAL_PERSONS_REVIEW_UPDATE_SQL = "update PROPOSAL_PERSONS t set t.update_user = ? where t.PROPOSAL_ID = ?";
    ...
    private static final String PROPOSAL_PERSON_UNITS_UPDATE_SQL = "update PROPOSAL_PERSON_UNITS t set t.update_user = ? where t.PROPOSAL_PERSON_ID = ?";
    ...
    private static final String PROPOSAL_PERS_UNIT_CRED_SPLITS_UPDATE_SQL = "update PROPOSAL_PERS_UNIT_CRED_SPLITS t set t.update_user = ? where t.PROPOSAL_PERSON_UNIT_ID = ?";
    ...
    private static final String PROPOSAL_PER_CREDIT_SPLIT_UPDATE_SQL = "update PROPOSAL_PER_CREDIT_SPLIT t set t.update_user = ? where t.PROPOSAL_PERSON_ID = ?";
    ...
    private static final String PROPOSAL_COMMENTS_UPDATE_SQL = "update PROPOSAL_COMMENTS t set t.update_user = ? where t.PROPOSAL_ID = ?";
    ...
    private static final String PROPOSAL_ATTACHMENTS_UPDATE_SQL = "update PROPOSAL_ATTACHMENTS t set t.update_user = ? where t.PROPOSAL_ID = ?";
