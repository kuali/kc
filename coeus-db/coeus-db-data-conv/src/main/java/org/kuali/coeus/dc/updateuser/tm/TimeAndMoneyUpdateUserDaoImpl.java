...
public class TimeAndMoneyUpdateUserDaoImpl extends AbstractUpdateUserDao {
    ...
    private static final String TIME_AND_MONEY_DOCUMENT_UPDATE_SQL = "update TIME_AND_MONEY_DOCUMENT u set u.update_user = ? where u.document_number = ? and u.update_user = 'kr'";
    ...
    private static final String AWARD_AMOUNT_TRANSACTION_UPDATE_SQL = "update AWARD_AMOUNT_TRANSACTION u set u.update_user = ? where u.TRANSACTION_ID = ? and u.update_user = 'kr'";
