...
public class SubawardUpdateUserDaoImpl extends AbstractUpdateUserDao {
    ...
    private static final String SUBAWARD_DOCUMENT_UPDATE_SQL = "update SUBAWARD_DOCUMENT u set u.update_user = ? where u.document_number = ?";
    ...
    private static final String SUBAWARD_UPDATE_SQL = "update SUBAWARD u set u.update_user = ? where u.document_number = ?";
    ...
    private static final String SUBAWARD_FUNDING_SOURCE_UPDATE_SQL = "update SUBAWARD_FUNDING_SOURCE u set u.update_user = ? where u.SUBAWARD_ID = ?";
    ...
    private static final String SUBAWARD_AMOUNT_INFO_UPDATE_SQL = "update SUBAWARD_AMOUNT_INFO u set u.update_user = ? where u.SUBAWARD_ID = ?";
    ...
    private static final String SUBAWARD_CONTACT_UPDATE_SQL = "update SUBAWARD_CONTACT u set u.update_user = ? where u.SUBAWARD_ID = ?";
    ...
    private static final String SUBAWARD_CLOSEOUT_UPDATE_SQL = "update SUBAWARD_CLOSEOUT u set u.update_user = ? where u.SUBAWARD_ID = ?";
    ...
    private static final String SUBAWARD_CUSTOM_DATA_UPDATE_SQL = "update SUBAWARD_CUSTOM_DATA u set u.update_user = ? where u.SUBAWARD_ID = ?";
    ...
    private static final String SUBAWARD_ATTACHMENTS_UPDATE_SQL = "update SUBAWARD_ATTACHMENTS u set u.update_user = ? where u.SUBAWARD_ID = ?";
    ...
    private static final String SUBAWARD_REPORTS_UPDATE_SQL = "update SUBAWARD_REPORTS u set u.update_user = ? where u.SUBAWARD_ID = ?";
    ...
    private static final String SUBAWARD_TEMPLATE_INFO_UPDATE_SQL = "update SUBAWARD_TEMPLATE_INFO u set u.update_user = ? where u.SUBAWARD_ID = ?";
