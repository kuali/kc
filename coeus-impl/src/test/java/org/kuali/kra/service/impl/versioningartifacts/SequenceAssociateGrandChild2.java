 ...
 */
public class SequenceAssociateGrandChild2 implements SequenceAssociate<OwnerAssociate> {
    private static final long serialVersionUID = -7334498072241996364L;
    
    private Long grandChildId;
    private OwnerAssociate owner;
    private SequenceAssociateChild2 parent;
    private String name;
    private Integer sequenceNumber;
        
    public SequenceAssociateGrandChild2(String name) {
        this.name = name;
     ...
     */
    public SequenceAssociateChild2 getParent() {
        return parent;
    }
     ...
     */
    public void setParent(SequenceAssociateChild2 parent) {
        this.parent = parent;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof SequenceAssociateGrandChild2)) {
            return false;
        }
        SequenceAssociateGrandChild2 other = (SequenceAssociateGrandChild2) obj;
        if (name == null) {
            if (other.name != null) {
                return false;
            }
