...
/**
 * BUKC-0002: ARRA Code field  on Award Module under Award Tab  on Panel Detail&dates under sub panel Project.
 */
public class ARRAValuesFinder extends UifKeyValuesFinderBase {
