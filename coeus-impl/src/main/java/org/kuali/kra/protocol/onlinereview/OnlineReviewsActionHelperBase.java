...
public abstract class OnlineReviewsActionHelperBase implements Serializable {
    ...
    public void init(boolean force) {
        if (!initComplete || force) {
            ...
            if (currentSubmission != null) {
                ...
                // Resetting to null, will be initialized in getters
                this.protocolOnlineReviewDocuments = null;
                this.reviewAttachmentsBeans = null;
                this.reviewCommentsBeans = null;
                this.documentHelperMap = null;
    ...
    private List<String> getReviewerIds(List<ProtocolOnlineReviewDocumentBase> protocolOnlineReviewDocuments) {
    ...
    public List<ProtocolOnlineReviewDocumentBase> getProtocolOnlineReviewsForCurrentSubmission() {
        return getProtocolOnlineReviewDocuments();
    }
    ...
    public List<ProtocolOnlineReviewDocumentBase> getProtocolOnlineReviewDocuments() {
        if (protocolOnlineReviewDocuments == null) {
    ...
    private void initDocumentHelperMap() {
        documentHelperMap = new LinkedHashMap<String, Map<String, Object>>();
        List<ProtocolOnlineReviewDocumentBase> protocolOnlineReviewDocuments = getProtocolOnlineReviewDocuments();
        List<String> reviewerIds = getReviewerIds(protocolOnlineReviewDocuments);
        for (ProtocolOnlineReviewDocumentBase pDoc : protocolOnlineReviewDocuments) {
    ...
    public long getIndexByDocumentNumber(String documentNumber) {
        ...
        return getProtocolOnlineReviewDocuments().indexOf(document);
    }
    ...
    public int getDocumentIndexByReviewer(String personId, boolean nonEmployeeFlag) {
        int idx = 0;
        for (ProtocolOnlineReviewDocumentBase reviewDocument : getProtocolOnlineReviewDocuments()) {
    ...
    public List<ReviewAttachmentsBeanBase> getReviewAttachmentsBeans() {
        if (reviewAttachmentsBeans == null) {
            initReviewAttachmentsBeans();
        }
