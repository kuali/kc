...
public final class KeyConstants {
   ...
   // Grants.gov System Parameters
    ...
    public static final String ERROR_QUESTION_DISPLAYED_ANSWERS_INVALID_CHECKBOXES = "error.question.displayed.answers.invalid.checkboxes";
    public static final String ERROR_QUESTION_DISPLAYED_ANSWERS_INVALID_CHECKBOXES_TEXT = "error.question.displayed.answers.invalid.checkboxes.text";
