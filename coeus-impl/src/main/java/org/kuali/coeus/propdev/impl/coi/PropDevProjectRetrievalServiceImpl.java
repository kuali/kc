...
public class PropDevProjectRetrievalServiceImpl extends AbstractProjectRetrievalService {
    ...
    private static final String PD_ALL_PROJECT_PERSON_QUERY = "SELECT t.PROPOSAL_NUMBER, t.PERSON_ID, t.ROLODEX_ID, u.PROP_PERSON_ROLE_CODE FROM EPS_PROP_PERSON t INNER JOIN EPS_PROP_PERSON_ROLE u ON t.PROP_PERSON_ROLE_ID = u.PROP_PERSON_ROLE_ID";
