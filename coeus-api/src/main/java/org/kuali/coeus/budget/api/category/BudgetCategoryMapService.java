...
public interface BudgetCategoryMapService {
    ...
    /**
     * Finds the {@link BudgetCategoryMapContract}s by targetCategoryCode and mappingName.  Will return an empty
    ...
    /**
     * Finds the {@link BudgetCategoryMappingContract}s by targetCategoryCode and mappingName.  Will return an empty
     * List if no items exist.
     * @param targetCategoryCode the target category code.  Cannot be blank.
     * @param mappingName the mapping name.  Cannot be blank.
