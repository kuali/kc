<?xml version="1.0" encoding="UTF-8"?><!-- $Revision:   1.10  $ -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:globLib="http://apply.grants.gov/system/GlobalLibrary-V1.0"
 xmlns:att="http://apply.grants.gov/system/Attachments-V1.0"
 xmlns:glob="http://apply.grants.gov/system/Global-V1.0"
 xmlns:PHS398_Checklist="http://apply.grants.gov/forms/PHS398_Checklist-V1.0">
      ...
      <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:footer="http://apply.grants.gov/system/Footer-V1.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:globLib="http://apply.grants.gov/system/GlobalLibrary-V1.0" xmlns:att="http://apply.grants.gov/system/Attachments-V1.0" xmlns:glob="http://apply.grants.gov/system/Global-V1.0">
         ...
         <fo:page-sequence master-reference="default-page" format="1" initial-page-number="1">
            ...
            <fo:flow flow-name="xsl-region-body"><!--Data components-->
               ...
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="21.212121212121215px" hyphenate="true" language="en" keep-together="always" top="240.60606060606062px" height="15.757575757575758px" width="287.2727272727273px">
               ...
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="33.333333333333336px" hyphenate="true" language="en" keep-together="always" top="538.1818181818182px" height="13.333333333333334px" width="90.27272727272728px">
               ...
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="33.333333333333336px" hyphenate="true" language="en" keep-together="always" top="564.8484848484849px" height="13.333333333333334px" width="197.5757575757576px">
...
source(s).  Otherwise, leave this section blank.</fo:block>
               ...
               <fo:block-container background-color="transparent" border-style="none" position="absolute" left="28.484848484848488px" hyphenate="true" language="en" keep-together="always" top="479.39393939393943px" height="32.72727272727273px" width="478.7878787878788px">
                  <fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">In agreeing to the assurances/certification section 18 on the SF424 (R&amp;R) form, the authorized organizational representative agrees to comply with the following policies, assurances and/or certifications when applicable. Descriptions of individual assurances/certifications are provided at: http://grants.nih.gov/grants/funding/phs398/PolAssurDef.doc</fo:block>
               </fo:block-container>
