													...
													<fo:table width="100%">
														...
														<fo:table-body>
															<fo:table-row>
																...
																<fo:table-cell line-height="15pt" hyphenate="true" language="en">
																	<fo:block>
																		<xsl:value-of select="RR_OtherProjectInfo:InternationalActivities/RR_OtherProjectInfo:ActivitiesPartnershipsCountries"/>
																	</fo:block>
																</fo:table-cell>
															</fo:table-row>
														</fo:table-body>
