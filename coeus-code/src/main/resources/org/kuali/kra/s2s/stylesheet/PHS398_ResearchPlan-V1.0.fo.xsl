...
<!-- $Revision:   1.6  $ -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:globLib="http://apply.grants.gov/system/GlobalLibrary-V2.0" xmlns:att="http://apply.grants.gov/system/Attachments-V1.0" xmlns:glob="http://apply.grants.gov/system/Global-V1.0" xmlns:PHS398_ResearchPlan="http://apply.grants.gov/forms/PHS398_ResearchPlan-V1.0">
		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:footer="http://apply.grants.gov/system/Footer-V1.0" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:globLib="http://apply.grants.gov/system/GlobalLibrary-V1.0" xmlns:att="http://apply.grants.gov/system/Attachments-V1.0" xmlns:glob="http://apply.grants.gov/system/Global-V1.0">
			...
			<fo:page-sequence master-reference="default-page" format="1" initial-page-number="1">
				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block-container background-color="black" border-style="none" position="absolute" left="18px" top="380px" width="530px" height="0.30px">
                                            <fo:block/>
                                        </fo:block-container>
					<fo:block-container background-color="black" border-style="none" position="absolute" left="18px" top="555px" width="530px" height="0.30px">
                                           <fo:block/>
                                        </fo:block-container>
					<fo:block-container background-color="black" border-style="none" position="absolute" left="18px"  top="681px" width="530px" height="0.20px">
                                           <fo:block/>
                                        </fo:block-container>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="188.4848484848485px" hyphenate="true" language="en" top="259.39393939393943px" height="13.333333333333334px" width="340.21212121212122px">
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="188.4848484848485px" hyphenate="true" language="en" top="292.1212121212121px" height="13.333333333333334px" width="340.21212121212122px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
							<xsl:choose>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="188.4848484848485px" hyphenate="true" language="en" top="312.1212121212121px" height="13.333333333333334px" width="340.21212121212122px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
							<xsl:choose>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="188.4848484848485px" hyphenate="true" language="en" top="330.90909090909093px" height="13.333333333333334px" width="340.21212121212122px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
							<xsl:choose>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="188.4848484848485px" hyphenate="true" language="en" top="351.51515151515156px" height="13.333333333333334px" width="340.21212121212122px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
							<xsl:choose>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="188.4848484848485px" hyphenate="true" language="en" top="470px" height="13.333333333333334px" width="340.21212121212122px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
							<xsl:choose>
								...
								<xsl:otherwise>
								t<xsl:value-of select="//PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:InclusionOfWomenAndMinorities/PHS398_ResearchPlan:attFile/att:FileName"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="189.0909090909091px" hyphenate="true" language="en" top="530px" height="13.333333333333334px" width="340.21212121212122px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
							<xsl:choose>
								<xsl:when test="not(//PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:DataAndSafetyMonitoringPlan/PHS398_ResearchPlan:attFile/att:FileName) or /PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:DataAndSafetyMonitoringPlan/PHS398_ResearchPlan:attFile/att:FileName = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:DataAndSafetyMonitoringPlan/PHS398_ResearchPlan:attFile/att:FileName"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="189.0909090909091px" hyphenate="true" language="en" top="590px" height="13.333333333333334px" width="340.21212121212122px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
							<xsl:choose>
								<xsl:when test="not(//PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:VertebrateAnimals/PHS398_ResearchPlan:attFile/att:FileName) or /PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:VertebrateAnimals/PHS398_ResearchPlan:attFile/att:FileName = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:VertebrateAnimals/PHS398_ResearchPlan:attFile/att:FileName"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="189.0909090909091px" hyphenate="true" language="en" top="610px" height="13.333333333333334px" width="340.21212121212122px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
							<xsl:choose>
								<xsl:when test="not(//PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:ConsortiumContractualArrangements/PHS398_ResearchPlan:attFile/att:FileName) or /PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:ConsortiumContractualArrangements/PHS398_ResearchPlan:attFile/att:FileName = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:ConsortiumContractualArrangements/PHS398_ResearchPlan:attFile/att:FileName"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="189.0909090909091px" hyphenate="true" language="en" top="630px" height="13.333333333333334px" width="340.21212121212122px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
							<xsl:choose>
								<xsl:when test="not(//PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:LettersOfSupport/PHS398_ResearchPlan:attFile/att:FileName) or /PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:LettersOfSupport/PHS398_ResearchPlan:attFile/att:FileName = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:LettersOfSupport/PHS398_ResearchPlan:attFile/att:FileName"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="189.0909090909091px" hyphenate="true" language="en" top="650px" height="13.333333333333334px" width="340.21212121212122px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
							<xsl:choose>
								<xsl:when test="not(//PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:ResourceSharingPlans/PHS398_ResearchPlan:attFile/att:FileName) or /PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:ResourceSharingPlans/PHS398_ResearchPlan:attFile/att:FileName = ''">
									<fo:inline color="#FFFFFF">&#160;</fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:ResourceSharingPlans/PHS398_ResearchPlan:attFile/att:FileName"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="21.81818181818182px" hyphenate="true" language="en" top="292.1212121212121px" height="13.333333333333334px" width="68.48484848484848px">
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="21.81818181818182px" hyphenate="true" language="en" top="312.1212121212121px" height="13.333333333333334px" width="117.57575757575758px">
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="21.81818181818182px" hyphenate="true" language="en" top="330.90909090909093px" height="13.333333333333334px" width="148.4848484848485px">
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="21.81818181818182px" hyphenate="true" language="en" top="351.51515151515156px" height="13.333333333333334px" width="124.24242424242425px">
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="21.81818181818182px" hyphenate="true" language="en" top="450px" height="13.333333333333334px" width="123.63636363636364px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">6. Protection of Human Subjects</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="21.81818181818182px" hyphenate="true" language="en" top="470px" height="13.333333333333334px" width="135.75757575757575px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">7. Inclusion of Women and Minorities</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="21.81818181818182px" hyphenate="true" language="en" top="490px" height="13.333333333333334px" width="135.75757575757575px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">8. Targeted/Planned Enrollment Table</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="21.81818181818182px" hyphenate="true" language="en" top="510px" height="13.333333333333334px" width="85.45454545454545px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">9. Inclusion of Children</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="21.81818181818182px" hyphenate="true" language="en" top="530px" height="13.333333333333334px" width="130.3030303030303px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">10. Data and Safety Monitoring Plan</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="21.81818181818182px" hyphenate="true" language="en" top="590px" height="13.333333333333334px" width="87.87878787878789px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">11. Vertebrate Animals</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="21.81818181818182px" hyphenate="true" language="en" top="610px" height="13.333333333333334px" width="152.12121212121212px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">12. Consortium/Contractual Arrangements</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="21.81818181818182px" hyphenate="true" language="en" top="630px" height="13.333333333333334px" width="80.60606060606061px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">13. Letters of Support</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="21.81818181818182px" hyphenate="true" language="en" top="650px" height="13.333333333333334px" width="113.93939393939395px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">14. Resource Sharing Plan(s)</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="23.03030303030303px" hyphenate="true" language="en" top="695px" height="13.333333333333334px" width="100.60606060606061px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">15. Appendix</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="21.81818181818182px" hyphenate="true" language="en" top="259.39393939393943px" height="13.333333333333334px" width="106.66666666666667px">
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="21.81818181818182px" hyphenate="true" language="en" top="275.72727272727275px" height="13.333333333333334px" width="148.4848484848485px">
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="21.81818181818182px" hyphenate="true" language="en" top="414px" height="50.303030303030305px" width="513.939393939394px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal">Attachments 6-10 apply only when you have answered "yes" to the question "are human subjects involved" on the R&amp;R Other Project Information
Form. In this case, attachments 6-10 may be required, and you are encouraged to consult the Application guide instructions and/or the
specific Funding Opportunity Announcement to determine which sections must be submitted with this application.</fo:block>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="21.81818181818182px" hyphenate="true" language="en" top="570px" height="12.121212121212121px" width="125.15151515151516px">
      ...
      `                  </fo:table-cell>
							...
							<fo:table-row>
								<fo:table-cell hyphenate="true" language="en" padding-start="0pt" padding-end="0pt" padding-before="1pt" padding-after="1pt" display-align="before" text-align="left" border-style="solid" border-width="0pt" border-color="white" number-columns-spanned="2">
									...
									<fo:block font-size="10pt">DataAndSafetyMonitoringPlan_attDataGroup0</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
								<fo:table-cell hyphenate="true" language="en" padding-start="0pt" padding-end="0pt" padding-before="1pt" padding-after="1pt" display-align="before" text-align="left" border-style="solid" border-width="0pt" border-color="white">
							...
							<fo:table-row>
								...
								<fo:table-cell hyphenate="true" language="en" padding-start="0pt" padding-end="0pt" padding-before="1pt" padding-after="1pt" display-align="before" text-align="left" border-style="solid" border-width="0pt" border-color="white">
									<fo:block font-size="8pt">
										<xsl:value-of select="//PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:DataAndSafetyMonitoringPlan/PHS398_ResearchPlan:attFile/att:MimeType"/>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
							...
							<fo:table-row>
								...
								<fo:table-cell hyphenate="true" language="en" padding-start="0pt" padding-end="0pt" padding-before="1pt" padding-after="1pt" display-align="before" text-align="left" border-style="solid" border-width="0pt" border-color="white">
									<fo:block font-size="8pt">
										<xsl:value-of select="//PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:VertebrateAnimals/PHS398_ResearchPlan:attFile/att:MimeType"/>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
							...
							<fo:table-row>
								...
								<fo:table-cell hyphenate="true" language="en" padding-start="0pt" padding-end="0pt" padding-before="1pt" padding-after="1pt" display-align="before" text-align="left" border-style="solid" border-width="0pt" border-color="white">
									<fo:block font-size="8pt">
										<xsl:value-of select="//PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:ConsortiumContractualArrangements/PHS398_ResearchPlan:attFile/att:MimeType"/>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
							...
							<fo:table-row>
								...
								<fo:table-cell hyphenate="true" language="en" padding-start="0pt" padding-end="0pt" padding-before="1pt" padding-after="1pt" display-align="before" text-align="left" border-style="solid" border-width="0pt" border-color="white">
									<fo:block font-size="8pt">
										<xsl:value-of select="//PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:LettersOfSupport/PHS398_ResearchPlan:attFile/att:MimeType"/>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
							...
							<fo:table-row>
								...
								<fo:table-cell hyphenate="true" language="en" padding-start="0pt" padding-end="0pt" padding-before="1pt" padding-after="1pt" display-align="before" text-align="left" border-style="solid" border-width="0pt" border-color="white">
									<fo:block font-size="8pt">
										<xsl:value-of select="//PHS398_ResearchPlan:PHS398_ResearchPlan/PHS398_ResearchPlan:ResearchPlanAttachments/PHS398_ResearchPlan:HumanSubjectSection/PHS398_ResearchPlan:ResourceSharingPlans/PHS398_ResearchPlan:attFile/att:MimeType"/>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
