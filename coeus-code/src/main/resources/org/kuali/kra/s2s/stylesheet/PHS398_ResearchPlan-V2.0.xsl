...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
                              xmlns:PHS398_ResearchPlan_2_0="http://apply.grants.gov/forms/PHS398_ResearchPlan_2_0-V2.0" 
                ...
                <fo:flow flow-name="xsl-region-body">
                    <fo:block>
                        <xsl:for-each select="$XML">
                            ...
                            <fo:table font-family="Helvetica" font-size="9px" table-layout="fixed" width="100%" border="solid 1pt gray" border-spacing="2pt">
                                                        ...
                                                        <fo:table-row>
                                                            ...
                                                            <fo:table-cell padding="2pt" display-align="center">
                                                                <fo:block>
                                                                    ...
                                                                    <fo:table font-family="Georgia" font-size="9px" table-layout="fixed" width="100%" border-spacing="2pt">
                                                                        <fo:table-column column-width="proportional-column-width(1)"/>
                                                                        <fo:table-body start-indent="0pt">
                                                                            <fo:table-row>
                                                                                <fo:table-cell padding="2pt" display-align="center">
                                                                                    <fo:block>
                                                                                        ...
                                                                                        <xsl:for-each select="//PHS398_ResearchPlan_2_0:PHS398_ResearchPlan_2_0">
                                                                                            <xsl:for-each select="PHS398_ResearchPlan_2_0:ResearchPlanAttachments">
                                                                                                <xsl:for-each select="PHS398_ResearchPlan_2_0:IntroductionToApplication">
                                                                                                    <xsl:for-each select="PHS398_ResearchPlan_2_0:attFile">
                                                                            ...
                                                                            <fo:table-row>
                                                                                <fo:table-cell padding="2pt" display-align="center">
                                                                                    <fo:block>
                                                                                        ...
                                                                                        <xsl:for-each select="//PHS398_ResearchPlan_2_0:PHS398_ResearchPlan_2_0">
                                                                                            <xsl:for-each select="PHS398_ResearchPlan_2_0:ResearchPlanAttachments">
                                                                                                <xsl:for-each select="PHS398_ResearchPlan_2_0:SpecificAims">
                                                                                                    <xsl:for-each select="PHS398_ResearchPlan_2_0:attFile">
                                                                                                        <xsl:for-each select="att:FileName">
                                                                                                            <xsl:variable name="value-of-template">
                                                                                                                <xsl:apply-templates/>
                                                                            ...
                                                                            <fo:table-row>
                                                                                <fo:table-cell padding="2pt" display-align="center">
                                                                                    <fo:block>
                                                                                        ...
                                                                                        <xsl:for-each select="//PHS398_ResearchPlan_2_0:PHS398_ResearchPlan_2_0">
                                                                                            <xsl:for-each select="PHS398_ResearchPlan_2_0:ResearchPlanAttachments">
                                                                                                <xsl:for-each select="PHS398_ResearchPlan_2_0:ResearchStrategy">
                                                                                                    <xsl:for-each select="PHS398_ResearchPlan_2_0:attFile">
                                                                                                        <xsl:for-each select="att:FileName">
                                                                                                            <xsl:variable name="value-of-template">
                                                                                                                <xsl:apply-templates/>
                                                                            ...
                                                                            <fo:table-row>
                                                                                <fo:table-cell padding="2pt" display-align="center">
                                                                                    <fo:block>
                                                                                        ...
                                                                                        <xsl:for-each select="//PHS398_ResearchPlan_2_0:PHS398_ResearchPlan_2_0">
                                                                                            <xsl:for-each select="PHS398_ResearchPlan_2_0:ResearchPlanAttachments">
                                                                                                <xsl:for-each select="PHS398_ResearchPlan_2_0:ProgressReportPublicationList">
                                                                                                    <xsl:for-each select="PHS398_ResearchPlan_2_0:attFile">
                                                                                                        <xsl:for-each select="att:FileName">
                                                                                                            <xsl:variable name="value-of-template">
                                                                                                                <xsl:apply-templates/>
                                                    ...
                                                    <fo:table-body start-indent="0pt">
                                                            ...
                                                            <fo:table-cell number-columns-spanned="2" padding="2pt" display-align="center">
                                                                <fo:block>
                                                                    <fo:inline font-weight="bold" font-size="10px">
                                                                        <xsl:text>Human Subjects Sections</xsl:text>
                                                                    </fo:inline>
                                                                </fo:block>
                                                            </fo:table-cell>
                                                        </fo:table-row>
                                                                            ...
                                                                            <fo:table-row>
                                                                                <fo:table-cell padding="2pt" display-align="center">
                                                                                    <fo:block>
                                                                                        ...
                                                                                        <xsl:for-each select="//PHS398_ResearchPlan_2_0:PHS398_ResearchPlan_2_0">
                                                                                            <xsl:for-each select="PHS398_ResearchPlan_2_0:ResearchPlanAttachments">
                                                                                                <xsl:for-each select="PHS398_ResearchPlan_2_0:HumanSubjectSection">
                                                                                                    <xsl:for-each select="PHS398_ResearchPlan_2_0:ProtectionOfHumanSubjects">
                                                                                                        <xsl:for-each select="PHS398_ResearchPlan_2_0:attFile">
                                                                                                            <xsl:for-each select="att:FileName">
                                                                                                                <xsl:variable name="value-of-template">
                                                                                                                    <xsl:apply-templates/>
                                                        ...
                                                        <fo:table-row>
                                                            <fo:table-cell padding="2pt" display-align="center">
                                                                <fo:block>
                                                                    <fo:inline>
                                                                        <xsl:text>6. Inclusion of Women and Minorities</xsl:text>
                                                                    </fo:inline>
                                                                </fo:block>
                                                            </fo:table-cell>
                                                            <fo:table-cell padding="2pt" display-align="center">
                                                                                ...
                                                                                <fo:table-cell padding="2pt" display-align="center">
                                                                                    <fo:block>
                                                                                        ...
                                                                                        <xsl:for-each select="//PHS398_ResearchPlan_2_0:PHS398_ResearchPlan_2_0">
                                                                                            <xsl:for-each select="PHS398_ResearchPlan_2_0:ResearchPlanAttachments">
                                                                                                <xsl:for-each select="PHS398_ResearchPlan_2_0:HumanSubjectSection">
                                                                                                    <xsl:for-each select="PHS398_ResearchPlan_2_0:InclusionOfWomenAndMinorities">
                                                                                                        <xsl:for-each select="PHS398_ResearchPlan_2_0:attFile">
                                                                                                            <xsl:for-each select="att:FileName">
                                                                                                                <xsl:variable name="value-of-template">
                                                                                                                    <xsl:apply-templates/>
                                                        ...
                                                        <fo:table-row>
                                                            <fo:table-cell padding="2pt" display-align="center">
                                                                <fo:block>
                                                                    <fo:inline>
                                                                        <xsl:text>7. Inclusion of Children</xsl:text>
                                                                    </fo:inline>
                                                                </fo:block>
                                                            </fo:table-cell>
                                                            <fo:table-cell padding="2pt" display-align="center">
                                                                                ...
                                                                                <fo:table-cell padding="2pt" display-align="center">
                                                                                    <fo:block>
                                                                                        ...
                                                                                        <xsl:for-each select="//PHS398_ResearchPlan_2_0:PHS398_ResearchPlan_2_0">
                                                                                            <xsl:for-each select="PHS398_ResearchPlan_2_0:ResearchPlanAttachments">
                                                                                                <xsl:for-each select="PHS398_ResearchPlan_2_0:HumanSubjectSection">
                                                                                                    <xsl:for-each select="PHS398_ResearchPlan_2_0:InclusionOfChildren">
                                                                                                        <xsl:for-each select="PHS398_ResearchPlan_2_0:attFile">
                                                                                                            <xsl:for-each select="att:FileName">
                                                                                                                <xsl:variable name="value-of-template">
                                                                                                                    <xsl:apply-templates/>
                                                                            ...
                                                                            <fo:table-row>
                                                                                <fo:table-cell padding="2pt" display-align="center">
                                                                                    <fo:block>
                                                                                        ...
                                                                                        <xsl:for-each select="//PHS398_ResearchPlan_2_0:PHS398_ResearchPlan_2_0">
                                                                                            <xsl:for-each select="PHS398_ResearchPlan_2_0:ResearchPlanAttachments">
                                                                                                <xsl:for-each select="PHS398_ResearchPlan_2_0:OtherResearchPlanSections">
                                                                                                    <xsl:for-each select="PHS398_ResearchPlan_2_0:VertebrateAnimals">
                                                                                                        <xsl:for-each select="PHS398_ResearchPlan_2_0:attFile">
                                                                                                            <xsl:for-each select="att:FileName">
                                                                                                                <xsl:variable name="value-of-template">
                                                                                                                    <xsl:apply-templates/>
                                                                                ...
                                                                                <fo:table-cell padding="2pt" display-align="center">
                                                                                    <fo:block>
                                                                                        ...
                                                                                        <xsl:for-each select="//PHS398_ResearchPlan_2_0:PHS398_ResearchPlan_2_0">
                                                                                            <xsl:for-each select="PHS398_ResearchPlan_2_0:ResearchPlanAttachments">
                                                                                                <xsl:for-each select="PHS398_ResearchPlan_2_0:OtherResearchPlanSections">
                                                                                                    <xsl:for-each select="PHS398_ResearchPlan_2_0:SelectAgentResearch">
                                                                                                        <xsl:for-each select="PHS398_ResearchPlan_2_0:attFile">
                                                                                                            <xsl:for-each select="att:FileName">
                                                                                                                <xsl:variable name="value-of-template">
                                                                                                                    <xsl:apply-templates/>
                                                                                ...
                                                                                <fo:table-cell padding="2pt" display-align="center">
                                                                                    <fo:block>
                                                                                        ...
                                                                                        <xsl:for-each select="//PHS398_ResearchPlan_2_0:PHS398_ResearchPlan_2_0">
                                                                                            <xsl:for-each select="PHS398_ResearchPlan_2_0:ResearchPlanAttachments">
                                                                                                <xsl:for-each select="PHS398_ResearchPlan_2_0:OtherResearchPlanSections">
                                                                                                    <xsl:for-each select="PHS398_ResearchPlan_2_0:MultiplePDPILeadershipPlan">
                                                                                                        <xsl:for-each select="PHS398_ResearchPlan_2_0:attFile">
                                                                                                            <xsl:for-each select="att:FileName">
                                                                                                                <xsl:variable name="value-of-template">
                                                                                                                    <xsl:apply-templates/>
                                                                                ...
                                                                                <fo:table-cell padding="2pt" display-align="center">
                                                                                    <fo:block>
                                                                                        ...
                                                                                        <xsl:for-each select="//PHS398_ResearchPlan_2_0:PHS398_ResearchPlan_2_0">
                                                                                            <xsl:for-each select="PHS398_ResearchPlan_2_0:ResearchPlanAttachments">
                                                                                                <xsl:for-each select="PHS398_ResearchPlan_2_0:OtherResearchPlanSections">
                                                                                                    <xsl:for-each select="PHS398_ResearchPlan_2_0:ConsortiumContractualArrangements">
                                                                                                        <xsl:for-each select="PHS398_ResearchPlan_2_0:attFile">
                                                                                                            <xsl:for-each select="att:FileName">
                                                                                                                <xsl:variable name="value-of-template">
                                                                                                                    <xsl:apply-templates/>
                                                    ...
                                                    <fo:table-body start-indent="0pt">
                                                        <fo:table-row>
                                                            <fo:table-cell padding="2pt" display-align="center">
                                                                <fo:block>
                                                                    <fo:inline>
                                                                        <xsl:text>12. Letters of Support</xsl:text>
                                                                    </fo:inline>
                                                                </fo:block>
                                                            </fo:table-cell>
                                                            <fo:table-cell padding="2pt" display-align="center">
                                                                                ...
                                                                                <fo:table-cell padding="2pt" display-align="center">
                                                                                    <fo:block>
                                                                                        ...
                                                                                        <xsl:for-each select="//PHS398_ResearchPlan_2_0:PHS398_ResearchPlan_2_0">
                                                                                            <xsl:for-each select="PHS398_ResearchPlan_2_0:ResearchPlanAttachments">
                                                                                                <xsl:for-each select="PHS398_ResearchPlan_2_0:OtherResearchPlanSections">
                                                                                                    <xsl:for-each select="PHS398_ResearchPlan_2_0:LettersOfSupport">
                                                                                                        <xsl:for-each select="PHS398_ResearchPlan_2_0:attFile">
                                                                                                            <xsl:for-each select="att:FileName">
                                                                                                                <xsl:variable name="value-of-template">
                                                                                                                    <xsl:apply-templates/>
                                                        ...
                                                        <fo:table-row>
                                                            <fo:table-cell padding="2pt" display-align="center">
                                                                <fo:block>
                                                                    <fo:inline>
                                                                        <xsl:text>13. Resource Sharing Plan(s)</xsl:text>
                                                                    </fo:inline>
                                                                </fo:block>
                                                            </fo:table-cell>
                                                            <fo:table-cell padding="2pt" display-align="center">
                                                                                ...
                                                                                <fo:table-cell padding="2pt" display-align="center">
                                                                                    <fo:block>
                                                                                        ...
                                                                                        <xsl:for-each select="//PHS398_ResearchPlan_2_0:PHS398_ResearchPlan_2_0">
                                                                                            <xsl:for-each select="PHS398_ResearchPlan_2_0:ResearchPlanAttachments">
                                                                                                <xsl:for-each select="PHS398_ResearchPlan_2_0:OtherResearchPlanSections">
                                                                                                    <xsl:for-each select="PHS398_ResearchPlan_2_0:ResourceSharingPlans">
                                                                                                        <xsl:for-each select="PHS398_ResearchPlan_2_0:attFile">
                                                                                                            <xsl:for-each select="att:FileName">
                                                                                                                <xsl:variable name="value-of-template">
                                                                                                                    <xsl:apply-templates/>
                                                        ...
                                                        <fo:table-row>
                                                            ...
                                                            <fo:table-cell padding="2pt" display-align="center">
                                                                <fo:block>
                                                                    ...
                                                                    <xsl:if test="//PHS398_ResearchPlan_2_0:PHS398_ResearchPlan_2_0/PHS398_ResearchPlan_2_0:ResearchPlanAttachments/PHS398_ResearchPlan_2_0:Appendix/att:AttachedFile">
                                                                        <fo:table table-layout="fixed" width="100%" border-spacing="2pt">
                                                                            <fo:table-column column-width="proportional-column-width(1)"/>
                                                                            <fo:table-body start-indent="0pt">
                                                                                <xsl:for-each select="//PHS398_ResearchPlan_2_0:PHS398_ResearchPlan_2_0">
                                                                                    <xsl:for-each select="PHS398_ResearchPlan_2_0:ResearchPlanAttachments">
                                                                                        <xsl:for-each select="PHS398_ResearchPlan_2_0:Appendix">
                            ...
                            <fo:table-cell padding="0" text-align="left" display-align="center">
                                <fo:block>
                                    <fo:inline font-family="Helvetica" font-size="9px">
                                        <xsl:text>Please attach applicable sections of the research plan, below.</xsl:text>
                                    </fo:inline>
                                </fo:block>
                            </fo:table-cell>
                            <fo:table-cell padding="0" text-align="right" display-align="center">
                                <fo:block>
                                    <fo:inline font-family="Helvetica" font-size="6px">
