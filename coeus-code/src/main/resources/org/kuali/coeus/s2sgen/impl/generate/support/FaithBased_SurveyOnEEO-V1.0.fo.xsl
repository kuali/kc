...
xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:FaithBased_SurveyOnEEO="http://apply.grants.gov/forms/FaithBased_SurveyOnEEO-V1.0" xmlns:glob="http://apply.grants.gov/system/Global-V1.0" xmlns:globLib="http://apply.grants.gov/system/GlobalLibrary-V1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
                                        ...
                                        <fo:table-cell text-align="center" padding-start="3pt" padding-end="3pt" padding-before="3pt" padding-after="3pt" display-align="center" border-style="solid" border-width="1pt" border-color="black">
                                            <fo:block>
                                                <fo:table width="100%" space-before.optimum="1pt" space-after.optimum="2pt">
                                                    ...
                                                    <fo:table-body>
                                                        <fo:table-row>
                                                            <fo:table-cell display-align="center" number-columns-spanned="2" text-align="center" width="169pt" padding-start="1pt" padding-end="1pt" padding-before="1pt" padding-after="1pt" border-style="solid" border-width="1pt" border-color="white"><fo:block>
                                                                                                                ...
                                                                                                                <fo:table-body>
                                                                                                                    <fo:table-row>
                                                                                                                        <fo:table-cell number-columns-spanned="2" width="25%" padding-start="1pt" padding-end="1pt" padding-before="1pt" padding-after="1pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="white">
                                                                                                                            <fo:block>
                                                                                                                                <fo:inline font-size="12px" font-weight="bold">Applicant's (Organization) Name:</fo:inline><xsl:text> </xsl:text> <xsl:for-each select="globLib:OrganizationName">
                                                                                                                                    <fo:inline font-size="12px" font-weight="normal">
                                                                                                                                        <xsl:apply-templates />
                                                                                                                                    </fo:inline>
  </xsl:for-each>
                                                                                                                            </fo:block>
                                                                                                                    ...
                                                                                                                    <fo:table-row>
                                                                                                                        <fo:table-cell number-columns-spanned="2" width="25%" padding-start="1pt" padding-end="1pt" padding-before="1pt" padding-after="1pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="white">
                                                                                                                            <fo:block>
                                                                                                                                <fo:inline font-size="12px" font-weight="bold">Applicant's DUNS Name:</fo:inline><xsl:text> </xsl:text><xsl:for-each select="globLib:DUNSID">
                                                                                                                                    <fo:inline font-size="12px" font-weight="normal">
                                                                                                                                        <xsl:apply-templates />
                                                                                                                                    </fo:inline>
                                                                                                                                </xsl:for-each>
                                                                                                                    ...
                                                                                                                    <fo:table-row>
                                                                                                                         <fo:table-cell number-columns-spanned="2" width="25%" padding-start="1pt" padding-end="1pt" padding-before="1pt" padding-after="1pt" display-align="center" text-align="start" border-style="solid" border-width="1pt" border-color="white">
                                                                                                                            <fo:block>
                                                                                                                                <fo:inline font-size="12px" font-weight="bold">Grant Title: </fo:inline><xsl:text> </xsl:text>   <xsl:for-each select="globLib:OpportunityTitle">
                                                                                                                                    <fo:inline font-size="12px" font-weight="normal">
                                                                                                                                        <xsl:apply-templates />
                                                                                                                                    </fo:inline>
</xsl:for-each>
                                                                                                                            ...
                                                                                                                            <fo:block>
                                                                                                                                <fo:inline font-size="12px" font-weight="bold">CFDA Number:</fo:inline><xsl:text> </xsl:text>  <xsl:for-each select="globLib:CFDANumber">
                                                                                                                                    <fo:inline font-size="12px" font-weight="normal">
                                                                                                                                        <xsl:apply-templates />
                                                                                                                                    </fo:inline>
                                                                                                                                </xsl:for-each>
