...
<!--  $Revision:   1.3  $ 
  -->
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:globLib="http://apply.grants.gov/system/GlobalLibrary-V1.0" xmlns:att="http://apply.grants.gov/system/Attachments-V1.0" xmlns:glob="http://apply.grants.gov/system/Global-V1.0" xmlns:PHS398_CoverLetter="http://apply.grants.gov/forms/PHS398_CoverLetter-V1.0">
				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="161.8181818181818px" hyphenate="true" language="en" top="115.75757575757576px" height="13.333333333333334px" width="318.7878787878788px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="normal" border-top-style="solid" border-bottom-style="solid" border-start-style="solid" border-end-style="solid">
							<xsl:choose>
								<xsl:when test="not(//PHS398_CoverLetter:PHS398_CoverLetter/PHS398_CoverLetter:CoverLetterFile/PHS398_CoverLetter:CoverLetterFilename/att:FileName) or /PHS398_CoverLetter:PHS398_CoverLetter/PHS398_CoverLetter:CoverLetterFile/PHS398_CoverLetter:CoverLetterFilename/att:FileName = ''">
									<fo:inline color="#FFFFFF"> </fo:inline>
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="//PHS398_CoverLetter:PHS398_CoverLetter/PHS398_CoverLetter:CoverLetterFile/PHS398_CoverLetter:CoverLetterFilename/att:FileName"/>
								</xsl:otherwise>
							</xsl:choose>
						</fo:block>
					</fo:block-container>
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="200.181818181818183px" hyphenate="true" language="en" top="40.30303030303031px" height="20.606060606060606px" width="160.3939393939394px">
						<fo:block background-color="transparent" color="#000000" font-size="14pt" font-style="normal" font-family="Helvetica" font-weight="bold">PHS 398 Cover Letter</fo:block>
					</fo:block-container>
					...
					<fo:block-container background-color="transparent" border-style="none" position="absolute" left="18.78787878787879px" hyphenate="true" language="en" top="115.15151515151516px" height="13.333333333333334px" width="140.27272727272728px">
						<fo:block background-color="transparent" color="#000000" font-size="8pt" font-style="normal" font-family="Helvetica" font-weight="bold">Mandatory Cover Letter Filename:</fo:block>
					</fo:block-container>
				</fo:flow>
			</fo:page-sequence>
						...
						<fo:table-body>
							...
							<fo:table-row>
								<fo:table-cell hyphenate="true" language="en" padding-start="0pt" padding-end="0pt" padding-before="1pt" padding-after="1pt" display-align="before" text-align="left" border-style="solid" border-width="0pt" border-color="white" number-columns-spanned="2">
									...
									<fo:block font-size="10pt">CoverLetterFilename_attDataGroup0</fo:block>
								</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
							...
							<fo:table-row>
								...
								<fo:table-cell hyphenate="true" language="en" padding-start="0pt" padding-end="0pt" padding-before="1pt" padding-after="1pt" display-align="before" text-align="left" border-style="solid" border-width="0pt" border-color="white">
									<fo:block font-size="8pt">
										<xsl:value-of select="//PHS398_CoverLetter:PHS398_CoverLetter/PHS398_CoverLetter:CoverLetterFile/PHS398_CoverLetter:CoverLetterFilename/att:MimeType"/>
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
						</fo:table-body>
