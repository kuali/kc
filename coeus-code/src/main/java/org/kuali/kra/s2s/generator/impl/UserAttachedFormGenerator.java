...
public class UserAttachedFormGenerator extends S2SBaseFormGenerator {
    ...
    private S2sUserAttachedFormAttFile findS2sUserAttachedFormAttFile(S2sUserAttachedFormAttContract s2sUserAttachedFormAtt) {
        if(s2sUserAttachedFormAtt!=null){
            S2sUserAttachedFormAttFile attachedFile = (S2sUserAttachedFormAttFile) KcServiceLocator.getService(S2sUserAttachedFormService.class).
    ...
    private S2sUserAttachedFormFile findUserAttachedFormFile() {
        ...
        if(userAttachedForm!=null){
            S2sUserAttachedFormFile attachedFile = (S2sUserAttachedFormFile) KcServiceLocator.getService(S2sUserAttachedFormService.class).
