...
import org.kuali.kra.s2s.depend.NarrativeCleanupService;
...
public abstract class RRBudgetBaseGenerator extends S2SBaseFormGenerator {
    ...
    protected NarrativeCleanupService narrativeCleanupService;
	...
	public RRBudgetBaseGenerator() {
        ...
        narrativeCleanupService = KcServiceLocator.getService(NarrativeCleanupService.class);
