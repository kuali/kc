...
public class RRFedNonFedBudgetV1_0Generator extends RRFedNonFedBudgetBaseGenerator {
    ...
    @Value("http://apply.grants.gov/forms/RR_FedNonFedBudget-V1.0")
    private String namespace;

    @Value("RR_FedNonFedBudget-V1.0")
    private String formName;

    @Value("classpath:org/kuali/coeus/s2sgen/impl/generate/support/RR_FedNonFedBudget-V1.0.fo.xsl")
    private Resource stylesheet;

    @Value("gov.grants.apply.forms.rrFedNonFedBudgetV10")
