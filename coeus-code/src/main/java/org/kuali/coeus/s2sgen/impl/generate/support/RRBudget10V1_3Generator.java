...
public class RRBudget10V1_3Generator extends RRBudgetBaseGenerator {
    ...
    @Value("http://apply.grants.gov/forms/RR_Budget10_1_3-V1.3")
    private String namespace;

    @Value("RR_Budget10_1_3")
    private String formName;

    @Value("classpath:org/kuali/coeus/s2sgen/impl/generate/support/RR_Budget10-V1-3.fo.xsl")
    private Resource stylesheet;

    @Value("gov.grants.apply.forms.rrBudget1013V13")
