...
public class NSFCoverPageV1_0Generator extends NSFCoverPageBaseGenerator {
    ...
    @Value("classpath:org/kuali/coeus/s2sgen/impl/generate/support/NSF_CoverPage-V1.0.fo.xsl")
    private Resource stylesheet;

    @Value("gov.grants.apply.forms.nsfCoverPageV10")
    ...
    private NSFCoverPageDocument getNSFCoverPage() {
        ...
        nsfCoverPage.setFormVersion(FormVersion.v1_0.getVersion());
