...
public class PHS398ModularBudgetV1_0Generator extends
    ...
    @Value("classpath:org/kuali/coeus/s2sgen/impl/generate/support/PHS398_ModularBudget-V1.0.fo.xsl")
    private Resource stylesheet;

    @Value("gov.grants.apply.forms.phs398ModularBudgetV10")
	...
	private PHS398ModularBudgetDocument getPHS398ModularBudget() {
		...
		PHS398ModularBudget modularBudget = PHS398ModularBudget.Factory
				.newInstance();
		modularBudget.setFormVersion(FormVersion.v1_0.getVersion());
