...
public class GGLobbyingFormV1_1Generator extends GGLobbyingFormBaseGenerator {
    ...
    @Value("http://apply.grants.gov/forms/GG_LobbyingForm-V1.1")
    private String namespace;

    @Value("GG_LobbyingForm-V1.1")
    private String formName;

    @Value("classpath:org/kuali/coeus/s2sgen/impl/generate/support/GG_LobbyingForm-V1.1.fo.xsl")
    private Resource stylesheet;

    @Value("gov.grants.apply.forms.ggLobbyingFormV11")
