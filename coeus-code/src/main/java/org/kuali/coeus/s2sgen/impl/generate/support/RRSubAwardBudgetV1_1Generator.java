...
public class RRSubAwardBudgetV1_1Generator extends S2SAdobeFormAttachmentBaseGenerator {
    ...
    @Value("http://apply.grants.gov/forms/RR_SubawardBudget-V1.1")
    private String namespace;

    @Value("RR_SubawardBudget-V1.1")
    private String formName;

    @Value("classpath:org/kuali/coeus/s2sgen/impl/generate/support/RR_SubawardBudget-V1.1.fo.xsl")
    private Resource stylesheet;

    @Value("gov.grants.apply.forms.rrSubawardBudgetV11")
