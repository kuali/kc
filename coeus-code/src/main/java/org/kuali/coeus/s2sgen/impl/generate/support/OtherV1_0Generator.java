...
public class OtherV1_0Generator extends OtherBaseGenerator {
    ...
    @Value("http://apply.grants.gov/forms/Other-V1.0")
    private String namespace;

    @Value("Other-V1.0")
    private String formName;

    @Value("classpath:org/kuali/coeus/s2sgen/impl/generate/support/Other-V1.0.fo.xsl")
    private Resource stylesheet;

    @Value("gov.grants.apply.forms.otherV10")
