...
public class PerformanceSiteV1_4Generator extends PerformanceSiteBaseGenerator {
    ...
    @Value("classpath:org/kuali/coeus/s2sgen/impl/generate/support/PerformanceSite-V1.4.xsl")
    private Resource stylesheet;

    @Value("gov.grants.apply.forms.performanceSite14V14")
	...
	private XmlObject getPerformanceSite() {
		...
		PerformanceSite14 performanceSite14 = PerformanceSite14.Factory
				.newInstance();
		performanceSite14.setFormVersion(FormVersion.v1_4.getVersion());
