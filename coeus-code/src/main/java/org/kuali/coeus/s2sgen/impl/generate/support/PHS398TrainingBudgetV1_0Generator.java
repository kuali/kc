...
import org.kuali.coeus.s2sgen.impl.budget.IndirectCostDto;
        ...
        for (BudgetPeriodContract budgetPeriod : budgetPeriods) {
            ...
            if (phs398TrainingBudgetYearDataType.getResearchDirectCostsRequested() != null) {
                ...
                if (researchDirectCostValue < ZERO) {
                    ...
                    AuditError stipendError = new AuditError(AuditError.NO_FIELD_ERROR_KEY, GRANTS_GOV_STIPEND_ERROR_MESSAGE, AuditError.GG_LINK);
