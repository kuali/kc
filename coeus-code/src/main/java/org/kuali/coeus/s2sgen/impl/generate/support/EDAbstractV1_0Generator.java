...
public class EDAbstractV1_0Generator extends EDAbstractBaseGenerator {
    ...
    @Value("http://apply.grants.gov/forms/ED_Abstract-V1.0")
    private String namespace;

    @Value("ED_Abstract-V1.0")
    private String formName;

    @Value("classpath:org/kuali/coeus/s2sgen/impl/generate/support/ED_Abstract-V1.0.fo.xsl")
    private Resource stylesheet;

    @Value("gov.grants.apply.forms.edAbstractV10")
    ...
    private AbstractAttachmentsDocument getAbstractAttachments() {
        ...
        abstractAttachments.setFormVersion(FormVersion.v1_0.getVersion());
