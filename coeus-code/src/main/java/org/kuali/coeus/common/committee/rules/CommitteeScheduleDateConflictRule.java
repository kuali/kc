...
import org.kuali.coeus.common.committee.rule.event.CommitteeScheduleDateConflictEvent;
...
public class CommitteeScheduleDateConflictRule extends KcTransactionalDocumentRuleBase implements KcBusinessRule<CommitteeScheduleDateConflictEvent> {
    ...
    /**
     * @see org.kuali.coeus.common.committee.rule.BusinessRuleInterface#processRules(org.kuali.coeus.sys.framework.rule.KcDocumentEventBase)
     */
