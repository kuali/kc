 ...
 */
package org.kuali.coeus.common.committee.rules;

import org.apache.commons.lang.StringUtils;
import org.kuali.coeus.common.committee.bo.CommitteeScheduleBase;
import org.kuali.coeus.common.committee.rule.event.CommitteeScheduleTimeEvent;
...
public class CommitteeScheduleTimeRule extends KcTransactionalDocumentRuleBase implements KcBusinessRule<CommitteeScheduleTimeEvent> {
    ...
    /**
     * @see org.kuali.coeus.common.committee.rule.FilterCommitteeScheduleRule#processRules(org.kuali.coeus.common.committee.rule.event.FilterCommitteeScheduleEvent)
     */
    ...
    private boolean processCommitteeSchedules(List<CommitteeScheduleBase> committeeSchedules) {

        boolean rulePassed = true;
        int count = 0;

        for (CommitteeScheduleBase cs : committeeSchedules) {
