## Lite View Protocol Submissions [/research-sys/api/v1/lite-view-protocol-submissions/]

### Get Lite View Protocol Submissions by Key [GET /research-sys/api/v1/lite-view-protocol-submissions/(key)]
...
### Get All Lite View Protocol Submissions [GET /research-sys/api/v1/lite-view-protocol-submissions/]
...
### Update Lite View Protocol Submissions [PUT /research-sys/api/v1/lite-view-protocol-submissions/(key)]
...
### Update Multiple Lite View Protocol Submissions [PUT /research-sys/api/v1/lite-view-protocol-submissions/]
...
### Insert Lite View Protocol Submissions [POST /research-sys/api/v1/lite-view-protocol-submissions/]
...
### Insert Multiple Lite View Protocol Submissions [POST /research-sys/api/v1/lite-view-protocol-submissions/]
...
### Delete Lite View Protocol Submissions by Key [DELETE /research-sys/api/v1/lite-view-protocol-submissions/(key)]
