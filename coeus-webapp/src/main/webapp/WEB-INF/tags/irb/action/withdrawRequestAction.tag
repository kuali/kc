...
<kul:innerTab tabTitle="Withdraw Submission" parentTab="" defaultOpen="false" tabErrorKey="actionHelper.protocolWithdrawSubmissionBean*">
        ...
        <table class="tab" cellpadding="0" cellspacing="0" summary=""> 
            <tbody>
                <tr>
                    ...
                    <td>
                        <nobr>
                        <kul:htmlControlAttribute property="actionHelper.protocolWithdrawSubmissionBean.reason" attributeEntry="${attributes.reason}" />
                        </nobr>
                    </td>
                </tr>
                <tr>
