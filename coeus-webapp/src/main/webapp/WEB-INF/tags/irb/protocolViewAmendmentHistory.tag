           			    ...
           			    <td class="infoline" colspan="5">
							...
							<kul:innerTab tabTitle="${summaryTabTitle}" parentTab="" defaultOpen="false">
    							<div class="innerTab-container">
					        		...
					        		<kra-irb:protocolSummary prefix="protocolSummary.amendRenewProtocol.protocolSummary" protocolSummary="${KualiForm.actionHelper.amendmentSummaries[status.index].amendRenewProtocol.protocolSummary}" />
					        	</div>
					        </kul:innerTab>
					    </td>
					</tr>
