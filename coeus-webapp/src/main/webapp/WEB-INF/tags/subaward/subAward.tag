	...
	<div class="tab-container" align="center">
        ...
        <table cellpadding=0 cellspacing=0 summary="">
            ...
            <tr>
                ...
                <th><div align="right"><kul:htmlAttributeLabel attributeEntry="${subAwardAttributes.fsrsSubawardNumber}" /></div></th>
                <td><kul:htmlControlAttribute property="document.subAwardList[0].fsrsSubawardNumber" attributeEntry="${subAwardAttributes.fsrsSubawardNumber}" /></td>
            </tr>
        </table>
    </div>
</kul:tab>
